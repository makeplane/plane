...
export class AnalyticsV2Service extends APIService {
    ...
    async getAdvanceAnalyticsStats<T>(workspaceSlug: string, tab: Exclude<TAnalyticsTabsV2Base, "overview">, params?: Record<string, any>): Promise<T> {
    ...
    async getAdvanceAnalyticsCharts<T>(workspaceSlug: string, tab: TAnalyticsGraphsV2Base, params?: Record<string, any>): Promise<T> {
