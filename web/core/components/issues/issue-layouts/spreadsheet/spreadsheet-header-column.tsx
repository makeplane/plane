...
export const SpreadsheetHeaderColumn = observer((props: Props) => {
  ...
  return (
    ...
    >
      <th
        className="h-11 w-full min-w-36 max-w-64 items-center bg-custom-background-90 text-sm font-medium py-1 border border-b-0 border-t-0 border-custom-border-100"
