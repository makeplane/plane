...
import { CustomMenu, CustomRow } from "@plane/ui";
//hooks
...
export const HeaderColumn = (props: Props) => {
  ...
  return (
    <CustomMenu
      ...
      className="!w-full"
      customButton={
        <CustomRow className="flex w-full cursor-pointer items-center justify-between gap-1.5 py-2 text-sm text-custom-text-200 hover:text-custom-text-100">
