...
export const SpreadsheetHeader = observer((props: Props) => {
  ...
  return (
    <thead className="sticky top-0 right-0 z-[12] border-b-[0.5px] border-custom-border-100">
      <tr>
        <th
          className="group/list-header sticky right-0 z-[15] h-11 w-[28rem] flex items-center gap-1 bg-custom-background-90 text-sm font-medium before:absolute before:h-full before:left-0 before:border-custom-border-100"
          tabIndex={-1}
        >
          <Row>
            {canSelectIssues && (
              <div className="flex-shrink-0 flex items-center w-3.5 ml-1 absolute right-1 py-[11px]">
