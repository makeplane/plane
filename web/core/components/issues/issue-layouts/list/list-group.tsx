...
import { CustomRow, setToast, TOAST_TYPE } from "@plane/ui";
// components
...
export const ListGroup = observer((props: Props) => {
  ...
  return validateEmptyIssueGroups(groupIssueCount) ? (
    ...
    >
      <CustomRow className="sticky top-0 z-[2] w-full flex-shrink-0 border-b border-custom-border-200 bg-custom-background-90 pr-3 py-1">
        <HeaderGroupByCard
          groupID={group.id}
          icon={group.icon}
          title={group.name || ""}
