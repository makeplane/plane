          ...
          >
            <Popover.Panel className="fixed z-50">
              <div
                ...
                style={styles.popper}
                {...attributes.popper}
                className="absolute left-0 z-10 mt-1 min-w-[12rem] overflow-hidden rounded border border-custom-border-200 bg-custom-background-100 p-1 shadow-custom-shadow-sm"
              >
                <div>
