          ...
          <Controller
            ...
            render={({ field: { value, onChange } }) => (
              <RichTextEditor
                ...
                ref={editorRef}
                tabIndex={getTabIndex("description_html", ETabIndices.ISSUE_FORM, isMobile)}
          ...
          <div className="border-0.5 z-10 flex items-center justify-end gap-2 p-3">
            {issueName && issueName.trim() !== "" && config?.has_openai_configured && (
              <button
                ...
                tabIndex={getTabIndex("feeling_lucky", ETabIndices.ISSUE_FORM, isMobile)}
              >
                {iAmFeelingLucky ? (
                  "Generating response"
                ) : (
              ...
              <GptAssistantPopover
                ...
                button={
                  <button
                    ...
                    tabIndex={getTabIndex("ai_assistant", ETabIndices.ISSUE_FORM, isMobile)}
                  >
