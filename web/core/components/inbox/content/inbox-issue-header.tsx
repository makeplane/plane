...
import { Button, ControlLink, CustomMenu, CustomRow, TOAST_TYPE, setToast } from "@plane/ui";
// components
import {
  DeclineIssueModal,
...
export const InboxIssueActionsHeader: FC<TInboxIssueActionsHeader> = observer((props) => {
  ...
  return (
    <>
      ...
      <CustomRow className="hidden relative lg:flex h-full w-full items-center justify-between gap-2">
