  ...
  return (
    <>
      {(isHovering || isRightResizing) && dateString && (
        <div className="z-[10] absolute flex text-xs font-normal text-custom-text-300 h-full w-32 -left-36 justify-start items-center">
      ...
      <div
        className={cn(
          ...
          {
            "-left-1.5 opacity-100": isRightResizing,
          }
        )}
      />
    </>
