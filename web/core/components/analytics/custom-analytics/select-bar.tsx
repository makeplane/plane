...
export const CustomAnalyticsSelectBar: React.FC<Props> = observer((props) => {
  ...
  return (
    ...
    >
      {!isProjectLevel && (
        <div>
          <h6 className="text-xs text-custom-text-200 my-2">Project</h6>
          <Controller
            name="project"
            control={control}
      ...
      <div>
        <h6 className="text-xs text-custom-text-200 my-2">Measure (y-axis)</h6>
        <Controller
          name="y_axis"
          control={control}
      ...
      <div>
        <h6 className="text-xs text-custom-text-200 my-2">Dimension (x-axis)</h6>
        <Controller
          name="x_axis"
          control={control}
          render={({ field: { value, onChange } }) => (
      ...
      <div>
        <h6 className="text-xs text-custom-text-200 my-2">Group</h6>
        <Controller
          name="segment"
          control={control}
          render={({ field: { value, onChange } }) => (
