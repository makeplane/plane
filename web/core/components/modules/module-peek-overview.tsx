  ...
  return (
    <>
      {peekModule && (
        <div
          ref={ref}
          className="flex h-full w-[21.5rem] flex-shrink-0 flex-col gap-3.5 overflow-y-auto border-l border-custom-border-100 bg-custom-sidebar-background-100 px-4 duration-300 vertical-scrollbar scrollbar-sm z-[13]"
          style={{
            boxShadow:
