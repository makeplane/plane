...
export const ModuleProgressStats: FC<TModuleProgressStates> = observer((props) => {
  const {
    plotType,
    distribution,
    groupedIssues,
  ...
  // hooks
  const { storedValue: currentTab, setValue: setModuleTab } = useLocalStorage("module-analytics-tab", "stat-assignees");
  // derived values
