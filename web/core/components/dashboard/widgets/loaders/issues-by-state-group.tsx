...
export const IssuesByStateGroupWidgetLoader = () => (
  <Loader className="bg-custom-background-100 rounded-xl p-6">
    ...
    <div className="flex items-center justify-between gap-32 mt-12 pr-6">
      <div className="w-1/2 grid place-items-center">
        <div className="rounded-full overflow-hidden relative flex-shrink-0 h-[184px] w-[184px]">
          ...
          <div className="absolute h-[100px] w-[100px] top-1/2 right-1/2 -translate-x-1/2 -translate-y-1/2 bg-custom-background-100 rounded-full" />
        </div>
      </div>
