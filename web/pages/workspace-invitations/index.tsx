  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center px-3">
      {invitationDetail ? (
        <>
          {error ? (
            <div className="flex w-full flex-col space-y-4 rounded border border-neutral-border-medium bg-neutral-component-surface-light px-4 py-8 text-center shadow-2xl md:w-1/3">
