...
export const SidebarWrapper: FC<TSidebarWrapperProps> = (props) => {
  ...
  return (
    <div
      className={cn(
        `absolute right-0 flex flex-col gap-4 h-full border-l border-custom-border-200 bg-custom-sidebar-background-100 pt-5 pb-10 sm:relative transition-[width] ease-linear overflow-hidden overflow-y-auto`,
        {
