...
export const Dashboard: FC = observer(() => {
  ...
  // fetching jobs
  useSWR(
    currentAuth?.isAuthenticated ? `IMPORTER_JOBS_ASANA` : null,
  ...
  const handleJobsRefresh = async () => {
    try {
      ...
      console.error("Error while refreshing Linear jobs", error);
    }
  };
      ...
      <div className="space-y-6 relative w-full h-full overflow-auto flex flex-col">
        ...
        <div className="flex-shrink-0 relative flex items-center gap-4 rounded bg-custom-background-90 p-4">
          <div className="flex-shrink-0 w-10 h-10 relative flex justify-center items-center overflow-hidden">
            <Image src={AsanaLogo} layout="fill" objectFit="contain" alt={`Asana Logo`} />
          </div>
          <div className="w-full h-full overflow-hidden">
            <div className="text-lg font-medium">Asana</div>
            <div className="text-sm text-custom-text-200">Import your Asana data into plane projects.</div>
          </div>
        ...
        <div className="w-full h-full space-y-3 relative flex flex-col">
          ...
          <div className="w-full h-full overflow-auto">
            <table className="w-full table-auto">
              <thead>
                <tr className="bg-custom-background-80 text-sm !font-medium text-left rounded-t">
                  <td className="p-3 whitespace-nowrap">Sr No.</td>
                  <td className="p-3 whitespace-nowrap">Plane Project</td>
                  <td className="p-3 whitespace-nowrap">Asana Workspace</td>
                  <td className="p-3 whitespace-nowrap">Asana Project</td>
