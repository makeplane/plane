...
import { TeamspaceCommentBlock } from "./comment-block";
import { TeamspaceCommentReactions } from "./comment-reaction";

type TTeamspaceCommentCard = {
...
export const TeamspaceCommentCard: FC<TTeamspaceCommentCard> = observer((props) => {
  const {
    workspaceSlug,
    comment,
    teamspaceId,
  ...
  // helpers
  const onEnter = (formData: Partial<TTeamspaceComment>) => {
