...
// components
import { AddTeamMembersModal } from "./modal";

type TAddTeamMembersButtonProps = {
  teamId: string;
...
const AddTeamMembersButton = observer((props: TAddTeamMembersButtonProps) => {
  const { teamId, variant, isEditingAllowed } = props;
  // state
