...
type Props = {
  data?: TTeamView | null;
  handleClose: () => void;
  handleFormSubmit: (values: TTeamView) => Promise<void>;
  preLoadedData?: Partial<TTeamView> | null;
};

const defaultValues: Partial<TTeamView> = {
  name: "",
  description: "",
...
export const TeamViewForm: React.FC<Props> = observer((props) => {
  ...
  const handleCreateUpdateView = async (formData: TTeamView) => {
