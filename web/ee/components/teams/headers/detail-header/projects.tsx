...
type TeamProjectListHeaderActionsProps = {
  teamId: string;
  isEditingAllowed: boolean;
};

export const TeamProjectListHeaderActions = observer((props: TeamProjectListHeaderActionsProps) => {
  ...
  return (
    <>
      ...
      {/* Add project button */}
      {isEditingAllowed && (
        <UpdateTeamProjectsButton variant="header" teamId={teamId} isEditingAllowed={isEditingAllowed} />
      )}
    </>
  );
});
