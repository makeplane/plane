...
type TIssueWorklogPropertyButton = { content?: string; placeHolder?: string; disabled?: boolean };

export const IssueWorklogPropertyButton: FC<TIssueWorklogPropertyButton> = (props) => {
  const { content, placeHolder, disabled } = props;
  ...
  return (
    ...
    >
      ...
      >
        {content ? content : placeHolder ? placeHolder : "Add time tracking"}
      </div>
