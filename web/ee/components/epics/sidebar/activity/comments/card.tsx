...
import { IssueCommentBlock } from "../../../epic-detail/activity";
import { IssueCommentReaction } from "../../../epic-detail/reactions/issue-comment";
...
export const EpicCommentCard: FC<TIssueCommentCard> = observer((props) => {
  const {
    workspaceSlug,
    projectId,
    commentId,
