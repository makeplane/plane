...
export const EpicSidebarPropertiesRoot: FC<Props> = observer((props) => {
  const { workspaceSlug, projectId, epicId, issueOperations, disabled } = props;
  // store hooks
  const {
    issue: { getIssueById },
    ...
    <div className={`mb-2 space-y-2.5 ${disabled ? "opacity-60" : ""}`}>
      <div className="flex h-8 items-center gap-2">
        ...
        <StateDropdown
          ...
          onChange={(val) => issueOperations.update(workspaceSlug, projectId, epicId, { state_id: val })}
      ...
      <div className="flex h-8 items-center gap-2">
        ...
        <MemberDropdown
          ...
          onChange={(val) => issueOperations.update(workspaceSlug, projectId, epicId, { assignee_ids: val })}
          disabled={disabled}
          projectId={projectId?.toString() ?? ""}
      ...
      <div className="flex h-8 items-center gap-2">
        ...
        <PriorityDropdown
          ...
          onChange={(val) => issueOperations.update(workspaceSlug, projectId, epicId, { priority: val })}
          disabled={disabled}
      ...
      <div className="flex h-8 items-center gap-2">
        ...
        <DateDropdown
          ...
          onChange={(val) =>
            issueOperations.update(workspaceSlug, projectId, epicId, {
        ...
        <div className="flex h-8 items-center gap-2">
          ...
          <EstimateDropdown
            ...
            onChange={(val: string | undefined) =>
              issueOperations.update(workspaceSlug, projectId, epicId, { estimate_point: val })
            }
            projectId={projectId}
            disabled={disabled}
            buttonVariant="transparent-with-text"
