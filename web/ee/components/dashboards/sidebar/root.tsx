...
export const DashboardsWidgetConfigSidebarRoot: React.FC<Props> = observer((props) => {
  ...
  const { asJSON, id, isConfigurationMissing, fetchWidgetData, updateWidget, x_axis_property, y_axis_metric, group_by } = widget ?? {};
  ...
  }, [isConfigurationMissing, widget?.name, x_axis_property, y_axis_metric, group_by, t]);
