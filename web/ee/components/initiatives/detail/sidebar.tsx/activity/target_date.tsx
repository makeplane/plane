...
type TInitiativeTargetDateActivity = { activity: TInitiativeActivity; ends: "top" | "bottom" | undefined };

export const InitiativeTargetDateActivity: FC<TInitiativeTargetDateActivity> = observer((props) => {
