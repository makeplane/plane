...
export const ApplicationInstallationDetails: React.FC<ApplicationInstallationDetailsProps> = observer((props) => {
  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <div className="flex flex-col space-y-2 bg-custom-background-90 p-4 rounded-xl">
        <div>{t("workspace_settings.settings.applications.connect_app_to_workspace", { app: app.name, workspace: currentWorkspace?.name })}</div>
        <div className="text-sm text-custom-text-200 border-b border-custom-border-200">{t("workspace_settings.settings.applications.with_the_permissions")}</div>
        ...
        <div className="text-sm text-custom-text-200">{t("workspace_settings.settings.applications.user_permissions_description")}</div>
        <div className="flex flex-col space-y-2">
      ...
      <div className="flex items-center space-x-2">
        ...
        <Button variant="primary" onClick={handleNext}>{t("common.next")}</Button>
      </div>
