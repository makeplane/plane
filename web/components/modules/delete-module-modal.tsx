                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-neutral-text-medium">
                          ...
                          <span className="break-all font-medium text-neutral-text-strong">{data?.name}</span>? All of
                          the data related to the module will be permanently removed. This action cannot be undone.
                        </p>
                      </div>
                    </div>
                  </div>
