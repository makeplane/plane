                ...
                {orderedJoinedProjects && orderedJoinedProjects.length > 0 && (
                  <Disclosure as="div" className="flex flex-col space-y-2" defaultOpen={true}>
                    {({ open }) => (
                      <>
                        {!themeStore?.sidebarCollapsed && (
                          <div className="group flex justify-between items-center text-xs px-1.5 py-1 rounded text-custom-sidebar-text-400 hover:bg-custom-sidebar-background-80 w-full">
                            <Disclosure.Button
                              as="button"
                              type="button"
                              className="flex items-center gap-1 px-1.5 font-semibold text-left whitespace-nowrap"
                            >
                              Projects
                              {open ? (
                                <ChevronDown className="h-3 w-3 group-hover:opacity-100 opacity-0 " />
