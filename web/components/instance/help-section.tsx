...
export const InstanceHelpSection: FC = () => {
  ...
  return (
    <div
      className={`flex w-full items-center justify-between gap-1 self-baseline border-t border-neutral-border-medium bg-sidebar-neutral-component-surface-light px-4 py-2 ${
