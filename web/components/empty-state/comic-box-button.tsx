  ...
  return (
    <Popover>
      ...
      {isHovered && (
        <Popover.Panel
          as="div"
          className="flex flex-col rounded border border-neutral-border-medium bg-neutral-component-surface-light p-5 relative min-w-80"
          ref={setPopperElement}
          style={styles.popper}
          {...attributes.popper}
          static
        >
          <div className="absolute w-2 h-2 bg-neutral-component-surface-light border rounded-lb-sm  border-neutral-border-medium border-r-0 border-t-0 transform rotate-45 bottom-2 -left-[5px]" />
