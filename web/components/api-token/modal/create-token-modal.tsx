      ...
      <Dialog as="div" className="relative z-20" onClose={() => {}}>
        ...
        <div className="fixed inset-0 z-20 overflow-y-auto">
          <div className="grid h-full w-full place-items-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="relative transform rounded-lg bg-custom-background-100 p-5 px-4 text-left shadow-custom-shadow-md transition-all w-full sm:max-w-2xl truncate">
                {generatedToken ? (
