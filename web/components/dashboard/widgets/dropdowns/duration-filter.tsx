...
export const DurationFilterDropdown: React.FC<Props> = (props) => {
  ...
  return (
    <CustomMenu
      ...
      customButton={
        <div className="px-3 py-2 border-[0.5px] border-neutral-border-medium hover:bg-custom-background-80 focus:bg-custom-background-80 text-xs font-medium whitespace-nowrap rounded-md outline-none flex items-center gap-2">
