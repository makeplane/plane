    ...
    >
      ...
      >
        <CustomDatePicker
          ...
          customInput={
            <div
              className={`flex items-center justify-center gap-2 rounded border border-neutral-border-medium px-2 py-1 text-xs shadow-sm duration-200 hover:bg-neutral-component-surface-dark ${
