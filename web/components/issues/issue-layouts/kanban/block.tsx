...
export const KanbanIssueBlock: React.FC<IssueBlockProps> = memo((props) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`space-y-2 rounded border-[0.5px] border-neutral-border-medium bg-neutral-component-surface-light px-3 py-2 text-sm shadow-custom-shadow-2xs transition-all ${
