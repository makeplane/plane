...
const IssueRowDetails = observer((props: IssueRowDetailsProps) => {
  ...
  return (
    <>
      <td
        className={cn(
          "sticky group left-0 h-11 w-40 md:w-[28rem] flex items-center bg-custom-background-100 text-sm after:absolute border-r-[0.5px] z-10 border-custom-border-200",
          {
