      ...
      >
        <div className="space-y-5">
          ...
          {watch("parent_id") &&
            ...
            selectedParentIssue && (
              <div className="flex w-min items-center gap-2 whitespace-nowrap rounded bg-neutral-component-surface-dark p-2 text-xs">
                ...
                <div className="relative">
                  <div className="border-0.5 absolute bottom-3.5 right-3.5 flex items-center gap-2">
                    {issueName && issueName !== "" && (
                      <button
                        type="button"
                        className={`flex items-center gap-1 rounded px-1.5 py-1 text-xs bg-neutral-component-surface-dark ${
        ...
        <div className="-mx-5 mt-5 flex items-center justify-between gap-2 border-t border-neutral-border-medium px-5 pt-5">
          <div
