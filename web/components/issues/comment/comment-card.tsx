  ...
  return (
    <div className="relative flex items-start space-x-3">
      <div className="relative px-1">
        ...
        <span className="absolute -bottom-0.5 -right-1 rounded bg-custom-background-80 px-0.5 py-px">
          <MessageCircle className="h-3.5 w-3.5 text-custom-text-200" aria-hidden="true" />
        </span>
      </div>
      <div className="min-w-0 flex-1">
        ...
        <div className="issue-comments-section p-0">
          <form className={`flex-col gap-2 ${isEditing ? "flex" : "hidden"}`} onSubmit={handleSubmit(onEnter)}>
            <div>
              <TipTapEditor
