              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-neutral-component-surface-light text-left shadow-custom-shadow-md transition-all sm:my-8 sm:w-[40rem]">
                <div className="px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-danger-component-surface-dark sm:mx-0 sm:h-10 sm:w-10">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-neutral-text-medium">
                          ...
                          <span className="break-words font-medium text-neutral-text-strong">{data?.name}</span>? All of
                          the data related to the view will be permanently removed. This action cannot be undone.
                        </p>
                      </div>
                    </div>
                  </div>
