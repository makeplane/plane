# Requirements Archive: v1.0 Project Templates MVP

**Archived:** 2026-07-01
**Status:** SHIPPED

Current requirements are intentionally cleared after milestone close. Start the next milestone with `$gsd-new-milestone` to create a fresh `.planning/REQUIREMENTS.md`.
