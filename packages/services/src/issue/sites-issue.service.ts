...
import type { IPublicIssue, TIssuePublicComment, TPublicIssuesResponse } from "@workspaces/types";
// api service
import { APIService } from "../api.service";

/**
 * Service class for managing issues within the Workspaces sites application
