...
import type { TProjectPublishSettings } from "@workspaces/types";
// api service
import { APIService } from "../api.service";

/**
 * Service class for managing project publish operations within the Workspaces sites application.
