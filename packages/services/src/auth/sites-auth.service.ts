...
// types
import type { IEmailCheckData, IEmailCheckResponse } from "@workspaces/types";
// services
import { APIService } from "../api.service";

/**
 * Service class for handling authentication-related operations for Workspaces space application
