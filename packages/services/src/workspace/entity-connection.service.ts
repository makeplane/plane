...
export class WorkspaceEntityConnectionService extends APIService {
  ...
  async createWorkspaceEntityConnection(workspaceSlug: string, data: Partial<TWorkspaceEntityConnection>): Promise<TWorkspaceEntityConnection> {
  ...
  async updateWorkspaceEntityConnection(workspaceSlug: string, connectionId: string, data: Partial<TWorkspaceEntityConnection>): Promise<TWorkspaceEntityConnection> {
  ...
  async listWorkspaceEntityConnections(workspaceSlug: string, params?: Partial<Record<keyof TWorkspaceEntityConnection, string | boolean | number>>): Promise<TWorkspaceEntityConnection[]> {
  ...
  async deleteWorkspaceEntityConnection(workspaceSlug: string, connectionId: string): Promise<TWorkspaceEntityConnection> {
