...
// workspaces imports
import type { IProject, IUserLite, TOperatorConfigMap, TSupportedOperators } from "@workspaces/types";
import { COMPARISON_OPERATOR, EQUALITY_OPERATOR } from "@workspaces/types";
// local imports
