 ...
 * In-app routes are canonically slash-terminated, and active-state checks compare against
 * slash-terminated constants, so navigation targets must be normalized before they are used.
