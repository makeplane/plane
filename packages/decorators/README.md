...
{
  "dependencies": {
    "@workspaces/decorators": "workspace:*"
  }
}
```
...
```typescript
import { Controller, Get, Post, BaseController } from "@workspaces/decorators";
...
```typescript
import { Controller, WebSocket, BaseWebSocketController } from "@workspaces/decorators";
