...
export type WorkflowHorizontalStackIllustrationProps = {
  className?: string;
};

export function WorkflowHorizontalStackIllustration({ className }: WorkflowHorizontalStackIllustrationProps) {
  return (
    <svg
      width="72"
      height="81"
