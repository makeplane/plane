...
export type WorklogHorizontalStackIllustrationProps = {
  className?: string;
};

export function WorklogHorizontalStackIllustration({ className }: WorklogHorizontalStackIllustrationProps) {
  return (
    <svg
      width="81"
      height="91"
