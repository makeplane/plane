...
export type UnknownHorizontalStackIllustrationProps = {
  className?: string;
};

export function UnknownHorizontalStackIllustration({ className }: UnknownHorizontalStackIllustrationProps) {
  return (
    <svg
      width="71"
      height="80"
