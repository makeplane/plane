...
export type WorkItemHorizontalStackIllustrationProps = {
  className?: string;
};

export function WorkItemHorizontalStackIllustration({ className }: WorkItemHorizontalStackIllustrationProps) {
  return (
    <svg
      width="71"
      height="80"
