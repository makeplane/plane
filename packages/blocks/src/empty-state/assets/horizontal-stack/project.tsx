...
export type ProjectHorizontalStackIllustrationProps = {
  className?: string;
};

export function ProjectHorizontalStackIllustration({ className }: ProjectHorizontalStackIllustrationProps) {
  return (
    <svg
      width="102"
      height="115"
