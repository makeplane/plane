...
export type PriorityHorizontalStackIllustrationProps = {
  className?: string;
};

export function PriorityHorizontalStackIllustration({ className }: PriorityHorizontalStackIllustrationProps) {
  return (
    <svg
      width="71"
      height="80"
