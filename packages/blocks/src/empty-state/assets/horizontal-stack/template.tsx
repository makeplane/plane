...
export type TemplateHorizontalStackIllustrationProps = {
  className?: string;
};

export function TemplateHorizontalStackIllustration({ className }: TemplateHorizontalStackIllustrationProps) {
  return (
    <svg
      width="81"
      height="92"
