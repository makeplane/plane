...
export type CalendarBeforeIconProps = React.ComponentPropsWithoutRef<"svg">;

export function CalendarBeforeIcon({ className = "fill-current", ...rest }: CalendarBeforeIconProps) {
  const clipPathId0 = React.useId();
  const clipPathId1 = React.useId();
  return (
