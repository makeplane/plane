...
export type ModuleCancelledIconProps = React.ComponentPropsWithoutRef<"svg">;

export function ModuleCancelledIcon({ width = "20", height = "20", className }: ModuleCancelledIconProps) {
