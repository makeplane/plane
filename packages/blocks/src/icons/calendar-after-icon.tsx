...
export type CalendarAfterIconProps = React.ComponentPropsWithoutRef<"svg">;

export function CalendarAfterIcon({ className = "fill-current", ...rest }: CalendarAfterIconProps) {
