  ...
  return (
    <div className="relative">
      <input
        ...
        className={cn(
          "w-full px-3 py-2 pr-10 border rounded-md bg-custom-background-100 text-custom-text-100 focus:outline-none focus:ring-2 focus:ring-custom-primary-100 focus:border-transparent transition-all duration-200",
          {
