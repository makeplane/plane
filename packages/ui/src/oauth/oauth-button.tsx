...
const OAuthButton = React.forwardRef(function OAuthButton(
  ...
  return (
    <button
      ref={ref}
      className={cn(
        "flex h-9 w-full items-center justify-center gap-2 rounded-md border border-strong px-4 py-2.5 text-sm font-medium text-primary duration-300 bg-onboarding-background-200 hover:bg-onboarding-background-300",
        className
      )}
      {...rest}
    >
