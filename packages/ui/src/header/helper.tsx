...
export const headerStyle: IHeaderProperties = {
  ...
  [EHeaderVariant.SECONDARY]:
    "!py-0  overflow-y-hidden border-b border-subtle-1 justify-between bg-custom-background-100 z-[15]",
  [EHeaderVariant.TERNARY]:
    "flex flex-wrap justify-between py-2  border-b border-subtle-1 gap-2 bg-custom-background-100 z-[12]",
};
