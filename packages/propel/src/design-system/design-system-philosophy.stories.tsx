...
export const ApplicationRoot = meta.story({
  render(_args) {
    return (
      <DemoRoot>
...
export const SurfaceSiblings = meta.story({
  render(_args) {
    return (
      <DemoRoot>
...
export const LayerStacking = meta.story({
  render(_args) {
    return (
      <DemoRoot>
...
export const SurfaceLayerAssociation = meta.story({
  render(_args) {
    return (
      <DemoRoot>
        <Info title="✅ Surface-Layer Association">
          Each surface should use its corresponding layer: surface-1 → layer-1, surface-2 → layer-2. Very rare
          exception: inputs/buttons can go one level above for visual separation.
        </Info>
...
export const ModalException = meta.story({
  render(_args) {
    return (
      <DemoRoot>
...
export const CardListPattern = meta.story({
  render(_args) {
    return (
      <DemoRoot>
...
export const SidebarLayoutPattern = meta.story({
  render(_args) {
    return (
      <DemoRoot>
        <Info title="✅ Sidebar Layout Pattern">
          Sidebar and main content are both part of the same surface. Sidebar menu items use transparent backgrounds
          with hover states.
        </Info>
...
export const StateVariants = meta.story({
  render(_args) {
    return (
      <DemoRoot>
...
export const TextColorHierarchy = meta.story({
  render(_args) {
    return (
      <DemoRoot>
...
export const CompleteExample = meta.story({
  render(_args) {
    return (
      <DemoRoot>
...
export const CommonMistakes = meta.story({
  render(_args) {
    return (
      <DemoRoot>
