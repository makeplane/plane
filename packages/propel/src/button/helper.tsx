...
export const buttonVariants = cva(
  "inline-flex items-center justify-center gap-1 rounded-md transition-colors focus-visible:outline-none disabled:pointer-events-none",
  {
    variants: {
      variant: {
        primary: "bg-accent-primary hover:bg-accent-primary-hover active:bg-accent-primary-active focus:bg-accent-primary-active disabled:bg-layer-disabled text-on-color disabled:text-disabled",
        "error-fill":
        ...
        "error-outline":
          "bg-layer-transparent hover:bg-danger-subtle active:bg-danger-subtle focus:bg-danger-subtle disabled:bg-layer-transparent text-danger disabled:text-disabled border border-danger-strong disabled:border-subtle-1",
        secondary:
        ...
        ghost: "bg-layer-transparent hover:bg-layer-transparent-hover active:bg-layer-transparent-active focus:bg-layer-transparent-active disabled:bg-layer-transparent text-secondary disabled:text-disabled",
...
export const getIconStyling = (size: NonNullable<ButtonProps["size"]>): string =>  buttonIconStyling[size];
