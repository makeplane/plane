    ...
    <button
      ...
      className={cn(
        ...
        reacted
          ...
          : "bg-custom-background-100 border-subtle-1 text-tertiary hover:border-strong hover:bg-custom-background-90",
        className
      )}
      {...props}
    >
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "bg-custom-background-100 text-placeholder transition-all duration-200",
