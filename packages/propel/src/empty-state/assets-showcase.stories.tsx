...
export const HorizontalStackAssets: Story = {
  ...
  render: () => (
    <div className="p-8">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-primary">Horizontal Stack Assets</h2>
        <p className="text-sm text-tertiary">Used primarily in EmptyStateCompact component</p>
      </div>
      <div className="grid w-full grid-cols-12 gap-6">
        {HorizontalStackAssetsMap.map((item) => (
          ...
          >
            ...
            <p className="text-center text-xs font-medium text-secondary">{item.title}</p>
            <code className="rounded bg-custom-background-80 px-2 py-1 text-xs text-tertiary">
...
export const VerticalStackAssets: Story = {
  ...
  render: () => (
    <div className="p-8">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-primary">Vertical Stack Assets</h2>
        <p className="text-sm text-tertiary">Used primarily in EmptyStateDetailed component</p>
      </div>
      <div className="grid w-full grid-cols-12 gap-6">
...
export const IllustrationAssets: Story = {
  ...
  render: () => (
    <div className="p-8">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-primary">Illustration Assets</h2>
        <p className="text-sm text-tertiary">Available in both EmptyStateCompact and EmptyStateDetailed</p>
      </div>
      <div className="grid w-full grid-cols-12 gap-6">
  ...
  render: () => (
    <div className="space-y-12 p-8">
      ...
      <div>
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-primary">Horizontal Stack Assets</h2>
          <p className="text-sm text-tertiary">For EmptyStateCompact - {HorizontalStackAssetsMap.length} assets</p>
        </div>
        <div className="grid w-full grid-cols-12 gap-4">
          {HorizontalStackAssetsMap.map((item) => (
            ...
            >
              ...
              <code className="text-[10px] text-placeholder">{item.title.toLowerCase().replace(/\s+/g, "-")}</code>
            </div>
          ))}
        </div>
      </div>
      ...
      <div>
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-primary">Vertical Stack Assets</h2>
          <p className="text-sm text-tertiary">For EmptyStateDetailed - {VerticalStackAssetsMap.length} assets</p>
        </div>
        <div className="grid w-full grid-cols-12 gap-4">
          {VerticalStackAssetsMap.map((item) => (
            <div
            ...
            >
              ...
              <code className="text-center text-[10px] text-placeholder">
                {item.title
                  .replace(/VerticalStackIllustration$/, "")
                  .replace(/([A-Z])/g, "-$1")
                  .toLowerCase()
      ...
      <div>
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-primary">Illustration Assets</h2>
          <p className="text-sm text-tertiary">For both components - {IllustrationMap.length} assets</p>
        </div>
        <div className="grid w-full grid-cols-12 gap-4">
          {IllustrationMap.map((item) => (
            <div
            ...
            >
              <div className="flex h-16 w-16 items-center justify-center">{item.asset}</div>
              <code className="text-[10px] text-placeholder">{item.title.toLowerCase()}</code>
            </div>
          ))}
        </div>
      </div>
