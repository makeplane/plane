...
export type JavaScriptIconProps = {
  width?: number;
  height?: number;
};

export const JavaScriptIcon: React.FC<JavaScriptIconProps> = ({ width = 40, height = 40 }) => (
