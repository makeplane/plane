    ...
    return (
      <div className="space-y-4">
        <div className="flex gap-2">
          <button onClick={() => setIsOpen(true)} className="rounded bg-blue-500 px-4 py-2 text-13 text-white">
            Open
          </button>
          <button onClick={() => setIsOpen(false)} className="rounded bg-gray-500 px-4 py-2 text-13 text-white">
            Close
          </button>
          <button onClick={() => setIsOpen(!isOpen)} className="rounded bg-green-500 px-4 py-2 text-13 text-white">
            Toggle
          </button>
        </div>
