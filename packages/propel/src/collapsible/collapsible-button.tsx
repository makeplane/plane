...
export function CollapsibleButton(props: Props) {
  ...
  return (
    <div className={cn("flex items-center justify-between gap-3 h-12 py-3 border-b border-subtle flex-1", className)}>
      <div className="flex items-center gap-3.5">
        <div className="flex items-center gap-3">
          <span className={cn("text-body-xs-medium text-primary", titleClassName)}>{title}</span>
        </div>
