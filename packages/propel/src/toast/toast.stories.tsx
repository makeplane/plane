    ...
    return (
      <>
        ...
        <button
          ...
          className="rounded-sm bg-green-500 px-4 py-2 text-on-color hover:bg-green-600"
        >
          Show Success Toast
        </button>
      </>
    ...
    return (
      <>
        ...
        <button
          ...
          className="rounded-sm bg-yellow-500 px-4 py-2 text-on-color hover:bg-yellow-600"
        >
          Show Warning Toast
        </button>
      </>
    ...
    return (
      <>
        ...
        <button
          ...
          className="rounded-sm bg-gray-500 px-4 py-2 text-on-color hover:bg-gray-600"
        >
          Show Loading Toast
        </button>
      </>
...
export const UpdateToast: Story = {
  render() {
    ...
    return (
      <>
        <Toast theme="light" />
        <button onClick={handleUpdate} className="rounded-sm bg-blue-500 px-4 py-2 text-on-color hover:bg-blue-600">
    ...
    return (
      <>
        ...
        <button
          ...
          className="rounded-sm bg-purple-500 px-4 py-2 text-on-color hover:bg-purple-600"
        >
          Show Promise Toast
        </button>
      </>
      ...
      <>
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="rounded-sm bg-green-500 px-3 py-2 text-13 text-on-color hover:bg-green-600"
          >
            Success
          </button>
          <button
            ...
            className="rounded-sm bg-red-500 px-3 py-2 text-13 text-on-color hover:bg-red-600"
          >
            Error
          </button>
          <button
            ...
            className="rounded-sm bg-yellow-500 px-3 py-2 text-13 text-on-color hover:bg-yellow-600"
          >
            Warning
          </button>
          <button
            ...
            className="rounded-sm bg-blue-500 px-3 py-2 text-13 text-on-color hover:bg-blue-600"
          >
            Info
          </button>
          <button
            ...
            className="rounded-sm bg-gray-500 px-3 py-2 text-13 text-on-color hover:bg-gray-600"
          >
            Loading
          </button>
        </div>
