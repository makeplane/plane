...
export const LABEL_CLASSNAME = "uppercase text-tertiary/60 text-sm tracking-wide";
export const AXIS_LABEL_CLASSNAME = "uppercase text-tertiary/60 text-sm tracking-wide";
