// plane imports
import type { TProfileSettingsTabs, TWorkspaceSettingsItem } from "@plane/types";
// local imports
...
export const PROJECT_SETTINGS_CATEGORIES: PROJECT_SETTINGS_CATEGORY[] = [PROJECT_SETTINGS_CATEGORY.PROJECTS];
