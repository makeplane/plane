// Metadata cleaned for government deployment - removed external URLs and social media references
...
export const SPACE_SITE_DESCRIPTION = "Plane Publish is a customer feedback management tool built on top of Plane.";
