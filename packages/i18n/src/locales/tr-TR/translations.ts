...
export default {
  ...
  language_and_time: "Dil ve Zaman",
  ...
  timezone_setting: "Mevcut saat dilimi ayarı.",
  language_setting: "Kullanıcı arayüzünde kullanılan dili seçin.",
  settings_moved_to_preferences: "Saat Dilimi ve Dil ayarları tercihlere taşındı.",
  go_to_preferences: "Tercihlere git",
  theme: "Tema",
  ...
  settings_description:
    "Hesap, çalışma alanı ve proje tercihlerinizi tek bir yerden yönetin. Kolayca yapılandırmak için sekmeler arasında geçiş yapın.",
  back_to_workspace: "Çalışma alanına dön",
  project_view: {
    sort_by: {
  ...
  workspace_analytics: {
    ...
    backlog_work_items: "Bekleme listesi {entity}",
  ...
  account_settings: {
    ...
    notifications: {
      ...
      description: "Abone olduğunuz iş öğelerinden haberdar olun. Bildirim almak için bunu etkinleştirin.",
    },
    security: {
      heading: "Güvenlik",
    },
    api_tokens: {
      heading: "Kişisel Erişim Token'ları",
      description: "Verilerinizi harici sistemler ve uygulamalarla entegre etmek için güvenli API token'ları oluşturun.",
    },
    activity: {
      heading: "Aktivite",
      description: "Tüm projeler ve iş öğeleri genelindeki son eylemlerinizi ve değişikliklerinizi takip edin.",
    },
  },
  workspace_settings: {
    ...
    settings: {
      ...
      billing_and_plans: {
        ...
        description: "Planınızı seçin, aboneliklerinizi yönetin ve ihtiyaçlarınız büyüdükçe kolayca yükseltin.",
      ...
      exports: {
        ...
        description: "Proje verilerinizi çeşitli formatlarda dışa aktarın ve indirme bağlantılarıyla dışa aktarım geçmişinize erişin.",
      ...
      webhooks: {
        heading: "Webhook'lar",
        description: "Proje olayları gerçekleştiğinde harici servislere otomatik bildirimler gönderin.",
        title: "Webhook'lar",
  ...
  profile: {
    ...
    actions: {
      ...
      preferences: "Tercihler",
      notifications: "Bildirimler",
      "api-tokens": "Kişisel Erişim Token'ları",
    },
    tabs: {
      summary: "Özet",
      assigned: "Atanan",
  ...
  project_settings: {
    ...
    estimates: {
      ...
      description: "Her iş öğesi için gereken çabayı takip etmek ve iletmek amacıyla tahmin sistemleri kurun.",
      enable_description: "Takımın karmaşıklık ve iş yükünü iletmesine yardımcı olurlar.",
      ...
      validation: {
        ...
        remove_empty: "Tahmin boş olamaz. Her alana bir değer girin veya değeri olmayan alanları kaldırın.",
      },
      systems: {
        points: {
          label: "Puanlar",
        ...
        categories: {
          label: "Kategoriler",
          t_shirt_sizes: "Tişört Bedenleri",
          easy_to_hard: "Kolaydan zora",
          custom: "Özel",
        },
        time: {
          label: "Zaman",
    ...
    automations: {
      ...
      description:
        "Proje yönetimi iş akışınızı düzene sokmak ve manuel görevleri azaltmak için otomatik eylemleri yapılandırın.",
      "auto-archive": {
  ...
  power_k: {
    contextual_actions: {
      work_item: {
        title: "İş öğesi eylemleri",
        indicator: "İş öğesi",
        change_state: "Durumu değiştir",
        change_priority: "Önceliği değiştir",
        change_assignees: "Ata",
        assign_to_me: "Bana ata",
        unassign_from_me: "Atamayı kaldır",
        change_estimate: "Tahmini değiştir",
        add_to_cycle: "Döngüye ekle",
        add_to_modules: "Modüllere ekle",
        add_labels: "Etiket ekle",
        subscribe: "Bildirimlere abone ol",
        unsubscribe: "Bildirim aboneliğinden çık",
        delete: "Sil",
        copy_id: "ID'yi kopyala",
        copy_id_toast_success: "İş öğesi ID'si panoya kopyalandı.",
        copy_id_toast_error: "İş öğesi ID'si panoya kopyalanırken bir hata oluştu.",
        ...
        copy_url_toast_error: "İş öğesi URL'si panoya kopyalanırken bir hata oluştu.",
      },
      cycle: {
        title: "Döngü eylemleri",
        indicator: "Döngü",
        add_to_favorites: "Favorilere ekle",
        remove_from_favorites: "Favorilerden kaldır",
        copy_url: "URL'yi kopyala",
      ...
      module: {
        title: "Modül eylemleri",
        indicator: "Modül",
        add_remove_members: "Üye ekle/kaldır",
    ...
    creation_actions: {
      create_work_item: "Yeni iş öğesi",
      create_page: "Yeni sayfa",
      create_view: "Yeni görünüm",
      create_cycle: "Yeni döngü",
      create_module: "Yeni modül",
      create_project: "Yeni proje",
      create_workspace: "Yeni çalışma alanı",
    },
    navigation_actions: {
      open_workspace: "Bir çalışma alanı aç",
      nav_home: "Ana sayfaya git",
      nav_inbox: "Gelen kutusuna git",
      nav_your_work: "Çalışmalarınıza git",
      nav_account_settings: "Hesap ayarlarına git",
      open_project: "Bir proje aç",
      nav_projects_list: "Proje listesine git",
      nav_all_workspace_work_items: "Tüm iş öğelerine git",
      nav_assigned_workspace_work_items: "Atanan iş öğelerine git",
      nav_created_workspace_work_items: "Oluşturulan iş öğelerine git",
      nav_subscribed_workspace_work_items: "Abone olunan iş öğelerine git",
      nav_workspace_analytics: "Çalışma alanı analitiğine git",
      nav_workspace_drafts: "Çalışma alanı taslaklarına git",
      nav_workspace_archives: "Çalışma alanı arşivlerine git",
      open_workspace_setting: "Bir çalışma alanı ayarını aç",
      nav_workspace_settings: "Çalışma alanı ayarlarına git",
      nav_project_work_items: "İş öğelerine git",
      open_project_cycle: "Bir döngü aç",
      nav_project_cycles: "Döngülere git",
      open_project_module: "Bir modül aç",
      nav_project_modules: "Modüllere git",
      open_project_view: "Bir proje görünümü aç",
      nav_project_views: "Proje görünümlerine git",
      nav_project_pages: "Sayfalara git",
      nav_project_intake: "Taleplere git",
      nav_project_archives: "Proje arşivlerine git",
      open_project_setting: "Bir proje ayarını aç",
      nav_project_settings: "Proje ayarlarına git",
    },
    account_actions: {
      sign_out: "Çıkış yap",
      workspace_invites: "Çalışma alanı davetleri",
    ...
    miscellaneous_actions: {
      toggle_app_sidebar: "Uygulama kenar çubuğunu aç/kapat",
      copy_current_page_url: "Geçerli sayfa URL'sini kopyala",
      ...
      focus_top_nav_search: "Arama girişine odaklan",
    },
    preferences_actions: {
      update_theme: "Arayüz temasını değiştir",
      update_timezone: "Saat dilimini değiştir",
      update_start_of_week: "Haftanın ilk gününü değiştir",
      update_language: "Arayüz dilini değiştir",
      toast: {
        theme: {
          success: "Tema başarıyla güncellendi.",
    ...
    help_actions: {
      open_keyboard_shortcuts: "Klavye kısayollarını aç",
      open_plane_documentation: "Plane dokümantasyonunu aç",
      join_forum: "Forumumuza katılın",
    ...
    page_placeholders: {
      ...
      open_project_view: "Bir proje görünümü aç",
      open_project_setting: "Bir proje ayarını aç",
      update_work_item_state: "Durumu değiştir",
      update_work_item_priority: "Önceliği değiştir",
      update_work_item_assignee: "Ata",
      update_work_item_estimate: "Tahmini değiştir",
      update_work_item_cycle: "Döngüye ekle",
      update_work_item_module: "Modüllere ekle",
      update_work_item_labels: "Etiket ekle",
      update_module_member: "Üyeleri değiştir",
      update_module_status: "Durumu değiştir",
      update_theme: "Temayı değiştir",
      update_timezone: "Saat dilimini değiştir",
      update_start_of_week: "Haftanın ilk gününü değiştir",
  ...
  customize_navigation: "Gezinmeyi özelleştir",
  personal: "Kişisel",
  accordion_navigation_control: "Akordeon kenar çubuğu gezinmesi",
  horizontal_navigation_bar: "Sekmeli Gezinme",
  show_limited_projects_on_sidebar: "Kenar çubuğunda sınırlı proje göster",
