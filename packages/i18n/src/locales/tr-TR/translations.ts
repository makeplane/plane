...
modüller arşivlenebilir.`,
 ...
 Bunun yerine yeni bir inisiyatif oluşturun.`,
  ...
  oauth_bridge_integration: {
    name: "OAuth Bridge",
    description: "API erişimi için harici IdP tokenlarını doğrulayın.",
    header_description:
      "IdP'nizden (Azure AD, Okta vb.) harici olarak verilen OIDC/JWT tokenlarını Plane API erişimi için doğrulayın.",
    connected: "Bağlı",
    connect: "Bağlan",
    uninstall: "Kaldır",
    uninstalling: "Kaldırılıyor...",
    install_success: "OAuth Bridge başarıyla kuruldu.",
    install_error: "OAuth Bridge kurulamadı.",
    uninstall_success: "OAuth Bridge kaldırıldı.",
    uninstall_error: "OAuth Bridge kaldırılamadı.",
    token_providers: "Token Sağlayıcıları",
    token_providers_description: "JWT'leri API kimlik bilgileri olarak kabul edilen harici IdP'leri yapılandırın.",
    add_provider: "Sağlayıcı ekle",
    edit_provider: "Sağlayıcıyı düzenle",
    enabled: "Etkin",
    disabled: "Devre dışı",
    test: "Test",
    no_providers_title: "Yapılandırılmış sağlayıcı yok.",
    no_providers_description: "Harici token kimlik doğrulamasını etkinleştirmek için bir IdP ekleyin.",
    provider_updated: "Sağlayıcı güncellendi.",
    provider_added: "Sağlayıcı eklendi.",
    provider_save_error: "Sağlayıcı kaydedilemedi.",
    provider_deleted: "Sağlayıcı silindi.",
    provider_delete_error: "Sağlayıcı silinemedi.",
    provider_update_error: "Sağlayıcı güncellenemedi.",
    jwks_reachable: "JWKS erişilebilir",
    jwks_unreachable: "JWKS erişilemez",
    jwks_test_error: "Yapılandırılmış URL'den JWKS alınamadı.",
    provider_form: {
      name_label: "Ad",
      name_placeholder: "ör. Azure AD Production",
      name_description: "Bu kimlik sağlayıcısı için okunabilir etiket",
      name_required: "Ad gereklidir.",
      issuer_label: "Yayıncı",
      issuer_placeholder: "https://login.microsoftonline.com/tenant-id/v2.0",
      issuer_description: "JWT'deki beklenen iss claim değeri",
      issuer_required: "Yayıncı gereklidir.",
      jwks_url_label: "JWKS URL",
      jwks_url_placeholder: "https://login.microsoftonline.com/tenant-id/discovery/v2.0/keys",
      jwks_url_description: "Sağlayıcının JSON Web Key Set'ini sunan HTTPS uç noktası",
      jwks_url_required: "JWKS URL gereklidir.",
      jwks_url_https: "JWKS URL HTTPS kullanmalıdır.",
      audience_label: "Hedef Kitle",
      audience_placeholder: "api://my-app-id",
      audience_description: "JWT'deki beklenen aud claim'leri, virgülle ayrılmış.",
      user_claims_label: "Kullanıcı claim'i",
      user_claims_placeholder: "email",
      user_claims_description: "Kullanıcının e-posta adresini içeren JWT claim'i",
      user_claims_required: "Kullanıcı claim'i gereklidir.",
      allowed_algorithms_label: "İzin verilen imza algoritmaları",
      allowed_algorithms_description: "JWT imza doğrulaması için kabul edilen asimetrik algoritmalar",
      allowed_algorithms_required: "En az bir algoritma gereklidir.",
      select_algorithms: "Algoritma seçin",
      jwks_cache_ttl_label: "JWKS önbellek TTL (saniye)",
      jwks_cache_ttl_description:
        "Sağlayıcının JWKS anahtarlarının önbellekte tutulma süresi (minimum 60s, varsayılan 24 saat)",
      jwks_cache_ttl_min: "Önbellek TTL en az 60 saniye olmalıdır.",
      rate_limit_label: "Hız limiti",
      rate_limit_placeholder: "120/minute",
      rate_limit_description:
        "İstek sınırlaması sayı/dönem olarak (ör. 120/minute). Varsayılan hız limiti için boş bırakın.",
...
• Görev ve yorum oluşturma: Sesli komutlarla görevler, açıklamalar ve yorumlar ekleyin.`,
  ...
  page_actions: {
    move_page: {
      placeholders: {
        project_to_all_with_wiki: "Wiki koleksiyonlarını, projeleri ve takım alanlarını ara",
        project_to_project_with_wiki: "Wiki koleksiyonlarını ve projeleri ara",
        teamspace_to_all_with_wiki: "Wiki koleksiyonlarını, projeleri ve takım alanlarını ara",
      },
      toasts: {
        collection_error: {
          title: "Wiki'ye taşındı",
          message: "Sayfa wiki'ye taşındı, ancak seçilen koleksiyona eklenemedi. General içinde kalır.",
        },
      },
    },
    remove_from_collection: {
      label: "Koleksiyondan kaldır",
      success_message: "Sayfa koleksiyondan kaldırıldı.",
      error_message: "Sayfa koleksiyondan kaldırılamadı. Lütfen tekrar deneyin.",
    },
  },
  wiki_collections: {
    predefined: {
    ...
    fallback_name: "Koleksiyon",
    form: {
      name_required: "Koleksiyon başlığı zorunludur",
      name_max_length: "Koleksiyon adı 255 karakterden kısa olmalıdır",
      name_placeholder_create: "Koleksiyona bir başlık verin",
      name_placeholder_edit: "Koleksiyon adı",
    },
    create_modal: {
    ...
    delete_modal: {
      ...
      page_count: "Bu koleksiyonda {pageCount} sayfa var. Onlara ne olacağını seçin.",
      transfer_title: "Sayfaları taşı ve koleksiyonu sil",
      transfer_description: "Silmeden önce tüm sayfaları başka bir koleksiyona taşıyın. Sayfalar ve izinleri korunur.",
      transfer_warning: "Taşınan sayfalar seçilen koleksiyonun izinlerini devralır.",
      transfer_target_label: "Sayfaları şuraya taşı",
      transfer_target_placeholder: "Bir koleksiyon seçin",
      delete_with_pages_title: "Koleksiyonu sayfalarla birlikte sil",
      delete_with_pages_description: "Koleksiyonu ve tüm sayfalarını kalıcı olarak siler. Bu işlem geri alınamaz.",
      submit: "Koleksiyonu sil",
    },
    header: {
      add_page: "Sayfa ekle",
    },
    ...
    add_existing_page_modal: {
      ...
      success_message: "{count} sayfa koleksiyona eklendi.",
      error_message: "Sayfalar taşınamadı. Lütfen tekrar deneyin.",
      no_pages_found: "Aramanızla eşleşen sayfa bulunamadı",
      no_pages_available: "Taşınabilecek sayfa yok",
      submit: "Taşı",
    },
    list: {
      invite_only: "Yalnızca davetliler",
      remove_error: "Sayfa koleksiyondan kaldırılamadı.",
      no_matching_pages: "Eşleşen sayfa yok",
      remove_search_criteria: "Tüm sayfaları görmek için arama kriterlerini kaldırın",
      remove_filters: "Tüm sayfaları görmek için filtreleri kaldırın",
      no_pages_title: "Henüz sayfa yok",
      no_pages_description: "Bu koleksiyonda şu anda hiç sayfa yok.",
      untitled: "Başlıksız",
      restricted_access: "Kısıtlı erişim",
      collapse_page: "Sayfayı daralt",
      expand_page: "Sayfayı genişlet",
      page_actions: "Sayfa işlemleri",
      page_link_copied: "Sayfa bağlantısı panoya kopyalandı.",
      columns: {
        page_name: "Sayfa adı",
        owner: "Sahip",
        nested_pages: "İç içe sayfalar",
        last_activity: "Son etkinlik",
        actions: "İşlemler",
      },
    },
    toasts: {
      created: "Koleksiyon başarıyla oluşturuldu.",
      create_error: "Koleksiyon oluşturulamadı. Lütfen tekrar deneyin.",
      renamed: "Koleksiyon başarıyla yeniden adlandırıldı.",
      rename_error: "Koleksiyon güncellenemedi. Lütfen tekrar deneyin.",
      transferred_deleted: "Sayfalar taşındı ve koleksiyon silindi.",
      deleted_with_pages: "Koleksiyon ve sayfaları silindi.",
      delete_error: "Koleksiyon silinemedi. Lütfen tekrar deneyin.",
      target_required: "Lütfen sayfaların taşınacağı bir koleksiyon seçin.",
      create_page_error: "Sayfa oluşturulamadı. Lütfen tekrar deneyin.",
      create_page_in_collection_error: "Sayfa oluşturulamadı veya koleksiyona eklenemedi. Lütfen tekrar deneyin.",
      collection_link_copied: "Koleksiyon bağlantısı panoya kopyalandı.",
    },
  },
} as const;
