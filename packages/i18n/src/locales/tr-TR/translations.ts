...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      page_not_found_description: "Aradığınız sayfa mevcut değil veya taşınmış.",
      instance_failure_image_alt: "Örnek ayrıntıları getirilemiyor",
      instance_failure_title: "Örnek ayrıntıları getirilemiyor.",
      instance_failure_description: "Örnek ayrıntılarınızı yükleyemedik.",
      instance_failure_hint: "Lütfen bağlantınızı kontrol edip tekrar deneyin.",
      retry: "Yeniden dene",
      ...
      public_board_not_found: "Kamu kurulu mevcut değil. Lütfen URL'yi kontrol edin.",
      no_work_items_found: "Hiçbir iş öğesi bulunamadı",
