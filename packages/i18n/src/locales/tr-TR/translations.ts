...
export default {
  ...
  localized_ui: {
    ...
    workspace_views: {
      page_title: "{workspaceName} - Tüm Görünümler",
    },
    ...
    editor: {
      url: "URL",
      enter_or_paste_url: "URL'yi girin veya yapıştırın",
      text: "Metin",
      enter_text_to_display: "Görüntülenecek metni girin",
      ...
      link: "Bağlantı",
      enter_or_paste_link: "Bağlantıyı girin veya yapıştırın",
      please_enter_valid_url: "Lütfen geçerli bir URL girin",
      delete: "Silmek",
      ...
      add_an_image: "Resim ekle",
      error_loading_image: "Resim yüklenirken hata oluştu",
      uploading: "Yükleniyor",
      drop_image_here: "Resmi buraya bırakın",
      retry_duplication: "Çoğaltmayı yeniden dene",
      retry: "Yeniden dene",
      no_emojis_found: "Hiçbir emoji bulunamadı",
      fullscreen_image_viewer: "Tam ekran resim görüntüleyici",
      close_image_viewer: "Resim görüntüleyiciyi kapat",
      zoom_out: "Uzaklaştır",
      zoom_in: "Yakınlaştır",
      download_image: "Resmi indir",
      open_image_in_new_tab: "Resmi yeni sekmede aç",
      ...
      insert_left: "Sola ekle",
      insert_right: "Sağa ekle",
      header_row: "Başlık satırı",
      header_column: "Başlık sütunu",
      alignment: {
        left: "Sol",
        center: "Merkez",
        right: "Sağ",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "{workspaceName}'e davet edildiniz",
      description:
        "Çalışma alanınız, Plane hesabınızda projeler oluşturacağınız, çalışma öğeleriniz üzerinde işbirliği yapacağınız ve farklı iş akışlarını organize edeceğiniz yerdir.",
      accept: "Kabul etmek",
      ignore: "Görmezden gelmek",
      already_member: "Zaten {workspaceName} üyesisiniz",
      continue_to_home: "Eve devam et",
      inactive_title: "Bu davet bağlantısı artık aktif değil.",
      empty_project_link: "Veya boş bir projeden başlayın",
      sign_in_to_continue: "Devam etmek için oturum açın",
      star_on_github: "GitHub'da bize yıldız verin",
      join_community: "Aktif yaratıcılardan oluşan topluluğumuza katılın",
    },
    space_auth: {
      email: "E-posta",
      ...
      go_to_workspace: "Çalışma alanına git",
      sign_in_with_unique_code: "Benzersiz kodla oturum açın",
      create_account: "Hesap oluşturmak",
      unique_code: "Benzersiz kod",
      paste_code_sent: "E-postanıza gönderilen kodu yapıştırın",
      resend_in: "{seconds}s içinde tekrar gönder",
      requesting_new_code: "Yeni kod isteniyor",
      resend: "Yeniden gönder",
      sending_code: "Kod gönderiliyor",
    },
    onboarding: {
      create_profile_title: "Profilinizi oluşturun.",
      create_profile_description: "Plane'de bu şekilde görüneceksiniz.",
      change_image: "Resmi değiştir",
      upload_image: "Resim yükle",
      name: "İsim",
      name_required: "Ad gerekli",
      name_within_50: "Ad 50 karakterden oluşmalıdır.",
      ...
      continue: "Devam etmek",
      invite_team_title: "Takım arkadaşlarınızı davet edin",
      invite_team_description:
        "Plane'de çalışmak ekibinizle en iyi şekilde gerçekleşir. Onları şimdi Plane'in potansiyelini sonuna kadar kullanmaya davet edin.",
      invalid_email: "Bu bir e-posta adresine benzemiyor.",
      success: "Başarı!",
      invitations_sent: "Davetiyeler başarıyla gönderildi.",
      error: "Hata!",
      add_another: "Başka ekle",
      do_later: "Daha sonra yapacağım",
      join_invites_title: "Davetlere katılın veya bir çalışma alanı oluşturun",
      unified_description: "Tüm çalışmalarınız — birleştirilmiş.",
      create_new_workspace: "Yeni çalışma alanı oluştur",
      no_invitations_found: "Hiçbir davetiye bulunamadı",
      you_are_invited: "Davetlisiniz!",
      accept_invites: "Ekibinizle işbirliği yapma davetlerini kabul edin.",
      continue_to_workspace: "Çalışma alanına devam et",
      or: "veya",
      create_own_workspace: "Kendi çalışma alanınızı yaratın",
      workspace_creation_disabled:
        "Bir çalışma alanına davetiniz yok gibi görünüyor ve örnek yöneticiniz yeni çalışma alanlarının oluşturulmasını kısıtladı. Lütfen bir çalışma alanı sahibinden veya yöneticisinden önce sizi bir çalışma alanına davet etmesini ve katılmak için bu ekrana geri dönmesini isteyin.",
      create_workspace_title: "Çalışma alanınızı yaratın",
      enter_workspace_name: "Çalışma alanı adını girin",
      join_existing_workspace: "Mevcut çalışma alanına katılın",
      profile_setup_completed: "Profil kurulumu tamamlandı.",
      profile_setup_failed: "Profil kurulumu başarısız oldu.",
      usecase_title: "Plane'i nasıl kullanmayı planlıyorsunuz?",
      usecase_description: "Deneyiminizi kişiselleştirebilmemiz için bir veya daha fazla seçeneği seçin.",
      select_one_or_more: "Bir veya daha fazlasını seçin",
      select_at_least_one: "En az bir seçeneği seçin.",
      skip: "Atlamak",
    },
    inbox: {
      ...
      errors: {
        asset_upload_failed: "Öğe yükleme başarısız oldu. Lütfen daha sonra tekrar deneyin.",
        asset_duplication_failed: "Varlık çoğaltması başarısız oldu. Lütfen daha sonra tekrar deneyin.",
        permission_denied: "İzin reddedildi",
        mark_duplicate_permission: "Yalnızca proje yöneticileri iş öğesini kopya olarak işaretleyebilir",
        mark_duplicate_permission_plural: "Yalnızca proje yöneticileri iş öğelerini kopya olarak işaretleyebilir",
      },
      filters: {
        ...
        status: "Durum",
        work_item_status: "İş öğesi durumu",
      ...
      navigation: {
        previous_work_item: "Önceki iş öğesi",
      ...
      sidebar: {
        label_count: "{count} etiketleri",
      },
      toasts: {
        editor_processing: "Düzenleyici hâlâ değişiklikleri işliyor. Devam etmeden önce lütfen bekleyin.",
        create_success: "İş öğesi başarıyla oluşturuldu.",
        delete_failed: "İş öğesi silinemedi",
        update_failed: "İş öğesi güncellemesi başarısız oldu",
      },
    },
    space_public: {
      error_description_prefix:
        "Plane çöktü. Mühendislerimiz bilgilendirildi. Daha fazla ayrıntınız varsa lütfen şuraya yazın",
      error_description_middle: "veya bizim",
      not_found_hint: "Tarayıcı adres çubuğundaki URL'yi kontrol edip tekrar deneyin.",
      logged_in_hint:
        "Görmek istediğiniz görünümün veya Sayfanın herkese açık paylaşım URL'sini ya da bağlantısını tarayıcı adres çubuğuna girin.",
      oauth_with_provider: "{provider} ile {action}",
      auth: {
        sign_in_header: "Oy vermek veya yorum yapmak için oturum açın",
        sign_in_subheader: "Yapılmasını istediğiniz özelliklerin ilerlemesine katkıda bulunun.",
        sign_up_header: "Görüntüleyin, yorum yapın ve daha fazlasını yapın",
        sign_up_subheader: "Plane iş öğeleri ve Sayfaları ile çalışmak için kaydolun veya oturum açın.",
      },
      peek: {
        side: "Yan Önizleme",
        modal: "Modal",
      ...
      bot_name: "{name} Botu",
      commented_time: "{time} yorum yaptı",
      and_more: "ve {count} kişi daha",
      no_upvotes_yet: "Henüz olumlu oy yok",
      no_downvotes_yet: "Henüz olumsuz oy yok",
      modules_count: "{count} Modül",
      labels_count: "{count} Etiket",
      page_not_found_alt: "Sayfa bulunamadı",
      something_went_wrong: "Hata! Bir şeyler ters gitti.",
      page_not_found_description: "Aradığınız sayfa yok veya taşınmış.",
      instance_failure_image_alt: "Örnek ayrıntıları alınamadı",
      instance_failure_title: "Örnek ayrıntıları alınamadı.",
      instance_failure_description: "Örnek ayrıntılarınız yüklenemedi.",
      instance_failure_hint: "Bağlantınızı kontrol edip tekrar deneyin.",
      powered_by: "Destekleyen",
      sign_in_to_add_comment: "Yorum eklemek için oturum açın",
      link_copied: "Bağlantı kopyalandı!",
      work_item_link_copied: "İş öğesi bağlantısı panoya kopyalandı.",
      comment_post_error: "Yorum gönderilemedi. Lütfen tekrar deneyin.",
      add_comment: "Yorum ekle",
      public_board_not_found: "Herkese açık pano mevcut değil. Lütfen URL'yi kontrol edin.",
      no_work_items_found: "İş öğesi bulunamadı",
      error_title: "Eyvah! Bu iyi görünmüyor.",
      refresh: "Yenile",
      forum: "Forum",
      not_found_title: "Bu işe yaramadı",
      user_already_logged_in: "Kullanıcı zaten oturum açmış",
      logged_in_title: "Güzel! Sadece bir adım kaldı.",
      by_creating_account: "Hesap oluşturarak",
      by_signing_in: "Oturum açarak",
      you_agree_to_our: "şunları kabul etmiş olursunuz",
      ...
      no_date: "Tarih yok",
      no_cycle: "Döngü yok",
      no_modules: "Modül yok",
      no_assignees: "Atanan yok",
