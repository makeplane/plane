 ...
 Bunun yerine yeni bir inisiyatif oluşturun.`,
  ...
  oauth_bridge_integration: {
    ...
    provider_form: {
      ...
      user_claim_label: "Kullanıcı claim'i",
      user_claim_placeholder: "email",
      user_claim_description: "Kullanıcının e-posta adresini içeren JWT claim'i",
      user_claim_required: "Kullanıcı claim'i gereklidir.",
