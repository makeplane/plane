...
export default {
  ...
  project_id: "專案 ID",
  project_id_tooltip_content: "協助您唯一識別專案中的工作事項。最多 50 個字元。",
  ...
  project_id_max_char: "專案 ID 最多只能有 {max} 個字元",
...
劃分的工作明細。`,
  ...
  oauth_bridge_integration: {
    name: "OAuth Bridge",
    description: "驗證外部 IdP 權杖以進行 API 存取。",
    header_description: "驗證來自您的 IdP（Azure AD、Okta 等）的外部 OIDC/JWT 權杖，用於 Plane API 存取。",
    connected: "已連線",
    connect: "連線",
    uninstall: "解除安裝",
    uninstalling: "解除安裝中...",
    install_success: "OAuth Bridge 安裝成功。",
    install_error: "OAuth Bridge 安裝失敗。",
    uninstall_success: "OAuth Bridge 已解除安裝。",
    uninstall_error: "OAuth Bridge 解除安裝失敗。",
    token_providers: "權杖提供者",
    token_providers_description: "設定其 JWT 被接受為 API 憑證的外部 IdP。",
    add_provider: "新增提供者",
    edit_provider: "編輯提供者",
    enabled: "已啟用",
    disabled: "已停用",
    test: "測試",
    no_providers_title: "尚未設定提供者。",
    no_providers_description: "新增 IdP 以啟用外部權杖驗證。",
    provider_updated: "提供者已更新。",
    provider_added: "提供者已新增。",
    provider_save_error: "儲存提供者失敗。",
    provider_deleted: "提供者已刪除。",
    provider_delete_error: "刪除提供者失敗。",
    provider_update_error: "更新提供者失敗。",
    jwks_reachable: "JWKS 可達",
    jwks_unreachable: "JWKS 不可達",
    jwks_test_error: "無法從設定的 URL 取得 JWKS。",
    provider_form: {
      name_label: "名稱",
      name_placeholder: "例如 Azure AD Production",
      name_description: "此身分提供者的可讀標籤",
      name_required: "名稱為必填。",
      issuer_label: "簽發者",
      issuer_placeholder: "https://login.microsoftonline.com/tenant-id/v2.0",
      issuer_description: "JWT 中預期的 iss 宣告值",
      issuer_required: "簽發者為必填。",
      jwks_url_label: "JWKS URL",
      jwks_url_placeholder: "https://login.microsoftonline.com/tenant-id/discovery/v2.0/keys",
      jwks_url_description: "提供者 JSON Web Key Set 的 HTTPS 端點",
      jwks_url_required: "JWKS URL 為必填。",
      jwks_url_https: "JWKS URL 必須使用 HTTPS。",
      audience_label: "受眾",
      audience_placeholder: "api://my-app-id",
      audience_description: "JWT 中預期的 aud 宣告，以逗號分隔。",
      user_claims_label: "使用者宣告",
      user_claims_placeholder: "email",
      user_claims_description: "包含使用者電子郵件地址的 JWT 宣告",
      user_claims_required: "使用者宣告為必填。",
      allowed_algorithms_label: "允許的簽章演算法",
      allowed_algorithms_description: "用於 JWT 簽章驗證的非對稱演算法",
      allowed_algorithms_required: "至少需要一個演算法。",
      select_algorithms: "選擇演算法",
      jwks_cache_ttl_label: "JWKS 快取 TTL（秒）",
      jwks_cache_ttl_description: "快取提供者 JWKS 金鑰的時長（最少 60 秒，預設 24 小時）",
      jwks_cache_ttl_min: "快取 TTL 至少為 60 秒。",
      rate_limit_label: "速率限制",
      rate_limit_placeholder: "120/minute",
      rate_limit_description: "請求限制格式為 次數/週期（例如 120/minute）。留空使用預設速率限制。",
      enable_provider: "啟用此提供者",
      saving: "儲存中...",
      update: "更新",
    },
  },
...
• 任務和評論創建：通過語音命令添加任務、描述和評論。`,
  ...
  page_actions: {
    move_page: {
      placeholders: {
        project_to_all_with_wiki: "搜尋 Wiki 集合、專案和團隊空間",
        project_to_project_with_wiki: "搜尋 Wiki 集合和專案",
        teamspace_to_all_with_wiki: "搜尋 Wiki 集合、專案和團隊空間",
      },
      toasts: {
        collection_error: {
          title: "已移至 Wiki",
          message: "頁面已移至 Wiki，但無法加入所選集合。它會保留在 General 中。",
        },
      },
    },
    remove_from_collection: {
      label: "從集合中移除",
      success_message: "頁面已從集合中移除。",
      error_message: "無法將頁面從集合中移除。請再試一次。",
    },
  },
  wiki_collections: {
    predefined: {
    ...
    fallback_name: "集合",
    form: {
      name_required: "集合標題為必填",
      name_max_length: "集合名稱必須少於 255 個字元",
      name_placeholder_create: "為集合輸入標題",
      name_placeholder_edit: "集合名稱",
    },
    create_modal: {
      title: "建立集合",
      submit: "建立集合",
    ...
    delete_modal: {
      title: "刪除集合",
      page_count: "此集合有 {pageCount} 個頁面。請選擇要如何處理它們。",
      transfer_title: "轉移頁面並刪除集合",
      transfer_description: "刪除前，請先將所有頁面移到另一個集合。頁面及其權限將會保留。",
      transfer_warning: "移動後的頁面將繼承所選集合的權限。",
      transfer_target_label: "將頁面移動到",
      transfer_target_placeholder: "選擇集合",
      delete_with_pages_title: "連同頁面一起刪除集合",
      delete_with_pages_description: "永久刪除集合及其所有頁面。此操作無法還原。",
      submit: "刪除集合",
    },
    header: {
      add_page: "新增頁面",
    ...
    menu: {
      create_new_page: "建立新頁面",
      add_existing_page: "新增現有頁面",
      rename_collection: "重新命名集合",
      collection_options: "集合選項",
    },
    add_existing_page_modal: {
      search_placeholder: "搜尋頁面",
      success_message: "已將 {count} 個頁面加入集合。",
      error_message: "無法移動頁面。請再試一次。",
      no_pages_found: "找不到符合搜尋條件的頁面",
      no_pages_available: "沒有可移動的頁面",
      submit: "移動",
    },
    list: {
      invite_only: "僅限邀請",
      remove_error: "無法將頁面從集合中移除。",
      no_matching_pages: "沒有符合的頁面",
      remove_search_criteria: "移除搜尋條件以查看所有頁面",
      remove_filters: "移除篩選條件以查看所有頁面",
      no_pages_title: "尚無頁面",
      no_pages_description: "此集合目前沒有任何頁面。",
      untitled: "未命名",
      restricted_access: "受限存取",
      collapse_page: "收合頁面",
      expand_page: "展開頁面",
      page_actions: "頁面操作",
      page_link_copied: "頁面連結已複製到剪貼簿。",
      columns: {
        page_name: "頁面名稱",
        owner: "擁有者",
        nested_pages: "巢狀頁面",
    ...
    toasts: {
      created: "集合建立成功。",
      create_error: "無法建立集合。請再試一次。",
      renamed: "集合重新命名成功。",
      rename_error: "無法更新集合。請再試一次。",
      transferred_deleted: "頁面已轉移，集合已刪除。",
      deleted_with_pages: "集合及其頁面已刪除。",
      delete_error: "無法刪除集合。請再試一次。",
      target_required: "請選擇要將頁面移動到的集合。",
      create_page_error: "無法建立頁面。請再試一次。",
      create_page_in_collection_error: "無法建立頁面或將其加入集合。請再試一次。",
      collection_link_copied: "集合連結已複製到剪貼簿。",
    },
  },
} as const;
