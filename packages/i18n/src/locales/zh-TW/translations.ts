export default {
  ...
  "stay_in_the_loop_on_issues_you_are_subscribed_to_enable_this_to_get_notified": "持續追蹤您訂閱的工作事項。啟用此功能以接收通知。",
  ...
  "quickly_see_make_or_break_issues_description": "預覽每個週期中相對於截止日期的高優先順序工作事項。一鍵檢視每個週期的所有工作事項。",
  ...
  "deactivate_your_account_description": "一旦停用，您將無法被指派工作事項，並且不會被收費。若要重新啟用帳號，您需要使用此電子郵件地址收到工作區的邀請。",
  "deactivating": "停用中",
  "confirm": "確認",
  "confirming": "確認中",
  "draft_created": "草稿已建立",
  ...
  "workspace_projects": {
    ...
    "empty_state": {
      "general": {
        "title": "沒有使用中的專案",
        "description": "請將每個專案視為目標導向工作的上層。專案是工作、週期和模組所在的地方，並與您的同事一起協助您達成目標。建立新專案或篩選已封存的專案。",
        "primary_button": {
          "text": "開始您的第一個專案",
          "comic": {
            "title": "在 Plane 中，一切都始於專案",
  ...
  "project_settings": {
    "general": {
      ...
      "archive_project": {
        "title": "封存專案",
        "description": "封存專案將不再從您的側邊導覽列中列出您的專案，但您仍然可以從專案頁面存取它。您可以隨時還原專案或刪除它。",
        "button": "封存專案"
      },
      "delete_project": {
        "title": "刪除專案",
  ...
  "project_cycles": {
    ...
    "empty_state": {
      ...
      "completed_no_issues": {
        "title": "週期中沒有工作事項",
        "description": "週期中沒有工作事項。工作事項已被轉移或隱藏。若要檢視隱藏的工作事項（如果有），請相應地更新您的顯示屬性。"
      },
      "active": {
        "title": "沒有使用中的週期",
      ...
      "no_issues": {
        ...
        "primary_button": {
          ...
          "comic": {
            ...
            "description": "重新設計 Plane 使用者介面、重塑公司品牌或推出新的燃料噴射系統都是可能有子工作事項的工作事項範例。"
          }
        }
      },
      "no_archived_issues": {
  ...
  "project_module": {
    ...
    "empty_state": {
      "general": {
        ...
        "description": "屬於邏輯、階層式上層的一組工作事項形成一個模組。將其視為一種依專案里程碑追蹤工作的方式。它們有自己的期間和截止日期以及分析，可協助您了解您距離里程碑有多近或多遠。",
        "primary_button": {
          "text": "建立您的第一個模組",
          "comic": {
            "title": "模組協助依階層結構分組工作。",
  ...
  "project_views": {
    "empty_state": {
      "general": {
        ...
        "description": "檢視是您經常使用或想要輕鬆存取的已儲存篩選器集。專案中的所有同事都可以看到每個人的檢視，並選擇最適合他們需求的檢視。",
        "primary_button": {
          "text": "建立您的第一個檢視",
          "comic": {
            "title": "檢視基於工作事項屬性運作。",
  ...
  "project_page": {
    "empty_state": {
      "general": {
        ...
        "description": "頁面是 Plane 中的思考筆記空間。記下會議筆記，輕鬆格式化，嵌入工作事項，使用元件庫排版，並將它們全部保留在專案的上下文中。若要快速完成任何文件，可以使用快速鍵或按鈕來呼叫 Plane 的 AI Galileo。",
        "primary_button": {
          "text": "建立您的第一個頁面"
        }
      },
  ...
  "disabled_project": {
    "empty_state": {
      "inbox": {
        "title": "進件功能未啟用於此專案。",
        "description": "進件可協助您管理專案的傳入請求，並將它們新增為工作流程中的工作事項。從專案設定啟用進件以管理請求。",
        "primary_button": {
          "text": "管理功能"
        }
      },
      "cycle": {
        "title": "週期功能未啟用於此專案。",
        "description": "將工作分解成時間區段化的區塊，從專案截止日期向後設定日期，並以團隊的方式取得具體進展。啟用專案的週期功能以開始使用。",
        "primary_button": {
          "text": "管理功能"
        }
      },
