...
export default {
  ...
  localized_ui: {
    ...
    editor: {
      ...
      text: "文字",
      enter_text_to_display: "輸入要顯示的文字",
      remove_link: "刪除連結",
      edit_link: "編輯連結",
      color: "顏色",
      text_colors: "文字顏色",
      ...
      link: "關聯",
      enter_or_paste_link: "輸入或貼上連結",
      please_enter_valid_url: "請輸入有效的URL",
      delete: "刪除",
      duplicate: "複製",
      multiple: "多種的",
      loading: "載入中",
      ...
      uploading: "上傳中",
      drop_image_here: "將圖像拖放到此處",
      retry_duplication: "重試複製",
      retry: "重試",
      no_emojis_found: "沒有找到表情符號",
      fullscreen_image_viewer: "全螢幕影像檢視器",
      close_image_viewer: "關閉影像檢視器",
      zoom_out: "縮小",
      zoom_in: "放大",
      download_image: "下載圖片",
      open_image_in_new_tab: "在新分頁中開啟圖像",
      view_in_full_screen: "全螢幕檢視",
      view_image_in_full_screen: "全螢幕檢視影像",
      align: "對齊",
      download: "下載",
      clear_contents: "清除內容",
      insert_above: "在上面插入",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "您已被邀請加入 {workspaceName}",
      description: "您可以在工作區中建立專案、協作處理工作專案以及在 Plane 帳戶中組織不同的工作流程。",
      accept: "接受",
      ignore: "忽略",
      already_member: "您已經是 {workspaceName} 的會員",
      continue_to_home: "繼續回家",
      inactive_title: "此邀請連結不再有效。",
      empty_project_link: "或從一個空項目開始",
      sign_in_to_continue: "登入以繼續",
      star_on_github: "在 GitHub 上給我們加星標",
      join_community: "加入我們的活躍創作者社群",
    },
    space_auth: {
      email: "電子郵件",
    ...
    onboarding: {
      create_profile_title: "建立您的個人資料。",
      create_profile_description: "這就是您在 Plane 中的顯示方式。",
      change_image: "更改圖像",
      upload_image: "上傳圖片",
      name: "姓名",
      name_required: "姓名為必填項",
      name_within_50: "名稱必須在 50 個字元以內。",
      enter_full_name: "輸入您的全名",
      set_password: "設定密碼",
      optional: "選修的",
      passwords_do_not_match: "密碼不匹配",
      passwords_match: "密碼匹配",
      continue: "繼續",
      invite_team_title: "邀請你的隊友",
      invite_team_description: "在 Plane 的工作最適合您的團隊。現在邀請他們充分發揮 Plane 的潛力。",
      invalid_email: "這看起來不像電子郵件地址。",
      success: "成功！",
      invitations_sent: "邀請已成功發送。",
      error: "錯誤！",
      add_another: "添加另一個",
      do_later: "我稍後會做",
      join_invites_title: "加入邀請或創建工作區",
      unified_description: "您的所有工作 — 統一。",
      create_new_workspace: "建立新工作區",
      no_invitations_found: "未找到邀請",
      you_are_invited: "誠摯邀請您！",
      accept_invites: "接受邀請與您的團隊合作。",
      continue_to_workspace: "繼續工作區",
      or: "或者",
      create_own_workspace: "創建您自己的工作空間",
      workspace_creation_disabled:
        "您似乎沒有任何工作區邀請，而您的實例管理員限制了新工作區的建立。請讓工作區擁有者或管理員先邀請您加入工作區，然後再回到此畫面加入。",
      create_workspace_title: "創建您的工作空間",
      enter_workspace_name: "輸入工作區名稱",
      join_existing_workspace: "加入現有工作區",
      profile_setup_completed: "個人資料設定完成。",
      profile_setup_failed: "設定檔設定失敗。",
      usecase_title: "您打算如何使用 Plane？",
      usecase_description: "選擇一個或多個選項，以便我們為您提供個人化體驗。",
      select_one_or_more: "選擇一個或多個",
      select_at_least_one: "至少選擇一個選項。",
      skip: "跳過",
    },
    inbox: {
      duplicate_issues_found: "{count} 發現重複問題",
      description_versions: {
        intake_form_user: "攝取表格用戶",
      },
      errors: {
        asset_upload_failed: "資源上傳失敗。請稍後重試。",
        asset_duplication_failed: "資產複製失敗。請稍後重試。",
        permission_denied: "沒有權限",
        mark_duplicate_permission: "只有專案管理員可以將工作項目標記為重複",
        mark_duplicate_permission_plural: "只有專案管理員可以將工作項目標記為重複",
      },
      filters: {
        created_date: "建立日期",
        updated_date: "更新日期",
      ...
      navigation: {
        previous_work_item: "上一個工作項目",
        next_work_item: "下一個工作項目",
      },
      properties: {
        duplicate_of: "重複的",
      },
      select_duplicate: {
        select_work_item: "選擇工作項目",
      },
      sidebar: {
        label_count: "{count} 標籤",
      },
      toasts: {
        editor_processing: "編輯器仍在處理更改。請稍候再繼續。",
        create_success: "工作項目建立成功。",
        delete_failed: "工作項目刪除失敗",
        update_failed: "工作項目更新失敗",
      },
    },
    space_public: {
      error_title: "糟糕，看起來不太妙。",
      error_description_prefix: "Plane 當掉了。別擔心，我們的工程師已收到通知。如果你有更多細節，請寫信到",
      error_description_middle: "或前往我們的",
      forum: "論壇",
      refresh: "重新整理",
      not_found_title: "這個連結無法開啟",
      not_found_hint: "請檢查瀏覽器位址列中的 URL，然後再試一次。",
      user_already_logged_in: "使用者已登入",
      logged_in_title: "很好，還差最後一步。",
      logged_in_hint: "請在瀏覽器位址列中輸入你要查看的公開分享檢視或頁面 URL。",
      by_creating_account: "建立帳戶即表示",
      by_signing_in: "登入即表示",
      you_agree_to_our: "你同意我們的",
      terms_of_service: "服務條款",
      and: "和",
      privacy_policy: "隱私權政策",
      sign_up: "註冊",
      oauth_with_provider: "使用 {provider} {action}",
      auth: {
        sign_in_header: "登入後即可投票或評論",
        sign_in_subheader: "為你希望建置的功能提供回饋。",
        sign_up_header: "查看、評論並執行更多操作",
        sign_up_subheader: "註冊或登入後即可處理 Plane 工作項目和頁面。",
      },
      peek: {
        side: "側邊預覽",
        modal: "彈窗",
      ...
      bot_name: "{name} 機器人",
      commented_time: "評論於 {time}",
      and_more: "還有 {count} 個",
      no_upvotes_yet: "暫無贊成票",
      no_downvotes_yet: "暫無反對票",
      view_less: "收起",
      view_all: "查看全部",
      no_matches_found: "未找到相符項目",
      no_date: "無日期",
      no_cycle: "無週期",
      no_modules: "無模組",
      modules_count: "{count} 個模組",
      no_assignees: "無負責人",
      labels_count: "{count} 個標籤",
      page_not_found_alt: "找不到頁面",
      something_went_wrong: "糟糕！出了點問題。",
      page_not_found_description: "你要尋找的頁面不存在或已被移動。",
      instance_failure_image_alt: "無法取得執行個體詳細資訊",
      instance_failure_title: "無法取得執行個體詳細資訊。",
      instance_failure_description: "我們無法載入你的執行個體詳細資訊。",
      instance_failure_hint: "請檢查連線並重試。",
      retry: "重試",
      powered_by: "技術支援",
      sign_in_to_add_comment: "登入以新增評論",
      sign_in: "登入",
      link_copied: "連結已複製！",
      work_item_link_copied: "工作項目連結已複製到剪貼簿。",
      comment_post_error: "評論發布失敗。請再試一次。",
      add_comment: "新增評論",
      public_board_not_found: "公開看板不存在。請檢查 URL。",
      no_work_items_found: "未找到工作項目",
      no_labels: "無標籤",
      user: "使用者",
    },
  },
