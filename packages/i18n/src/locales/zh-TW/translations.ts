...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      something_went_wrong: "哎呀！出了點問題。",
      page_not_found_description: "您要尋找的頁面不存在或已被移動。",
      instance_failure_image_alt: "無法取得實例詳細信息",
      instance_failure_title: "無法取得實例詳細資訊。",
      instance_failure_description: "我們無法載入您的實例詳細資訊。",
      instance_failure_hint: "請檢查您的連線並重試。",
      retry: "重試",
      powered_by: "供電",
      ...
      comment_post_error: "無法發表評論。請再試一次。",
      add_comment: "新增評論",
      public_board_not_found: "公共董事會不存在。請檢查 URL。",
