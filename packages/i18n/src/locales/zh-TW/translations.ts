...
export default {
  ...
  localized_ui: {
    editor: {
          "url": "URL",
          "enter_or_paste_url": "輸入或貼上 URL",
          "text": "文字",
          "enter_text_to_display": "輸入要顯示的文字",
          "remove_link": "移除連結"
    },
      "workspace_invitation": {
          "invitation_not_found": "找不到邀請",
          "invited_to_workspace": "你已受邀加入 {workspaceName}",
          "description": "工作區是你建立專案、協作處理工作項目，並在 Plane 帳戶中整理不同工作流的地方。",
          "accept": "接受",
          "ignore": "忽略",
          "already_member": "你已经是 {workspaceName} 的成员",
          "continue_to_home": "返回首頁",
          "inactive_title": "此邀請連結已失效。",
          "empty_project_link": "或從空白專案開始",
          "sign_in_to_continue": "登入以繼續",
          "star_on_github": "在 GitHub 上給我們星標",
      ...
      "onboarding": {
          ...
          "no_invitations_found": "找不到邀請",
          "you_are_invited": "你收到了邀请！",
          "accept_invites": "接受邀请，与团队一起协作。",
          "continue_to_workspace": "继续前往工作区",
          "or": "或",
          "create_own_workspace": "建立自己的工作區",
          "workspace_creation_disabled": "你似乎没有任何工作区邀请，且实例管理员已限制创建新工作区。请先让工作区所有者或管理员邀请你加入工作区，然后回到此页面继续。",
          "create_workspace_title": "建立你的工作區",
