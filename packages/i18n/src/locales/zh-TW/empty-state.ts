export default {
  ...
  project: {
    ...
    modules: {
      ...
      description: "模組由相互關聯的工作項組成。它們有助於監控專案階段的進度,每個階段都有特定的截止日期和分析,以指示您離實現這些階段有多近。",
    ...
    views: {
      title: "為專案儲存自訂檢視",
      description: "檢視是已儲存的篩選器,可協助您快速存取最常用的資訊。團隊成員可以輕鬆協作,共用檢視並根據特定需求進行調整。",
      cta_primary: "建立檢視",
    },
    ...
    pages: {
      title: "記錄一切 — 從筆記到 PRD",
      description: "頁面讓您在一個地方擷取和組織資訊。撰寫會議筆記、專案文件和 PRD,嵌入工作項,並使用現成的元件進行結構化。",
