...
export default {
  ...
  language_setting: "Chọn ngôn ngữ sử dụng trong giao diện.",
  settings_moved_to_preferences: "Cài đặt múi giờ & ngôn ngữ đã được chuyển sang tùy chọn.",
  go_to_preferences: "Đi đến tùy chọn",
  theme: "Chủ đề",
  ...
  capacity_items: "mục",
  total_logged_time: "Tổng thời gian đã ghi nhận",
  total_work_items: "Tổng mục công việc",
  ...
  analytics_logtime_breakdown: "Thời gian ghi theo người dùng",
  capacity_main_task_category: "Danh mục công việc chính",
  capacity_sub_task_category: "Danh mục công việc phụ",
  capacity_day_details: "Công việc ngày này",
  ...
  issue: {
    ...
    reason_placeholder: "Giải thích lý do ngày này được thay đổi...",
    reason_required: "Cần cung cấp lý do khi thay đổi trường này.",
    activity_reason: "Lý do",
    activity_due_date_set: "đã đặt ngày đến hạn thành",
    activity_due_date_removed: "đã xóa ngày đến hạn",
    activity_completed_at_set: "đã đặt ngày hoàn thành thành",
  ...
  workspace_analytics: {
    ...
    at_risk: "Rủi ro",
    current_cycles: "Chu kỳ hiện tại",
    upcoming_cycles: "Chu kỳ sắp tới",
    completed_cycles: "Chu kỳ đã hoàn thành",
    completed_modules: "Mô-đun đã hoàn thành",
    in_progress_modules: "Mô-đun đang tiến hành",
    planned_modules: "Mô-đun theo kế hoạch",
    paused_modules: "Mô-đun đã tạm dừng",
    ...
    tabs: {
      ...
      work_items_resolved_vs_pending: "Mục công việc đã giải quyết so với chờ xử lý",
    },
    empty_state: {
      customized_insights: {
    ...
    total_users_count: "Tổng số Người dùng",
    total_work_items_count: "Tổng số Mục công việc",
    total_intakes_count: "Tổng số Intake",
    completed_issues_title: "Mục công việc đã hoàn thành",
    status: {
      accepted: "Đã chấp nhận",
      declined: "Đã từ chối",
      duplicate: "Trùng lặp",
  ...
  workspace_views: {
    ...
    export: {
      button: "Xuất",
      button_loading: "Đang xuất...",
      col_id: "ID",
      col_title: "Tiêu đề",
      col_department: "Bộ phận",
      col_project: "Dự án",
      col_main_category: "Danh mục chính",
      col_sub_category: "Danh mục phụ",
      col_sub_issues: "Công việc con",
      col_project_lead: "Trưởng dự án",
      col_assignees: "Người được giao",
      col_bank_wide: "Toàn ngân hàng",
      ...
      col_log_time: "Thời gian ghi",
      col_ref_link: "Liên kết tham chiếu",
      col_labels: "Nhãn",
      col_estimate: "Ước tính",
      col_created_at: "Ngày tạo",
      col_updated_at: "Ngày cập nhật",
      col_link_count: "Liên kết",
      col_attachments: "Tệp đính kèm",
      warning_title: "Dữ liệu lớn",
      warning_message: "Bạn sắp xuất {count} mục công việc. Thao tác này có thể mất một lúc. Tiếp tục?",
      warning_confirm: "Vẫn xuất",
    },
    empty_state: {
      "all-issues": {
  ...
  account_settings: {
    ...
    notifications: {
      heading: "Thông báo email",
      description: "Nhận thông báo về các mục công việc bạn đang theo dõi. Bật tính năng này để nhận thông báo.",
    },
    security: {
      heading: "Bảo mật",
    },
    api_tokens: {
      heading: "Token truy cập cá nhân",
      description: "Tạo token API an toàn để tích hợp dữ liệu với các hệ thống và ứng dụng bên ngoài.",
    },
    activity: {
      heading: "Hoạt động",
  ...
  project_settings: {
    ...
    workflows: {
      ...
      reset: "Đặt lại quy trình",
      reset_confirm_title: "Bạn có chắc chắn muốn đặt lại quy trình này không?",
      reset_confirm_body: "Sau khi đặt lại, tất cả cài đặt quy trình tùy chỉnh của bạn sẽ bị xóa.",
      view_history: "Xem lịch sử thay đổi",
      ...
      blocker_title: "Chuyển đổi không được phép",
      blocker_body: "Chỉ {{reviewers}} mới có thể chuyển công việc này sang {{state}}.",
      blocker_all_members: "Tất cả thành viên",
      drag_blocked_title: "Bạn không thể di chuyển công việc này đến đây.",
      indicator_popup_title: "Thay đổi trạng thái",
      indicator_popup_for: "Đối với công việc trong",
      indicator_popup_can_move: "có thể chuyển sang",
      indicator_all_members: "Tất cả thành viên",
      no_transitions_into_state: "Không có chuyển đổi nào được định nghĩa vào trạng thái này.",
      activity_loading: "Đang tải...",
      activity_empty: "Chưa có hoạt động nào.",
      activity_changed: "đã thay đổi",
      activity_from: "từ",
      activity_to: "sang",
      activity_system_actor: "Hệ thống",
    },
    automations: {
      heading: "Automations",
      description:
  ...
  module: {
    ...
    activity: {
      ...
      load_more: "Tải thêm",
      unknown_actor: "Người dùng không xác định",
      created_module: "đã tạo mô-đun",
      deleted_module: "đã xóa mô-đun",
      archived_module: "đã lưu trữ mô-đun",
      unarchived_module: "đã khôi phục mô-đun",
      changed_name: "đã đổi tên từ {old} thành {new}",
      changed_status: "đã đổi trạng thái từ {old} thành {new}",
      changed_date: "đã thay đổi {field}",
      changed_lead: "đã thay đổi người phụ trách",
      changed_description: "đã cập nhật mô tả",
      updated_work_items: "đã cập nhật công việc",
      updated_members: "đã cập nhật thành viên",
      updated_module: "đã cập nhật {field}",
    },
  },
  ...
  power_k: {
    contextual_actions: {
      work_item: {
        title: "Thao tác mục công việc",
        indicator: "Mục công việc",
        change_state: "Đổi trạng thái",
        change_priority: "Đổi mức ưu tiên",
        change_assignees: "Giao cho",
        assign_to_me: "Giao cho tôi",
        unassign_from_me: "Bỏ giao khỏi tôi",
        change_estimate: "Đổi ước tính",
        add_to_cycle: "Thêm vào chu kỳ",
        add_to_modules: "Thêm vào mô-đun",
        add_labels: "Thêm nhãn",
        subscribe: "Đăng ký nhận thông báo",
        unsubscribe: "Hủy đăng ký thông báo",
        delete: "Xóa",
        copy_id: "Sao chép ID",
        copy_id_toast_success: "Đã sao chép ID mục công việc vào bảng tạm.",
        copy_id_toast_error: "Đã xảy ra lỗi khi sao chép ID mục công việc.",
        copy_title: "Sao chép tiêu đề",
        copy_title_toast_success: "Đã sao chép tiêu đề mục công việc vào bảng tạm.",
        copy_title_toast_error: "Đã xảy ra lỗi khi sao chép tiêu đề mục công việc.",
        copy_url: "Sao chép URL",
        copy_url_toast_success: "Đã sao chép URL mục công việc vào bảng tạm.",
        copy_url_toast_error: "Đã xảy ra lỗi khi sao chép URL mục công việc.",
      },
      cycle: {
        title: "Thao tác chu kỳ",
        indicator: "Chu kỳ",
        add_to_favorites: "Thêm vào yêu thích",
        remove_from_favorites: "Xóa khỏi yêu thích",
        copy_url: "Sao chép URL",
        copy_url_toast_success: "Đã sao chép URL chu kỳ vào bảng tạm.",
        copy_url_toast_error: "Đã xảy ra lỗi khi sao chép URL chu kỳ.",
      },
      module: {
        title: "Thao tác mô-đun",
        indicator: "Mô-đun",
        add_remove_members: "Thêm/xóa thành viên",
        change_status: "Đổi trạng thái",
        add_to_favorites: "Thêm vào yêu thích",
        remove_from_favorites: "Xóa khỏi yêu thích",
        copy_url: "Sao chép URL",
        copy_url_toast_success: "Đã sao chép URL mô-đun vào bảng tạm.",
        copy_url_toast_error: "Đã xảy ra lỗi khi sao chép URL mô-đun.",
      },
      page: {
        ...
        remove_from_favorites: "Xóa khỏi yêu thích",
        copy_url: "Sao chép URL",
        copy_url_toast_success: "Đã sao chép URL trang vào bảng tạm.",
        copy_url_toast_error: "Đã xảy ra lỗi khi sao chép URL trang.",
      },
    },
    creation_actions: {
      create_work_item: "Mục công việc mới",
    ...
    navigation_actions: {
      ...
      nav_subscribed_workspace_work_items: "Đến mục công việc đang theo dõi",
      nav_workspace_analytics: "Đến phân tích không gian làm việc",
      nav_workspace_drafts: "Đến bản nháp không gian làm việc",
      nav_workspace_archives: "Đến kho lưu trữ không gian làm việc",
      open_workspace_setting: "Mở cài đặt không gian làm việc",
      nav_workspace_settings: "Đến cài đặt không gian làm việc",
      nav_project_work_items: "Đến mục công việc",
    ...
    miscellaneous_actions: {
      toggle_app_sidebar: "Bật/tắt thanh bên",
      copy_current_page_url: "Sao chép URL trang hiện tại",
      copy_current_page_url_toast_success: "Đã sao chép URL trang hiện tại vào bảng tạm.",
      copy_current_page_url_toast_error: "Đã xảy ra lỗi khi sao chép URL trang hiện tại.",
      focus_top_nav_search: "Tập trung ô tìm kiếm",
    },
    preferences_actions: {
      update_theme: "Đổi giao diện",
      update_timezone: "Đổi múi giờ",
      update_start_of_week: "Đổi ngày đầu tuần",
      update_language: "Đổi ngôn ngữ giao diện",
      toast: {
        theme: {
          success: "Đã cập nhật giao diện.",
          error: "Cập nhật giao diện thất bại. Vui lòng thử lại.",
        },
        timezone: {
          success: "Đã cập nhật múi giờ.",
          error: "Cập nhật múi giờ thất bại. Vui lòng thử lại.",
        },
        generic: {
          success: "Đã cập nhật tùy chọn.",
          error: "Cập nhật tùy chọn thất bại. Vui lòng thử lại.",
        },
      },
    },
    help_actions: {
    ...
    page_placeholders: {
      ...
      update_work_item_estimate: "Đổi ước tính",
      update_work_item_cycle: "Thêm vào chu kỳ",
      update_work_item_module: "Thêm vào mô-đun",
      update_work_item_labels: "Thêm nhãn",
      update_module_member: "Đổi thành viên",
      update_module_status: "Đổi trạng thái",
      update_theme: "Đổi giao diện",
      update_timezone: "Đổi múi giờ",
      update_start_of_week: "Đổi ngày đầu tuần",
  ...
  worklog: {
    ...
    locked_description: "Nhật ký cũ hơn 60 ngày làm việc không thể chỉnh sửa",
    ...
    backdate_limit: "Không thể ghi nhận thời gian quá 60 ngày làm việc trước",
    reason_label: "Lý do thay đổi",
    reason_placeholder: "Giải thích lý do chỉnh sửa nhật ký công việc...",
    reason_required: "Bắt buộc phải có lý do thay đổi.",
    delete_reason_label: "Lý do xóa",
    delete_reason_placeholder: "Giải thích lý do xóa nhật ký công việc...",
    delete_reason_required: "Bắt buộc phải có lý do xóa.",
    confirm_delete: "Xác nhận xóa",
    confirm_delete_title: "Xóa nhật ký công việc",
    confirm_delete_message: "Hành động này không thể hoàn tác. Vui lòng cung cấp lý do xóa nhật ký công việc này.",
    activity_modified: "đã chỉnh sửa nhật ký thời gian",
    activity_deleted_log: "đã xóa nhật ký thời gian",
    activity_reason: "Lý do",
  ...
  department: {
    ...
    name: { label: "Tên phòng ban", placeholder: "Nhập tên phòng ban" },
    code: { label: "Mã", placeholder: "Nhập mã" },
    ...
    deleted_message: "Phòng ban đã được xóa thành công.",
  ...
  staff: {
    ...
    add: "Thêm nhân viên",
    edit: "Sửa nhân viên",
    import: "Nhập nhân viên",
    delete: "Xóa nhân viên",
    delete_confirm: "Bạn có chắc chắn muốn xóa nhân viên này không?",
    deactivate_confirm: "Bạn có chắc chắn muốn vô hiệu hóa nhân viên này không?",
    staff_id: { label: "Mã nhân viên", placeholder: "Mã NV (ví dụ: 18506320)" },
    name: { label: "Họ và tên", placeholder: "Nhập họ và tên" },
    first_name: { placeholder: "Họ" },
    last_name: { placeholder: "Tên" },
    email: { label: "Email", placeholder: "Nhập email" },
    position: { label: "Chức vụ", placeholder: "Chức vụ" },
    department: { label: "Phòng ban", select: "Chọn phòng ban" },
    job_grade: { placeholder: "Cấp bậc" },
    ...
    deleted_message: "Nhân viên đã được xóa thành công.",
    delete_failed: "Xóa nhân viên thất bại.",
    deactivated: "Đã vô hiệu hóa nhân viên",
    deactivated_message: "Nhân viên đã được vô hiệu hóa thành công.",
    deactivate_failed: "Vô hiệu hóa nhân viên thất bại.",
  ...
  analytics_dashboard: {
    ...
    create: "Tạo bảng phân tích",
    edit: "Sửa bảng phân tích",
    update: "Cập nhật bảng phân tích",
    delete: "Xóa bảng phân tích",
    delete_confirm:
      "Bạn có chắc chắn muốn xóa <strong>{name}</strong> không? Hành động này không thể hoàn tác và sẽ xóa tất cả widget trong bảng phân tích này.",
    duplicate: "Nhân bản",
    name: { label: "Tên", placeholder: "Tên bảng phân tích" },
    description: { label: "Mô tả", placeholder: "Mô tả bảng phân tích..." },
    ...
    // Form modal
    modal_title_create: "Tạo bảng phân tích",
    modal_title_update: "Cập nhật bảng phân tích",
    name_max_length: "Tên phải có 255 ký tự hoặc ít hơn",
    description_placeholder: "Thêm mô tả (tùy chọn)",
    public_access: "Truy cập công khai",
    public_access_description: "Cho phép tất cả thành viên không gian làm việc xem bảng phân tích này",
    ...
    tab_basic: "Cơ bản",
    tab_style: "Kiểu",
    tab_display: "Hiển thị",
    tab_filters: "Bộ lọc",
    configure_widget: "Cấu hình widget",
    add_widget: "Thêm widget",
    submit_update_widget: "Cập nhật widget",
    submit_add_widget: "Thêm widget",
    // Basic settings
    widget_name: "Tên widget",
    property_x_axis: "Thuộc tính (Trục X)",
    metric_y_axis: "Chỉ số (Trục Y)",
    chart_model: "Mô hình biểu đồ",
    group_by_optional: "Nhóm theo (tùy chọn)",
    property_required: "Thuộc tính là bắt buộc",
    metric_required: "Chỉ số là bắt buộc",
    select_property: "Chọn thuộc tính",
    select_metric: "Chọn chỉ số",
    widget_name_placeholder: "Vấn đề theo mức độ ưu tiên",
    none: "Không có",
    chart_model_basic: "Cơ bản",
    chart_model_grouped: "Nhóm",
    // Display settings
    show_legend: "Hiển thị chú thích",
    show_tooltip: "Hiển thị chú giải",
    show_center_value: "Hiển thị giá trị trung tâm",
    show_data_points: "Hiển thị điểm dữ liệu",
    // Style settings
    color_preset: "Bộ màu",
    fill_opacity: "Độ mờ đục lấp đầy",
    show_border: "Hiển thị viền",
    smooth_lines: "Đường mượt",
    // Filter settings
    filter_description: "Lọc dữ liệu widget theo các chiều cụ thể. Chỉ những vấn đề phù hợp mới được đưa vào biểu đồ.",
    filter_priority: "Mức độ ưu tiên",
    filter_state_group: "Nhóm trạng thái",
    filter_date_ranges: "Phạm vi ngày",
    // Context menu
    context_edit: "Sửa",
    context_open_new_tab: "Mở trong tab mới",
    context_copy_link: "Sao chép liên kết",
    context_delete: "Xóa",
    link_copied: "Đã sao chép liên kết vào clipboard",
    copy_link_failed: "Sao chép liên kết thất bại",
    // Toolbar
    refresh: "Làm mới",
    done: "Xong",
    edit_mode: "Sửa",
    // Dashboard detail page toasts
    dashboard_refreshed: "Đã làm mới bảng phân tích",
    refresh_failed: "Làm mới bảng phân tích thất bại",
    widget_deleted: "Đã xóa widget",
    delete_widget_failed: "Xóa widget thất bại",
    layout_update_failed: "Cập nhật bố cục thất bại",
    widget_duplicated: "Đã nhân bản widget",
    duplicate_widget_failed: "Nhân bản widget thất bại",
    widget_updated: "Đã cập nhật widget",
    widget_added: "Đã thêm widget",
    update_widget_failed: "Cập nhật widget thất bại",
    add_widget_failed: "Thêm widget thất bại",
    empty_widgets: "Chưa có widget nào. Thêm widget đầu tiên của bạn để bắt đầu.",
    // Dashboard list page toasts
    created_success: "Tạo bảng phân tích thành công.",
    create_failed: "Tạo bảng phân tích thất bại",
    updated_success: "Cập nhật bảng phân tích thành công.",
    update_failed: "Cập nhật bảng phân tích thất bại",
    deleted_success: "Xóa bảng phân tích thành công.",
    delete_failed: "Xóa bảng phân tích thất bại",
    empty_description: "Tạo bảng phân tích đầu tiên để trực quan hóa dữ liệu mục công việc.",
