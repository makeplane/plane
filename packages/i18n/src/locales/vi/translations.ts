...
export default {
  ...
  timesheet_no_issues: "Không có công việc nào được theo dõi tuần này",
  timesheet_week_of: "Tuần của",
  timesheet_this_week: "Tuần này",
  timesheet_total: "Tổng",
  capacity_no_data: "Không có dữ liệu",
  capacity_dashboard: "Bảng năng lực",
  capacity_dashboard_description: "Tổng quan về năng lực nhóm và phân bổ khối lượng công việc.",
  capacity_total_logged: "Tổng đã ghi",
  capacity_total_estimated: "Tổng ước tính",
  capacity_member: "Thành viên",
  capacity_overloaded: "Quá tải",
  capacity_under_capacity: "Dưới năng lực",
  capacity_normal: "Bình thường",
  total_logged_time: "Tổng thời gian đã ghi",
  ...
  workspace_analytics: {
    ...
    tabs: {
      ...
      work_items_resolved_vs_pending: "Công việc đã giải quyết vs Đang chờ",
      cycle_progress: "Tiến độ chu kỳ",
      module_progress: "Tiến độ mô-đun",
    ...
    completed_issues_title: "Đã hoàn thành",
    total_intakes_count: "Tổng tiếp nhận",
    status: {
  ...
  worklog: {
    ...
    description: "Mô tả",
    date: "Ngày",
    no_entries: "Chưa có thời gian ghi nhận",
    delete_confirm: "Xóa nhật ký công việc này?",
    over_budget: "Vượt ước tính",
    on_track: "Đúng tiến độ",
    total_logged: "Tổng đã ghi",
    ...
    error: "Lỗi",
    duration_required: "Thời gian phải lớn hơn 0.",
    save_failed: "Lưu nhật ký thất bại.",
    edit_log: "Sửa nhật ký",
    update: "Cập nhật",
  ...
  staff: {
    label: "Staff",
    profile_section_title: "Hồ sơ nhân viên",
    add: "Add staff",
    edit: "Edit staff",
    import: "Import staff",
    delete: "Delete staff",
  ...
  analytics_dashboard: {
    ...
    duplicate: "Duplicate",
    name: { label: "Name", placeholder: "Analytics Dashboard" },
