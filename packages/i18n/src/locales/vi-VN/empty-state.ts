export default {
  common: {
    ...
    server_error: {
      title: "Lỗi máy chủ",
      description: "Chúng tôi không thể kết nối và lấy dữ liệu từ máy chủ của chúng tôi. Đừng lo lắng, chúng tôi đang khắc phục.",
      cta_primary: "Thử tải lại",
    },
  },
  project: {
    work_items: {
      ...
      description: "Các mục công việc là những khối xây dựng của dự án của bạn — chỉ định người sở hữu, đặt mức độ ưu tiên và theo dõi tiến độ dễ dàng.",
      cta_primary: "Tạo mục công việc đầu tiên của bạn",
    },
    cycles: {
      title: "Nhóm và giới hạn thời gian công việc của bạn trong Chu kỳ.",
      description: "Chia nhỏ công việc thành các phần có giới hạn thời gian, làm ngược từ thời hạn dự án để đặt ngày và tạo tiến triển cụ thể như một đội.",
      cta_primary: "Đặt chu kỳ đầu tiên của bạn",
    },
    cycle_work_items: {
      title: "Không có mục công việc để hiển thị trong chu kỳ này",
      description: "Tạo các mục công việc để bắt đầu giám sát tiến độ của đội bạn trong chu kỳ này và đạt được mục tiêu đúng hạn.",
    ...
    modules: {
      ...
      description: "Các mô-đun được tạo thành từ các mục công việc kết nối với nhau. Chúng hỗ trợ theo dõi tiến độ qua các giai đoạn dự án, mỗi giai đoạn có thời hạn và phân tích cụ thể để chỉ ra bạn gần đạt được các giai đoạn đó như thế nào.",
    ...
    views: {
      ...
      description: "Chế độ xem là các bộ lọc đã lưu giúp bạn truy cập nhanh chóng thông tin bạn sử dụng nhiều nhất. Cộng tác dễ dàng khi các đồng đội chia sẻ và điều chỉnh chế độ xem theo nhu cầu cụ thể của họ.",
      cta_primary: "Tạo chế độ xem",
    },
    no_work_items_in_project: {
      title: "Chưa có mục công việc trong dự án",
      description: "Thêm các mục công việc vào dự án của bạn và chia nhỏ công việc thành các phần có thể theo dõi với chế độ xem.",
    ...
    pages: {
      ...
      description: "Các trang cho phép bạn ghi lại và tổ chức thông tin ở một nơi. Viết ghi chú cuộc họp, tài liệu dự án và PRD, nhúng các mục công việc và cấu trúc chúng với các thành phần sẵn sàng sử dụng.",
  ...
  workspace: {
    archive_work_items: {
      ...
      description: "Thủ công hoặc thông qua tự động hóa, bạn có thể lưu trữ các mục công việc đã hoàn thành hoặc bị hủy. Tìm chúng ở đây sau khi lưu trữ.",
    ...
    archive_modules: {
      ...
      description: "Để sắp xếp dự án của bạn, hãy lưu trữ các mô-đun đã hoàn thành hoặc bị hủy. Tìm chúng ở đây sau khi lưu trữ.",
    },
    ...
    views: {
      ...
      description: "Thêm các mục công việc vào dự án của bạn và sử dụng chế độ xem để lọc, sắp xếp và giám sát tiến độ dễ dàng.",
      cta_primary: "Thêm mục công việc",
    },
    drafts: {
      title: "Các mục công việc viết dở",
      description: "Để thử điều này, hãy bắt đầu thêm một mục công việc và để nó ở giữa chừng hoặc tạo bản nháp đầu tiên của bạn bên dưới. 😉",
    ...
    analytics_work_items: {
      title: "Tạo dự án với các mục công việc và người được giao để bắt đầu theo dõi hiệu suất, tiến độ và tác động của đội ở đây.",
    },
    analytics_no_cycle: {
      title: "Tạo chu kỳ để tổ chức công việc thành các giai đoạn có giới hạn thời gian và theo dõi tiến độ qua các sprint.",
    },
    analytics_no_module: {
  ...
  settings: {
    estimates: {
      ...
      description: "Xác định cách đội của bạn đo lường nỗ lực và theo dõi nó một cách nhất quán trên tất cả các mục công việc.",
    ...
    exports: {
      ...
      description: "Bạn chưa có bản ghi xuất khẩu nào ngay bây giờ. Sau khi bạn xuất dữ liệu, tất cả các bản ghi sẽ xuất hiện ở đây.",
    },
    tokens: {
      title: "Chưa có token Cá nhân",
      description: "Tạo token API an toàn để kết nối không gian làm việc của bạn với các hệ thống và ứng dụng bên ngoài.",
