...
export default {
  ...
  localized_ui: {
    ...
    workspace_views: {
      page_title: "{workspaceName} - Tất cả chế độ xem",
    },
    ...
    editor: {
      url: "URL",
      enter_or_paste_url: "Nhập hoặc dán URL",
      text: "Chữ",
      enter_text_to_display: "Nhập văn bản để hiển thị",
      ...
      add_an_image: "Thêm một hình ảnh",
      error_loading_image: "Lỗi tải hình ảnh",
      uploading: "Đang tải lên",
      drop_image_here: "Thả hình ảnh ở đây",
      retry_duplication: "Thử lại việc sao chép",
      retry: "Thử lại",
      no_emojis_found: "Không tìm thấy biểu tượng cảm xúc nào",
      fullscreen_image_viewer: "Trình xem ảnh toàn màn hình",
      close_image_viewer: "Đóng trình xem ảnh",
      zoom_out: "Thu nhỏ",
      zoom_in: "Phóng to",
      download_image: "Tải hình ảnh xuống",
      open_image_in_new_tab: "Mở hình ảnh trong tab mới",
      view_in_full_screen: "Xem toàn màn hình",
      view_image_in_full_screen: "Xem hình ảnh toàn màn hình",
      align: "Căn chỉnh",
      download: "Tải xuống",
      clear_contents: "Xóa nội dung",
      insert_above: "Chèn ở trên",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "Bạn đã được mời tham gia {workspaceName}",
      description:
        "Không gian làm việc của bạn là nơi bạn sẽ tạo các dự án, cộng tác trên các mục công việc của mình và sắp xếp các luồng công việc khác nhau trong tài khoản Plane của bạn.",
      accept: "Chấp nhận",
      ignore: "Phớt lờ",
      already_member: "Bạn đã là thành viên của {workspaceName}",
      continue_to_home: "Tiếp tục về nhà",
      inactive_title: "Liên kết lời mời này không còn hoạt động nữa.",
      empty_project_link: "Hoặc bắt đầu từ một dự án trống",
      sign_in_to_continue: "Đăng nhập để tiếp tục",
      star_on_github: "Gắn sao cho chúng tôi trên GitHub",
      join_community: "Tham gia cộng đồng những người sáng tạo tích cực của chúng tôi",
    },
    space_auth: {
      email: "E-mail",
      ...
      continue: "Tiếp tục",
      go_to_workspace: "Đi tới không gian làm việc",
      sign_in_with_unique_code: "Đăng nhập bằng mã duy nhất",
      create_account: "Tạo tài khoản",
      unique_code: "Mã duy nhất",
      paste_code_sent: "Dán mã được gửi tới email của bạn",
      resend_in: "Gửi lại sau {seconds}s",
      requesting_new_code: "Yêu cầu mã mới",
      resend: "Gửi lại",
      sending_code: "Đang gửi mã",
    },
    onboarding: {
      create_profile_title: "Tạo hồ sơ của bạn.",
      create_profile_description: "Đây là cách bạn sẽ xuất hiện trong Plane.",
      change_image: "Thay đổi hình ảnh",
      upload_image: "Tải hình ảnh lên",
      name: "Tên",
      name_required: "Tên là bắt buộc",
      name_within_50: "Tên phải trong vòng 50 ký tự.",
      ...
      continue: "Tiếp tục",
      invite_team_title: "Mời đồng đội của bạn",
      invite_team_description:
        "Làm việc trong Plane hiệu quả nhất khi có đội nhóm của bạn. Hãy mời họ ngay để tận dụng tối đa Plane.",
      invalid_email: "Đó không giống như một địa chỉ email.",
      success: "Thành công!",
      invitations_sent: "Lời mời đã được gửi thành công.",
      error: "Lỗi!",
      add_another: "Thêm cái khác",
      do_later: "tôi sẽ làm nó sau",
      join_invites_title: "Tham gia lời mời hoặc tạo không gian làm việc",
      unified_description: "Tất cả công việc của bạn - thống nhất.",
      create_new_workspace: "Tạo không gian làm việc mới",
      no_invitations_found: "Không tìm thấy lời mời nào",
      you_are_invited: "Bạn được mời!",
      accept_invites: "Chấp nhận lời mời cộng tác với nhóm của bạn.",
      continue_to_workspace: "Tiếp tục đến không gian làm việc",
      or: "hoặc",
      create_own_workspace: "Tạo không gian làm việc của riêng bạn",
      workspace_creation_disabled:
        "Có vẻ như bạn không nhận được bất kỳ lời mời nào vào không gian làm việc và quản trị viên phiên bản của bạn đã hạn chế việc tạo không gian làm việc mới. Vui lòng yêu cầu chủ sở hữu hoặc quản trị viên không gian làm việc mời bạn đến không gian làm việc trước và quay lại màn hình này để tham gia.",
      create_workspace_title: "Tạo không gian làm việc của bạn",
      enter_workspace_name: "Nhập tên không gian làm việc",
      join_existing_workspace: "Tham gia không gian làm việc hiện có",
      profile_setup_completed: "Thiết lập hồ sơ đã hoàn tất.",
      profile_setup_failed: "Thiết lập hồ sơ không thành công.",
      usecase_title: "Bạn dự định sử dụng ZXPLaneZ như thế nào?",
      usecase_description: "Chọn một hoặc nhiều tùy chọn để chúng tôi có thể cá nhân hóa trải nghiệm của bạn.",
      select_one_or_more: "Chọn một hoặc nhiều",
      select_at_least_one: "Chọn ít nhất một tùy chọn.",
      skip: "Nhảy",
    },
    inbox: {
      ...
      errors: {
        asset_upload_failed: "Tải nội dung lên không thành công. Vui lòng thử lại sau.",
        asset_duplication_failed: "Sao chép nội dung không thành công. Vui lòng thử lại sau.",
        permission_denied: "Quyền bị từ chối",
        mark_duplicate_permission: "Chỉ quản trị viên dự án mới có thể đánh dấu mục công việc là trùng lặp",
        mark_duplicate_permission_plural: "Chỉ quản trị viên dự án mới có thể đánh dấu các mục công việc là trùng lặp",
      },
      filters: {
        ...
        status: "Trạng thái",
        work_item_status: "Trạng thái mục công việc",
        view_all: "Xem tất cả",
      ...
      navigation: {
        previous_work_item: "Mục công việc trước đó",
        next_work_item: "Mục công việc tiếp theo",
      },
      properties: {
      ...
      toasts: {
        editor_processing: "Trình chỉnh sửa vẫn đang xử lý các thay đổi. Vui lòng đợi trước khi tiếp tục.",
        create_success: "Mục công việc được tạo thành công.",
        delete_failed: "Xóa mục công việc không thành công",
        update_failed: "Cập nhật mục công việc không thành công",
      },
    },
    space_public: {
      error_description_prefix:
        "Plane đã gặp sự cố. Kỹ sư của chúng tôi đã được thông báo. Nếu bạn có thêm chi tiết, vui lòng viết tới",
      error_description_middle: "hoặc trên",
      not_found_hint: "Kiểm tra URL trong thanh địa chỉ trình duyệt rồi thử lại.",
      logged_in_hint:
        "Nhập URL chia sẻ công khai hoặc liên kết của chế độ xem hay Trang bạn muốn xem vào thanh địa chỉ trình duyệt.",
      oauth_with_provider: "{action} bằng {provider}",
      auth: {
        sign_in_header: "Đăng nhập để bình chọn hoặc bình luận",
        sign_in_subheader: "Góp phần thúc đẩy các tính năng bạn muốn được xây dựng.",
        sign_up_header: "Xem, bình luận và làm nhiều việc hơn",
        sign_up_subheader: "Đăng ký hoặc đăng nhập để làm việc với các mục công việc và Trang của Plane.",
      },
      peek: {
        side: "Xem nhanh bên cạnh",
        modal: "Hộp thoại",
        full_screen: "Toàn màn hình",
      },
      bot_name: "Bot {name}",
      commented_time: "đã bình luận {time}",
      and_more: "và {count} người khác",
      no_upvotes_yet: "Chưa có lượt ủng hộ",
      no_downvotes_yet: "Chưa có lượt phản đối",
      modules_count: "{count} mô-đun",
      labels_count: "{count} nhãn",
      page_not_found_alt: "Không tìm thấy trang",
      something_went_wrong: "Rất tiếc! Đã xảy ra lỗi.",
      page_not_found_description: "Trang bạn đang tìm không tồn tại hoặc đã được di chuyển.",
      instance_failure_image_alt: "Không thể lấy chi tiết phiên bản",
      instance_failure_title: "Không thể lấy chi tiết phiên bản.",
      instance_failure_description: "Chúng tôi không thể tải chi tiết phiên bản của bạn.",
      instance_failure_hint: "Vui lòng kiểm tra kết nối rồi thử lại.",
      powered_by: "Được hỗ trợ bởi",
      sign_in_to_add_comment: "Đăng nhập để thêm bình luận",
      link_copied: "Đã sao chép liên kết!",
      work_item_link_copied: "Đã sao chép liên kết mục công việc vào bảng nhớ tạm.",
      comment_post_error: "Không thể đăng bình luận. Vui lòng thử lại.",
      add_comment: "Thêm bình luận",
      public_board_not_found: "Bảng công khai không tồn tại. Vui lòng kiểm tra URL.",
      no_work_items_found: "Không tìm thấy mục công việc",
      error_title: "Rất tiếc! Có vẻ không ổn.",
      refresh: "Làm mới",
      forum: "Diễn đàn",
      not_found_title: "Thao tác không thành công",
      user_already_logged_in: "Người dùng đã đăng nhập",
      logged_in_title: "Tốt rồi! Chỉ còn một bước nữa.",
      by_creating_account: "Bằng cách tạo tài khoản",
      by_signing_in: "Bằng cách đăng nhập",
      you_agree_to_our: "bạn đồng ý với",
      ...
      no_cycle: "Không có chu kỳ",
      no_modules: "Không có mô-đun",
      no_assignees: "Không có người phụ trách",
