...
export default {
  ...
  localized_ui: {
    ...
    workspace_invitation: {
      ...
      description:
        "Your workspace is where you will create projects, collaborate on your work items, and organize different streams of work in your Plane account.",
      accept: "Accept",
      ignore: "Ignore",
    ...
    onboarding: {
      ...
      workspace_creation_disabled:
        "You do not seem to have any invites to a workspace and your instance admin has restricted creation of new workspaces. Please ask a workspace owner or admin to invite you to a workspace first and come back to this screen to join.",
