...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      something_went_wrong: "Ối! Đã xảy ra lỗi.",
      page_not_found_description: "Trang bạn đang tìm kiếm không tồn tại hoặc đã bị di chuyển.",
      instance_failure_image_alt: "Không thể tìm nạp thông tin chi tiết về phiên bản",
      instance_failure_title: "Không thể tìm nạp chi tiết phiên bản.",
      instance_failure_description: "Chúng tôi không thể tải chi tiết phiên bản của bạn.",
      instance_failure_hint: "Vui lòng kiểm tra kết nối của bạn và thử lại.",
      retry: "Thử lại",
      ...
      comment_post_error: "Không thể gửi bình luận. Vui lòng thử lại.",
      add_comment: "Thêm nhận xét",
      public_board_not_found: "Hội đồng công cộng không tồn tại. Vui lòng kiểm tra URL.",
      no_work_items_found: "Không tìm thấy mục công việc nào",
