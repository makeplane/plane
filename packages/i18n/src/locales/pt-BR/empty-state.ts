export default {
  common: {
    progress: {
      ...
      description: "Comece definindo valores de propriedades em itens de trabalho para ver as métricas de progresso aqui.",
    },
    updates: {
    ...
    server_error: {
      ...
      description: "Não conseguimos conectar e buscar dados do nosso servidor. Não se preocupe, estamos trabalhando nisso.",
      cta_primary: "Tentar recarregar",
    },
  },
  project: {
    work_items: {
      ...
      description: "Os itens de trabalho são os blocos de construção do seu projeto — atribua proprietários, defina prioridades e acompanhe o progresso facilmente.",
      cta_primary: "Criar seu primeiro item de trabalho",
    },
    cycles: {
      title: "Agrupe e defina prazos para seu trabalho em Ciclos.",
      description: "Divida o trabalho em blocos com prazo definido, trabalhe de trás para frente a partir do prazo do projeto para definir datas e faça progresso tangível como equipe.",
      cta_primary: "Definir seu primeiro ciclo",
    },
    cycle_work_items: {
      title: "Nenhum item de trabalho para mostrar neste ciclo",
      description: "Crie itens de trabalho para começar a monitorar o progresso da sua equipe neste ciclo e atingir seus objetivos no prazo.",
    ...
    modules: {
      ...
      description: "Os módulos são compostos por itens de trabalho interconectados. Eles auxiliam no monitoramento do progresso através das fases do projeto, cada uma com prazos e análises específicas para indicar o quão perto você está de alcançar essas fases.",
    ...
    views: {
      ...
      description: "As visualizações são filtros salvos que ajudam você a acessar rapidamente as informações que mais usa. Colabore sem esforço enquanto os colegas de equipe compartilham e adaptam as visualizações às suas necessidades específicas.",
      cta_primary: "Criar visualização",
    },
    no_work_items_in_project: {
      title: "Ainda não há itens de trabalho no projeto",
      description: "Adicione itens de trabalho ao seu projeto e divida seu trabalho em partes rastreáveis com visualizações.",
    ...
    pages: {
      ...
      description: "As páginas permitem que você capture e organize informações em um só lugar. Escreva notas de reuniões, documentação de projetos e PRDs, incorpore itens de trabalho e estruture-os com componentes prontos para uso.",
    ...
    intake_sidebar: {
      ...
      description: "Envie novas solicitações para serem revisadas, priorizadas e rastreadas dentro do fluxo de trabalho do seu projeto.",
  ...
  workspace: {
    archive_work_items: {
      ...
      description: "Manualmente ou por meio de automação, você pode arquivar itens de trabalho concluídos ou cancelados. Encontre-os aqui uma vez arquivados.",
    ...
    archive_modules: {
      ...
      description: "Para organizar seu projeto, arquive módulos concluídos ou cancelados. Encontre-os aqui uma vez arquivados.",
    },
    ...
    views: {
      ...
      description: "Adicione itens de trabalho ao seu projeto e use visualizações para filtrar, classificar e monitorar o progresso sem esforço.",
      cta_primary: "Adicionar item de trabalho",
    },
    drafts: {
      title: "Itens de trabalho semi-escritos",
      description: "Para experimentar isso, comece a adicionar um item de trabalho e deixe-o no meio do caminho ou crie seu primeiro rascunho abaixo. 😉",
    ...
    analytics_work_items: {
      title: "Crie projetos com itens de trabalho e responsáveis para começar a rastrear desempenho, progresso e impacto da equipe aqui.",
    },
    analytics_no_cycle: {
  ...
  settings: {
    estimates: {
      ...
      description: "Defina como sua equipe mede o esforço e acompanhe-o consistentemente em todos os itens de trabalho.",
    ...
    exports: {
      ...
      description: "Você não tem nenhum registro de exportação no momento. Depois de exportar dados, todos os registros aparecerão aqui.",
    },
    tokens: {
      title: "Ainda não há token Pessoal",
      description: "Gere tokens de API seguros para conectar seu espaço de trabalho com sistemas e aplicativos externos.",
