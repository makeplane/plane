 ...
 divisão do trabalho por etiquetas.`,
  ...
  oauth_bridge_integration: {
    ...
    provider_form: {
      ...
      user_claim_label: "Claim do usuário",
      user_claim_placeholder: "email",
      user_claim_description: "Claim JWT contendo o endereço de e-mail do usuário",
      user_claim_required: "O claim do usuário é obrigatório.",
