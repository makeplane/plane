...
se você tem certeza de que sua pesquisa está correta.`,
 ...
 Crie uma nova visualização em vez disso.`,
  ...
  initiatives: {
    ...
    archive_description: "Somente iniciativas concluídas ou fechadas podem ser arquivadas",
    toast: {
      ...
      archive: {
        success: "Iniciativa arquivada com sucesso.",
        error: "Falha ao arquivar a iniciativa",
        initiative_cannot_be_archived_in_this_state: "A iniciativa não pode ser arquivada neste estado",
      },
 ...
 Crie uma nova iniciativa em vez disso.`,
        archived_description: "Nenhuma iniciativa arquivada detectada com os critérios correspondentes.",
      },
      not_found: {
 ...
 divisão do trabalho por etiquetas.`,
  ...
  oauth_bridge_integration: {
    name: "OAuth Bridge",
    description: "Validar tokens de IdP externos para acesso à API.",
    header_description:
      "Valide tokens OIDC/JWT emitidos externamente pelo seu IdP (Azure AD, Okta, etc.) para acesso à API do Plane.",
    connected: "Conectado",
    connect: "Conectar",
    uninstall: "Desinstalar",
    uninstalling: "Desinstalando...",
    install_success: "OAuth Bridge instalado com sucesso.",
    install_error: "Falha ao instalar o OAuth Bridge.",
    uninstall_success: "OAuth Bridge desinstalado.",
    uninstall_error: "Falha ao desinstalar o OAuth Bridge.",
    token_providers: "Provedores de tokens",
    token_providers_description: "Configure IdPs externos cujos JWTs são aceitos como credenciais de API.",
    add_provider: "Adicionar provedor",
    edit_provider: "Editar provedor",
    enabled: "Habilitado",
    disabled: "Desabilitado",
    test: "Testar",
    no_providers_title: "Nenhum provedor configurado.",
    no_providers_description: "Adicione um IdP para habilitar a autenticação por token externo.",
    provider_updated: "Provedor atualizado.",
    provider_added: "Provedor adicionado.",
    provider_save_error: "Falha ao salvar o provedor.",
    provider_deleted: "Provedor excluído.",
    provider_delete_error: "Falha ao excluir o provedor.",
    provider_update_error: "Falha ao atualizar o provedor.",
    jwks_reachable: "JWKS acessível",
    jwks_unreachable: "JWKS inacessível",
    jwks_test_error: "Não foi possível obter o JWKS da URL configurada.",
    provider_form: {
      name_label: "Nome",
      name_placeholder: "ex. Azure AD Production",
      name_description: "Rótulo legível para este provedor de identidade",
      name_required: "O nome é obrigatório.",
      issuer_label: "Emissor",
      issuer_placeholder: "https://login.microsoftonline.com/tenant-id/v2.0",
      issuer_description: "Valor esperado do claim iss no JWT",
      issuer_required: "O emissor é obrigatório.",
      jwks_url_label: "URL JWKS",
      jwks_url_placeholder: "https://login.microsoftonline.com/tenant-id/discovery/v2.0/keys",
      jwks_url_description: "Endpoint HTTPS que fornece o JSON Web Key Set do provedor",
      jwks_url_required: "A URL JWKS é obrigatória.",
      jwks_url_https: "A URL JWKS deve usar HTTPS.",
      audience_label: "Audiência",
      audience_placeholder: "api://my-app-id",
      audience_description: "Claim(s) aud esperado(s) no JWT, separados por vírgula.",
      user_claims_label: "Claim do usuário",
      user_claims_placeholder: "email",
      user_claims_description: "Claim JWT contendo o endereço de e-mail do usuário",
      user_claims_required: "O claim do usuário é obrigatório.",
      allowed_algorithms_label: "Algoritmos de assinatura permitidos",
      allowed_algorithms_description: "Algoritmos assimétricos aceitos para verificação de assinatura JWT",
      allowed_algorithms_required: "É necessário pelo menos um algoritmo.",
      select_algorithms: "Selecionar algoritmos",
      jwks_cache_ttl_label: "TTL do cache JWKS (segundos)",
      jwks_cache_ttl_description: "Tempo de cache das chaves JWKS do provedor (mínimo 60s, padrão 24 horas)",
      jwks_cache_ttl_min: "O TTL do cache deve ser de pelo menos 60 segundos.",
      rate_limit_label: "Limite de taxa",
      rate_limit_placeholder: "120/minute",
      rate_limit_description:
        "Limitação de requisições como quantidade/período (ex. 120/minute). Deixe em branco para o limite padrão.",
      enable_provider: "Habilitar este provedor",
      saving: "Salvando...",
      update: "Atualizar",
    },
  },
...
• Criação de tarefas e comentários: Adicione tarefas, descrições e comentários através de comandos de voz.`,
  ...
  automations: {
    ...
    trigger: {
      ...
      section_plane_events: "Eventos do Plane",
      section_time_based: "Baseado em tempo",
      fixed_schedule: "Agendamento fixo",
      schedule: {
        frequency: "Frequência",
        select_day: "Selecionar dia",
        day_of_month: "Dia do mês",
        monthly_every: "Todo",
        monthly_day_aria: "Dia {day}",
        time: "Horário",
        hour: "Hora",
        minute: "Minuto",
        hour_suffix: "h",
        ...
        pm: "PM",
        timezone: "Fuso horário",
        timezone_placeholder: "Selecionar um fuso horário",
        frequency_daily: "Diário",
        frequency_weekly: "Semanal",
        frequency_monthly: "Mensal",
        on: "Em",
        validation_weekly_day_required: "Selecione pelo menos um dia da semana.",
        validation_monthly_date_required: "Selecione um dia do mês.",
        main_content_schedule_summary_daily: "Todo dia às {time} ({timezone}).",
        main_content_schedule_summary_weekly: "Toda semana em {days} às {time} ({timezone}).",
        main_content_schedule_summary_monthly: "Todo mês no dia {day} às {time} ({timezone}).",
        schedule_mode: "Modo de agendamento",
        schedule_mode_fixed: "Fixo",
        schedule_mode_cron: "Cron",
        cron_expression_label: "Inserir expressão Cron",
        cron_expression_placeholder: "0 9 * * 1-5",
        cron_invalid: "Expressão cron inválida.",
        cron_preview: 'Esta expressão Cron executa "{description}".',
  ...
  page_actions: {
    move_page: {
      placeholders: {
        project_to_all_with_wiki: "Pesquisar coleções wiki, projetos e teamspaces",
        project_to_project_with_wiki: "Pesquisar coleções wiki e projetos",
        teamspace_to_all_with_wiki: "Pesquisar coleções wiki, projetos e teamspaces",
      },
      toasts: {
        collection_error: {
          title: "Movida para o wiki",
          message:
            "A página foi movida para o wiki, mas não pôde ser adicionada à coleção selecionada. Ela permanece em General.",
        },
      },
    },
    remove_from_collection: {
      label: "Remover da coleção",
      success_message: "Página removida da coleção.",
      error_message: "Não foi possível remover a página da coleção. Tente novamente.",
    },
  },
  wiki_collections: {
    predefined: {
    ...
    fallback_name: "Coleção",
    form: {
      name_required: "O título da coleção é obrigatório",
      name_max_length: "O nome da coleção deve ter menos de 255 caracteres",
      name_placeholder_create: "Dê um título para a coleção",
      name_placeholder_edit: "Nome da coleção",
    },
    create_modal: {
    ...
    delete_modal: {
      ...
      page_count: "Esta coleção tem {pageCount} páginas. Escolha o que deve acontecer com elas.",
      transfer_title: "Transferir páginas e excluir coleção",
      transfer_description:
        "Mova todas as páginas para outra coleção antes de excluir. As páginas e suas permissões serão preservadas.",
      transfer_warning: "As páginas movidas herdarão as permissões da coleção selecionada.",
      transfer_target_label: "Mover páginas para",
      transfer_target_placeholder: "Selecione uma coleção",
      delete_with_pages_title: "Excluir coleção com páginas",
      delete_with_pages_description:
        "Exclui permanentemente a coleção e todas as suas páginas. Esta ação não pode ser desfeita.",
      submit: "Excluir coleção",
    },
    header: {
    ...
    add_existing_page_modal: {
      ...
      success_message: "{count} páginas adicionadas à coleção.",
      error_message: "Não foi possível mover as páginas. Tente novamente.",
      no_pages_found: "Nenhuma página encontrada para a sua busca",
      no_pages_available: "Nenhuma página disponível para mover",
      submit: "Mover",
    },
    list: {
      invite_only: "Somente por convite",
      remove_error: "Não foi possível remover a página da coleção.",
      no_matching_pages: "Nenhuma página correspondente",
      remove_search_criteria: "Remova os critérios de busca para ver todas as páginas",
      remove_filters: "Remova os filtros para ver todas as páginas",
      no_pages_title: "Ainda não há páginas",
      no_pages_description: "Esta coleção ainda não tem páginas.",
      untitled: "Sem título",
      restricted_access: "Acesso restrito",
      collapse_page: "Recolher página",
      expand_page: "Expandir página",
      page_actions: "Ações da página",
      page_link_copied: "Link da página copiado para a área de transferência.",
      columns: {
        page_name: "Nome da página",
        owner: "Proprietário",
        nested_pages: "Páginas aninhadas",
    ...
    toasts: {
      ...
      create_error: "Não foi possível criar a coleção. Tente novamente.",
      renamed: "Coleção renomeada com sucesso.",
      rename_error: "Não foi possível atualizar a coleção. Tente novamente.",
      transferred_deleted: "As páginas foram transferidas e a coleção foi excluída.",
      deleted_with_pages: "A coleção e suas páginas foram excluídas.",
      delete_error: "Não foi possível excluir a coleção. Tente novamente.",
      target_required: "Selecione uma coleção para mover as páginas.",
      create_page_error: "Não foi possível criar a página. Tente novamente.",
      create_page_in_collection_error: "Não foi possível criar a página ou adicioná-la à coleção. Tente novamente.",
      collection_link_copied: "Link da coleção copiado para a área de transferência.",
    },
  },
} as const;
