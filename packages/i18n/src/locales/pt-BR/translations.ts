...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      page_not_found_description: "A página que você procura não existe ou foi movida.",
      instance_failure_image_alt: "Não foi possível buscar detalhes da instância",
      instance_failure_title: "Não foi possível buscar detalhes da instância.",
      instance_failure_description: "Não foi possível carregar os detalhes da sua instância.",
      instance_failure_hint: "Verifique sua conexão e tente novamente.",
      retry: "Tentar novamente",
      powered_by: "Distribuído por",
      sign_in_to_add_comment: "Faça login para adicionar um comentário",
      sign_in: "Entrar",
      link_copied: "Link copiado!",
      work_item_link_copied: "Link do item de trabalho copiado para a área de transferência.",
      comment_post_error: "Falha ao postar comentário. Por favor, tente novamente.",
      add_comment: "Adicionar comentário",
      public_board_not_found: "O conselho público não existe. Por favor, verifique o URL.",
      no_work_items_found: "Nenhum item de trabalho encontrado",
      no_labels: "Sem rótulos",
      user: "Usuário",
    },
  },
} as const;
