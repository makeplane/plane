...
export default {
  ...
  localized_ui: {
    editor: {
          "url": "URL",
          "enter_or_paste_url": "Enter or paste URL",
          "text": "Text",
      ...
      "workspace_invitation": {
          ...
          "invited_to_workspace": "You have been invited to {workspaceName}",
          "description": "Your workspace is where you will create projects, collaborate on your work items, and organize different streams of work in your Plane account.",
          "accept": "Accept",
          "ignore": "Ignore",
          "already_member": "You are already a member of {workspaceName}",
          "continue_to_home": "Continue to home",
          "inactive_title": "This invitation link is not active anymore.",
          "empty_project_link": "Or start from an empty project",
      ...
      "space_auth": {
          ...
          "paste_code_sent": "Paste the code sent to your email",
      ...
      "onboarding": {
          ...
          "create_profile_description": "This is how you will appear in Plane.",
          "change_image": "Change image",
          "upload_image": "Upload image",
          "name": "Name",
          "name_required": "Name is required",
          "name_within_50": "Name must be within 50 characters.",
          ...
          "continue": "Continue",
          "invite_team_title": "Invite your teammates",
          "invite_team_description": "Work in Plane happens best with your team. Invite them now to use Plane to its potential.",
          "invalid_email": "That does not look like an email address.",
          "success": "Success!",
          "invitations_sent": "Invitations sent successfully.",
          "error": "Error!",
          "add_another": "Add another",
          "do_later": "I will do it later",
          "join_invites_title": "Join invites or create a workspace",
          "unified_description": "All your work — unified.",
          "create_new_workspace": "Create new workspace",
          "no_invitations_found": "No invitations found",
          "you_are_invited": "You are invited!",
          "accept_invites": "Accept the invites to collaborate with your team.",
          "continue_to_workspace": "Continue to workspace",
          "or": "or",
          "create_own_workspace": "Create your own workspace",
          "workspace_creation_disabled": "You do not seem to have any invites to a workspace and your instance admin has restricted creation of new workspaces. Please ask a workspace owner or admin to invite you to a workspace first and come back to this screen to join.",
          "create_workspace_title": "Create your workspace",
