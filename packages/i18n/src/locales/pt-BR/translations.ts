...
export default {
  ...
  localized_ui: {
    ...
    workspace_views: {
      page_title: "{workspaceName} - Todas as visualizações",
    },
    ...
    editor: {
      url: "URL",
      enter_or_paste_url: "Insira ou cole o URL",
      text: "Texto",
      enter_text_to_display: "Digite o texto para exibir",
      remove_link: "Remover link",
      edit_link: "Editar link",
      color: "Cor",
      text_colors: "Cores do texto",
      background_colors: "Cores de fundo",
      link: "Link",
      enter_or_paste_link: "Insira ou cole o link",
      please_enter_valid_url: "Insira um URL válido",
      delete: "Excluir",
      duplicate: "Duplicado",
      multiple: "Múltiplo",
      loading: "Carregando",
      ...
      retry_duplication: "Tentar novamente a duplicação",
      retry: "Tentar novamente",
      no_emojis_found: "Nenhum emoji encontrado",
      fullscreen_image_viewer: "Visualizador de imagens em tela cheia",
      close_image_viewer: "Fechar visualizador de imagens",
      zoom_out: "Diminuir zoom",
      zoom_in: "Ampliar",
      download_image: "Baixar imagem",
      open_image_in_new_tab: "Abrir imagem em nova aba",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "Você foi convidado para {workspaceName}",
      description:
        "Seu espaço de trabalho é onde você criará projetos, colaborará em seus itens de trabalho e organizará diferentes fluxos de trabalho em sua conta Plane.",
      accept: "Aceitar",
      ignore: "Ignorar",
      already_member: "Você já é membro do {workspaceName}",
      continue_to_home: "Continuar para casa",
      inactive_title: "Este link de convite não está mais ativo.",
      empty_project_link: "Ou comece com um projeto vazio",
      sign_in_to_continue: "Faça login para continuar",
      star_on_github: "Marque-nos no GitHub",
      join_community: "Junte-se à nossa comunidade de criadores ativos",
    },
    space_auth: {
      email: "E-mail",
      ...
      continue: "Continuar",
      go_to_workspace: "Ir para o espaço de trabalho",
      sign_in_with_unique_code: "Faça login com código exclusivo",
      create_account: "Criar uma conta",
      unique_code: "Código exclusivo",
      paste_code_sent: "Cole o código enviado para seu e-mail",
    ...
    onboarding: {
      ...
      create_profile_description: "É assim que você aparecerá no Plane.",
      change_image: "Alterar imagem",
      upload_image: "Carregar imagem",
      name: "Nome",
      name_required: "O nome é obrigatório",
      name_within_50: "O nome deve ter até 50 caracteres.",
      ...
      continue: "Continuar",
      invite_team_title: "Convide seus companheiros de equipe",
      invite_team_description:
        "O trabalho no Plane acontece melhor com sua equipe. Convide-os agora a usar o Plane em todo o seu potencial.",
      invalid_email: "Isso não se parece com um endereço de e-mail.",
      success: "Sucesso!",
      invitations_sent: "Convites enviados com sucesso.",
      error: "Erro!",
      add_another: "Adicionar outro",
      do_later: "Eu farei isso mais tarde",
      join_invites_title: "Participe de convites ou crie um espaço de trabalho",
      unified_description: "Todo o seu trabalho — unificado.",
      create_new_workspace: "Criar novo espaço de trabalho",
      no_invitations_found: "Nenhum convite encontrado",
      you_are_invited: "Você está convidado!",
      accept_invites: "Aceite os convites para colaborar com sua equipe.",
      continue_to_workspace: "Continuar para o espaço de trabalho",
      or: "ou",
      create_own_workspace: "Crie seu próprio espaço de trabalho",
      workspace_creation_disabled:
        "Parece que você não tem nenhum convite para um espaço de trabalho e o administrador da sua instância restringiu a criação de novos espaços de trabalho. Peça a um proprietário ou administrador do espaço de trabalho para convidá-lo primeiro para um espaço de trabalho e volte a esta tela para ingressar.",
      create_workspace_title: "Crie seu espaço de trabalho",
      enter_workspace_name: "Insira o nome do espaço de trabalho",
      join_existing_workspace: "Junte-se ao espaço de trabalho existente",
      profile_setup_completed: "Configuração do perfil concluída.",
      profile_setup_failed: "Falha na configuração do perfil.",
      usecase_title: "Como você planeja usar o Plane?",
      usecase_description: "Selecione uma ou mais opções para que possamos personalizar sua experiência.",
    ...
    inbox: {
      ...
      errors: {
        asset_upload_failed: "Falha no upload do recurso. Por favor, tente novamente mais tarde.",
        asset_duplication_failed: "Falha na duplicação de recursos. Por favor, tente novamente mais tarde.",
        permission_denied: "Permissão negada",
        mark_duplicate_permission: "Somente administradores de projeto podem marcar itens de trabalho como duplicados",
        mark_duplicate_permission_plural:
          "Somente administradores de projeto podem marcar itens de trabalho como duplicados",
      },
      filters: {
        ...
        status: "Status",
        work_item_status: "Status do item de trabalho",
        view_all: "Ver tudo",
        view_less: "Ver menos",
        date_options: {
          today: "Hoje",
      ...
      navigation: {
        previous_work_item: "Item de trabalho anterior",
        next_work_item: "Próximo item de trabalho",
      },
      properties: {
        duplicate_of: "Duplicado de",
      },
      select_duplicate: {
        select_work_item: "Selecione o item de trabalho",
      },
      sidebar: {
        label_count: "Etiquetas {count}",
      },
      toasts: {
        editor_processing: "O editor ainda está processando as alterações. Aguarde antes de continuar.",
        create_success: "Item de trabalho criado com sucesso.",
        delete_failed: "Falha na exclusão do item de trabalho",
        update_failed: "Falha na atualização do item de trabalho",
      },
    },
    space_public: {
      error_description_prefix:
        "O Plane travou. Nossos engenheiros foram notificados. Se você tiver mais detalhes, escreva para",
      error_description_middle: "ou em nosso",
      not_found_hint: "Confira a URL na barra de endereços do navegador e tente novamente.",
      logged_in_hint:
        "Insira na barra de endereços do navegador a URL pública compartilhada ou o link da visualização ou Página que você quer ver.",
      oauth_with_provider: "{action} com {provider}",
      auth: {
        sign_in_header: "Entre para votar ou comentar",
        sign_in_subheader: "Ajude a impulsionar as funcionalidades que você quer ver criadas.",
        sign_up_header: "Veja, comente e faça mais",
        sign_up_subheader: "Cadastre-se ou entre para trabalhar com itens de trabalho e Páginas do Plane.",
      },
      peek: {
        side: "Visualização lateral",
        modal: "Modal",
        full_screen: "Tela cheia",
      },
      bot_name: "Bot {name}",
      commented_time: "comentou {time}",
      ...
      instance_failure_image_alt: "Não foi possível buscar os detalhes da instância",
      instance_failure_title: "Não foi possível buscar os detalhes da instância.",
      instance_failure_description: "Não conseguimos carregar os detalhes da sua instância.",
      instance_failure_hint: "Verifique sua conexão e tente novamente.",
      powered_by: "Desenvolvido por",
      sign_in_to_add_comment: "Entre para adicionar um comentário",
      link_copied: "Link copiado!",
      work_item_link_copied: "Link do item de trabalho copiado para a área de transferência.",
      comment_post_error: "Falha ao publicar o comentário. Tente novamente.",
      add_comment: "Adicionar comentário",
      public_board_not_found: "O quadro público não existe. Verifique a URL.",
      no_work_items_found: "Nenhum item de trabalho encontrado",
      error_title: "Ops! Isso não parece bom.",
      refresh: "Atualizar",
      forum: "Fórum",
      not_found_title: "Isso não funcionou",
      user_already_logged_in: "Usuário já conectado",
      logged_in_title: "Ótimo! Só falta mais uma etapa.",
      by_creating_account: "Ao criar uma conta",
      by_signing_in: "Ao entrar",
      you_agree_to_our: "você concorda com nossos",
      ...
      no_date: "Sem data",
      no_cycle: "Sem ciclo",
      no_modules: "Sem módulos",
      no_assignees: "Sem responsáveis",
