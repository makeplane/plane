...
划分的工作明细`,
  ...
  oauth_bridge_integration: {
    name: "OAuth Bridge",
    description: "验证外部 IdP 令牌以进行 API 访问。",
    header_description: "验证来自您的 IdP（Azure AD、Okta 等）的外部 OIDC/JWT 令牌，用于 Plane API 访问。",
    connected: "已连接",
    connect: "连接",
    uninstall: "卸载",
    uninstalling: "卸载中...",
    install_success: "OAuth Bridge 安装成功。",
    install_error: "OAuth Bridge 安装失败。",
    uninstall_success: "OAuth Bridge 已卸载。",
    uninstall_error: "OAuth Bridge 卸载失败。",
    token_providers: "令牌提供者",
    token_providers_description: "配置其 JWT 被接受为 API 凭证的外部 IdP。",
    add_provider: "添加提供者",
    edit_provider: "编辑提供者",
    enabled: "已启用",
    disabled: "已禁用",
    test: "测试",
    no_providers_title: "未配置提供者。",
    no_providers_description: "添加 IdP 以启用外部令牌认证。",
    provider_updated: "提供者已更新。",
    provider_added: "提供者已添加。",
    provider_save_error: "保存提供者失败。",
    provider_deleted: "提供者已删除。",
    provider_delete_error: "删除提供者失败。",
    provider_update_error: "更新提供者失败。",
    jwks_reachable: "JWKS 可达",
    jwks_unreachable: "JWKS 不可达",
    jwks_test_error: "无法从配置的 URL 获取 JWKS。",
    provider_form: {
      name_label: "名称",
      name_placeholder: "例如 Azure AD Production",
      name_description: "此身份提供者的可读标签",
      name_required: "名称为必填项。",
      issuer_label: "签发者",
      issuer_placeholder: "https://login.microsoftonline.com/tenant-id/v2.0",
      issuer_description: "JWT 中预期的 iss 声明值",
      issuer_required: "签发者为必填项。",
      jwks_url_label: "JWKS URL",
      jwks_url_placeholder: "https://login.microsoftonline.com/tenant-id/discovery/v2.0/keys",
      jwks_url_description: "提供者 JSON Web Key Set 的 HTTPS 端点",
      jwks_url_required: "JWKS URL 为必填项。",
      jwks_url_https: "JWKS URL 必须使用 HTTPS。",
      audience_label: "受众",
      audience_placeholder: "api://my-app-id",
      audience_description: "JWT 中预期的 aud 声明，以逗号分隔。",
      user_claims_label: "用户声明",
      user_claims_placeholder: "email",
      user_claims_description: "包含用户电子邮件地址的 JWT 声明",
      user_claims_required: "用户声明为必填项。",
      allowed_algorithms_label: "允许的签名算法",
      allowed_algorithms_description: "用于 JWT 签名验证的非对称算法",
      allowed_algorithms_required: "至少需要一个算法。",
      select_algorithms: "选择算法",
      jwks_cache_ttl_label: "JWKS 缓存 TTL（秒）",
      jwks_cache_ttl_description: "缓存提供者 JWKS 密钥的时长（最少 60 秒，默认 24 小时）",
      jwks_cache_ttl_min: "缓存 TTL 至少为 60 秒。",
      rate_limit_label: "速率限制",
      rate_limit_placeholder: "120/minute",
      rate_limit_description: "请求限制格式为 次数/周期（例如 120/minute）。留空使用默认速率限制。",
      enable_provider: "启用此提供者",
      saving: "保存中...",
      update: "更新",
    },
  },
...
• 任务和评论创建：通过语音命令添加任务、描述和评论。`,
  ...
  work_item_type_hierarchy: {
    ...
    levels: {
      max_level_placeholder: "拖放类型以添加新的层级",
      empty_level_placeholder: "将工作项类型拖放到第 {level} 层",
      drag_tooltip: "拖动以更改层级",
      quick_actions: {
        set_as_default: {
          label: "设为默认",
          toast: {
      ...
      update_level_toast: {
        loading: "正在将 {workItemTypeName} 移动到层级 {level}...",
        success: {
          title: "成功！",
          message: "{workItemTypeName} 已成功移动到层级 {level}。",
        },
      },
    },
    break_hierarchy_modal: {
      title: "验证错误！",
      content: {
        intro: "工作项类型 {workItemTypeName} 包含：",
        parent_items: "{count, plural, other {个父工作项}}",
        child_items: "{count, plural, other {个子工作项}}",
        parent_line_suffix_when_also_children: "，以及 ",
        footer: "此变更将从 {workItemTypeName} 工作项类型的现有工作项中移除父子关系。",
      },
      confirm_input: {
        label: "请输入「确认」以继续。",
        placeholder: "确认",
  ...
  page_actions: {
    move_page: {
      placeholders: {
        ...
        teamspace_to_all_with_wiki: "搜索 Wiki 集合、项目和团队空间",
      },
      toasts: {
        collection_error: {
          title: "已移动到 Wiki",
  ...
  wiki_collections: {
    ...
    fallback_name: "集合",
    form: {
      name_required: "集合标题为必填项",
      name_max_length: "集合名称必须少于 255 个字符",
      name_placeholder_create: "为集合输入一个标题",
      name_placeholder_edit: "集合名称",
    },
    create_modal: {
      title: "创建集合",
      submit: "创建集合",
    ...
    delete_modal: {
      title: "删除集合",
      page_count: "此集合中有 {pageCount} 个页面。请选择如何处理它们。",
      transfer_title: "转移页面并删除集合",
      transfer_description: "删除前，请先将所有页面移动到另一个集合。页面及其权限将被保留。",
      transfer_warning: "移动后的页面将继承所选集合的权限。",
      transfer_target_label: "将页面移动到",
      transfer_target_placeholder: "选择一个集合",
      delete_with_pages_title: "连同页面一起删除集合",
      delete_with_pages_description: "永久删除集合及其所有页面。此操作无法撤销。",
      submit: "删除集合",
    },
    header: {
      add_page: "添加页面",
    ...
    add_existing_page_modal: {
      ...
      success_message: "已将 {count} 个页面添加到集合。",
      error_message: "无法移动页面。请重试。",
      no_pages_found: "没有找到与您的搜索匹配的页面",
      no_pages_available: "没有可移动的页面",
      submit: "移动",
    },
    list: {
      invite_only: "仅限邀请",
      remove_error: "无法将页面从集合中移除。",
      no_matching_pages: "没有匹配的页面",
      remove_search_criteria: "移除搜索条件以查看所有页面",
      remove_filters: "移除筛选条件以查看所有页面",
      no_pages_title: "还没有页面",
      no_pages_description: "此集合当前没有任何页面。",
      untitled: "未命名",
      restricted_access: "访问受限",
      collapse_page: "折叠页面",
      expand_page: "展开页面",
      page_actions: "页面操作",
      page_link_copied: "页面链接已复制到剪贴板。",
      columns: {
        page_name: "页面名称",
        owner: "所有者",
        nested_pages: "嵌套页面",
    ...
    toasts: {
      created: "集合创建成功。",
      create_error: "无法创建集合。请重试。",
      renamed: "集合重命名成功。",
      rename_error: "无法更新集合。请重试。",
      transferred_deleted: "页面已转移，集合已删除。",
      deleted_with_pages: "集合及其页面已删除。",
      delete_error: "无法删除集合。请重试。",
      target_required: "请选择要将页面移动到的集合。",
      create_page_error: "无法创建页面。请重试。",
      create_page_in_collection_error: "无法创建页面或将其添加到集合中。请重试。",
      collection_link_copied: "集合链接已复制到剪贴板。",
    },
  },
} as const;
