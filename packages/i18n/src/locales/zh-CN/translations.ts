export default {
  ...
  stay_ahead_of_blockers_description: "发现从一个项目到另一个项目的挑战，并查看从其他视图中不易发现的迭代间依赖关系。",
  analytics: "分析",
    ...
    empty_state: {
      ...
      general: {
        ...
        primary_button: {
          text: "开始您的第一个项目",
          comic: {
            title: "分析功能在迭代 + 模块中效果最佳",
            description:
              "首先，将您的问题在迭代中进行时间限制，如果可能的话，将跨越多个迭代的问题分组到模块中。在左侧导航中查看这两个功能。",
          },
        },
      },
    },
    ...
    empty_state: {
      general: {
        ...
        primary_button: {
          ...
          comic: {
            title: "迭代是重复的时间框。",
            description: "冲刺、迭代或您用于每周或每两周跟踪工作的任何其他术语都是一个迭代。",
          },
        },
      },
      no_issues: {
      ...
      general: {
        ...
        primary_button: {
          ...
          comic: {
            ...
            description: "购物车发布、底盘发布和仓库发布都是这种分组的好例子。",
          },
        },
      },
      no_issues: {
