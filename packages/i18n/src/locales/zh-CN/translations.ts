...
export default {
  ...
  localized_ui: {
    ...
    inbox: {
      duplicate_issues_found: "发现 {count} 个重复工作项",
      description_versions: {
        intake_form_user: "收集表单用户",
      },
      errors: {
      ...
      navigation: {
        previous_work_item: "上一个工作项",
        next_work_item: "下一个工作项",
      },
      properties: {
        duplicate_of: "重复于",
      },
      select_duplicate: {
        select_work_item: "选择工作项",
      },
      sidebar: {
    ...
    space_public: {
      ...
      add_comment: "添加评论",
      public_board_not_found: "公开看板不存在。请检查 URL。",
