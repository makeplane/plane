...
export default {
  ...
  localized_ui: {
    ...
    editor: {
      ...
      copy_code: "复制代码",
      add_an_image: "添加图像",
      error_loading_image: "加载图像时出错",
      uploading: "上传中",
      drop_image_here: "将图像拖放到此处",
      retry_duplication: "重试复制",
      retry: "重试",
      no_emojis_found: "没有找到表情符号",
      fullscreen_image_viewer: "全屏图像查看器",
      close_image_viewer: "关闭图像查看器",
      zoom_out: "缩小",
      zoom_in: "放大",
      download_image: "下载图片",
      open_image_in_new_tab: "在新选项卡中打开图像",
      view_in_full_screen: "全屏查看",
      view_image_in_full_screen: "全屏查看图像",
      align: "对齐",
      download: "下载",
      clear_contents: "清除内容",
      insert_above: "在上面插入",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "你已受邀加入 {workspaceName}",
      description: "工作区用于创建项目、协作处理工作项，并在 Plane 账户中组织不同的工作流。",
      accept: "接受",
      ignore: "忽略",
      already_member: "你已经是 {workspaceName} 的成员",
      continue_to_home: "返回主页",
      inactive_title: "此邀请链接已失效。",
      empty_project_link: "或从空项目开始",
      sign_in_to_continue: "登录以继续",
      star_on_github: "在 GitHub 上给我们加星",
      join_community: "加入我们的创作者社区",
    },
    space_auth: {
      email: "邮箱",
    ...
    onboarding: {
      create_profile_title: "创建你的个人资料。",
      create_profile_description: "这是你在 Plane 中显示给他人的信息。",
      change_image: "更换图片",
      upload_image: "上传图片",
      name: "姓名",
      name_required: "姓名为必填项",
      name_within_50: "姓名必须在 50 个字符以内。",
      enter_full_name: "输入你的全名",
      set_password: "设置密码",
      optional: "可选",
      passwords_do_not_match: "密码不匹配",
      passwords_match: "密码匹配",
      continue: "继续",
      invite_team_title: "邀请你的队友",
      invite_team_description: "Plane 最适合团队协作使用。现在邀请团队成员，充分发挥 Plane 的价值。",
      invalid_email: "这看起来不像有效的邮箱地址。",
      success: "成功！",
      invitations_sent: "邀请已成功发送。",
      error: "错误！",
      add_another: "再添加一个",
      do_later: "稍后再说",
      join_invites_title: "加入邀请或创建工作区",
      unified_description: "所有工作，统一管理。",
      create_new_workspace: "创建新工作区",
      no_invitations_found: "未找到邀请",
      you_are_invited: "你收到了邀请！",
      accept_invites: "接受邀请，与团队一起协作。",
      continue_to_workspace: "继续前往工作区",
      or: "或",
      create_own_workspace: "创建自己的工作区",
      workspace_creation_disabled:
        "你似乎没有任何工作区邀请，且实例管理员已限制创建新工作区。请先让工作区所有者或管理员邀请你加入工作区，然后回到此页面继续。",
      create_workspace_title: "创建你的工作区",
      enter_workspace_name: "输入工作区名称",
      join_existing_workspace: "加入现有工作区",
      profile_setup_completed: "个人资料设置完成。",
      profile_setup_failed: "配置文件设置失败。",
      usecase_title: "您打算如何使用 Plane？",
      usecase_description: "选择一个或多个选项，以便我们为您提供个性化体验。",
      select_one_or_more: "选择一个或多个",
      select_at_least_one: "至少选择一个选项。",
      skip: "跳过",
    },
    inbox: {
      duplicate_issues_found: "{count} 发现重复问题",
      description_versions: {
        intake_form_user: "摄入表格用户",
      },
      errors: {
        asset_upload_failed: "资源上传失败。请稍后重试。",
        asset_duplication_failed: "资产复制失败。请稍后重试。",
        permission_denied: "没有权限",
        mark_duplicate_permission: "只有项目管理员可以将工作项标记为重复",
        mark_duplicate_permission_plural: "只有项目管理员可以将工作项标记为重复",
      },
      filters: {
        created_date: "创建日期",
        updated_date: "更新日期",
      ...
      navigation: {
        previous_work_item: "上一个工作项目",
        next_work_item: "下一个工作项目",
      },
      properties: {
        duplicate_of: "重复的",
      },
      select_duplicate: {
        select_work_item: "选择工作项目",
      },
      sidebar: {
        label_count: "{count} 标签",
      },
      toasts: {
        editor_processing: "编辑器仍在处理更改。请稍候再继续。",
        create_success: "工作项创建成功。",
        delete_failed: "工作项删除失败",
        update_failed: "工作项更新失败",
      },
    },
    space_public: {
      error_title: "糟糕，看起来不太妙。",
      error_description_prefix: "Plane 崩溃了。别担心，我们的工程师已经收到通知。如果你有更多细节，请写信到",
      error_description_middle: "或前往我们的",
      forum: "论坛",
      refresh: "刷新",
      not_found_title: "这个链接无法打开",
      not_found_hint: "请检查浏览器地址栏中的 URL，然后重试。",
      user_already_logged_in: "用户已登录",
      logged_in_title: "很好，还差最后一步。",
      logged_in_hint: "请在浏览器地址栏中输入你要查看的公开分享视图或页面 URL。",
      by_creating_account: "创建账户即表示",
      by_signing_in: "登录即表示",
      you_agree_to_our: "你同意我们的",
      ...
      auth: {
        sign_in_header: "登录后即可投票或评论",
        sign_in_subheader: "为你希望构建的功能提供反馈。",
        sign_up_header: "查看、评论并执行更多操作",
        sign_up_subheader: "注册或登录后即可处理 Plane 工作项和页面。",
      },
      peek: {
        side: "侧边预览",
        modal: "弹窗",
      ...
      bot_name: "{name} 机器人",
      commented_time: "评论于 {time}",
      and_more: "还有 {count} 个",
      no_upvotes_yet: "暂无赞成票",
      no_downvotes_yet: "暂无反对票",
      view_less: "收起",
      view_all: "查看全部",
      no_matches_found: "未找到匹配项",
      no_date: "无日期",
      ...
      no_assignees: "无负责人",
      labels_count: "{count} 个标签",
      page_not_found_alt: "找不到页面",
      something_went_wrong: "哎呀！出了点问题。",
      page_not_found_description: "您要查找的页面不存在或已被移动。",
      instance_failure_image_alt: "无法获取实例详细信息",
      instance_failure_title: "无法获取实例详细信息。",
      instance_failure_description: "我们无法加载您的实例详细信息。",
      instance_failure_hint: "请检查您的连接并重试。",
      retry: "重试",
      powered_by: "供电",
      sign_in_to_add_comment: "登录以添加评论",
      sign_in: "登入",
      link_copied: "链接已复制！",
      work_item_link_copied: "工作项链接已复制到剪贴板。",
      comment_post_error: "无法发表评论。请再试一次。",
      add_comment: "添加评论",
      public_board_not_found: "公共董事会不存在。请检查 URL。",
      no_work_items_found: "未找到工作项",
      no_labels: "无标签",
      user: "用户",
    },
  },
