...
power_k: {
    contextual_actions: {
      work_item: {
        ...
        change_assignees: "分配",
        assign_to_me: "分配给我",
        unassign_from_me: "取消我的分配",
        change_estimate: "更改预估",
        add_to_cycle: "添加到周期",
        ...
        copy_url_toast_error: "复制工作项 URL 到剪贴板时出错。",
      },
      cycle: {
        title: "周期操作",
        indicator: "周期",
        ...
        copy_url_toast_error: "复制周期 URL 到剪贴板时出错。",
      },
      module: {
        title: "模块操作",
        indicator: "模块",
        ...
        copy_url_toast_error: "复制模块 URL 到剪贴板时出错。",
      },
      page: {
        title: "页面操作",
        indicator: "页面",
        ...
        copy_url_toast_error: "复制页面 URL 到剪贴板时出错。",
      },
    },
    creation_actions: {
    ...
    navigation_actions: {
      ...
      nav_home: "转到主页",
      nav_inbox: "转到收件箱",
      nav_your_work: "转到我的工作",
      nav_account_settings: "转到账户设置",
      open_project: "打开项目",
      nav_projects_list: "转到项目列表",
      nav_all_workspace_work_items: "转到所有工作项",
      nav_assigned_workspace_work_items: "转到已分配的工作项",
      nav_created_workspace_work_items: "转到已创建的工作项",
      nav_subscribed_workspace_work_items: "转到已订阅的工作项",
      nav_workspace_analytics: "转到工作区分析",
      nav_workspace_drafts: "转到工作区草稿",
      nav_workspace_archives: "转到工作区归档",
      open_workspace_setting: "打开工作区设置",
      nav_workspace_settings: "转到工作区设置",
      nav_project_work_items: "转到工作项",
      open_project_cycle: "打开周期",
      nav_project_cycles: "转到周期",
      open_project_module: "打开模块",
      nav_project_modules: "转到模块",
      open_project_view: "打开视图",
      nav_project_views: "转到视图",
      nav_project_pages: "转到页面",
      nav_project_intake: "转到收集",
      nav_project_archives: "转到项目归档",
      open_project_setting: "打开项目设置",
      nav_project_settings: "转到项目设置",
    },
    account_actions: {
      sign_out: "退出登录",
      workspace_invites: "工作区邀请",
    ...
    miscellaneous_actions: {
      ...
      copy_current_page_url_toast_error: "复制当前页面 URL 到剪贴板时出错。",
      focus_top_nav_search: "聚焦搜索输入",
    },
    preferences_actions: {
      update_theme: "更改界面主题",
      update_timezone: "更改时区",
      update_start_of_week: "更改每周第一天",
    ...
    page_placeholders: {
      ...
      update_work_item_assignee: "分配",
      update_work_item_estimate: "更改预估",
  ...
  notifications: {
    heading: "邮件通知",
    description: "关注您订阅的工作项动态。启用此功能以获得通知。",
  },
  preferences: {
    heading: "偏好设置",
