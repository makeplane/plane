...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      something_went_wrong: "Ojoj! Niečo sa pokazilo.",
      page_not_found_description: "Stránka, ktorú hľadáte, neexistuje alebo bola presunutá.",
      instance_failure_image_alt: "Nemožno načítať podrobnosti o inštancii",
      instance_failure_title: "Nemožno načítať podrobnosti o inštancii.",
      instance_failure_description: "Nepodarilo sa načítať podrobnosti o vašej inštancii.",
      instance_failure_hint: "Skontrolujte pripojenie a skúste to znova.",
      retry: "Skúste to znova",
      powered_by: "Beží na",
      sign_in_to_add_comment: "Ak chcete pridať komentár, prihláste sa",
      ...
      comment_post_error: "Pridanie komentára zlyhalo. Skúste to znova.",
      add_comment: "Pridať komentár",
      public_board_not_found: "Verejná rada neexistuje. Skontrolujte URL.",
