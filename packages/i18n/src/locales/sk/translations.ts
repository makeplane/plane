...
pre lepší zážitok!`,
  ...
  common: {
    ...
    custom_properties: "Vlastné vlastnosti",
  },
  chart: {
    x_axis: "Os X",
    y_axis: "Os Y",
...
{email}`,
  ...
  workspace_projects: {
    ...
    common: {
      ...
      days_count: "{days, plural, one{# deň} other{# dni}}",
    },
    empty_state: {
      general: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-remind": {
        ...
        description:
          "Plane automaticky bude poslať upozornenia cez email a notifikácie v aplikácii, aby vaša ekipa zostala na ceste s termínmi.",
        duration: "Poslať upozornenie pred",
      },
    },
    empty_state: {
      labels: {
 ...
 rozdelenie práce podľa štítkov.`,
  ...
  project: {
    members_import: {
      title: "Importovať členov z CSV",
      description:
        "Nahrajte CSV so stĺpcami: E-mail a Rola (5=Hosť, 15=Člen, 20=Správca). Používatelia musia byť už členmi pracovného priestoru.",
      download_sample: "Stiahnuť vzorové CSV",
      dropzone: {
        active: "Presuňte CSV súbor sem",
        inactive: "Presuňte alebo kliknite pre nahranie",
        file_type: "Podporované sú iba súbory .csv",
      },
      buttons: {
        cancel: "Zrušiť",
        import: "Importovať",
      ...
      summary: {
        ...
        message: {
          success: "Úspešne importovaných {count} člen{plural} do projektu.",
          no_imports: "Zo súboru CSV neboli importovaní žiadni noví členovia.",
        },
        stats: {
          added: "Pridané",
          reactivated: "Znovu aktivované",
          already_members: "Už členovia",
          skipped: "Preskočené",
        },
        download_errors: "Stiahnuť podrobnosti preskočených",
      },
      toast: {
        invalid_file: {
          title: "Neplatný súbor",
  ...
  oauth_bridge_integration: {
    name: "OAuth Bridge",
    description: "Overenie tokenov externých IdP pre prístup k API.",
    header_description:
      "Overujte externe vydané OIDC/JWT tokeny z vášho IdP (Azure AD, Okta atď.) pre prístup k API Plane.",
    connected: "Pripojené",
    connect: "Pripojiť",
    uninstall: "Odinštalovať",
    uninstalling: "Odinštalovanie...",
    install_success: "OAuth Bridge úspešne nainštalovaný.",
    install_error: "Nepodarilo sa nainštalovať OAuth Bridge.",
    uninstall_success: "OAuth Bridge odinštalovaný.",
    uninstall_error: "Nepodarilo sa odinštalovať OAuth Bridge.",
    token_providers: "Poskytovatelia tokenov",
    token_providers_description:
      "Nakonfigurujte externých IdP, ktorých JWT sú akceptované ako API prihlasovacie údaje.",
    add_provider: "Pridať poskytovateľa",
    edit_provider: "Upraviť poskytovateľa",
    enabled: "Povolené",
    disabled: "Zakázané",
    test: "Test",
    no_providers_title: "Žiadni poskytovatelia nie sú nakonfigurovaní.",
    no_providers_description: "Pridajte IdP na povolenie overovania externými tokenmi.",
    provider_updated: "Poskytovateľ aktualizovaný.",
    provider_added: "Poskytovateľ pridaný.",
    provider_save_error: "Nepodarilo sa uložiť poskytovateľa.",
    provider_deleted: "Poskytovateľ zmazaný.",
    provider_delete_error: "Nepodarilo sa zmazať poskytovateľa.",
    provider_update_error: "Nepodarilo sa aktualizovať poskytovateľa.",
    jwks_reachable: "JWKS dostupný",
    jwks_unreachable: "JWKS nedostupný",
    jwks_test_error: "Nepodarilo sa získať JWKS z nakonfigurovanej URL.",
    provider_form: {
      name_label: "Názov",
      name_placeholder: "napr. Azure AD Production",
      name_description: "Čitateľný popisok pre tohto poskytovateľa identity",
      name_required: "Názov je povinný.",
      issuer_label: "Vydavateľ",
      issuer_placeholder: "https://login.microsoftonline.com/tenant-id/v2.0",
      issuer_description: "Očakávaná hodnota claim iss v JWT",
      issuer_required: "Vydavateľ je povinný.",
      jwks_url_label: "URL JWKS",
      jwks_url_placeholder: "https://login.microsoftonline.com/tenant-id/discovery/v2.0/keys",
      jwks_url_description: "HTTPS endpoint poskytujúci JSON Web Key Set poskytovateľa",
      jwks_url_required: "URL JWKS je povinná.",
      jwks_url_https: "URL JWKS musí používať HTTPS.",
      audience_label: "Publikum",
      audience_placeholder: "api://my-app-id",
      audience_description: "Očakávané claim(y) aud v JWT, oddelené čiarkami.",
      user_claims_label: "Claim používateľa",
      user_claims_placeholder: "email",
      user_claims_description: "JWT claim obsahujúci e-mailovú adresu používateľa",
      user_claims_required: "Claim používateľa je povinný.",
      allowed_algorithms_label: "Povolené podpisové algoritmy",
      allowed_algorithms_description: "Asymetrické algoritmy pre overenie podpisu JWT",
      allowed_algorithms_required: "Je vyžadovaný aspoň jeden algoritmus.",
      select_algorithms: "Vyberte algoritmy",
      jwks_cache_ttl_label: "TTL vyrovnávacej pamäte JWKS (sekundy)",
      jwks_cache_ttl_description:
        "Doba ukladania kľúčov JWKS poskytovateľa do vyrovnávacej pamäte (minimum 60s, predvolene 24 hodín)",
      jwks_cache_ttl_min: "TTL vyrovnávacej pamäte musí byť aspoň 60 sekúnd.",
      rate_limit_label: "Limit požiadaviek",
      rate_limit_placeholder: "120/minute",
      rate_limit_description:
        "Obmedzenie požiadaviek ako počet/obdobie (napr. 120/minute). Ponechajte prázdne pre predvolený limit.",
      enable_provider: "Povoliť tohto poskytovateľa",
      saving: "Ukladanie...",
      update: "Aktualizovať",
    },
  },
...
• Vytváranie úloh a komentárov: Pridávajte úlohy, popisy a komentáre pomocou hlasových príkazov.`,
  ...
  automations: {
    ...
    trigger: {
      ...
      section_plane_events: "Udalosti Plane",
      section_time_based: "Časovo založené",
      fixed_schedule: "Pevný rozvrh",
      schedule: {
        frequency: "Frekvencia",
        select_day: "Vybrať deň",
        day_of_month: "Deň v mesiaci",
        monthly_every: "Každý",
        monthly_day_aria: "Deň {day}",
        time: "Čas",
        hour: "Hodina",
        minute: "Minúta",
        hour_suffix: "hod",
        ...
        frequency_daily: "Denne",
        frequency_weekly: "Týždenne",
        frequency_monthly: "Mesačne",
        on: "V",
        validation_weekly_day_required: "Vyberte aspoň jeden deň v týždni.",
        validation_monthly_date_required: "Vyberte deň v mesiaci.",
        main_content_schedule_summary_daily: "Každý deň o {time} ({timezone}).",
        main_content_schedule_summary_weekly: "Každý týždeň v {days} o {time} ({timezone}).",
        main_content_schedule_summary_monthly: "Každý mesiac v deň {day} o {time} ({timezone}).",
        schedule_mode: "Režim plánovania",
        schedule_mode_fixed: "Pevný",
        schedule_mode_cron: "Cron",
        cron_expression_label: "Zadajte Cron výraz",
        cron_expression_placeholder: "0 9 * * 1-5",
        cron_invalid: "Neplatný Cron výraz.",
        cron_preview: 'Tento Cron výraz spúšťa "{description}".',
  ...
  work_item_type_hierarchy: {
    ...
    work_item_type_modal: {
      ...
      invalid_level_toast: {
        title: "Chyba!",
        message: "Typ pracovnej položky nie je možné aktualizovať, pretože to porušuje pravidlá hierarchie.",
      },
    },
  },
  page_actions: {
    move_page: {
      placeholders: {
        project_to_all_with_wiki: "Hľadať wiki kolekcie, projekty a tímové priestory",
        project_to_project_with_wiki: "Hľadať wiki kolekcie a projekty",
        teamspace_to_all_with_wiki: "Hľadať wiki kolekcie, projekty a tímové priestory",
      },
      toasts: {
        collection_error: {
          title: "Presunuté do wiki",
          message:
            "Stránka bola presunutá do wiki, ale nepodarilo sa ju pridať do vybratej kolekcie. Zostáva v General.",
        },
      },
    },
    remove_from_collection: {
      label: "Odstrániť z kolekcie",
      success_message: "Stránka bola odstránená z kolekcie.",
      error_message: "Stránku sa nepodarilo odstrániť z kolekcie. Skúste to prosím znova.",
    },
  },
  wiki_collections: {
    predefined: {
    ...
    fallback_name: "Kolekcia",
    form: {
      name_required: "Názov kolekcie je povinný",
      name_max_length: "Názov kolekcie musí mať menej ako 255 znakov",
      name_placeholder_create: "Zadajte názov kolekcie",
      name_placeholder_edit: "Názov kolekcie",
    },
    create_modal: {
    ...
    delete_modal: {
      ...
      page_count: "Táto kolekcia obsahuje {pageCount} stránok. Vyberte, čo sa s nimi má stať.",
      transfer_title: "Presunúť stránky a odstrániť kolekciu",
      transfer_description:
        "Pred odstránením presuňte všetky stránky do inej kolekcie. Stránky aj ich oprávnenia zostanú zachované.",
      transfer_warning: "Presunuté stránky zdedia oprávnenia vybratej kolekcie.",
      transfer_target_label: "Presunúť stránky do",
      transfer_target_placeholder: "Vyberte kolekciu",
      delete_with_pages_title: "Odstrániť kolekciu aj so stránkami",
      delete_with_pages_description:
        "Natrvalo odstráni kolekciu aj všetky jej stránky. Túto akciu nie je možné vrátiť späť.",
      submit: "Odstrániť kolekciu",
    },
    header: {
    ...
    add_existing_page_modal: {
      ...
      success_message: "Do kolekcie bolo pridaných {count} stránok.",
      error_message: "Stránky sa nepodarilo presunúť. Skúste to prosím znova.",
      no_pages_found: "Neboli nájdené žiadne stránky zodpovedajúce vášmu vyhľadávaniu",
      no_pages_available: "Žiadne stránky na presun",
      submit: "Presunúť",
    },
    list: {
      invite_only: "Len na pozvanie",
      remove_error: "Stránku sa nepodarilo odstrániť z kolekcie.",
      no_matching_pages: "Žiadne zodpovedajúce stránky",
      remove_search_criteria: "Odstráňte kritériá vyhľadávania a zobrazia sa všetky stránky",
      remove_filters: "Odstráňte filtre a zobrazia sa všetky stránky",
      no_pages_title: "Zatiaľ žiadne stránky",
      no_pages_description: "Táto kolekcia zatiaľ neobsahuje žiadne stránky.",
      untitled: "Bez názvu",
      restricted_access: "Obmedzený prístup",
      collapse_page: "Zbaliť stránku",
      expand_page: "Rozbaliť stránku",
      page_actions: "Akcie stránky",
      page_link_copied: "Odkaz na stránku bol skopírovaný do schránky.",
      columns: {
    ...
    toasts: {
      created: "Kolekcia bola úspešne vytvorená.",
      create_error: "Kolekciu sa nepodarilo vytvoriť. Skúste to prosím znova.",
      renamed: "Kolekcia bola úspešne premenovaná.",
      rename_error: "Kolekciu sa nepodarilo aktualizovať. Skúste to prosím znova.",
      transferred_deleted: "Stránky boli presunuté a kolekcia odstránená.",
      deleted_with_pages: "Kolekcia aj jej stránky boli odstránené.",
      delete_error: "Kolekciu sa nepodarilo odstrániť. Skúste to prosím znova.",
      target_required: "Vyberte prosím kolekciu, do ktorej chcete stránky presunúť.",
      create_page_error: "Stránku sa nepodarilo vytvoriť. Skúste to prosím znova.",
      create_page_in_collection_error:
        "Stránku sa nepodarilo vytvoriť alebo pridať do kolekcie. Skúste to prosím znova.",
      collection_link_copied: "Odkaz na kolekciu bol skopírovaný do schránky.",
    },
  },
} as const;
