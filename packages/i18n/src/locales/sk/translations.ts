...
export default {
  ...
  localized_ui: {
    ...
    workspace_views: {
      page_title: "{workspaceName} - Všetky zobrazenia",
    },
    ...
    editor: {
      ...
      color: "Farba",
      text_colors: "Farby textu",
      background_colors: "Farby pozadia",
      link: "Odkaz",
      enter_or_paste_link: "Zadajte alebo prilepte odkaz",
      please_enter_valid_url: "Zadajte platný URL",
      delete: "Odstrániť",
      ...
      add_an_image: "Pridajte obrázok",
      error_loading_image: "Chyba pri načítavaní obrázka",
      uploading: "Nahráva sa",
      drop_image_here: "Sem presuňte obrázok",
      retry_duplication: "Opakovať duplikáciu",
      retry: "Skúste to znova",
      no_emojis_found: "Nenašli sa žiadne emotikony",
      fullscreen_image_viewer: "Prehliadač obrázkov na celú obrazovku",
      close_image_viewer: "Zatvorte prehliadač obrázkov",
      zoom_out: "Oddialiť",
      zoom_in: "Priblížiť",
      download_image: "Stiahnite si obrázok",
      open_image_in_new_tab: "Otvoriť obrázok na novej karte",
      view_in_full_screen: "Zobraziť na celej obrazovke",
      view_image_in_full_screen: "Zobraziť obrázok na celej obrazovke",
      align: "Zarovnať",
      download: "Stiahnuť",
      clear_contents: "Prehľadný obsah",
      insert_above: "Vložte vyššie",
      insert_below: "Vložte nižšie",
      insert_left: "Vložte vľavo",
      insert_right: "Vložte vpravo",
      header_row: "Riadok hlavičky",
      header_column: "Hlavička stĺpca",
      alignment: {
        left: "Vľavo",
        center: "centrum",
        right: "Správne",
    ...
    onboarding: {
      ...
      profile_setup_completed: "Nastavenie profilu je dokončené.",
      profile_setup_failed: "Nastavenie profilu zlyhalo.",
      usecase_title: "Ako plánujete používať Plane?",
      usecase_description: "Vyberte jednu alebo viac možností, aby sme vám mohli prispôsobiť váš zážitok.",
      select_one_or_more: "Vyberte jednu alebo viac",
      select_at_least_one: "Vyberte aspoň jednu možnosť.",
      skip: "Preskočiť",
    },
    inbox: {
      ...
      errors: {
        ...
        asset_duplication_failed: "Duplikácia aktív zlyhala. Skúste to znova neskôr.",
        permission_denied: "Povolenie zamietnuté",
        mark_duplicate_permission: "Iba správcovia projektu môžu označiť pracovnú položku ako duplikát",
        mark_duplicate_permission_plural: "Iba správcovia projektu môžu označiť pracovné položky ako duplicitné",
      },
      filters: {
        created_date: "Dátum vytvorenia",
        updated_date: "Aktualizovaný dátum",
        last_updated_date: "Dátum poslednej aktualizácie",
        status: "Stav",
        work_item_status: "Stav pracovnej položky",
      ...
      navigation: {
        previous_work_item: "Predchádzajúca pracovná položka",
      ...
      sidebar: {
        label_count: "{count} štítky",
      },
      toasts: {
        editor_processing: "Editor stále spracováva zmeny. Pred pokračovaním počkajte.",
        create_success: "Pracovná položka bola úspešne vytvorená.",
        delete_failed: "Odstránenie pracovnej položky zlyhalo",
        update_failed: "Aktualizácia pracovnej položky zlyhala",
      },
    },
    space_public: {
      error_description_prefix: "Plane zlyhal. Naši inžinieri boli upozornení. Ak máte ďalšie podrobnosti, napíšte na",
      error_description_middle: "alebo na našom",
      not_found_hint: "Skontrolujte URL v paneli s adresou prehliadača a skúste to znova.",
      logged_in_hint:
        "Do panela s adresou prehliadača zadajte verejnú zdieľanú URL alebo odkaz na zobrazenie či stránku, ktorú chcete vidieť.",
      oauth_with_provider: "{action} cez {provider}",
      auth: {
        sign_in_header: "Prihláste sa, aby ste mohli hlasovať alebo komentovať",
        sign_in_subheader: "Pomôžte posunúť funkcie, ktoré chcete mať vytvorené.",
        sign_up_header: "Zobrazujte, komentujte a robte viac",
        sign_up_subheader:
          "Zaregistrujte sa alebo sa prihláste, aby ste mohli pracovať s pracovnými položkami a Stránkami Plane.",
      },
      peek: {
        side: "Bočný náhľad",
        modal: "Modálne okno",
      ...
      bot_name: "Bot {name}",
      commented_time: "komentoval {time}",
      and_more: "a ďalších {count}",
      no_upvotes_yet: "Zatiaľ žiadne hlasy za",
      no_downvotes_yet: "Zatiaľ žiadne hlasy proti",
      modules_count: "{count} modulov",
      labels_count: "{count} štítkov",
      page_not_found_alt: "Stránka sa nenašla",
      something_went_wrong: "Ups! Niečo sa pokazilo.",
      page_not_found_description: "Stránka, ktorú hľadáte, neexistuje alebo bola presunutá.",
      instance_failure_image_alt: "Nie je možné načítať podrobnosti inštancie",
      instance_failure_title: "Nie je možné načítať podrobnosti inštancie.",
      instance_failure_description: "Nepodarilo sa načítať podrobnosti vašej inštancie.",
      instance_failure_hint: "Skontrolujte pripojenie a skúste to znova.",
      powered_by: "Používa",
      sign_in_to_add_comment: "Prihláste sa a pridajte komentár",
      link_copied: "Odkaz skopírovaný!",
      work_item_link_copied: "Odkaz na pracovnú položku bol skopírovaný do schránky.",
      comment_post_error: "Komentár sa nepodarilo uverejniť. Skúste to znova.",
      add_comment: "Pridať komentár",
      public_board_not_found: "Verejná nástenka neexistuje. Skontrolujte URL.",
      no_work_items_found: "Nenašli sa žiadne pracovné položky",
      error_title: "Ups! Toto nevyzerá dobre.",
      refresh: "Obnoviť",
      forum: "Fórum",
      not_found_title: "Toto nefungovalo",
      user_already_logged_in: "Používateľ je už prihlásený",
      logged_in_title: "Výborne! Ešte jeden krok.",
      by_creating_account: "Vytvorením účtu",
      by_signing_in: "Prihlásením",
      you_agree_to_our: "súhlasíte s našimi",
      ...
      no_date: "Bez dátumu",
      no_cycle: "Bez cyklu",
      no_modules: "Bez modulov",
      no_assignees: "Bez priradených osôb",
