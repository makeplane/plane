 ...
 rozdelenie práce podľa štítkov.`,
  ...
  oauth_bridge_integration: {
    ...
    provider_form: {
      ...
      user_claim_label: "Claim používateľa",
      user_claim_placeholder: "email",
      user_claim_description: "JWT claim obsahujúci e-mailovú adresu používateľa",
      user_claim_required: "Claim používateľa je povinný.",
