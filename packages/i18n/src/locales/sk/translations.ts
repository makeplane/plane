...
export default {
  ...
  support: "Podpora",
  forum: "Forum",
  powered_by_plane_pages: "Poháňa Gizmo Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Väčšina vecí začína projektom v Gizmo.",
        cta: "Začať",
      },
      invite_team: {
        title: "Pozvať tím",
  ...
  workspace_creation: {
    ...
    subheading: "Na používanie Gizmo musíte vytvoriť alebo sa pripojiť k pracovnému priestoru.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Vitajte v Gizmo, teší nás, že ste tu. Vytvorte prvý projekt, sledujte pracovné položky a táto stránka sa zmení na priestor pre váš pokrok. Správcovia tu uvidia aj položky pomáhajúce tímu.",
        primary_button: {
          text: "Vytvorte prvý projekt",
          comic: {
            title: "Všetko začína projektom v Gizmo",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Skopírujte a uložte tento kľúč do Gizmo Pages. Po zatvorení ho neuvidíte. CSV súbor s kľúčom bol stiahnutý.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Používajte API na integráciu Gizmo s externými systémami.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Gizmo bude archivovať dokončené alebo zrušené položky.",
        duration: "Archivovať položky uzavreté dlhšie ako",
      },
      "auto-close": {
        title: "Automaticky uzatvárať položky",
        description: "Gizmo uzavrie neaktívne položky.",
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Gizmo sa nespustil. Toto môže byť spôsobené tým, že sa jedna alebo viac služieb Gizmo nepodarilo spustiť.",
