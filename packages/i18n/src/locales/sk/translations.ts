export default {
  ...
  "auth": {
    ...
    "forgot_password": {
      ...
      "description": "Zadajte overenú e-mailovú adresu vášho používateľského účtu a my vám zašleme odkaz na obnovenie hesla.",
      ...
      "toast": {
        "success": {
          ...
          "message": "Skontrolujte si doručenú poštu pre odkaz na obnovenie hesla. Ak sa neobjaví v priebehu niekoľkých minút, skontrolujte si spam."
        },
        "error": {
          "title": "Chyba!",
          "message": "Niečo sa pokazilo. Skúste to prosím znova."
  ...
  "deactivate_account_description": "Pri deaktivácii účtu budú všetky dáta a prostriedky v rámci tohto účtu trvalo odstránené a nedajú sa obnoviť.",
  ...
  "stay_in_the_loop_on_issues_you_are_subscribed_to_enable_this_to_get_notified": "Majte prehľad o pracovných položkách, ktoré odoberáte. Aktivujte toto pre zasielanie oznámení.",
  ...
  "property_changes_description": "Upozorniť ma, keď sa zmenia vlastnosti pracovných položiek ako priradenie, priorita, odhady alebo čokoľvek iné.",
  ...
  "active_cycles_description": "Sledujte cykly naprieč projektmi, monitorujte vysoko prioritné pracovné položky a zamerajte sa na cykly vyžadujúce pozornosť.",
  ...
  "10000_feet_view_description": "Priblížte si všetky prebiehajúce cykly naprieč všetkými projektmi naraz, namiesto prepínania medzi cyklami v každom projekte.",
  "get_snapshot_of_each_active_cycle": "Získajte snapshot každého aktívneho cyklu.",
  "get_snapshot_of_each_active_cycle_description": "Sledujte kľúčové metriky pre všetky aktívne cykly, zistite ich priebeh a porovnajte rozsah s termínmi.",
  ...
  "quickly_see_make_or_break_issues_description": "Pozrite si vysoko prioritné pracovné položky pre každý cyklus vzhľadom na termíny. Zobrazte všetky jedným kliknutím.",
  "zoom_into_cycles_that_need_attention": "Zamerajte sa na cykly vyžadujúce pozornosť.",
  "zoom_into_cycles_that_need_attention_description": "Preskúmajte stav akéhokoľvek cyklu, ktorý nespĺňa očakávania, jedným kliknutím.",
  "stay_ahead_of_blockers": "Buďte o krok pred prekážkami.",
  "stay_ahead_of_blockers_description": "Identifikujte problémy medzi projektmi a zistite závislosti medzi cyklami, ktoré nie sú z iných pohľadov zrejmé.",
  "analytics": "Analytika",
  ...
  "cycles_description": "Časovo ohraničte prácu podľa projektu a upravte obdobie podľa potreby. Jeden cyklus môže mať 2 týždne, ďalší 1 týždeň.",
  ...
  "please_select_at_least_one_invitation_description": "Vyberte aspoň jednu pozvánku na pripojenie do pracovného priestoru.",
  ...
  "we_see_that_someone_has_invited_you_to_join_a_workspace_description": "Vidíme, že vás niekto pozval do pracovného priestoru",
  ...
  "deactivate_your_account_description": "Po deaktivácii nebudete môcť byť priradení k pracovným položkám a nebude vám účtovaný poplatok za pracovný priestor. Na opätovnú aktiváciu účtu budete potrebovať pozvánku do pracovného priestoru na tento e-mail.",
  ...
  "issue": {
    ...
    "add": {
      ...
      "cycle": {
        ...
        "success": "{count, plural, one {Pracovná položka} few {Pracovné položky} other {Pracovných položiek}} pridaná do cyklu.",
        "loading": "Pridávanie {count, plural, one {pracovnej položky} few {pracovných položiek} other {pracovných položiek}} do cyklu"
      },
    ...
    "archive": {
      ...
      "confirm_message": "Naozaj chcete archivovať túto pracovnú položku? Všetky archivované položky je možné neskôr obnoviť.",
      "success": {
  ...
  "workspace_dashboard": {
    "empty_state": {
      "general": {
        ...
        "description": "Vitajte v Plane, teší nás, že ste tu. Vytvorte prvý projekt, sledujte pracovné položky a táto stránka sa zmení na priestor pre váš pokrok. Správcovia tu uvidia aj položky pomáhajúce tímu.",
        "primary_button": {
  ...
  "workspace_analytics": {
    ...
    "empty_state": {
      ...
      "general": {
        "title": "Sledujte pokrok, pracovné zaťaženie a alokácie. Identifikujte trendy, odstráňte prekážky a urýchlite prácu",
        "description": "Porovnávajte rozsah s dopytom, odhady a rozširovanie rozsahu. Získajte výkonnosť podľa členov tímu a tímov, a uistite sa, že váš projekt beží načas.",
        "primary_button": {
          "text": "Začnite svoj prvý projekt",
          "comic": {
            "title": "Analytika funguje najlepšie s Cyklami + Modulmi",
            "description": "Najprv časovo ohraničte svoje problémy do Cyklov a, ak môžete, zoskupte problémy, ktoré trvajú viac ako jeden cyklus, do Modulov. Pozrite si oboje v ľavej navigácii."
          }
        }
      }
    },
  ...
  "workspace_projects": {
    ...
    "empty_state": {
      "general": {
        ...
        "description": "Projekt je nadradený cieľom. Projekty obsahujú Úlohy, Cykly a Moduly. Vytvorte nový alebo filtrujte archivované.",
        "primary_button": {
  ...
  "workspace_settings": {
    ...
    "copy_key": "Skopírujte a uložte tento kľúč do Plane Pages. Po zatvorení ho neuvidíte. CSV súbor s kľúčom bol stiahnutý.",
  ...
  "project_page": {
    "empty_state": {
      "general": {
        ...
        "description": "Stránky sú priestorom pre myšlienky. Píšte, formátujte, vkladajte položky a používajte komponenty.",
        "primary_button": {
