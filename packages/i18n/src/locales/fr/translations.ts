  ...
  "workspace_analytics": {
    ...
    "empty_state": {
      ...
      "general": {
        ...
        "description": "Voyez la portée par rapport à la demande, les estimations et l'évolution du périmètre. Obtenez les performances par les membres de l'équipe et les équipes, et assurez-vous que votre projet se déroule dans les temps.",
        "primary_button": {
