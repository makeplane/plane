...
export default {
  ...
  localized_ui: {
    ...
    workspace_invitation: {
      ...
      description:
        "Votre espace de travail est l’endroit où vous créez des projets, collaborez sur vos éléments de travail et organisez différents flux de travail dans votre compte Plane.",
      accept: "Accepter",
      ignore: "Ignorer",
    ...
    onboarding: {
      ...
      invite_team_description:
        "Plane fonctionne mieux avec votre équipe. Invitez-la maintenant pour tirer pleinement parti de Plane.",
      ...
      workspace_creation_disabled:
        "Vous ne semblez avoir aucune invitation à un espace de travail et l’administrateur de votre instance a limité la création de nouveaux espaces de travail. Demandez d’abord à un propriétaire ou administrateur de vous inviter, puis revenez sur cet écran pour rejoindre.",
