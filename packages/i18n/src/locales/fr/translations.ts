...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      instance_failure_hint: "Veuillez vérifier votre connexion et réessayer.",
      retry: "Réessayer",
      powered_by: "Alimenté par",
      sign_in_to_add_comment: "Connectez-vous pour ajouter un commentaire",
      sign_in: "Se connecter",
      link_copied: "Lien copié !",
      work_item_link_copied: "Lien d’élément de travail copié dans le presse-papiers.",
      comment_post_error: "Échec de la publication du commentaire. Veuillez réessayer.",
      add_comment: "Ajouter un commentaire",
      public_board_not_found: "Le conseil public n'existe pas. Veuillez vérifier le URL.",
