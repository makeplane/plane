...
export default {
  ...
  localized_ui: {
    ...
    editor: {
      url: "URL",
      enter_or_paste_url: "Saisissez ou collez l'URL",
      text: "Texte",
      enter_text_to_display: "Saisissez le texte à afficher",
      ...
      link: "Lien",
      enter_or_paste_link: "Saisir ou coller le lien",
      please_enter_valid_url: "Veuillez entrer un URL valide",
      delete: "Supprimer",
      duplicate: "Double",
      multiple: "Multiple",
      loading: "Chargement",
      ...
      drop_image_here: "Déposez l'image ici",
      retry_duplication: "Réessayer la duplication",
      retry: "Réessayer",
      no_emojis_found: "Aucun emoji trouvé",
      fullscreen_image_viewer: "Visionneuse d'images plein écran",
      close_image_viewer: "Fermer la visionneuse d'images",
      zoom_out: "Zoom arrière",
      zoom_in: "Zoomer",
      download_image: "Télécharger l'image",
      open_image_in_new_tab: "Ouvrir l'image dans un nouvel onglet",
      view_in_full_screen: "Afficher en plein écran",
      view_image_in_full_screen: "Afficher l'image en plein écran",
      align: "Aligner",
      download: "Télécharger",
      clear_contents: "Effacer le contenu",
      insert_above: "Insérer ci-dessus",
      insert_below: "Insérer ci-dessous",
      insert_left: "Insérer à gauche",
      insert_right: "Insérer à droite",
      header_row: "Ligne d'en-tête",
      header_column: "Colonne d'en-tête",
      alignment: {
        left: "Gauche",
        center: "Centre",
        right: "Droite",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "Vous avez été invité à {workspaceName}",
      description:
        "Votre espace de travail est l'endroit où vous créerez des projets, collaborerez sur vos éléments de travail et organiserez différents flux de travail dans votre compte Plane.",
      accept: "Accepter",
      ignore: "Ignorer",
      already_member: "Vous êtes déjà membre de {workspaceName}",
      continue_to_home: "Continuer à la maison",
      inactive_title: "Ce lien d'invitation n'est plus actif.",
      empty_project_link: "Ou partir d'un projet vide",
      sign_in_to_continue: "Connectez-vous pour continuer",
      star_on_github: "Mettez-nous en vedette sur GitHub",
      join_community: "Rejoignez notre communauté de créateurs actifs",
    },
    space_auth: {
      email: "E-mail",
      ...
      continue: "Continuer",
      go_to_workspace: "Aller à l'espace de travail",
      sign_in_with_unique_code: "Connectez-vous avec un code unique",
      create_account: "Créer un compte",
      unique_code: "Code unique",
      paste_code_sent: "Collez le code envoyé sur votre email",
      resend_in: "Renvoyer dans {seconds}s",
      requesting_new_code: "Demander un nouveau code",
      resend: "Renvoyer",
      sending_code: "Envoi du code",
    },
    onboarding: {
      create_profile_title: "Créez votre profil.",
      create_profile_description: "C'est ainsi que vous apparaîtrez dans Plane.",
      change_image: "Changer l'image",
      upload_image: "Télécharger une image",
      name: "Nom",
      name_required: "Le nom est requis",
      name_within_50: "Le nom doit contenir moins de 50 caractères.",
      ...
      continue: "Continuer",
      invite_team_title: "Invitez vos coéquipiers",
      invite_team_description:
        "Le travail chez Plane se déroule mieux avec votre équipe. Invitez-les maintenant à utiliser Plane à son potentiel.",
      ...
      join_invites_title: "Rejoignez des invitations ou créez un espace de travail",
      unified_description: "Tout votre travail – unifié.",
      ...
      accept_invites: "Acceptez les invitations à collaborer avec votre équipe.",
      continue_to_workspace: "Continuer vers l'espace de travail",
      or: "ou",
      create_own_workspace: "Créez votre propre espace de travail",
      workspace_creation_disabled:
        "Vous ne semblez recevoir aucune invitation à un espace de travail et l'administrateur de votre instance a restreint la création de nouveaux espaces de travail. Veuillez d'abord demander à un propriétaire ou à un administrateur d'espace de travail de vous inviter à un espace de travail, puis de revenir sur cet écran pour le rejoindre.",
      create_workspace_title: "Créez votre espace de travail",
      enter_workspace_name: "Entrez le nom de l'espace de travail",
      join_existing_workspace: "Rejoindre l'espace de travail existant",
      profile_setup_completed: "Configuration du profil terminée.",
      profile_setup_failed: "La configuration du profil a échoué.",
      usecase_title: "Comment comptez-vous utiliser Plane ?",
      usecase_description:
        "Sélectionnez une ou plusieurs options afin que nous puissions personnaliser votre expérience.",
    ...
    inbox: {
      ...
      errors: {
        ...
        asset_duplication_failed: "La duplication des actifs a échoué. Veuillez réessayer plus tard.",
        permission_denied: "Autorisation refusée",
        mark_duplicate_permission:
          "Seuls les administrateurs de projet peuvent marquer un élément de travail comme doublon",
        mark_duplicate_permission_plural:
          "Seuls les administrateurs de projet peuvent marquer les éléments de travail comme doublons",
      },
      filters: {
        ...
        status: "Statut",
        work_item_status: "Statut de l'élément de travail",
        view_all: "Voir tout",
      ...
      navigation: {
        previous_work_item: "Élément de travail précédent",
      ...
      sidebar: {
        label_count: "Étiquettes {count}",
      },
      toasts: {
        editor_processing:
          "L'éditeur est toujours en train de traiter les modifications. Veuillez patienter avant de continuer.",
        create_success: "Élément de travail créé avec succès.",
        delete_failed: "Échec de la suppression de l'élément de travail",
        update_failed: "Échec de la mise à jour de l'élément de travail",
      },
    },
    space_public: {
      error_title: "Oups ! Cela ne semble pas bon.",
      error_description_prefix:
        "Plane a planté. Pas d'inquiétude, nos ingénieurs ont été informés. Si vous avez plus de détails, écrivez à",
      error_description_middle: "ou sur notre",
      forum: "Forum",
      refresh: "Actualiser",
      not_found_title: "Cela n'a pas fonctionné",
      not_found_hint: "Vérifiez l'URL dans la barre d'adresse du navigateur puis réessayez.",
      user_already_logged_in: "Utilisateur déjà connecté",
      logged_in_title: "Parfait ! Plus qu'une étape.",
      logged_in_hint:
        "Saisissez dans la barre d'adresse du navigateur l'URL publique partagée ou le lien de la vue ou de la page que vous souhaitez consulter.",
      by_creating_account: "En créant un compte",
      by_signing_in: "En vous connectant",
      you_agree_to_our: "vous acceptez nos",
      terms_of_service: "Conditions d'utilisation",
      and: "et",
      privacy_policy: "Politique de confidentialité",
      sign_up: "S'inscrire",
      oauth_with_provider: "{action} avec {provider}",
      auth: {
        sign_in_header: "Connectez-vous pour voter ou commenter",
        sign_in_subheader: "Aidez à faire avancer les fonctionnalités que vous souhaitez voir créées.",
        sign_up_header: "Consultez, commentez et faites plus",
        sign_up_subheader:
          "Inscrivez-vous ou connectez-vous pour travailler avec les éléments de travail et les pages Plane.",
      },
      peek: {
        side: "Aperçu latéral",
      ...
      bot_name: "Bot {name}",
      commented_time: "a commenté {time}",
      and_more: "et {count} de plus",
      no_upvotes_yet: "Aucun vote positif pour le moment",
      no_downvotes_yet: "Aucun vote négatif pour le moment",
      view_less: "Voir moins",
      view_all: "Tout voir",
      no_matches_found: "Aucune correspondance trouvée",
      no_date: "Aucune date",
      ...
      no_assignees: "Aucune personne assignée",
      labels_count: "{count} étiquettes",
      page_not_found_alt: "Page introuvable",
      something_went_wrong: "Oups ! Une erreur s'est produite.",
      page_not_found_description: "La page que vous recherchez n'existe pas ou a été déplacée.",
      instance_failure_image_alt: "Impossible de récupérer les détails de l'instance",
      instance_failure_title: "Impossible de récupérer les détails de l'instance.",
      ...
      link_copied: "Lien copié !",
      work_item_link_copied: "Lien de l'élément de travail copié dans le presse-papiers.",
      comment_post_error: "Impossible de publier le commentaire. Veuillez réessayer.",
      add_comment: "Ajouter un commentaire",
      public_board_not_found: "Le tableau public n'existe pas. Veuillez vérifier l'URL.",
      no_work_items_found: "Aucun élément de travail trouvé",
