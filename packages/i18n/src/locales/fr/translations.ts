...
export default {
  ...
  localized_ui: {
    editor: {
          "url": "URL",
          "enter_or_paste_url": "Saisir ou coller une URL",
          "text": "Texte",
          "enter_text_to_display": "Saisir le texte à afficher",
          "remove_link": "Supprimer le lien"
    },
      "workspace_invitation": {
          "invitation_not_found": "Invitation introuvable",
          "invited_to_workspace": "Vous avez été invité à rejoindre {workspaceName}",
          "description": "Votre espace de travail est l’endroit où vous créez des projets, collaborez sur vos éléments de travail et organisez différents flux de travail dans votre compte Plane.",
          "accept": "Accepter",
          "ignore": "Ignorer",
          ...
          "empty_project_link": "Ou commencer avec un projet vide",
      ...
      "space_auth": {
          ...
          "paste_code_sent": "Collez le code envoyé à votre e-mail",
      ...
      "onboarding": {
          ...
          "create_profile_description": "Voici comment vous apparaîtrez dans Plane.",
          "change_image": "Changer l’image",
          "upload_image": "Importer une image",
          "name": "Nom",
          "name_required": "Le nom est obligatoire",
          "name_within_50": "Le nom doit contenir au maximum 50 caractères.",
          "enter_full_name": "Saisissez votre nom complet",
          "set_password": "Définir un mot de passe",
          "optional": "Facultatif",
          ...
          "invite_team_description": "Plane fonctionne mieux avec votre équipe. Invitez-la maintenant pour tirer pleinement parti de Plane.",
          ...
          "join_invites_title": "Rejoindre des invitations ou créer un espace de travail",
          ...
          "accept_invites": "Acceptez les invitations pour collaborer avec votre équipe.",
          "continue_to_workspace": "Continuer vers l’espace de travail",
          "or": "ou",
          "create_own_workspace": "Créer votre propre espace de travail",
          "workspace_creation_disabled": "Vous ne semblez avoir aucune invitation à un espace de travail et l’administrateur de votre instance a limité la création de nouveaux espaces de travail. Demandez d’abord à un propriétaire ou administrateur de vous inviter, puis revenez sur cet écran pour rejoindre.",
          "create_workspace_title": "Créez votre espace de travail",
          "enter_workspace_name": "Saisir le nom de l’espace de travail",
