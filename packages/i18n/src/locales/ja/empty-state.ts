export default {
  ...
  project: {
    work_items: {
      ...
      description: "作業項目はプロジェクトの構成要素です — 担当者の割り当て、優先度の設定、進捗の追跡が簡単に行えます。",
      cta_primary: "最初の作業項目を作成",
    },
    cycles: {
      title: "サイクルで作業をグループ化してタイムボックス化します。",
      description: "作業をタイムボックスで区切り、プロジェクトの締め切りから逆算して日付を設定し、チームとして具体的な進捗を達成します。",
    ...
    views: {
      ...
      description: "ビューは保存されたフィルターで、最も頻繁に使用する情報に素早くアクセスできます。チームメイトがビューを共有し、それぞれのニーズに合わせて調整することで、簡単に協力できます。",
      cta_primary: "ビューを作成",
    },
    ...
    pages: {
      ...
      description: "ページを使用すると、情報を1か所でキャプチャして整理できます。会議のメモ、プロジェクトドキュメント、PRDを作成し、作業項目を埋め込み、すぐに使えるコンポーネントで構造化します。",
  ...
  workspace: {
    archive_work_items: {
      ...
      description: "手動または自動化により、完了またはキャンセルされた作業項目をアーカイブできます。アーカイブされると、ここで見つけられます。",
      cta_primary: "自動化を設定",
    },
    archive_cycles: {
      title: "アーカイブされたサイクルはまだありません",
      description: "プロジェクトを整理するために、完了したサイクルをアーカイブします。アーカイブされると、ここで見つけられます。",
    },
    archive_modules: {
      title: "アーカイブされたモジュールはまだありません",
      description: "プロジェクトを整理するために、完了またはキャンセルされたモジュールをアーカイブします。アーカイブされると、ここで見つけられます。",
    },
