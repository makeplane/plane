...
export default {
  ...
  project_id: "プロジェクトID",
  project_id_tooltip_content: "プロジェクト内の作業項目を一意に識別するのに役立ちます。最大50文字。",
  ...
  project_id_max_char: "プロジェクトIDは最大{max}文字までです",
...
ラベル別の作業内訳を確認できます。`,
  ...
  bulk_operations: {
    ...
    workflows: {
      toggle: {
        title: "ワークフローを有効化",
        description: "ワークアイテムの移動を制御するためのワークフローを設定します",
        no_states_tooltip: "ワークフローに状態が追加されていません。",
        toast: {
          loading: {
            enabling: "ワークフローを有効化しています",
            disabling: "ワークフローを無効化しています",
          },
          success: {
            title: "成功！",
            message: "ワークフローが正常に有効化されました。",
          },
          error: {
            title: "エラー！",
            message: "ワークフローを有効化できませんでした。もう一度お試しください。",
          },
        },
      },
      heading: "ワークフロー",
      description:
        "作業項目の遷移を自動化し、タスクがプロジェクトのパイプラインをどのように進むかを制御するルールを設定します。",
      add_button: "新しいワークフローを追加",
      search: "ワークフローを検索",
      detail: {
        define: "ワークフローを定義",
        add_states: "状態を追加",
        unmapped_states: {
          title: "未マッピングの状態が検出されました",
          description: "選択したタイプの一部の作業項目は、現在このワークフローに存在しない状態にあります。",
          note: "このワークフローを有効にすると、それらの項目はこのワークフローの初期状態に自動的に移動します。",
          label: "不足している状態",
          tooltip:
            "一部の作業項目は、このワークフローにマッピングされていない状態にあります。確認するにはワークフローを開いてください。",
        },
      },
      select_states: {
        empty_state: {
          title: "すべての状態が使用中です",
          description: "このプロジェクトで定義されているすべての状態は、すでに現在のワークフローに含まれています。",
        },
      },
      default_footer: {
        fallback_message: "このワークフローは、どのワークフローにも割り当てられていない作業項目タイプに適用されます。",
      },
      create: {
        heading: "新しいワークフローを作成",
      },
    },
  },
  work_item_types: {
  ...
  oauth_bridge_integration: {
    name: "OAuth Bridge",
    description: "外部IdPトークンをAPI アクセス用に検証します。",
    header_description: "IdP（Azure AD、Oktaなど）から発行されたOIDC/JWTトークンをPlane APIアクセス用に検証します。",
    connected: "接続済み",
    connect: "接続",
    uninstall: "アンインストール",
    uninstalling: "アンインストール中...",
    install_success: "OAuth Bridgeが正常にインストールされました。",
    install_error: "OAuth Bridgeのインストールに失敗しました。",
    uninstall_success: "OAuth Bridgeがアンインストールされました。",
    uninstall_error: "OAuth Bridgeのアンインストールに失敗しました。",
    token_providers: "トークンプロバイダー",
    token_providers_description: "JWTがAPI資格情報として受け入れられる外部IdPを設定します。",
    ...
    no_providers_description: "外部トークン認証を有効にするにはIdPを追加してください。",
    provider_updated: "プロバイダーが更新されました。",
    provider_added: "プロバイダーが追加されました。",
    provider_save_error: "プロバイダーの保存に失敗しました。",
    provider_deleted: "プロバイダーが削除されました。",
    provider_delete_error: "プロバイダーの削除に失敗しました。",
    provider_update_error: "プロバイダーの更新に失敗しました。",
    jwks_reachable: "JWKS到達可能",
    jwks_unreachable: "JWKS到達不可",
    jwks_test_error: "設定されたURLからJWKSを取得できませんでした。",
    provider_form: {
      name_label: "名前",
      name_placeholder: "例: Azure AD Production",
      name_description: "このIDプロバイダーの表示名",
      name_required: "名前は必須です。",
      issuer_label: "発行者",
      issuer_placeholder: "https://login.microsoftonline.com/tenant-id/v2.0",
      issuer_description: "JWTで期待されるissクレームの値",
      issuer_required: "発行者は必須です。",
      jwks_url_label: "JWKS URL",
      jwks_url_placeholder: "https://login.microsoftonline.com/tenant-id/discovery/v2.0/keys",
      jwks_url_description: "プロバイダーのJSON Web Key Setを提供するHTTPSエンドポイント",
      jwks_url_required: "JWKS URLは必須です。",
      jwks_url_https: "JWKS URLはHTTPSを使用する必要があります。",
      audience_label: "オーディエンス",
      audience_placeholder: "api://my-app-id",
      audience_description: "JWTで期待されるaudクレーム（カンマ区切り）。",
      user_claims_label: "ユーザークレーム",
      user_claims_placeholder: "email",
      user_claims_description: "ユーザーのメールアドレスを含むJWTクレーム",
      user_claims_required: "ユーザークレームは必須です。",
      allowed_algorithms_label: "許可された署名アルゴリズム",
      allowed_algorithms_description: "JWT署名検証に使用される非対称アルゴリズム",
      allowed_algorithms_required: "少なくとも1つのアルゴリズムが必要です。",
      select_algorithms: "アルゴリズムを選択",
      jwks_cache_ttl_label: "JWKSキャッシュTTL（秒）",
      jwks_cache_ttl_description: "プロバイダーのJWKSキーをキャッシュする期間（最小60秒、デフォルト24時間）",
      jwks_cache_ttl_min: "キャッシュTTLは60秒以上である必要があります。",
      rate_limit_label: "レート制限",
      rate_limit_placeholder: "120/minute",
      rate_limit_description:
        "リクエスト制限（例: 120/minute）。デフォルトのレート制限を使用する場合は空欄にしてください。",
...
• タスクとコメントの作成：音声コマンドでタスク、説明、コメントを追加できます。`,
  ...
  automations: {
    ...
    trigger: {
      ...
      section_plane_events: "Planeイベント",
  ...
  page_actions: {
    move_page: {
      placeholders: {
        project_to_all_with_wiki: "Wiki コレクション、プロジェクト、チームスペースを検索",
        project_to_project_with_wiki: "Wiki コレクションとプロジェクトを検索",
        teamspace_to_all_with_wiki: "Wiki コレクション、プロジェクト、チームスペースを検索",
      },
      toasts: {
        collection_error: {
          title: "Wiki に移動しました",
          message:
            "ページは Wiki に移動されましたが、選択したコレクションに追加できませんでした。ページは General に残ります。",
        },
      },
    },
    remove_from_collection: {
      label: "コレクションから削除",
      success_message: "ページをコレクションから削除しました。",
      error_message: "ページをコレクションから削除できませんでした。もう一度お試しください。",
    },
  },
  wiki_collections: {
    predefined: {
    ...
    fallback_name: "コレクション",
    form: {
      name_required: "コレクション名は必須です",
      name_max_length: "コレクション名は255文字未満である必要があります",
      name_placeholder_create: "コレクションにタイトルを付けてください",
      name_placeholder_edit: "コレクション名",
    },
    create_modal: {
      title: "コレクションを作成",
      submit: "コレクションを作成",
    ...
    delete_modal: {
      title: "コレクションを削除",
      page_count: "このコレクションには {pageCount} 件のページがあります。どうするか選択してください。",
      transfer_title: "ページを移動してコレクションを削除",
      transfer_description: "削除する前に、すべてのページを別のコレクションへ移動します。ページと権限は保持されます。",
      transfer_warning: "移動したページは、選択したコレクションの権限を引き継ぎます。",
      transfer_target_label: "ページの移動先",
      transfer_target_placeholder: "コレクションを選択",
      delete_with_pages_title: "ページごとコレクションを削除",
      delete_with_pages_description: "コレクションとすべてのページを完全に削除します。この操作は元に戻せません。",
      submit: "コレクションを削除",
    },
    header: {
      add_page: "ページを追加",
    ...
    add_existing_page_modal: {
      ...
      success_message: "{count} 件のページをコレクションに追加しました。",
      error_message: "ページを移動できませんでした。もう一度お試しください。",
      no_pages_found: "検索条件に一致するページが見つかりません",
      no_pages_available: "移動できるページがありません",
      submit: "移動",
    },
    list: {
      invite_only: "招待制",
      remove_error: "ページをコレクションから削除できませんでした。",
      no_matching_pages: "一致するページがありません",
      remove_search_criteria: "検索条件を削除するとすべてのページが表示されます",
      remove_filters: "フィルターを削除するとすべてのページが表示されます",
      no_pages_title: "まだページがありません",
      no_pages_description: "このコレクションにはまだページがありません。",
      untitled: "無題",
      restricted_access: "アクセス制限あり",
      collapse_page: "ページを折りたたむ",
      expand_page: "ページを展開",
      page_actions: "ページ操作",
      page_link_copied: "ページリンクをクリップボードにコピーしました。",
      columns: {
        page_name: "ページ名",
        owner: "所有者",
        nested_pages: "ネストされたページ",
    ...
    toasts: {
      ...
      create_error: "コレクションを作成できませんでした。もう一度お試しください。",
      renamed: "コレクション名を変更しました。",
      rename_error: "コレクションを更新できませんでした。もう一度お試しください。",
      transferred_deleted: "ページを移動し、コレクションを削除しました。",
      deleted_with_pages: "コレクションとそのページを削除しました。",
      delete_error: "コレクションを削除できませんでした。もう一度お試しください。",
      target_required: "ページの移動先となるコレクションを選択してください。",
      create_page_error: "ページを作成できませんでした。もう一度お試しください。",
      create_page_in_collection_error:
        "ページを作成するか、コレクションに追加できませんでした。もう一度お試しください。",
      collection_link_copied: "コレクションリンクをクリップボードにコピーしました。",
    },
  },
} as const;
