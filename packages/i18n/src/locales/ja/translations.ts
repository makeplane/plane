...
export default {
  ...
  localized_ui: {
    ...
    editor: {
      ...
      text: "文章",
      enter_text_to_display: "表示するテキストを入力してください",
      remove_link: "リンクを削除する",
      edit_link: "リンクを編集",
      color: "色",
      text_colors: "文字の色",
      background_colors: "背景色",
      link: "リンク",
      enter_or_paste_link: "リンクを入力または貼り付けます",
      please_enter_valid_url: "有効な URL を入力してください",
      delete: "消去",
      duplicate: "重複",
      multiple: "複数",
      loading: "読み込み中",
      no_results: "結果はありません",
      copy_code: "コードをコピーする",
      add_an_image: "画像を追加する",
      error_loading_image: "画像の読み込みエラー",
      uploading: "アップロード中",
      drop_image_here: "ここに画像をドロップ",
      retry_duplication: "重複を再試行する",
      retry: "リトライ",
      no_emojis_found: "絵文字が見つかりませんでした",
      fullscreen_image_viewer: "全画面画像ビューア",
      close_image_viewer: "画像ビューアを閉じる",
      zoom_out: "ズームアウト",
      zoom_in: "ズームイン",
      download_image: "画像をダウンロード",
      open_image_in_new_tab: "新しいタブで画像を開く",
      view_in_full_screen: "全画面で表示する",
      view_image_in_full_screen: "画像を全画面で表示する",
      align: "整列",
      download: "ダウンロード",
      clear_contents: "クリアコンテンツ",
      insert_above: "上に挿入",
      insert_below: "以下に挿入",
      insert_left: "左に挿入",
      insert_right: "右に挿入",
    ...
    workspace_invitation: {
      invitation_not_found: "招待状が見つかりません",
      invited_to_workspace: "{workspaceName} に招待されました",
      description:
        "ワークスペースは、Plane アカウントでプロジェクトを作成し、作業項目で共同作業し、さまざまな作業ストリームを整理する場所です。",
      accept: "受け入れる",
      ignore: "無視する",
      already_member: "あなたはすでに {workspaceName} のメンバーです",
      continue_to_home: "家に帰る",
      inactive_title: "この招待リンクはもうアクティブではありません。",
      empty_project_link: "または空のプロジェクトから開始します",
      sign_in_to_continue: "続行するにはサインインしてください",
      star_on_github: "GitHub でスターを付けてください",
      join_community: "アクティブなクリエイターのコミュニティに参加しましょう",
    },
    space_auth: {
      email: "電子メール",
      ...
      continue: "続く",
      go_to_workspace: "ワークスペースに移動",
      sign_in_with_unique_code: "固有のコードでサインインする",
      create_account: "アカウントを作成する",
      unique_code: "固有のコード",
      paste_code_sent: "メールに送信されたコードを貼り付けます",
      resend_in: "{seconds}sで再送信",
      requesting_new_code: "新しいコードをリクエストする",
      resend: "再送信",
      sending_code: "コードの送信",
    },
    onboarding: {
      create_profile_title: "プロフィールを作成します。",
      create_profile_description: "これがPlaneに登場する様子です。",
      change_image: "イメージを変更する",
      upload_image: "画像をアップロードする",
      name: "名前",
      name_required: "名前は必須です",
      name_within_50: "名前は50文字以内にしてください。",
      ...
      continue: "続く",
      invite_team_title: "チームメイトを招待する",
      invite_team_description:
        "Plane での作業は、チームと一緒に行うのが最も効果的です。今すぐ彼らを招待して、Plane の可能性を最大限に活用してください。",
      invalid_email: "それは電子メールアドレスのようには見えません。",
      success: "成功！",
      invitations_sent: "招待状は正常に送信されました。",
      error: "エラー！",
      add_another: "別のを追加",
      do_later: "後でやります",
      join_invites_title: "招待に参加するか、ワークスペースを作成する",
      unified_description: "すべての作業を統合します。",
      create_new_workspace: "新しいワークスペースを作成する",
      no_invitations_found: "招待状が見つかりませんでした",
      you_are_invited: "あなたは招待されています！",
      accept_invites: "チームと共同作業するための招待を受け入れます。",
      continue_to_workspace: "ワークスペースに進む",
      or: "または",
      create_own_workspace: "独自のワークスペースを作成する",
      workspace_creation_disabled:
        "ワークスペースへの招待がなく、インスタンス管理者によって新しいワークスペースの作成が制限されているようです。まずワークスペースに招待するようワークスペースの所有者または管理者に依頼してから、この画面に戻って参加してください。",
      create_workspace_title: "ワークスペースを作成する",
      enter_workspace_name: "ワークスペース名を入力してください",
      join_existing_workspace: "既存のワークスペースに参加する",
      profile_setup_completed: "プロファイルの設定が完了しました。",
      profile_setup_failed: "プロファイルのセットアップに失敗しました。",
      usecase_title: "Planeをどのように使用する予定ですか?",
      usecase_description: "エクスペリエンスをパーソナライズできるように、1 つ以上のオプションを選択してください。",
      select_one_or_more: "1 つ以上を選択してください",
      select_at_least_one: "少なくとも 1 つのオプションを選択してください。",
      skip: "スキップ",
    },
    inbox: {
      ...
      errors: {
        asset_upload_failed: "アセットのアップロードに失敗しました。後でもう一度試してください。",
        asset_duplication_failed: "アセットの複製に失敗しました。後でもう一度試してください。",
        permission_denied: "許可が拒否されました",
        mark_duplicate_permission: "プロジェクト管理者のみが作業項目を重複としてマークできます",
        mark_duplicate_permission_plural: "プロジェクト管理者のみが作業項目を重複としてマークできます",
      },
      filters: {
        created_date: "作成日",
        updated_date: "更新日",
      ...
      sidebar: {
        label_count: "{count} ラベル",
      },
      toasts: {
        editor_processing: "エディターはまだ変更を処理中です。続行する前にお待ちください。",
        create_success: "作業項目が正常に作成されました。",
        delete_failed: "作業項目の削除に失敗しました",
        update_failed: "作業項目の更新に失敗しました",
      },
    },
    space_public: {
      error_description_prefix:
        "Plane がクラッシュしました。担当エンジニアには通知済みです。追加の詳細がある場合は、次までご連絡ください",
      error_description_middle: "または次の場所で",
      not_found_hint: "ブラウザーのアドレスバーに入力した URL を確認して、もう一度お試しください。",
      logged_in_hint:
        "表示したいビューまたはページの公開共有 URL もしくはリンクをブラウザーのアドレスバーに入力してください。",
      oauth_with_provider: "{provider} で{action}",
      auth: {
        sign_in_header: "投票またはコメントするにはサインインしてください",
        sign_in_subheader: "実装してほしい機能を後押ししましょう。",
        sign_up_header: "表示、コメント、さらに多くの操作",
        sign_up_subheader: "Plane の作業項目とページを扱うには、登録またはサインインしてください。",
      },
      peek: {
        side: "サイドピーク",
        modal: "モーダル",
      ...
      bot_name: "{name} ボット",
      commented_time: "{time}にコメント",
      and_more: "他 {count} 件",
      no_upvotes_yet: "賛成票はまだありません",
      no_downvotes_yet: "反対票はまだありません",
      modules_count: "{count} 個のモジュール",
      labels_count: "{count} 個のラベル",
      page_not_found_alt: "ページが見つかりません",
      something_went_wrong: "問題が発生しました。",
      page_not_found_description: "お探しのページは存在しないか、移動されました。",
      instance_failure_image_alt: "インスタンスの詳細を取得できません",
      instance_failure_title: "インスタンスの詳細を取得できません。",
      instance_failure_description: "インスタンスの詳細を読み込めませんでした。",
      instance_failure_hint: "接続を確認して、もう一度お試しください。",
      powered_by: "提供元",
      sign_in_to_add_comment: "コメントを追加するにはサインインしてください",
      link_copied: "リンクをコピーしました。",
      work_item_link_copied: "作業項目のリンクをクリップボードにコピーしました。",
      comment_post_error: "コメントを投稿できませんでした。もう一度お試しください。",
      add_comment: "コメントを追加",
      public_board_not_found: "公開ボードが存在しません。URL を確認してください。",
      no_work_items_found: "作業項目が見つかりません",
      error_title: "問題が発生しました。",
      refresh: "再読み込み",
      forum: "フォーラム",
      not_found_title: "うまくいきませんでした",
      user_already_logged_in: "ユーザーはすでにログインしています",
      logged_in_title: "あと 1 ステップです。",
      by_creating_account: "アカウントを作成すると",
      by_signing_in: "サインインすると",
      you_agree_to_our: "以下に同意したことになります",
