...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      something_went_wrong: "おっと！何か問題が発生しました。",
      ...
      instance_failure_description: "インスタンスの詳細をロードできませんでした。",
      instance_failure_hint: "接続を確認して、もう一度試してください。",
      retry: "リトライ",
      powered_by: "搭載",
      sign_in_to_add_comment: "コメントを追加するにはサインインしてください",
      sign_in: "サインイン",
      link_copied: "リンクがコピーされました!",
      work_item_link_copied: "作業項目のリンクがクリップボードにコピーされました。",
      comment_post_error: "コメントの投稿に失敗しました。もう一度試してください。",
      add_comment: "コメントを追加",
      public_board_not_found: "公開掲示板は存在しません。 URLをご確認ください。",
