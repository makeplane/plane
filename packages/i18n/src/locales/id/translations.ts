...
export default {
  ...
  localized_ui: {
    ...
    editor: {
      ...
      text: "Teks",
      enter_text_to_display: "Masukkan teks untuk ditampilkan",
      remove_link: "Hapus tautan",
      edit_link: "Sunting tautan",
      color: "Warna",
      text_colors: "Warna teks",
      background_colors: "Warna latar belakang",
      link: "Link",
      enter_or_paste_link: "Masukkan atau tempel tautan",
      please_enter_valid_url: "Silakan masukkan URL yang valid",
      delete: "Menghapus",
      duplicate: "Duplikat",
      multiple: "Banyak",
      loading: "Memuat",
      ...
      add_an_image: "Tambahkan gambar",
      error_loading_image: "Terjadi kesalahan saat memuat gambar",
      uploading: "Mengunggah",
      drop_image_here: "Jatuhkan gambar di sini",
      retry_duplication: "Coba lagi duplikasi",
      retry: "Mencoba kembali",
      no_emojis_found: "Tidak ada emoji yang ditemukan",
      fullscreen_image_viewer: "Penampil gambar layar penuh",
      close_image_viewer: "Tutup penampil gambar",
      zoom_out: "Perkecil",
      zoom_in: "Perbesar",
      download_image: "Unduh gambar",
      open_image_in_new_tab: "Buka gambar di tab baru",
      view_in_full_screen: "Lihat dalam layar penuh",
      view_image_in_full_screen: "Lihat gambar dalam layar penuh",
      align: "Meluruskan",
      download: "Unduh",
      clear_contents: "Hapus isinya",
      insert_above: "Sisipkan di atas",
      insert_below: "Sisipkan di bawah",
      insert_left: "Sisipkan ke kiri",
      insert_right: "Masukkan ke kanan",
      header_row: "Baris tajuk",
      header_column: "Kolom tajuk",
      alignment: {
        left: "Kiri",
        center: "Tengah",
        right: "Benar",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "Anda telah diundang ke {workspaceName}",
      description:
        "Ruang kerja Anda adalah tempat Anda membuat proyek, berkolaborasi pada item pekerjaan Anda, dan mengatur berbagai aliran pekerjaan di akun Plane Anda.",
      accept: "Menerima",
      ignore: "Mengabaikan",
      already_member: "Anda sudah menjadi anggota {workspaceName}",
      continue_to_home: "Lanjutkan ke rumah",
      inactive_title: "Tautan undangan ini sudah tidak aktif lagi.",
      empty_project_link: "Atau mulai dari proyek kosong",
      sign_in_to_continue: "Masuk untuk melanjutkan",
      star_on_github: "Bintangi kami di GitHub",
      join_community: "Bergabunglah dengan komunitas pembuat konten aktif kami",
    },
    space_auth: {
      email: "E-mail",
      ...
      paste_code_sent: "Tempelkan kode yang dikirimkan ke email Anda",
      resend_in: "Kirim ulang dalam {seconds}s",
      requesting_new_code: "Meminta kode baru",
      resend: "Kirim ulang",
      sending_code: "Mengirim kode",
    },
    onboarding: {
      create_profile_title: "Buat profil Anda.",
      create_profile_description: "Ini adalah tampilan Anda di Plane.",
      change_image: "Ubah gambar",
      upload_image: "Unggah gambar",
      name: "Nama",
      name_required: "Nama wajib diisi",
      name_within_50: "Nama harus dalam 50 karakter.",
      ...
      continue: "Melanjutkan",
      invite_team_title: "Undang rekan satu tim Anda",
      invite_team_description:
        "Pekerjaan di Plane paling baik dilakukan bersama tim Anda. Undang mereka sekarang untuk menggunakan Plane semaksimal mungkin.",
      invalid_email: "Itu tidak terlihat seperti alamat email.",
      success: "Kesuksesan!",
      invitations_sent: "Undangan berhasil dikirim.",
      error: "Kesalahan!",
      add_another: "Tambahkan yang lain",
      do_later: "Saya akan melakukannya nanti",
      join_invites_title: "Bergabunglah dengan undangan atau buat ruang kerja",
      unified_description: "Semua pekerjaan Anda — terpadu.",
      create_new_workspace: "Buat ruang kerja baru",
      no_invitations_found: "Tidak ada undangan yang ditemukan",
      you_are_invited: "Anda diundang!",
      accept_invites: "Terima undangan untuk berkolaborasi dengan tim Anda.",
      continue_to_workspace: "Lanjutkan ke ruang kerja",
      or: "atau",
      create_own_workspace: "Buat ruang kerja Anda sendiri",
      workspace_creation_disabled:
        "Tampaknya Anda tidak mendapat undangan apa pun ke ruang kerja dan admin instans Anda telah membatasi pembuatan ruang kerja baru. Silakan minta pemilik atau admin ruang kerja untuk mengundang Anda ke ruang kerja terlebih dahulu dan kembali ke layar ini untuk bergabung.",
      create_workspace_title: "Ciptakan ruang kerja Anda",
      enter_workspace_name: "Masukkan nama ruang kerja",
      join_existing_workspace: "Bergabunglah dengan ruang kerja yang ada",
      profile_setup_completed: "Penyiapan profil selesai.",
      profile_setup_failed: "Penyiapan profil gagal.",
      usecase_title: "Bagaimana Anda berencana menggunakan Plane?",
      usecase_description: "Pilih satu atau lebih opsi sehingga kami dapat mempersonalisasi pengalaman Anda.",
      select_one_or_more: "Pilih satu atau lebih",
      select_at_least_one: "Pilih setidaknya satu opsi.",
      skip: "Melewati",
    },
    inbox: {
      ...
      errors: {
        ...
        asset_duplication_failed: "Duplikasi aset gagal. Silakan coba lagi nanti.",
        permission_denied: "Izin ditolak",
        mark_duplicate_permission: "Hanya admin proyek yang dapat menandai item pekerjaan sebagai duplikat",
        mark_duplicate_permission_plural: "Hanya admin proyek yang dapat menandai item pekerjaan sebagai duplikat",
      },
      filters: {
        created_date: "Tanggal dibuat",
        updated_date: "Tanggal diperbarui",
        last_updated_date: "Tanggal terakhir diperbarui",
        status: "Status",
        work_item_status: "Status item pekerjaan",
        view_all: "Lihat semuanya",
      ...
      navigation: {
        previous_work_item: "Item pekerjaan sebelumnya",
        next_work_item: "Item pekerjaan berikutnya",
      },
      properties: {
        duplicate_of: "Duplikat dari",
      },
      select_duplicate: {
        select_work_item: "Pilih item pekerjaan",
      },
      sidebar: {
        label_count: "label {count}",
      },
      toasts: {
        editor_processing: "Editor masih memproses perubahan. Harap tunggu sebelum melanjutkan.",
        create_success: "Item pekerjaan berhasil dibuat.",
        delete_failed: "Penghapusan item pekerjaan gagal",
        update_failed: "Pembaruan item pekerjaan gagal",
      },
    },
    space_public: {
      error_description_prefix:
        "Plane mengalami crash. Teknisi kami telah diberi tahu. Jika Anda memiliki detail tambahan, silakan tulis ke",
      error_description_middle: "atau di",
      not_found_hint: "Periksa URL di bilah alamat browser lalu coba lagi.",
      logged_in_hint:
        "Masukkan URL berbagi publik atau tautan tampilan maupun Halaman yang ingin Anda lihat di bilah alamat browser.",
      oauth_with_provider: "{action} dengan {provider}",
      auth: {
        sign_in_header: "Masuk untuk memberi suara atau berkomentar",
        sign_in_subheader: "Bantu mendorong fitur yang ingin Anda lihat dibangun.",
        sign_up_header: "Lihat, komentari, dan lakukan lebih banyak",
        sign_up_subheader: "Daftar atau masuk untuk bekerja dengan item kerja dan Halaman Plane.",
      },
      peek: {
        side: "Pratinjau Samping",
        modal: "Modal",
        full_screen: "Layar Penuh",
      },
      bot_name: "Bot {name}",
      commented_time: "berkomentar {time}",
      and_more: "dan {count} lainnya",
      no_upvotes_yet: "Belum ada suara positif",
      no_downvotes_yet: "Belum ada suara negatif",
      modules_count: "{count} Modul",
      labels_count: "{count} Label",
      page_not_found_alt: "Halaman tidak ditemukan",
      something_went_wrong: "Ups! Terjadi kesalahan.",
      page_not_found_description: "Halaman yang Anda cari tidak ada atau telah dipindahkan.",
      instance_failure_image_alt: "Tidak dapat mengambil detail instans",
      instance_failure_title: "Tidak dapat mengambil detail instans.",
      instance_failure_description: "Kami tidak dapat memuat detail instans Anda.",
      instance_failure_hint: "Periksa koneksi Anda lalu coba lagi.",
      powered_by: "Didukung oleh",
      sign_in_to_add_comment: "Masuk untuk menambahkan komentar",
      link_copied: "Tautan disalin!",
      work_item_link_copied: "Tautan item kerja disalin ke papan klip.",
      comment_post_error: "Gagal mengirim komentar. Silakan coba lagi.",
      add_comment: "Tambahkan komentar",
      public_board_not_found: "Papan publik tidak ada. Periksa URL.",
      no_work_items_found: "Tidak ada item kerja yang ditemukan",
      error_title: "Ups! Ini tidak terlihat baik.",
      refresh: "Muat ulang",
      forum: "Forum",
      not_found_title: "Itu tidak berhasil",
      user_already_logged_in: "Pengguna sudah masuk",
      logged_in_title: "Bagus! Tinggal satu langkah lagi.",
      by_creating_account: "Dengan membuat akun",
      by_signing_in: "Dengan masuk",
      you_agree_to_our: "Anda menyetujui",
      ...
      no_matches_found: "Tidak ada hasil yang cocok",
      no_date: "Tanpa Tanggal",
      no_cycle: "Tanpa Siklus",
      no_modules: "Tanpa Modul",
      no_assignees: "Tanpa Penanggung Jawab",
