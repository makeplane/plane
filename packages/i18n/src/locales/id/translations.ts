...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      something_went_wrong: "Ups! Ada yang tidak beres.",
      page_not_found_description: "Halaman yang dicari tidak ada atau sudah dipindahkan.",
      instance_failure_image_alt: "Tidak dapat mengambil detail instance",
      ...
      instance_failure_hint: "Silakan periksa koneksi Anda dan coba lagi.",
      retry: "Mencoba kembali",
      ...
      public_board_not_found: "Badan publik tidak ada. Silakan periksa URL.",
      no_work_items_found: "Tidak ada item pekerjaan yang ditemukan",
