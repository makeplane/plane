export default {
  ...
  "auth": {
    ...
    "forgot_password": {
      ...
      "description": "Masukkan alamat email akun anda yang telah diverifikasi dan kami akan mengirimkan link reset password.",
      "email_sent": "Kami telah mengirim link reset ke alamat email anda",
      "send_reset_link": "Kirim link reset",
      "errors": {
        "smtp_not_enabled": "Kami melihat bahwa admin anda belum mengaktifkan SMTP, kami tidak dapat mengirimkan link reset password"
      },
      "toast": {
        "success": {
          "title": "Email terkirim",
          "message": "Periksa inbox anda untuk link reset password. Jika tidak muncul dalam beberapa menit, periksa folder spam."
        },
        "error": {
          "title": "Error!",
          "message": "Terjadi kesalahan. Silakan coba lagi."
  ...
  "deactivate_account_description": "Saat menonaktifkan akun, semua data dan sumber daya dalam akun tersebut akan dihapus secara permanen dan tidak dapat dipulihkan.",
  ...
  "stay_in_the_loop_on_issues_you_are_subscribed_to_enable_this_to_get_notified": "Tetap terupdate tentang item kerja yang Anda langgani. Aktifkan ini untuk mendapatkan notifikasi.",
  ...
  "property_changes_description": "Beri tahu saya ketika properti item kerja seperti penugasannya, prioritas, estimasi, atau hal lainnya berubah.",
  ...
  "active_cycles_description": "Pantau siklus di seluruh proyek, lacak item kerja prioritas tinggi, dan fokus pada siklus yang membutuhkan perhatian.",
  ...
  "10000_feet_view_description": "Perbesar untuk melihat siklus yang berjalan di seluruh proyek Anda sekaligus, bukan berpindah dari Siklus ke Siklus di setiap proyek.",
  "get_snapshot_of_each_active_cycle": "Dapatkan snapshot dari setiap siklus aktif.",
  "get_snapshot_of_each_active_cycle_description": "Lacak metrik tingkat tinggi untuk semua siklus aktif, lihat kemajuan mereka, dan dapatkan gambaran tentang ruang lingkup terhadap tenggat waktu.",
  "compare_burndowns": "Bandingkan burndown.",
  "compare_burndowns_description": "Pantau bagaimana kinerja setiap tim Anda dengan melihat laporan burndown masing-masing siklus.",
  "quickly_see_make_or_break_issues": "Lihat dengan cepat item kerja yang krusial.",
  "quickly_see_make_or_break_issues_description": "Prabaca item kerja prioritas tinggi untuk setiap siklus terhadap tanggal jatuh tempo. Lihat semuanya per siklus hanya dengan satu klik.",
  "zoom_into_cycles_that_need_attention": "Perbesar siklus yang membutuhkan perhatian.",
  "zoom_into_cycles_that_need_attention_description": "Selidiki status siklus mana pun yang tidak sesuai dengan harapan dengan satu klik.",
  "stay_ahead_of_blockers": "Tetap di depan penghambat.",
  "stay_ahead_of_blockers_description": "Identifikasi tantangan dari satu proyek ke proyek lainnya dan lihat ketergantungan antar siklus yang tidak terlihat dari tampilan lain mana pun.",
  "analytics": "Analitik",
  ...
  "project_id_tooltip_content": "Membantu Anda mengidentifikasi item kerja dalam proyek secara unik. Maksimal 5 karakter.",
  ...
  "please_select_at_least_one_invitation_description": "Silakan pilih setidaknya satu undangan untuk bergabung dengan ruang kerja.",
  "we_see_that_someone_has_invited_you_to_join_a_workspace": "Kami melihat bahwa seseorang telah mengundang Anda untuk bergabung dengan ruang kerja",
  "join_a_workspace": "Bergabunglah dengan ruang kerja",
  "we_see_that_someone_has_invited_you_to_join_a_workspace_description": "Kami melihat bahwa seseorang telah mengundang Anda untuk bergabung dengan ruang kerja",
  ...
  "you_can_see_here_if_someone_invites_you_to_a_workspace": "Anda dapat melihat di sini jika seseorang mengundang Anda untuk bergabung dengan ruang kerja",
  "back_to_home": "Kembali ke beranda",
  "workspace_name": "nama-ruang-kerja",
  "deactivate_your_account": "Nonaktifkan akun Anda",
  "deactivate_your_account_description": "Setelah dinonaktifkan, Anda tidak akan dapat ditugaskan item kerja dan ditagih untuk ruang kerja Anda. Untuk mengaktifkan kembali akun Anda, Anda akan memerlukan undangan ke ruang kerja di alamat email ini.",
  ...
  "issue": {
    ...
    "archive": {
      ...
      "confirm_message": "Apakah Anda yakin ingin mengarsipkan item kerja ini? Semua item kerja yang diarsipkan dapat dipulihkan nanti.",
      "success": {
  ...
  "inbox_issue": {
    ...
    "empty_state": {
      ...
      "sidebar_filter": {
        ...
        "description": "Tidak ada item kerja yang cocok dengan filter yang diterapkan dalam pendapat. Buat item kerja baru."
      },
      "detail": {
  ...
  "workspace_creation": {
    ...
    "errors": {
      "creation_disabled": {
        ...
        "description": "Jika Anda tahu alamat email admin instansi Anda, klik tombol di bawah ini untuk menghubungi mereka.",
  ...
  "workspace_dashboard": {
    "empty_state": {
      "general": {
        ...
        "description": "Selamat datang di Plane, kami sangat senang memiliki Anda di sini. Buat proyek pertama Anda dan lacak item kerja Anda, dan halaman ini akan berubah menjadi ruang yang membantu Anda berkembang. Admin juga akan melihat item yang membantu tim mereka berkembang.",
        "primary_button": {
  ...
  "workspace_analytics": {
    ...
    "empty_state": {
      ...
      "general": {
        ...
        "description": "Lihat lingkup versus permintaan, perkiraan, dan perluasan lingkup. Dapatkan kinerja berdasarkan anggota tim dan tim, dan pastikan proyek Anda berjalan tepat waktu.",
        "primary_button": {
  ...
  "workspace_projects": {
    ...
    "empty_state": {
      "general": {
        ...
        "description": "Anggap setiap proyek sebagai induk untuk pekerjaan yang terarah pada tujuan. Proyek adalah tempat di mana Pekerjaan, Siklus, dan Modul tinggal dan, bersama rekan-rekan Anda, membantu Anda mencapai tujuan tersebut. Buat proyek baru atau filter untuk proyek yang diarsipkan.",
        "primary_button": {
          "text": "Mulai proyek pertama Anda",
          "comic": {
            "title": "Segalanya dimulai dengan proyek di Plane",
      ...
      "no_projects": {
        ...
        "description": "Untuk membuat item kerja atau mengelola pekerjaan Anda, Anda perlu membuat proyek atau menjadi bagian dari salah satunya.",
        "primary_button": {
          "text": "Mulai proyek pertama Anda",
          "comic": {
            "title": "Segalanya dimulai dengan proyek di Plane",
  ...
  "workspace_views": {
    ...
    "empty_state": {
      "all-issues": {
        ...
        "description": "Proyek pertama sudah selesai! Sekarang, bagi pekerjaan Anda menjadi bagian yang dapat dilacak dengan item kerja. Mari kita mulai!",
        "primary_button": {
  ...
  "workspace_settings": {
    ...
    "copy_key": "Salin dan simpan kunci rahasia ini di Halaman Plane. Anda tidak dapat melihat kunci ini setelah Anda menekan Tutup. File CSV yang berisi kunci telah diunduh.",
    ...
    "settings": {
      "general": {
        ...
        "delete_workspace_description": "Ketika menghapus ruang kerja, semua data dan sumber daya di dalam ruang kerja tersebut akan dihapus secara permanen dan tidak dapat dipulihkan.",
        "delete_btn": "Hapus ruang kerja ini",
        "delete_modal": {
          "title": "Apakah Anda yakin ingin menghapus ruang kerja ini?",
          "description": "Anda memiliki percobaan aktif untuk salah satu rencana berbayar kami. Silakan batalkan terlebih dahulu untuk melanjutkan.",
          "dismiss": "Tutup",
      ...
      "members": {
        ...
        "leave_confirmation": "Apakah Anda yakin ingin meninggalkan ruang kerja? Anda tidak akan lagi memiliki akses ke ruang kerja ini. Tindakan ini tidak dapat dibatalkan.",
        "details": {
      ...
      "api_tokens": {
        ...
        "delete": {
          ...
          "description": "Setiap aplikasi yang menggunakan token ini tidak akan memiliki akses ke data Plane. Tindakan ini tidak dapat dibatalkan.",
          "success": {
            "title": "Sukses!",
    ...
    "empty_state": {
      "api_tokens": {
        ...
        "description": "API Plane dapat digunakan untuk mengintegrasikan data Anda di Plane dengan sistem eksternal mana pun. Buat token untuk memulai."
      },
      "webhooks": {
  ...
  "profile": {
    ...
    "empty_state": {
      "activity": {
        ...
        "description": "Mulai dengan membuat item kerja baru! Tambahkan detail dan properti. Jelajahi lebih lanjut di Plane untuk melihat aktivitas Anda."
      },
      "assigned": {
  ...
  "project_settings": {
    "general": {
      ...
      "archive_project": {
        ...
        "description": "Mengarsipkan proyek akan menghapus proyek Anda dari navigasi samping meskipun Anda masih dapat mengaksesnya dari halaman proyek Anda. Anda dapat memulihkan proyek tersebut atau menghapusnya kapan saja.",
        "button": "Arsipkan proyek"
      },
      "delete_project": {
        "title": "Hapus proyek",
        "description": "Ketika menghapus proyek, semua data dan sumber daya di dalam proyek tersebut akan dihapus secara permanen dan tidak dapat dipulihkan.",
  ...
  "project_cycles": {
    ...
    "action": {
      ...
      "update": {
        ...
        "error": {
          "already_exists": "Anda sudah memiliki siklus pada tanggal yang diberikan, jika Anda ingin membuat siklus draf, Anda dapat melakukannya dengan menghapus kedua tanggal tersebut."
        }
      }
    },
    "empty_state": {
      "general": {
        ...
        "description": "Pecah pekerjaan menjadi bagian yang dibatasi waktu, kerjakan mundur dari tenggat waktu proyek Anda untuk menetapkan tanggal, dan buat kemajuan nyata sebagai tim.",
        "primary_button": {
          "text": "Tetapkan siklus pertama Anda",
          "comic": {
            "title": "Siklus adalah batas waktu berulang.",
            "description": "Sprint, iterasi, dan istilah lain apa pun yang Anda gunakan untuk pelacakan pekerjaan mingguan atau dua mingguan adalah siklus."
          }
        }
      },
      "no_issues": {
      ...
      "completed_no_issues": {
        ...
        "description": "Tidak ada item kerja dalam siklus. Item kerja baik ditransfer atau disembunyikan. Untuk melihat item kerja yang disembunyikan jika ada, perbarui properti tampilan Anda sesuai."
      },
      "active": {
        "title": "Tidak ada siklus aktif",
        "description": "Siklus aktif mencakup periode apa pun yang mencakup tanggal hari ini dalam rentangnya. Temukan kemajuan dan detail siklus aktif di sini."
      },
      "archived": {
        "title": "Belum ada siklus yang diarsipkan",
        "description": "Untuk membersihkan proyek Anda, arsipkan siklus yang telah diselesaikan. Temukan di sini setelah diarsipkan."
      }
    }
  },
  "project_issues": {
    "empty_state": {
      "no_issues": {
        ...
        "description": "Anggap item kerja sebagai pekerjaan, tugas, atau JTBD. Yang kami suka. Item kerja dan sub-item kerjanya biasanya merupakan tindakan berbasis waktu yang ditugaskan kepada anggota tim Anda. Tim Anda membuat, menetapkan, dan menyelesaikan item kerja untuk memindahkan proyek Anda menuju tujuannya.",
        "primary_button": {
          "text": "Buat item kerja pertama Anda",
          "comic": {
            "title": "Item kerja adalah blok bangunan di Plane.",
            "description": "Mendesain ulang UI Plane, Mengganti merek perusahaan, atau Meluncurkan sistem injeksi bahan bakar baru adalah contoh item kerja yang kemungkinan besar memiliki sub-item kerja."
          }
        }
      },
      "no_archived_issues": {
        "title": "Belum ada item kerja yang diarsipkan",
        "description": "Secara manual atau melalui otomatisasi, Anda dapat mengarsipkan item kerja yang telah selesai atau dibatalkan. Temukan di sini setelah diarsipkan.",
        "primary_button": {
  ...
  "project_module": {
    ...
    "empty_state": {
      ...
      "archived": {
        ...
        "description": "Untuk membersihkan proyek Anda, arsipkan modul yang telah selesai atau dibatalkan. Temukan di sini setelah diarsipkan."
      },
      "sidebar": {
  ...
  "project_views": {
    "empty_state": {
      "general": {
        ...
        "description": "Tampilan adalah sekumpulan filter yang disimpan yang Anda gunakan secara sering atau ingin akses mudah. Semua rekan Anda dalam proyek dapat melihat tampilan semua orang dan memilih yang paling sesuai dengan kebutuhan mereka.",
        "primary_button": {
          "text": "Buat tampilan pertama Anda",
          "comic": {
            "title": "Tampilan bekerja berdasarkan properti item kerja.",
            "description": "Anda dapat membuat tampilan dari sini dengan sebanyak mungkin properti sebagai filter yang Anda anggap sesuai."
          }
        }
      },
      "filter": {
  ...
  "project_page": {
    "empty_state": {
      "general": {
        "title": "Tulis catatan, dokumen, atau seluruh basis pengetahuan. Dapatkan Galileo, asisten AI Plane, untuk membantu Anda memulai",
        "description": "Halaman adalah ruang pemikiran di Plane. Catat notul rapat, format dengan mudah, sertakan item kerja, tata letak menggunakan perpustakaan komponen, dan simpan semua di dalam konteks proyek Anda. Untuk menyelesaikan dokumen dengan cepat, panggil Galileo, AI Plane, dengan pintasan atau dengan mengklik tombol.",
        "primary_button": {
      ...
      "private": {
        ...
        "description": "Simpan pemikiran pribadi Anda di sini. Ketika Anda sudah siap untuk berbagi, tim hanya seklik jarak.",
        "primary_button": {
          "text": "Buat halaman pertama Anda"
        }
      },
  ...
  "disabled_project": {
    "empty_state": {
      "inbox": {
        ...
        "description": "Intake membantu Anda mengelola permintaan yang masuk ke proyek Anda dan menambahkannya sebagai item kerja dalam alur kerja Anda. Aktifkan intake dari pengaturan proyek untuk mengelola permintaan.",
        "primary_button": {
          "text": "Kelola fitur"
        }
      },
      "cycle": {
        ...
        "description": "Pecah pekerjaan menjadi bagian yang dibatasi waktu, kerjakan mundur dari tenggat waktu proyek Anda untuk menetapkan tanggal, dan buat kemajuan nyata sebagai tim. Aktifkan fitur siklus untuk proyek Anda agar dapat mulai menggunakannya.",
        "primary_button": {
          "text": "Kelola fitur"
        }
      },
      "module": {
        ...
        "description": "Modul adalah blok bangunan dari proyek Anda. Aktifkan modul dari pengaturan proyek untuk mulai menggunakannya.",
        "primary_button": {
          "text": "Kelola fitur"
        }
      },
      "page": {
        ...
        "description": "Halaman adalah blok bangunan dari proyek Anda. Aktifkan halaman dari pengaturan proyek untuk mulai menggunakannya.",
        "primary_button": {
          "text": "Kelola fitur"
        }
      },
      "view": {
        ...
        "description": "Tampilan adalah blok bangunan dari proyek Anda. Aktifkan tampilan dari pengaturan proyek untuk mulai menggunakannya.",
        "primary_button": {
          "text": "Kelola fitur"
        }
      }
  ...
  "workspace_draft_issues": {
    ...
    "empty_state": {
      ...
      "description": "Untuk mencoba ini, mulai dengan menambahkan item kerja dan tinggalkan di tengah jalan atau buat draf pertama Anda di bawah ini. 😉",
      "primary_button": {
  ...
  "stickies": {
    ...
    "no-data": "Tuliskan sebuah ide, tangkap momen aha, atau catat pemikiran brilian. Tambahkan catatan tempel untuk memulai.",
    ...
    "empty_state": {
      "simple": "Tuliskan sebuah ide, tangkap momen aha, atau catat pemikiran brilian. Tambahkan catatan tempel untuk memulai.",
      "general": {
        "title": "Catatan tempel adalah catatan cepat dan tugas yang Anda buat secara langsung.",
        "description": "Tangkap pemikiran dan ide Anda dengan mudah dengan membuat catatan tempel yang dapat Anda akses kapan saja dan dari mana saja.",
        "primary_button": {
  ...
  "role_details": {
    ...
    "member": {
      "title": "Anggota",
      "description": "Kemampuan untuk membaca, menulis, mengedit, dan menghapus entitas di dalam proyek, siklus, dan modul"
    },
    "admin": {
      "title": "Admin",
