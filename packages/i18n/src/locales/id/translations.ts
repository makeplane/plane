...
export default {
  ...
  project_id_tooltip_content:
    "Membantu Anda mengidentifikasi item kerja dalam proyek secara unik. Maksimal 50 karakter.",
  ...
  project_id_max_char: "ID proyek maksimal {max} karakter",
...
jika Anda yakin pencarian Anda benar. `,
 ...
 pembagian pekerjaan berdasarkan label.`,
  ...
  oauth_bridge_integration: {
    name: "OAuth Bridge",
    description: "Validasi token IdP eksternal untuk akses API.",
    header_description:
      "Validasi token OIDC/JWT yang diterbitkan secara eksternal dari IdP Anda (Azure AD, Okta, dll.) untuk akses API Plane.",
    connected: "Terhubung",
    connect: "Hubungkan",
    uninstall: "Copot pemasangan",
    uninstalling: "Mencopot...",
    install_success: "OAuth Bridge berhasil dipasang.",
    install_error: "Gagal memasang OAuth Bridge.",
    uninstall_success: "OAuth Bridge dicopot.",
    uninstall_error: "Gagal mencopot OAuth Bridge.",
    token_providers: "Penyedia Token",
    token_providers_description: "Konfigurasi IdP eksternal yang JWT-nya diterima sebagai kredensial API.",
    add_provider: "Tambah penyedia",
    edit_provider: "Edit penyedia",
    enabled: "Diaktifkan",
    disabled: "Dinonaktifkan",
    test: "Tes",
    no_providers_title: "Tidak ada penyedia yang dikonfigurasi.",
    no_providers_description: "Tambahkan IdP untuk mengaktifkan autentikasi token eksternal.",
    provider_updated: "Penyedia diperbarui.",
    provider_added: "Penyedia ditambahkan.",
    provider_save_error: "Gagal menyimpan penyedia.",
    provider_deleted: "Penyedia dihapus.",
    provider_delete_error: "Gagal menghapus penyedia.",
    provider_update_error: "Gagal memperbarui penyedia.",
    jwks_reachable: "JWKS dapat dijangkau",
    jwks_unreachable: "JWKS tidak dapat dijangkau",
    jwks_test_error: "Tidak dapat mengambil JWKS dari URL yang dikonfigurasi.",
    provider_form: {
      name_label: "Nama",
      name_placeholder: "mis. Azure AD Production",
      name_description: "Label yang mudah dibaca untuk penyedia identitas ini",
      name_required: "Nama wajib diisi.",
      issuer_label: "Penerbit",
      issuer_placeholder: "https://login.microsoftonline.com/tenant-id/v2.0",
      issuer_description: "Nilai claim iss yang diharapkan dalam JWT",
      issuer_required: "Penerbit wajib diisi.",
      jwks_url_label: "URL JWKS",
      jwks_url_placeholder: "https://login.microsoftonline.com/tenant-id/discovery/v2.0/keys",
      jwks_url_description: "Endpoint HTTPS yang menyediakan JSON Web Key Set penyedia",
      jwks_url_required: "URL JWKS wajib diisi.",
      jwks_url_https: "URL JWKS harus menggunakan HTTPS.",
      audience_label: "Audiens",
      audience_placeholder: "api://my-app-id",
      audience_description: "Claim aud yang diharapkan dalam JWT, dipisahkan koma.",
      user_claims_label: "Claim pengguna",
      user_claims_placeholder: "email",
      user_claims_description: "Claim JWT yang berisi alamat email pengguna",
      user_claims_required: "Claim pengguna wajib diisi.",
      allowed_algorithms_label: "Algoritma penandatanganan yang diizinkan",
      allowed_algorithms_description: "Algoritma asimetris yang diterima untuk verifikasi tanda tangan JWT",
      allowed_algorithms_required: "Diperlukan setidaknya satu algoritma.",
      select_algorithms: "Pilih algoritma",
      jwks_cache_ttl_label: "TTL cache JWKS (detik)",
      jwks_cache_ttl_description:
        "Berapa lama menyimpan kunci JWKS penyedia dalam cache (minimum 60 detik, default 24 jam)",
      jwks_cache_ttl_min: "TTL cache minimal 60 detik.",
      rate_limit_label: "Batas laju",
      rate_limit_placeholder: "120/minute",
      rate_limit_description:
        "Pembatasan permintaan sebagai jumlah/periode (mis. 120/minute). Kosongkan untuk batas laju default.",
  ...
  dashboards: {
    ...
    create_modal: {
      ...
      filters_label: "Tetapkan filter untuk sumber data di atas",
...
• Membuat tugas dan komentar: Tambahkan tugas, deskripsi, dan komentar melalui perintah suara.`,
  ...
  automations: {
    ...
    trigger: {
      ...
      section_plane_events: "Peristiwa Plane",
      section_time_based: "Berbasis waktu",
      fixed_schedule: "Jadwal tetap",
      schedule: {
        frequency: "Frekuensi",
        select_day: "Pilih hari",
        day_of_month: "Hari dalam sebulan",
        monthly_every: "Setiap",
        monthly_day_aria: "Hari {day}",
        time: "Waktu",
        hour: "Jam",
        minute: "Menit",
        hour_suffix: "jam",
        ...
        pm: "PM",
        timezone: "Zona waktu",
        timezone_placeholder: "Pilih zona waktu",
        frequency_daily: "Harian",
        frequency_weekly: "Mingguan",
        frequency_monthly: "Bulanan",
        on: "Pada",
        validation_weekly_day_required: "Pilih setidaknya satu hari dalam seminggu.",
        validation_monthly_date_required: "Pilih satu hari dalam sebulan.",
        main_content_schedule_summary_daily: "Setiap hari pukul {time} ({timezone}).",
        main_content_schedule_summary_weekly: "Setiap minggu pada {days} pukul {time} ({timezone}).",
        main_content_schedule_summary_monthly: "Setiap bulan pada hari {day} pukul {time} ({timezone}).",
        schedule_mode: "Mode jadwal",
        schedule_mode_fixed: "Tetap",
        schedule_mode_cron: "Cron",
        cron_expression_label: "Masukkan ekspresi Cron",
        cron_expression_placeholder: "0 9 * * 1-5",
        cron_invalid: "Ekspresi Cron tidak valid.",
        cron_preview: 'Ekspresi Cron ini menjalankan "{description}".',
  ...
  pql: {
    functions: {
      date: {
        now: {
          description: "Tanggal dan waktu saat ini",
        },
        today: {
          description: "Tanggal hari ini",
        },
        start_of_day: {
          description: "Awal hari ini",
        },
        end_of_day: {
          description: "Akhir hari ini",
        },
        start_of_week: {
          description: "Awal minggu ini",
        },
        end_of_week: {
          description: "Akhir minggu ini",
        },
        start_of_month: {
          description: "Awal bulan ini",
        },
        end_of_month: {
          description: "Akhir bulan ini",
        },
        start_of_year: {
          description: "Awal tahun ini",
        },
        end_of_year: {
          description: "Akhir tahun ini",
        },
        days_ago: {
          description: "Tanggal n hari yang lalu",
        },
        days_from_now: {
          description: "Tanggal n hari dari sekarang",
        },
        weeks_ago: {
          description: "Tanggal n minggu yang lalu",
        },
        weeks_from_now: {
          description: "Tanggal n minggu dari sekarang",
        },
        months_ago: {
          description: "Tanggal n bulan yang lalu",
        },
        months_from_now: {
          description: "Tanggal n bulan dari sekarang",
        },
      },
      user: {
        current_user: {
        ...
        members_of: {
          description: 'Anggota dari "project:<id>" atau "teamspace:<id>"',
        },
        workspace_members: {
          description: "Semua anggota ruang kerja",
        },
      },
      cycle: {
        active_cycle: {
          description: "Siklus yang aktif hari ini",
        },
        completed_cycles: {
          description: "Siklus yang tanggal akhirnya telah lewat",
        },
        upcoming_cycles: {
          description: "Siklus yang tanggal mulainya di masa depan",
        },
      },
      state: {
        open_states: {
      ...
      predicate: {
        is_overdue: {
          description: "Tanggal jatuh tempo telah lewat DAN status masih terbuka",
        },
        has_no_assignee: {
          description: "Item pekerjaan tidak memiliki penugasan",
        },
        has_no_label: {
          description: "Item pekerjaan tidak memiliki label",
        },
        is_top_level: {
          description: "Bukan sub-item pekerjaan (tidak memiliki induk)",
        },
        is_sub_work_item: {
          description: "Adalah sub-item pekerjaan (memiliki induk)",
        },
        is_epic: {
          description: "Epic",
        },
        is_intake: {
          description: "Adalah item pekerjaan masukan",
        },
        is_draft: {
          description: "Adalah item pekerjaan draf",
        },
        is_archived: {
          description: "Diarsipkan",
        },
        has_children: {
          description: "Memiliki setidaknya satu sub-item pekerjaan",
        },
        has_start_and_due_dates: {
          description: "Memiliki tanggal mulai dan tanggal jatuh tempo",
        },
      },
      relation: {
        linked_to: {
          description: "Item pekerjaan yang terkait dengan item yang diberikan",
        },
        blocked_by: {
          description: "Item pekerjaan yang diblokir oleh item yang diberikan",
        },
        blocks: {
          description: "Item pekerjaan yang memblokir item yang diberikan",
        },
        child_of: {
          description: "Sub-item pekerjaan dari item yang diberikan",
        },
        parent_of: {
          description: "Item pekerjaan induk dari item yang diberikan",
        },
        duplicate_of: {
          description: "Item pekerjaan yang ditandai sebagai duplikat dari item yang diberikan",
        },
      },
      history: {
        was_ever: {
          description: "Bidang pernah diatur ke nilai ini",
        },
        was: {
          description: "Bidang sebelumnya memiliki nilai ini (telah diubah)",
        },
        changed_from: {
          description: "Bidang diubah dari nilai ini",
        },
        changed_to: {
          description: "Bidang diubah ke nilai ini",
        },
        changed: {
          description: "Bidang telah diubah",
        },
        updated_by: {
          description: "Item pekerjaan diperbarui oleh pengguna ini",
        },
        commented_by: {
          description: "Item pekerjaan dikomentari oleh pengguna ini",
        },
        field_changed_by: {
          description: "Bidang diubah oleh pengguna ini",
        },
        was_assigned_to: {
          description: "Item pekerjaan ditugaskan ke pengguna ini",
        },
        changed_after: {
          description: "Bidang diubah setelah tanggal ini",
        },
        changed_before: {
          description: "Bidang diubah sebelum tanggal ini",
        },
        field_changed_after: {
          description: "Bidang diubah setelah tanggal ini",
        },
        ...
        changed_to_after: {
          description: "Bidang diubah ke nilai ini setelah tanggal ini",
        },
        changed_to_before: {
          description: "Bidang diubah ke nilai ini sebelum tanggal ini",
        },
        field_changed_between: {
          description: "Bidang diubah di antara tanggal-tanggal ini",
        },
      },
    },
  ...
  releases: {
    label: "{count, plural, one {Rilis} other {Rilis}}",
    ...
    scope: "Cakupan",
    page_title: {
      scope: "Rilis - {name} | Cakupan",
      scope_fallback: "Rilis | Cakupan",
    },
    properties: "Properti",
    ...
    release_tag: "Tag",
    labels: "Label",
    description_placeholder: "Tambahkan deskripsi...",
    progress: "Progres",
    completed_work_items: "Item kerja selesai",
    pending_work_items: "Item kerja tertunda",
    cancelled_work_items: "Item kerja dibatalkan",
    scope_page: {
      work_items: "Item kerja",
      add_work_items: "Tambah item kerja",
      remove_from_release: "Hapus dari rilis",
      empty_state: {
        title: "Tidak ada item kerja",
        description: "Tambahkan item kerja untuk menentukan cakupan rilis.",
      },
      confirm_remove: {
        content: "Yakin ingin menghapus item kerja ini dari rilis? Item akan tetap ada di proyek.",
        primary_button: {
          default: "Hapus",
          loading: "Menghapus",
        },
    ...
    empty_state: {
      ...
      description: "Tambahkan item kerja ke rilis untuk melacak penyelesaiannya untuk rilis ini.",
      add_scope: "Tambah ruang lingkup",
      not_found: {
        title: "Rilis tidak ditemukan",
        description: "Rilis mungkin telah dihapus.",
        primary_button: "Kembali ke rilis",
      },
    },
    toast: {
      work_items_added: "{count, plural, one {Item kerja ditambahkan} other {Item kerja ditambahkan}}",
      work_items_error: "Gagal menambahkan item kerja",
    },
  ...
  page_actions: {
    move_page: {
      placeholders: {
        project_to_all_with_wiki: "Cari koleksi wiki, proyek, dan teamspace",
        project_to_project_with_wiki: "Cari koleksi wiki dan proyek",
        teamspace_to_all_with_wiki: "Cari koleksi wiki, proyek, dan teamspace",
      },
      toasts: {
        collection_error: {
          title: "Dipindahkan ke wiki",
          message:
            "Halaman dipindahkan ke wiki, tetapi tidak dapat ditambahkan ke koleksi yang dipilih. Halaman tetap berada di General.",
        },
      },
    },
    remove_from_collection: {
      label: "Hapus dari koleksi",
      success_message: "Halaman dihapus dari koleksi.",
      error_message: "Halaman tidak dapat dihapus dari koleksi. Silakan coba lagi.",
    },
  },
  wiki_collections: {
    predefined: {
    ...
    fallback_name: "Koleksi",
    form: {
      name_required: "Judul koleksi wajib diisi",
      name_max_length: "Nama koleksi harus kurang dari 255 karakter",
      name_placeholder_create: "Beri judul untuk koleksi",
      name_placeholder_edit: "Nama koleksi",
    },
    create_modal: {
      title: "Buat koleksi",
      submit: "Buat koleksi",
    ...
    delete_modal: {
      title: "Hapus koleksi",
      page_count: "Koleksi ini memiliki {pageCount} halaman. Pilih apa yang akan terjadi pada halaman tersebut.",
      transfer_title: "Pindahkan halaman dan hapus koleksi",
      transfer_description:
        "Pindahkan semua halaman ke koleksi lain sebelum menghapus. Halaman dan izinnya akan tetap dipertahankan.",
      transfer_warning: "Halaman yang dipindahkan akan mewarisi izin dari koleksi yang dipilih.",
      transfer_target_label: "Pindahkan halaman ke",
      transfer_target_placeholder: "Pilih koleksi",
      delete_with_pages_title: "Hapus koleksi beserta halamannya",
      delete_with_pages_description:
        "Hapus koleksi dan semua halamannya secara permanen. Tindakan ini tidak dapat dibatalkan.",
      submit: "Hapus koleksi",
    },
    header: {
    ...
    add_existing_page_modal: {
      ...
      success_message: "{count} halaman ditambahkan ke koleksi.",
      error_message: "Halaman tidak dapat dipindahkan. Silakan coba lagi.",
      no_pages_found: "Tidak ada halaman yang cocok dengan pencarian Anda",
      no_pages_available: "Tidak ada halaman yang tersedia untuk dipindahkan",
      submit: "Pindahkan",
    },
    list: {
      invite_only: "Hanya undangan",
      remove_error: "Halaman tidak dapat dihapus dari koleksi.",
      no_matching_pages: "Tidak ada halaman yang cocok",
      remove_search_criteria: "Hapus kriteria pencarian untuk melihat semua halaman",
      remove_filters: "Hapus filter untuk melihat semua halaman",
      no_pages_title: "Belum ada halaman",
      no_pages_description: "Koleksi ini belum memiliki halaman.",
      untitled: "Tanpa judul",
      restricted_access: "Akses terbatas",
      collapse_page: "Ciutkan halaman",
      expand_page: "Bentangkan halaman",
      page_actions: "Aksi halaman",
      page_link_copied: "Tautan halaman disalin ke clipboard.",
      columns: {
        page_name: "Nama halaman",
        owner: "Pemilik",
        nested_pages: "Halaman bertingkat",
        last_activity: "Aktivitas terakhir",
        actions: "Aksi",
      },
    },
    toasts: {
      created: "Koleksi berhasil dibuat.",
      create_error: "Koleksi tidak dapat dibuat. Silakan coba lagi.",
      renamed: "Nama koleksi berhasil diubah.",
      rename_error: "Koleksi tidak dapat diperbarui. Silakan coba lagi.",
      transferred_deleted: "Halaman dipindahkan dan koleksi dihapus.",
      deleted_with_pages: "Koleksi dan halamannya dihapus.",
      delete_error: "Koleksi tidak dapat dihapus. Silakan coba lagi.",
      target_required: "Silakan pilih koleksi tujuan untuk memindahkan halaman.",
      create_page_error: "Halaman tidak dapat dibuat. Silakan coba lagi.",
      create_page_in_collection_error: "Halaman tidak dapat dibuat atau ditambahkan ke koleksi. Silakan coba lagi.",
      collection_link_copied: "Tautan koleksi disalin ke clipboard.",
    },
  },
} as const;
