...
export default {
  ...
  all_epics: "All epics",
  cannot_move_to_completed_cycle: "Work item cannot be moved to completed cycles",
  add_link: "Add link",
  points: "Points",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Most things start with a project in Gizmo.",
        cta: "Get started",
      },
      invite_team: {
  ...
  workspace_creation: {
    ...
    subheading: "To start using Gizmo, you need to create or join a workspace.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Welcome to Gizmo, we are excited to have you here. Create your first project and track your work items, and this page will transform into a space that helps you progress. Admins will also see items which help their team progress.",
        primary_button: {
          text: "Build your first project",
          comic: {
            title: "Everything starts with a project in Gizmo",
  ...
  workspace_analytics: {
    ...
    projects_count_overflow: "{count}+ projects",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copy and save this secret key in Gizmo Pages. You can't see this key after you hit Close. A CSV file containing the key has been downloaded.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Any application using this token will no longer have the access to Gizmo data. This action cannot be undone.",
          success: {
            title: "Success!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "Gizmo APIs can be used to integrate your data in Gizmo with any external system. Create a token to get started.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Get started by creating a new work item! Add details and properties to it. Explore more in Gizmo to see your activity.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Gizmo will auto archive work items that have been completed or canceled.",
        duration: "Auto-archive work items that are closed for",
      },
      "auto-close": {
        title: "Auto-close work items",
        description: "Gizmo will automatically close work items that haven't been completed or canceled.",
  ...
  project_cycles: {
    ...
    active_cycle: {
      ...
      current: "Current",
      labels: "Labels",
      work_items_closed: "{count, plural, one {work item} other {work items}} closed",
      work_items_count: "{count, plural, one {# work item} other {# work items}}",
      cancelled_work_items_excluded:
        "{count, plural, one {# cancelled work item is} other {# cancelled work items are}} excluded from this report.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Work items are building blocks in Gizmo.",
            description:
              "Redesign the Gizmo UI, Rebrand the company, or Launch the new fuel injection system are examples of work items that likely have sub-work items.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Write a note, a doc, or a full knowledge base. Get Galileo, Gizmo's AI assistant, to help you get started",
        description:
          "Pages are thoughts potting space in Gizmo. Take down meeting notes, format them easily, embed work items, lay them out using a library of components, and keep them all in your project's context. To make short work of any doc, invoke Galileo, Gizmo's AI, with a shortcut or the click of a button.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Gizmo didn't start up. This could be because one or more Gizmo services failed to start.",
  ...
  power_k: {
    ...
    help_actions: {
      ...
      open_plane_documentation: "Open Gizmo documentation",
  ...
  mail: {
    ...
    compose: {
      ...
      body_placeholder: "Message text…",
      template_replace_title: "Insert template?",
      template_replace_description: "Inserting a template will remove what is already written in this message.",
      template_replace_confirm: "Insert template",
      ...
      import: "Import HTML or Markdown file",
      import_unsupported: "Only .html and .md files can be imported",
      import_error: "Could not import file",
      import_replace_title: "Insert imported file?",
      import_replace_description: "Inserting the imported file will remove what is already written in this message.",
      import_replace_confirm: "Insert file",
      toolbar: {
        bold: "Bold",
        italic: "Italic",
        underline: "Underline",
    ...
    settings: {
      title: "Mail settings",
      subtitle: "Account, signature and mail preferences",
      save: "Save",
      cancel: "Cancel",
      create: "Create",
      edit: "Edit",
      ...
      account: {
        email: "Mailbox",
        subtitle: "Mailbox details and general preferences",
        domain: "Domain",
        general: "General",
        conversation_view: "Group messages into conversations",
        conversation_view_desc: "Combine related messages into a single thread",
        show_snippets: "Show message previews",
        show_snippets_desc: "A snippet of text under the subject in the list",
        language: "Interface language",
        language_desc: "Language of menus and system mail",
      },
      signature: {
        empty: "No signatures yet",
        subtitle: "Added to the end of your messages",
        new: "New signature",
        name: "Name",
        name_placeholder: "e.g. Primary",
        content: "Signature text",
        content_placeholder: "John Doe · Gizmo",
      ...
      folders: {
        subtitle: "System folders and your labels",
        system_title: "Folders",
        labels_title: "Labels",
      ...
      filters: {
        ...
        subtitle: "Rules to process incoming mail automatically",
        new: "Create filter",
        name: "Name",
        name_placeholder: "e.g. Finance",
        if: "If",
        then_label: "Then",
        match_all: "all conditions match",
        match_any: "any condition matches",
        contains: "contains",
      ...
      templates: {
        ...
        subtitle: "Ready-made messages — insert in one click",
        new: "Create template",
        ...
        name: "Name",
        category: "Category",
        category_placeholder: "e.g. Sales",
        subject: "Subject",
        body: "Body",
        save: "Save template",
      },
      forwarding: {
        ...
        subtitle: "Forwarding and out-of-office auto-reply",
        enabled_desc: "A copy of every message goes to another address",
        address: "Forwarding address",
        address_placeholder: "backup@example.com",
        keep_copy: "Keep a copy in the inbox",
        vacation_title: "Out-of-office auto-reply",
        vacation_enabled: "Enable auto-reply",
      ...
      security: {
        ...
        subtitle: "Account protection and mailbox access",
        mailbox: "Mailbox",
      ...
      appearance: {
        ...
        compact: "Compact",
        subtitle: "Theme, density and reading pane",
        theme: "Theme",
        theme_light: "Light",
        theme_dark: "Dark",
        theme_system: "Use Gizmo",
        reading_pane: "Reading pane",
        pane_right: "Right",
        pane_bottom: "Bottom",
        pane_none: "Hidden",
        messages_per_page: "Messages per page",
        mark_read_delay: "Mark read delay",
        delay_none: "Immediately",
        delay_1s: "1 sec",
        delay_1_5s: "1.5 sec",
        delay_3s: "3 sec",
      },
