...
export default {
  ...
  common: {
    ...
    public_board_not_found: "The public board does not exist. Please check the URL.",
    error: {
      label: "Error!",
    ...
    join_to_rearrange: "Join the project to rearrange",
    drag_to_rearrange: "Drag to rearrange",
    all_filters_applied: "All filters applied",
    filter_config_error: "Filter configuration error",
    filter_config_error_message: "This filter is not properly configured and cannot be applied",
  ...
  workspace_creation: {
    ...
    errors: {
      ...
      validation: {
        ...
        url_alphanumeric_alt: "URLs can contain only ( - ), ( _ ) and alphanumeric characters.",
        url_length: "Limit your URL to 48 characters.",
        url_already_taken: "Workspace URL is already taken!",
        url_already_taken_alt: "This URL is taken. Try something else.",
      },
    },
    request_email: {
  ...
  workspace_projects: {
    ...
    join_project: {
      title: "Join Project?",
      description: "Are you sure you want to join the project",
      description_suffix: "? Please click the 'Join Project' button below to continue.",
      button: "Join Project",
      joining: "Joining...",
    },
    error: {
  ...
  project_settings: {
    ...
    general: {
      ...
      network: "Network",
      project_id: "Project ID",
      name_max_length_error: "Project name should be less than 255 characters",
    ...
    members: {
      ...
      invite_members: {
        ...
        member_required_error: "Please select a member",
  ...
  project_page: {
    version_history: {
      ...
      restore_error: "Failed to restore page version.",
      load_error_title: "Something went wrong!",
      load_error_description: "The version could not be loaded, please try again.",
      loading_details: "Loading version details",
      view_only: "View only",
      restoring: "Restoring",
    },
    modal: {
  ...
  notification: {
    ...
    snooze: {
      ...
      no_time_available: "No available time for this date.",
  ...
  onboarding: {
    ...
    invite_members: {
      ...
      not_email_error: "That doesn't look like an email address.",
      success_title: "Success!",
      success_message: "Invitations sent successfully.",
    },
    invitations: {
      title: "You are invited!",
      description: "Accept the invites to collaborate with your team.",
      continue_button: "Continue to workspace",
      or: "or",
  ...
  admin: {
    welcome_title: "Welcome aboard Plane!",
    ...
    configuration_save_error: "Failed to save configuration",
    ...
    openai_title: "OpenAI",
    openai_description: "If you use ChatGPT, this is for you.",
    llm_model_label: "LLM Model",
    llm_model_description: "Choose an OpenAI engine.",
    api_key_label: "API key",
    api_key_description: "You will find your API key ",
    ...
    allow_signup_description: "Toggling this off will only let users sign up when they are invited.",
    available_auth_modes: "Available authentication modes",
    auth_meta_title: "Authentication Settings - Plane Web",
    email_disabled_title: "Email feature disabled",
    email_disabled_message: "Email feature has been disabled",
    ...
    google_client_secret_label: "Client secret",
    google_client_secret_description: "Your client secret should also be in your Google API Console.",
    google_sync_label: "Google",
    google_auth_configured_title: "Done!",
    google_auth_configured_message: "Your Google authentication is configured. You should test it now.",
    google_provided_details_title: "Google-provided details for Plane",
    plane_provided_details_google_title: "Plane-provided details for Google",
    origin_url_label: "Origin URL",
    origin_url_description: "We will auto-generate this. Paste this into your",
    origin_url_field: "Authorized JavaScript origins",
    origin_url_suffix: "field. For this OAuth client",
    callback_uri_label: "Callback URI",
    callback_uri_description: "We will auto-generate this. Paste this into your",
    callback_uri_field: "Authorized Redirect URI",
    callback_uri_suffix: "field. For this OAuth client",
    web_title: "Web",
    github_client_id_description: "You will get this from your",
    github_oauth_apps_link: "GitHub OAuth application settings.",
    github_org_id_label: "Organization ID",
    github_org_id_description: "The organization github ID.",
    github_sync_label: "GitHub",
    github_auth_configured_message: "Your GitHub authentication is configured. You should test it now.",
    github_provided_details_title: "GitHub-provided details for Plane",
    plane_provided_details_github_title: "Plane-provided details for GitHub",
    auth_origin_url_field: "Authorized origin URL",
    auth_callback_uri_field: "Authorized Callback URI",
    gitlab_host_description: "This is either https://gitlab.com or the domain.tld where you host GitLab.",
    gitlab_app_id_label: "Application ID",
    gitlab_oauth_apps_link: "GitLab OAuth application settings",
    gitlab_secret_label: "Secret",
    gitlab_sync_label: "GitLab",
    gitlab_auth_configured_message: "Your GitLab authentication is configured. You should test it now.",
    gitlab_provided_details_title: "GitLab-provided details for Plane",
    plane_provided_details_gitlab_title: "Plane-provided details for GitLab",
    ...
    gitea_provided_details_title: "Gitea-provided details for Plane",
    plane_provided_details_gitea_title: "Plane-provided details for Gitea",
  },
} as const;
