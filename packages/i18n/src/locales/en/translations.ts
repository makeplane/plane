...
export default {
  ...
  cancel: "Cancel",
  copy_project: {
    menu_item: "Copy to Workspace",
    modal_title: "Copy Project to Another Workspace",
  ...
  state_change_description: "Notify me when the work items moves to a different status",
  ...
  support: "Support",
  discord: "Discord",
  powered_by_plane_pages: "Powered by Shinhan Workspace Pages",
  ...
  state_is_required: "Status is required",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Most things start with a team/project in Shinhan Workspace.",
        cta: "Get started",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Make Shinhan Workspace yours.",
    ...
    new_at_plane: {
      title: "New at Shinhan Workspace",
    },
    quick_tutorial: {
  ...
  workspace_creation: {
    ...
    subheading: "To start using Shinhan Workspace, you need to create or join a workspace.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Welcome to Shinhan Workspace, we are excited to have you here. Create your first team/project and track your work items, and this page will transform into a space that helps you progress. Admins will also see items which help their team progress.",
        primary_button: {
          text: "Build your first team/project",
          comic: {
            title: "Everything starts with a team/project in Shinhan Workspace",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copy and save this secret key in Shinhan Workspace Pages. You can't see this key after you hit Close. A CSV file containing the key has been downloaded.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Any application using this token will no longer have the access to Shinhan Workspace data. This action cannot be undone.",
          success: {
            title: "Success!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "Shinhan Workspace APIs can be used to integrate your data in Shinhan Workspace with any external system. Create a token to get started.",
      },
      webhooks: {
  ...
  profile: {
    ...
    stats: {
      ...
      state_distribution: {
        ...
        empty: "Create work items to view the them by status in the graph for better analysis.",
      },
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Get started by creating a new work item! Add details and properties to it. Explore more in Shinhan Workspace to see your activity.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    workflows: {
      ...
      add_transition: "Add permitted status change",
      add_reviewers: "Add reviewers",
      change_state_to: "Change status to",
      n_permitted_state_changes: "{count, plural, one{# permitted status change} other{# permitted status changes}}",
      ...
      delete_transition_title: "Are you sure you want to delete this status-change rule?",
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Shinhan Workspace will auto archive work items that have been completed or canceled.",
        duration: "Auto-archive work items that are closed for",
      },
      "auto-close": {
        title: "Auto-close work items",
        description: "Shinhan Workspace will automatically close work items that haven't been completed or canceled.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Work items are building blocks in Shinhan Workspace.",
            description:
              "Redesign the Shinhan Workspace UI, Rebrand the company, or Launch the new fuel injection system are examples of work items that likely have sub-work items.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Write a note, a doc, or a full knowledge base. Get Galileo, Shinhan Workspace's AI assistant, to help you get started",
        description:
          "Pages are thoughts potting space in Shinhan Workspace. Take down meeting notes, format them easily, embed work items, lay them out using a library of components, and keep them all in your team/project's context. To make short work of any doc, invoke Galileo, Shinhan Workspace's AI, with a shortcut or the click of a button.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Shinhan Workspace didn't start up. This could be because one or more Shinhan Workspace services failed to start.",
  ...
  power_k: {
    ...
    help_actions: {
      ...
      open_plane_documentation: "Open Shinhan Workspace documentation",
  ...
  analytics_dashboard: {
    ...
    filter_state_group: "Status Group",
  ...
  task_category: {
    ...
    no_main_categories: "No categories available",
  ...
  ho: {
    ...
    export_queued: "Please download report in Export tab or SWING mail.",
  ...
  capacity_export: {
    ...
    select_members_title: "Select members to export",
    select_members_desc: "Choose specific members, or include everyone in the report.",
    all_members: "Include all members",
  ...
  ho_exports: {
    tab: "HO Exports",
    title: "HO Datasheet Exports",
    subtitle: "Track and download your Overall Management datasheet exports.",
    refresh: "Refresh",
    empty: "No exports yet. Use the Export button on the Datasheet tab to generate one.",
    col_status: "Status",
    col_range: "Date Range",
    col_rows: "Rows",
    col_size: "Size",
    col_created: "Created",
    col_expires: "Expires",
  ...
  capacity_exports: {
    tab: "My Exports",
    title: "My Exports",
    subtitle: "Track and download your detailed work-item exports.",
    empty: "No exports yet",
    empty_hint: "Generate one from the Capacity page using Export → Detailed work-item report.",
    footer_hint: "Files are kept for a limited time. Download promptly to avoid expiration.",
    refresh: "Refresh",
    download: "Download",
    copy_link: "Copy link",
    all_members: "All",
  ...
  help_center: {
    menu_label: "Help Center",
    title: "Help Center",
    subtitle: "Guides and answers for Shinhan Workspace",
    ...
    read_more: "Read more",
    last_updated: "Last updated",
    content_unavailable: "This article is not available yet",
    ...
    only_admins_can_edit: "Only workspace admins can edit help content",
