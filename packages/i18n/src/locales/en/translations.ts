...
export default {
  ...
  common: {
    ...
    order_by: {
      ...
      start_date: "Start date",
      start_date_desc: "Start date (latest first)",
      due_date: "Due date",
  ...
  issue: {
    ...
    layouts: {
      ...
      title: {
        ...
        grouped_board: "Grouped Board Layout",
      },
    },
    states: {
      active: "Active",
  ...
  project_cycles: {
    ...
    date_range: "Date range",
    add_date: "Add date",
    not_started_points: "Not started points",
    in_progress_points: "In progress points",
    done_points: "Done points",
    not_started_issues: "Not started work items",
    in_progress_issues: "In progress work items",
    done_issues: "Done work items",
