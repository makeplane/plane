...
export default {
  ...
  activity_empty_state: {
    ...
    no_transitions: "No transitions yet",
  ...
  project_id_tooltip_content: "Helps you identify work items in the project uniquely. Max 50 characters.",
  ...
  project_id_max_char: "Project ID must at most be of {max} characters",
  ...
  workspace_settings: {
    ...
    settings: {
      ...
      relations: {
        title: "Relations",
        heading: "Relations",
        description: "Create and manage relation types that connect work items across your workspace.",
      },
      cancel_trial: {
      ...
      applications: {
        ...
        app_consent_workspace_permissions_title: "{app} would like",
        ...
        read_access_to: "Read-only access to",
        write_access_to: "Write access to",
        ...
        selected_scopes: "{count} selected",
        scopes_and_permissions: "Scopes & Permissions",
        read: "Read",
        write: "Write",
        scope_description: {
          projects: "Access to projects, and all project related entities",
          wiki: "Access to wiki, and all wiki related entities",
          customers: "Access to customers, and all customer related entities",
          initiatives: "Access to initiatives, and all initiative related entities",
          workspaces: "Access to workspaces, and all workspace related entities",
...
if you are sure your search is right. `,
 ...
 breakdown of work by labels.`,
  ...
  oauth_bridge_integration: {
    name: "OAuth Bridge",
    description: "Validate external IdP tokens for API access.",
    header_description:
      "Validate externally-issued OIDC/JWT tokens from your IdP (Azure AD, Okta, etc.) for Plane API access.",
    connected: "Connected",
    connect: "Connect",
    uninstall: "Uninstall",
    uninstalling: "Uninstalling...",
    install_success: "OAuth Bridge installed successfully.",
    install_error: "Failed to install OAuth Bridge.",
    uninstall_success: "OAuth Bridge uninstalled.",
    uninstall_error: "Failed to uninstall OAuth Bridge.",
    token_providers: "Token Providers",
    token_providers_description: "Configure external IdPs whose JWTs are accepted as API credentials.",
    ...
    no_providers_description: "Add an IdP to enable external token authentication.",
    provider_updated: "Provider updated.",
    provider_added: "Provider added.",
    provider_save_error: "Failed to save provider.",
    provider_deleted: "Provider deleted.",
    provider_delete_error: "Failed to delete provider.",
    provider_update_error: "Failed to update provider.",
    jwks_reachable: "JWKS Reachable",
    jwks_unreachable: "JWKS Unreachable",
    jwks_test_error: "Could not fetch JWKS from the configured URL.",
    provider_form: {
      name_label: "Name",
      name_placeholder: "e.g. Azure AD Production",
      name_description: "Human-readable label for this identity provider",
      name_required: "Name is required.",
      issuer_label: "Issuer",
      issuer_placeholder: "https://login.microsoftonline.com/tenant-id/v2.0",
      issuer_description: "Expected iss claim value in the JWT",
      ...
      jwks_url_description: "HTTPS endpoint serving the provider's JSON Web Key Set",
      jwks_url_required: "JWKS URL is required.",
      jwks_url_https: "JWKS URL must use HTTPS.",
      audience_label: "Audience",
      audience_placeholder: "api://my-app-id",
      audience_description: "Expected aud claim(s) in the JWT, comma-separated.",
      user_claims_label: "User claims",
      user_claims_placeholder: "email, preferred_username, upn",
      user_claims_description: "Comma-separated JWT claims to match against the Plane email (first match wins)",
      user_claims_required: "At least one user claim is required.",
      allowed_algorithms_label: "Allowed signing algorithms",
      allowed_algorithms_description: "Asymmetric algorithms accepted for JWT signature verification",
      allowed_algorithms_required: "At least one algorithm is required.",
      select_algorithms: "Select algorithms",
      jwks_cache_ttl_label: "JWKS cache TTL (seconds)",
      jwks_cache_ttl_description: "How long to cache the provider's JWKS keys (minimum 60s, default 24 hours)",
      jwks_cache_ttl_min: "Cache TTL must be at least 60 seconds.",
      rate_limit_label: "Rate limit",
      rate_limit_placeholder: "120/minute",
      rate_limit_description:
        "Request throttle as count/period (e.g. 120/minute). Leave blank for the default rate limit.",
  ...
  jira_importer: {
    ...
    create_project_automatically_description: "We'll create a new project for you based on the Jira project details.",
    import_to_existing_project: "Import to an existing project",
    import_to_existing_project_description: "Choose an existing project from the dropdown menu below.",
    state_mapping_automatic_creation: "All Jira states will be automatically created in Plane.",
  ...
  notion_importer: {
    ...
    upload: {
      ...
      upload_from_url: "Import from URL",
      upload_from_url_description: "Paste the public URL of your ZIP export to proceed.",
  ...
  dashboards: {
    ...
    create_modal: {
      ...
      filters_label: "Set filters for datasources above",
...
• Task and comment creation: Add tasks, descriptions, and comments through voice commands.`,
  ...
  page_actions: {
    move_page: {
      ...
      placeholders: {
        ...
        teamspace_to_all_with_wiki: "Search for wiki collections, projects, and teamspaces",
      },
      toasts: {
        success: {
          title: "Success!",
  ...
  wiki_collections: {
    ...
    delete_modal: {
      ...
      page_count:
        "This collection has {pageCount} {pageCount, plural, one {page} other {pages}}. Choose what happens to them.",
      transfer_title: "Transfer pages and delete collection",
      transfer_description:
        "Move all pages to another collection before deleting. Pages and their permissions are preserved.",
      ...
      delete_with_pages_description:
        "Permanently delete the collection and all its pages. This action can't be undone.",
  ...
  releases: {
    ...
    changelog: "Changelog",
    page_title: {
      scope: "Release - {name} | Scope",
      scope_fallback: "Release | Scope",
    },
    properties: "Properties",
    target_date: "Target date",
    lead: "Lead",
    ...
    cancelled_work_items: "Cancelled work items",
    scope_page: {
      work_items: "Work items",
      add_work_items: "Add work items",
      remove_from_release: "Remove from release",
      empty_state: {
        title: "No work items",
        description: "Add work items to define the release scope.",
      },
      confirm_remove: {
        content: "Are you sure you want to remove this work item from the release? It will remain in the project.",
        primary_button: {
          default: "Remove",
          loading: "Removing",
        },
    ...
    empty_state: {
      title: "No scope yet",
      description: "Add work items to the release to track their completion for this release.",
      add_scope: "Add scope",
      not_found: {
        title: "Release not found",
        description: "The release may have been deleted.",
        primary_button: "Back to releases",
      },
    },
    toast: {
      work_items_added: "{count, plural, one {Work item added} other {Work items added}}",
      work_items_error: "Failed to add work items",
    },
  ...
  pql: {
    functions: {
      date: {
        ...
        start_of_year: {
          description: "Start of current year",
        },
        end_of_year: {
          description: "End of current year",
        },
        days_ago: {
        ...
        weeks_ago: {
          description: "Date n weeks in the past",
        },
        weeks_from_now: {
          description: "Date n weeks in the future",
        },
        months_ago: {
          description: "Date n months in the past",
        },
        months_from_now: {
          description: "Date n months in the future",
        },
      },
      user: {
        current_user: {
      ...
      cycle: {
        ...
        upcoming_cycles: {
          description: "Cycles whose start date is in the future",
        },
      },
      state: {
        open_states: {
      ...
      predicate: {
        is_overdue: {
          description: "Due date is past AND state is open",
        },
        has_no_assignee: {
          description: "Work item has no assignee",
        },
        has_no_label: {
          description: "Work item has no labels",
        },
        is_top_level: {
          description: "Not a sub-work item(has no parent)",
        },
        is_sub_work_item: {
          description: "Is a sub-work item(has a parent)",
        },
        is_epic: {
          description: "Epic",
        },
        is_intake: {
          description: "Is an intake work item",
        },
        is_draft: {
          description: "Is a draft work item",
        },
        is_archived: {
      ...
      relation: {
        linked_to: {
          description: "Work items related to the given work item",
        },
        blocked_by: {
          description: "Work items blocked by the given work item",
        },
        blocks: {
          description: "Work items that block the given work item",
        },
        child_of: {
          description: "Sub-work items of the given work item",
        },
        parent_of: {
          description: "Parent work item of the given work item",
        },
        duplicate_of: {
          description: "Work items marked as duplicates of the given work item",
        },
      },
      history: {
        was_ever: {
          description: "Field was ever set to this value",
        },
        was: {
          description: "Field was previously this value (changed away from)",
        },
        changed_from: {
          description: "Field was changed from this value",
        },
        changed_to: {
          description: "Field was changed to this value",
        },
        changed: {
          description: "Field was changed at all",
        },
        updated_by: {
          description: "Work item updated by this user",
        },
        commented_by: {
          description: "Work item commented by this user",
        },
        field_changed_by: {
          description: "Field changed by this user",
        },
        was_assigned_to: {
          description: "Work item was assigned to this user",
        },
        changed_after: {
          description: "Field changed after this date",
        },
        changed_before: {
          description: "Field changed before this date",
        },
        field_changed_after: {
          description: "Field changed after this date",
        },
        ...
        changed_to_after: {
          description: "Field changed to this value after this date",
        },
        changed_to_before: {
          description: "Field changed to this value before this date",
        },
        field_changed_between: {
          description: "Field changed between these dates",
        },
      },
    },
