export default {
  ...
  common: {
    ...
    start_tracking_time: "Start tracking your time",
    timer: "Timer",
    timer_running_elsewhere: "Timer running on another issue",
    hours: "Hours",
    minutes: "Minutes",
    description_placeholder: "What did you work on?",
    confirm_delete: "Are you sure you want to delete this time entry?",
    today: "Today",
    week: "Week",
    month: "Month",
    quarter: "Quarter",
