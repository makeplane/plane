export default {
  ...
  power_k: {
    ...
    navigation_actions: {
      ...
      nav_all_workspace_work_items: "Go to all workspace work items",
      nav_assigned_workspace_work_items: "Go to assigned workspace work items",
      nav_created_workspace_work_items: "Go to created workspace work items",
      nav_subscribed_workspace_work_items: "Go to subscribed workspace work items",
      ...
      open_project_cycle: "Open a project cycle",
      nav_project_cycles: "Go to project cycles",
      open_project_module: "Open a project module",
      nav_project_modules: "Go to project modules",
      open_project_view: "Open a project view",
      nav_project_views: "Go to project views",
      nav_project_pages: "Go to project pages",
      nav_project_intake: "Go to project intake",
    ...
    miscellaneous_actions: {
      ...
      copy_page_url_toast_success: "Current page URL copied to clipboard.",
      copy_page_url_toast_error: "Some error occurred while copying the current page URL to clipboard.",
    },
    preferences_actions: {
