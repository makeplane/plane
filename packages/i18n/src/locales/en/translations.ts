...
export default {
  ...
  localized_ui: {
    ...
    workspace_views: {
      page_title: "{workspaceName} - All Views",
    },
    ...
    editor: {
      ...
      link: "Link",
      enter_or_paste_link: "Enter or paste link",
      ...
      retry_duplication: "Retry duplication",
      retry: "Retry",
      no_emojis_found: "No emojis found",
      fullscreen_image_viewer: "Fullscreen image viewer",
      ...
      view_image_in_full_screen: "View image in full screen",
      align: "Align",
      download: "Download",
    ...
    onboarding: {
      ...
      usecase_title: "How are you planning to use Plane?",
      usecase_description: "Select one or more options so we can personalize your experience.",
      select_one_or_more: "Select one or more",
      select_at_least_one: "Select at least one option.",
      skip: "Skip",
    },
    inbox: {
      duplicate_issues_found: "{count} duplicate issues found",
      description_versions: {
        intake_form_user: "Intake Form user",
      },
      errors: {
        asset_upload_failed: "Asset upload failed. Please try again later.",
        asset_duplication_failed: "Asset duplication failed. Please try again later.",
        permission_denied: "Permission denied",
        mark_duplicate_permission: "Only project admins can mark work item as duplicate",
        mark_duplicate_permission_plural: "Only project admins can mark work items as duplicate",
      },
      filters: {
      ...
      navigation: {
        previous_work_item: "Previous work item",
        next_work_item: "Next work item",
      },
      properties: {
      ...
      toasts: {
        editor_processing: "Editor is still processing changes. Please wait before proceeding.",
        create_success: "Work item created successfully.",
        delete_failed: "Work item delete failed",
        update_failed: "Work item update failed",
      },
    },
    space_public: {
      error_title: "Yikes! That does not look good.",
      error_description_prefix:
        "That crashed Plane, pun intended. No worries, though. Our engineers have been notified. If you have more details, please write to",
      error_description_middle: "or on our",
      forum: "Forum",
      refresh: "Refresh",
      not_found_title: "That did not work",
      not_found_hint: "Check the URL you are entering in the browser address bar and try again.",
      user_already_logged_in: "User already logged in",
      logged_in_title: "Nice! Just one more step.",
      logged_in_hint:
        "Enter the public-share URL or link of the view or Page you are trying to see in the browser address bar.",
      by_creating_account: "By creating an account",
      by_signing_in: "By signing in",
      you_agree_to_our: "you agree to our",
      terms_of_service: "Terms of Service",
      and: "and",
      privacy_policy: "Privacy Policy",
      sign_up: "Sign up",
      oauth_with_provider: "{action} with {provider}",
      auth: {
        sign_in_header: "Sign in to upvote or comment",
        sign_in_subheader: "Contribute in nudging the features you want to get built.",
        sign_up_header: "View, comment, and do more",
        sign_up_subheader: "Sign up or log in to work with Plane work items and Pages.",
      },
      peek: {
        side: "Side Peek",
        modal: "Modal",
      ...
      page_not_found_alt: "Page not found",
      something_went_wrong: "Oops! Something went wrong.",
      page_not_found_description: "The page you are looking for does not exist or has been moved.",
      instance_failure_image_alt: "Unable to fetch instance details",
      instance_failure_title: "Unable to fetch instance details.",
      instance_failure_description: "We could not load your instance details.",
      instance_failure_hint: "Please check your connection and try again.",
      retry: "Retry",
      powered_by: "Powered by",
      sign_in_to_add_comment: "Sign in to add a comment",
      sign_in: "Sign in",
      link_copied: "Link copied!",
      work_item_link_copied: "Work item link copied to clipboard.",
      comment_post_error: "Failed to post comment. Please try again.",
