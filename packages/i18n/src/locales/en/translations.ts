...
export default {
  ...
  mail: {
    ...
    webmail: {
      ...
      reload: "Reload",
      open_external: "Open separately",
      unavailable_title: "Webmail is not configured",
      unavailable_description: "Set MAIL_WEBMAIL_URL or MAIL_DOMAIN to connect Roundcube to this section.",
    },
    settings: {
      title: "Mail settings",
