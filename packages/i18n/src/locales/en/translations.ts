...
export default {
  ...
  timesheet_no_issues: "No issues tracked this week",
  ...
  capacity_dashboard_description: "Overview of team capacity and workload distribution.",
  ...
  workspace_analytics: {
    ...
    started: "Started",
    unstarted: "Unstarted",
    completed_issues_title: "Completed",
    total_intakes_count: "Total Intakes",
    status: {
      accepted: "Accepted",
      declined: "Declined",
      duplicate: "Duplicate",
  ...
  workspace_empty_state: {
    analytics_work_items: {
      title: "No work items data available yet",
    },
  },
  workspace_projects: {
  ...
  staff: {
    label: "Staff",
    profile_section_title: "Staff Profile",
    add: "Add staff",
    edit: "Edit staff",
    import: "Import staff",
    delete: "Delete staff",
