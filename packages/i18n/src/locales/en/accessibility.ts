export default {
  aria_labels: {
    projects_sidebar: {
      ...
      create_new_project: "Create new program",
      open_projects_menu: "Open programs menu",
      close_projects_menu: "Close programs menu",
      toggle_quick_actions_menu: "Toggle quick actions menu",
      open_project_menu: "Open program menu",
      close_project_menu: "Close program menu",
