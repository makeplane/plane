...
export default {
  ...
  project_id_tooltip_content: "Допомагає унікально ідентифікувати робочі одиниці в проєкті. Макс. 50 символів.",
  ...
  project_id_max_char: "ID проєкту може містити максимум {max} символів",
...
робочі одиниці`,
    ...
    vote: {
      click_to_upvote: "Натисніть, щоб проголосувати за",
      click_to_downvote: "Натисніть, щоб проголосувати проти",
      click_to_view_upvotes: "Натисніть, щоб переглянути голоси за",
      click_to_view_downvotes: "Натисніть, щоб переглянути голоси проти",
    },
  },
  attachment: {
...
Створіть новий.`,
 ...
 Натомість створіть нове в'ю.`,
  ...
  initiatives: {
    ...
    archive_description: "Архівувати можна лише завершені або закриті ініціативи",
    toast: {
      ...
      archive: {
        success: "Ініціативу успішно заархівовано.",
        error: "Не вдалося заархівувати ініціативу",
        initiative_cannot_be_archived_in_this_state: "Ініціативу неможливо заархівувати в цьому стані",
      },
 ...
 Натомість створіть нову ініціативу.`,
        archived_description: "Не виявлено архівованих ініціатив, що відповідають критеріям.",
      },
      not_found: {
 ...
 побачити розподіл роботи за лейблами.`,
  ...
  bulk_operations: {
    ...
    workflows: {
      toggle: {
        title: "Увімкнути робочі процеси",
        description: "Налаштуйте робочі процеси для керування переміщенням робочих елементів",
        no_states_tooltip: "До робочого процесу не додано жодного стану.",
        toast: {
          loading: {
            enabling: "Увімкнення робочих процесів",
            disabling: "Вимкнення робочих процесів",
          },
          success: {
            title: "Успіх!",
            message: "Робочі процеси успішно увімкнено.",
          },
          error: {
            title: "Помилка!",
            message: "Не вдалося увімкнути робочі процеси. Будь ласка, спробуйте ще раз.",
          },
        },
      },
      heading: "Робочі процеси",
      description:
        "Автоматизуйте переходи робочих елементів і налаштуйте правила, які керують тим, як завдання рухаються через процес вашого проєкту.",
      add_button: "Додати новий робочий процес",
      search: "Шукати робочі процеси",
      detail: {
        define: "Визначити робочий процес",
        add_states: "Додати стани",
        unmapped_states: {
          title: "Виявлено незіставлені стани",
          description:
            "Деякі робочі елементи вибраних типів зараз перебувають у станах, яких не існує в цьому робочому процесі.",
          note: "Якщо ви увімкнете цей робочий процес, ці елементи буде автоматично переміщено до початкового стану цього робочого процесу.",
          label: "Відсутні стани",
          tooltip:
            "Деякі робочі елементи перебувають у станах, які не зіставлені з цим робочим процесом. Відкрийте робочий процес, щоб перевірити це.",
        },
      },
      select_states: {
        empty_state: {
          title: "Усі стани використовуються",
          description: "Усі стани, визначені для цього проєкту, уже присутні у вашому поточному робочому процесі.",
        },
      },
      default_footer: {
        fallback_message:
          "Цей робочий процес застосовується до будь-якого типу робочого елемента, який не призначений жодному робочому процесу.",
      },
      create: {
        heading: "Створити новий робочий процес",
      },
    },
  },
  work_item_types: {
    ...
    settings: {
      ...
      cant_set_default_inactive_message: "Активуйте цей тип перед встановленням за замовчуванням",
      set_default_confirmation: {
        title: "Встановити як тип робочого елемента за замовчуванням",
        description:
          "Встановлення {name} за замовчуванням імпортує його в усі проекти цього робочого простору. Усі нові робочі елементи використовуватимуть цей тип за замовчуванням.",
        confirm_button: "Встановити за замовчуванням",
      },
    },
    create: {
  ...
  oauth_bridge_integration: {
    name: "OAuth Bridge",
    description: "Перевірка токенів зовнішніх IdP для доступу до API.",
    header_description:
      "Перевіряйте зовнішні OIDC/JWT-токени від вашого IdP (Azure AD, Okta тощо) для доступу до API Plane.",
    connected: "Підключено",
    connect: "Підключити",
    uninstall: "Видалити",
    uninstalling: "Видалення...",
    install_success: "OAuth Bridge успішно встановлено.",
    install_error: "Не вдалося встановити OAuth Bridge.",
    uninstall_success: "OAuth Bridge видалено.",
    uninstall_error: "Не вдалося видалити OAuth Bridge.",
    token_providers: "Провайдери токенів",
    token_providers_description: "Налаштуйте зовнішні IdP, чиї JWT приймаються як облікові дані API.",
    add_provider: "Додати провайдера",
    edit_provider: "Редагувати провайдера",
    enabled: "Увімкнено",
    disabled: "Вимкнено",
    test: "Тест",
    no_providers_title: "Провайдери не налаштовані.",
    no_providers_description: "Додайте IdP для увімкнення автентифікації за зовнішніми токенами.",
    provider_updated: "Провайдера оновлено.",
    provider_added: "Провайдера додано.",
    provider_save_error: "Не вдалося зберегти провайдера.",
    provider_deleted: "Провайдера видалено.",
    provider_delete_error: "Не вдалося видалити провайдера.",
    provider_update_error: "Не вдалося оновити провайдера.",
    jwks_reachable: "JWKS доступний",
    jwks_unreachable: "JWKS недоступний",
    jwks_test_error: "Не вдалося отримати JWKS з налаштованого URL.",
    provider_form: {
      name_label: "Назва",
      name_placeholder: "напр. Azure AD Production",
      name_description: "Зрозуміла назва для цього провайдера ідентифікації",
      name_required: "Назва обов'язкова.",
      issuer_label: "Видавець",
      issuer_placeholder: "https://login.microsoftonline.com/tenant-id/v2.0",
      issuer_description: "Очікуване значення claim iss у JWT",
      issuer_required: "Видавець обов'язковий.",
      jwks_url_label: "URL JWKS",
      jwks_url_placeholder: "https://login.microsoftonline.com/tenant-id/discovery/v2.0/keys",
      jwks_url_description: "HTTPS-ендпоінт, що надає JSON Web Key Set провайдера",
      jwks_url_required: "URL JWKS обов'язковий.",
      jwks_url_https: "URL JWKS повинен використовувати HTTPS.",
      audience_label: "Аудиторія",
      audience_placeholder: "api://my-app-id",
      audience_description: "Очікувані claim(и) aud у JWT, через кому.",
      user_claims_label: "Claim користувача",
      user_claims_placeholder: "email",
      user_claims_description: "JWT claim, що містить email користувача",
      user_claims_required: "Claim користувача обов'язковий.",
      allowed_algorithms_label: "Дозволені алгоритми підпису",
      allowed_algorithms_description: "Асиметричні алгоритми для перевірки підпису JWT",
      allowed_algorithms_required: "Потрібен хоча б один алгоритм.",
      select_algorithms: "Оберіть алгоритми",
      jwks_cache_ttl_label: "TTL кешу JWKS (секунди)",
      jwks_cache_ttl_description:
        "Тривалість кешування ключів JWKS провайдера (мінімум 60 сек., за замовчуванням 24 години)",
      jwks_cache_ttl_min: "TTL кешу повинен бути не менше 60 секунд.",
      rate_limit_label: "Обмеження запитів",
      rate_limit_placeholder: "120/minute",
      rate_limit_description:
        "Обмеження запитів у форматі кількість/період (напр. 120/minute). Залиште порожнім для обмеження за замовчуванням.",
      enable_provider: "Увімкнути цього провайдера",
      saving: "Збереження...",
      update: "Оновити",
    },
  },
...
• Створення завдань та коментарів: Додавайте завдання, описи та коментарі за допомогою голосових команд.`,
  ...
  automations: {
    ...
    trigger: {
      ...
      section_plane_events: "Події Plane",
      section_time_based: "За часом",
      fixed_schedule: "Фіксований розклад",
      schedule: {
        frequency: "Частота",
        ...
        on: "У",
        validation_weekly_day_required: "Виберіть принаймні один день тижня.",
        validation_monthly_date_required: "Виберіть день місяця.",
        main_content_schedule_summary_daily: "Щодня о {time} ({timezone}).",
        main_content_schedule_summary_weekly: "Щотижня у {days} о {time} ({timezone}).",
        main_content_schedule_summary_monthly: "Щомісяця в день {day} о {time} ({timezone}).",
        schedule_mode: "Режим розкладу",
        schedule_mode_fixed: "Фіксований",
        schedule_mode_cron: "Cron",
        cron_expression_label: "Введіть Cron-вираз",
        cron_expression_placeholder: "0 9 * * 1-5",
        cron_invalid: "Недійсний Cron-вираз.",
        cron_preview: 'Цей Cron-вираз запускає "{description}".',
  ...
  work_item_type_hierarchy: {
    settings: {
      ...
      tab_label: "Ієрархія",
      description:
        "Налаштуйте рівні ієрархії для організації роботи. Кожен рівень визначає батьківський зв'язок з елементом безпосередньо вище та дочірній зв'язок з елементом безпосередньо нижче. ",
      sidebar_label: "Ієрархія",
      enable_control: {
        title: "Увімкнути ієрархію",
        description: "Створіть відносини батько-нащадок між різними типами робочих елементів.",
        tooltip: "Ви не зможете вимкнути ієрархію після її увімкнення.",
      },
      workspace_work_item_types_disabled_banner: {
        content: "Спочатку визначте типи робочих елементів для створення нової ієрархії.",
        cta: "Налаштування типів робочих елементів",
      },
    },
    levels: {
      ...
      quick_actions: {
        set_as_default: {
          ...
          toast: {
            loading: "Встановлення за замовчуванням...",
            success: {
              title: "Успіх!",
              message: "Рівень ієрархії {level} успішно встановлено за замовчуванням.",
            },
            error: {
              title: "Помилка!",
              message: "Не вдалося встановити рівень ієрархії {level} за замовчуванням. Будь ласка, спробуйте ще раз.",
            },
          },
        },
      },
    ...
    work_item_modal: {
      invalid_work_item_type_create_toast: {
        title: "Помилка!",
        message:
          "Вибраний тип робочого елемента не може бути використаний для створення нового робочого елемента, оскільки це порушує правила ієрархії.",
      },
  ...
  page_actions: {
    move_page: {
      placeholders: {
        project_to_all_with_wiki: "Шукати колекції wiki, проєкти та командні простори",
        project_to_project_with_wiki: "Шукати колекції wiki та проєкти",
        teamspace_to_all_with_wiki: "Шукати колекції wiki, проєкти та командні простори",
      },
      toasts: {
        collection_error: {
          title: "Переміщено до wiki",
          message:
            "Сторінку було переміщено до wiki, але не вдалося додати її до вибраної колекції. Вона залишається в General.",
        },
      },
    },
    remove_from_collection: {
      label: "Видалити з колекції",
      success_message: "Сторінку видалено з колекції.",
      error_message: "Не вдалося видалити сторінку з колекції. Спробуйте ще раз.",
    },
  },
  wiki_collections: {
    predefined: {
    ...
    fallback_name: "Колекція",
    form: {
      name_required: "Назва колекції обов’язкова",
      name_max_length: "Назва колекції має містити менше 255 символів",
      name_placeholder_create: "Вкажіть назву колекції",
      name_placeholder_edit: "Назва колекції",
    },
    create_modal: {
    ...
    delete_modal: {
      ...
      page_count: "У цій колекції {pageCount} сторінок. Виберіть, що з ними зробити.",
      transfer_title: "Перемістити сторінки й видалити колекцію",
      transfer_description:
        "Перед видаленням перемістіть усі сторінки до іншої колекції. Сторінки та їхні дозволи буде збережено.",
      transfer_warning: "Переміщені сторінки успадкують дозволи вибраної колекції.",
      transfer_target_label: "Перемістити сторінки до",
      transfer_target_placeholder: "Виберіть колекцію",
      delete_with_pages_title: "Видалити колекцію разом зі сторінками",
      delete_with_pages_description: "Назавжди видаляє колекцію та всі її сторінки. Цю дію не можна скасувати.",
      submit: "Видалити колекцію",
    },
    header: {
    ...
    add_existing_page_modal: {
      ...
      success_message: "До колекції додано сторінок: {count}.",
      error_message: "Не вдалося перемістити сторінки. Спробуйте ще раз.",
      no_pages_found: "Не знайдено сторінок, що відповідають вашому пошуку",
      no_pages_available: "Немає сторінок, доступних для переміщення",
      submit: "Перемістити",
    },
    list: {
      invite_only: "Лише за запрошенням",
      remove_error: "Не вдалося видалити сторінку з колекції.",
      no_matching_pages: "Немає відповідних сторінок",
      remove_search_criteria: "Приберіть критерії пошуку, щоб побачити всі сторінки",
      remove_filters: "Приберіть фільтри, щоб побачити всі сторінки",
      no_pages_title: "Поки що немає сторінок",
      no_pages_description: "У цій колекції поки що немає сторінок.",
      untitled: "Без назви",
      restricted_access: "Обмежений доступ",
      collapse_page: "Згорнути сторінку",
      expand_page: "Розгорнути сторінку",
      page_actions: "Дії зі сторінкою",
      page_link_copied: "Посилання на сторінку скопійовано в буфер обміну.",
      columns: {
        page_name: "Назва сторінки",
        owner: "Власник",
        nested_pages: "Вкладені сторінки",
        last_activity: "Остання активність",
        actions: "Дії",
      },
    },
    toasts: {
      created: "Колекцію успішно створено.",
      create_error: "Не вдалося створити колекцію. Спробуйте ще раз.",
      renamed: "Колекцію успішно перейменовано.",
      rename_error: "Не вдалося оновити колекцію. Спробуйте ще раз.",
      transferred_deleted: "Сторінки переміщено, а колекцію видалено.",
      deleted_with_pages: "Колекцію та її сторінки видалено.",
      delete_error: "Не вдалося видалити колекцію. Спробуйте ще раз.",
      target_required: "Виберіть колекцію, до якої потрібно перемістити сторінки.",
      create_page_error: "Не вдалося створити сторінку. Спробуйте ще раз.",
      create_page_in_collection_error: "Не вдалося створити сторінку або додати її до колекції. Спробуйте ще раз.",
      collection_link_copied: "Посилання на колекцію скопійовано в буфер обміну.",
    },
  },
} as const;
