...
export default {
  ...
  support: "Підтримка",
  forum: "Forum",
  powered_by_plane_pages: "Працює на Gizmo Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Більшість речей починається з проєкту в Gizmo.",
        cta: "Почати",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Налаштуйте Gizmo під себе.",
  ...
  workspace_creation: {
    ...
    subheading: "Щоб користуватися Gizmo, вам потрібно створити або приєднатися до робочого простору.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Ласкаво просимо до Gizmo, ми раді, що ви з нами. Створіть перший проєкт, додайте робочі одиниці — і ця сторінка заповниться вашим прогресом. Адміністратори побачать тут також важливі елементи для команди.",
        primary_button: {
          text: "Створіть перший проєкт",
          comic: {
            title: "Усе починається з проєкту в Gizmo",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Скопіюйте й збережіть цей ключ для Gizmo Pages. Після закриття ви його більше не побачите. CSV-файл із ключем було завантажено.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Використовуйте API, щоб інтегрувати Gizmo із зовнішніми системами.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Gizmo архівуватиме завершені або скасовані одиниці.",
        duration: "Архівувати одиниці, закриті понад",
      },
      "auto-close": {
        title: "Автоматично закривати одиниці",
        description: "Gizmo закриватиме неактивні одиниці.",
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Gizmo не запустився. Це може бути через те, що один або декілька сервісів Gizmo не змогли запуститися.",
  ...
  power_k: {
    ...
    help_actions: {
      ...
      open_plane_documentation: "Відкрити документацію Gizmo",
