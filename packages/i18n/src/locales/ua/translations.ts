...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      page_not_found_alt: "Сторінка не знайдена",
      something_went_wrong: "Ой! Щось пішло не так.",
      page_not_found_description: "Сторінка, яку ви шукаєте, не існує або була переміщена.",
      instance_failure_image_alt: "Не вдалося отримати деталі екземпляра",
      instance_failure_title: "Не вдалося отримати деталі екземпляра.",
      instance_failure_description: "Не вдалося завантажити деталі вашого екземпляра.",
      instance_failure_hint: "Перевірте підключення та повторіть спробу.",
      retry: "Повторіть спробу",
      ...
      public_board_not_found: "Громадської дошки не існує. Будь ласка, перевірте URL.",
      no_work_items_found: "Робочі елементи не знайдено",
      no_labels: "Без міток",
      user: "Користувач",
    },
  },
