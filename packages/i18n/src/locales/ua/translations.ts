...
export default {
  ...
  localized_ui: {
    ...
    workspace_views: {
      page_title: "{workspaceName} - Усі подання",
    },
    ...
    editor: {
      url: "URL",
      enter_or_paste_url: "Введіть або вставте URL",
      text: "текст",
      enter_text_to_display: "Введіть текст для відображення",
      remove_link: "Видалити посилання",
      edit_link: "Редагувати посилання",
      color: "Колір",
      text_colors: "Кольори тексту",
      background_colors: "Кольори фону",
      link: "Посилання",
      enter_or_paste_link: "Введіть або вставте посилання",
      ...
      add_an_image: "Додайте зображення",
      error_loading_image: "Помилка завантаження зображення",
      uploading: "Завантаження",
      drop_image_here: "Перетягніть зображення сюди",
      retry_duplication: "Повторіть спробу дублювання",
      retry: "Повторіть спробу",
      no_emojis_found: "Емодзі не знайдено",
      fullscreen_image_viewer: "Переглядач повноекранних зображень",
      close_image_viewer: "Закрити переглядач зображень",
      zoom_out: "Зменшити масштаб",
      zoom_in: "Збільшити",
      download_image: "Завантажити зображення",
      open_image_in_new_tab: "Відкрити зображення в новій вкладці",
      view_in_full_screen: "Переглянути на весь екран",
      view_image_in_full_screen: "Переглянути зображення на весь екран",
      align: "Вирівняти",
      download: "Завантажити",
      clear_contents: "Очистити вміст",
      insert_above: "Вставте вище",
      insert_below: "Вставте нижче",
      insert_left: "Вставте ліворуч",
      insert_right: "Вставте праворуч",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "Вас запросили до {workspaceName}",
      description:
        "У вашому робочому просторі ви створюватимете проекти, співпрацюватимете над своїми робочими елементами та організовуватимете різні потоки роботи у своєму обліковому записі Plane.",
      accept: "прийняти",
      ignore: "Ігнорувати",
      already_member: "Ви вже є учасником {workspaceName}",
      continue_to_home: "Продовжуйте додому",
      inactive_title: "Це посилання для запрошення більше не активне.",
      empty_project_link: "Або почати з порожнього проекту",
      sign_in_to_continue: "Увійдіть, щоб продовжити",
      star_on_github: "Зіркою нас на GitHub",
      join_community: "Приєднуйтесь до нашої спільноти активних творців",
    },
    space_auth: {
      email: "Електронна пошта",
      email_invalid: "Електронна адреса недійсна",
      clear_email: "Очистити електронну пошту",
      password: "Пароль",
      ...
      continue: "Продовжити",
      go_to_workspace: "Перейдіть до робочої області",
      sign_in_with_unique_code: "Увійдіть за допомогою унікального коду",
      create_account: "Створити акаунт",
      unique_code: "Унікальний код",
      paste_code_sent: "Вставте код, надісланий на вашу електронну пошту",
      resend_in: "Повторно надішліть через {seconds}s",
      requesting_new_code: "Запит на новий код",
      resend: "Надіслати повторно",
      sending_code: "Надсилання коду",
    },
    onboarding: {
      create_profile_title: "Створіть свій профіль.",
      create_profile_description: "Ось як ви будете виглядати в Plane.",
      change_image: "Змінити зображення",
      upload_image: "Завантажити зображення",
      name: "Ім'я",
      name_required: "Необхідно вказати ім'я",
      name_within_50: "Назва має містити не більше 50 символів.",
      enter_full_name: "Введіть своє повне ім'я",
      set_password: "Встановіть пароль",
      optional: "Додатково",
      passwords_do_not_match: "Паролі не збігаються",
      passwords_match: "Паролі збігаються",
      continue: "Продовжити",
      invite_team_title: "Запросіть своїх товаришів по команді",
      invite_team_description:
        "Робота в Plane найкраще відбувається з вашою командою. Запропонуйте їм зараз використати потенціал Plane.",
      invalid_email: "Це не схоже на електронну адресу.",
      success: "Успіх!",
      invitations_sent: "Запрошення успішно надіслано.",
      error: "Помилка!",
      add_another: "Додайте іншу",
      do_later: "Я зроблю це пізніше",
      join_invites_title: "Приєднайтеся до запрошень або створіть робочу область",
      unified_description: "Вся ваша робота — єдина.",
      create_new_workspace: "Створіть новий робочий простір",
      no_invitations_found: "Запрошень не знайдено",
      you_are_invited: "Ви запрошені!",
      accept_invites: "Прийміть запрошення співпрацювати з вашою командою.",
      continue_to_workspace: "Продовжуйте до робочої області",
      or: "або",
      create_own_workspace: "Створіть власний робочий простір",
      workspace_creation_disabled:
        "Схоже, у вас немає запрошень до робочої області, а адміністратор вашого екземпляра обмежив створення нових робочих областей. Будь ласка, попросіть власника робочої області або адміністратора запросити вас у робочу область і поверніться на цей екран, щоб приєднатися.",
      create_workspace_title: "Створіть свій робочий простір",
      enter_workspace_name: "Введіть назву робочої області",
      join_existing_workspace: "Приєднайтеся до існуючої робочої області",
      profile_setup_completed: "Налаштування профілю завершено.",
      profile_setup_failed: "Помилка налаштування профілю.",
      usecase_title: "Як ви плануєте використовувати Plane?",
      usecase_description: "Виберіть один або кілька варіантів, щоб ми могли персоналізувати ваш досвід.",
      select_one_or_more: "Виберіть один або декілька",
      select_at_least_one: "Виберіть хоча б один варіант.",
      skip: "Пропустити",
    },
    inbox: {
      ...
      errors: {
        ...
        asset_duplication_failed: "Помилка копіювання ресурсу. Спробуйте пізніше.",
        permission_denied: "У дозволі відмовлено",
        mark_duplicate_permission: "Лише адміністратори проекту можуть позначити робочий елемент як дублікат",
        mark_duplicate_permission_plural: "Лише адміністратори проекту можуть позначати робочі елементи як дублікати",
      },
      filters: {
        created_date: "Дата створення",
        updated_date: "Оновлена ​​дата",
        last_updated_date: "Дата останнього оновлення",
        status: "Статус",
        work_item_status: "Статус робочого елемента",
      ...
      navigation: {
        previous_work_item: "Попередній робочий елемент",
      ...
      sidebar: {
        label_count: "{count} міток",
      },
      toasts: {
        editor_processing: "Редактор ще обробляє зміни. Зачекайте, перш ніж продовжити.",
        create_success: "Робочий елемент створено успішно.",
        delete_failed: "Не вдалося видалити робочий елемент",
        update_failed: "Не вдалося оновити робочий елемент",
      },
    },
    space_public: {
      error_description_prefix:
        "Plane аварійно завершив роботу. Наших інженерів уже повідомлено. Якщо у вас є більше деталей, напишіть на",
      error_description_middle: "або на нашому",
      not_found_hint: "Перевірте URL в адресному рядку браузера та спробуйте ще раз.",
      logged_in_hint:
        "Введіть в адресному рядку браузера публічну URL-адресу спільного доступу або посилання на подання чи сторінку, яку хочете переглянути.",
      oauth_with_provider: "{action} через {provider}",
      auth: {
        sign_in_header: "Увійдіть, щоб голосувати або коментувати",
        sign_in_subheader: "Допоможіть просувати функції, які хочете бачити реалізованими.",
        sign_up_header: "Переглядайте, коментуйте та робіть більше",
        sign_up_subheader: "Зареєструйтеся або увійдіть, щоб працювати з робочими елементами та сторінками Plane.",
      },
      peek: {
        side: "Бічний перегляд",
        modal: "Модальне вікно",
        full_screen: "Повний екран",
      },
      bot_name: "Бот {name}",
      commented_time: "прокоментував {time}",
      and_more: "і ще {count}",
      no_upvotes_yet: "Поки що немає голосів за",
      no_downvotes_yet: "Поки що немає голосів проти",
      modules_count: "{count} модулів",
      labels_count: "{count} міток",
      page_not_found_alt: "Сторінку не знайдено",
      something_went_wrong: "Ой! Щось пішло не так.",
      page_not_found_description: "Сторінка, яку ви шукаєте, не існує або була переміщена.",
      instance_failure_image_alt: "Не вдалося отримати деталі інстансу",
      instance_failure_title: "Не вдалося отримати деталі інстансу.",
      instance_failure_description: "Не вдалося завантажити деталі вашого інстансу.",
      instance_failure_hint: "Перевірте підключення та спробуйте ще раз.",
      powered_by: "Працює на",
      sign_in_to_add_comment: "Увійдіть, щоб додати коментар",
      link_copied: "Посилання скопійовано!",
      work_item_link_copied: "Посилання на робочий елемент скопійовано в буфер обміну.",
      comment_post_error: "Не вдалося опублікувати коментар. Спробуйте ще раз.",
      add_comment: "Додати коментар",
      public_board_not_found: "Публічна дошка не існує. Перевірте URL.",
      no_work_items_found: "Робочих елементів не знайдено",
      error_title: "Ой! Це виглядає не дуже добре.",
      refresh: "Оновити",
      forum: "Форум",
      not_found_title: "Це не спрацювало",
      user_already_logged_in: "Користувач уже ввійшов",
      logged_in_title: "Чудово! Залишився ще один крок.",
      by_creating_account: "Створюючи обліковий запис",
      by_signing_in: "Входячи",
      you_agree_to_our: "ви погоджуєтеся з нашими",
      ...
      no_date: "Без дати",
      no_cycle: "Без циклу",
      no_modules: "Без модулів",
      no_assignees: "Без виконавців",
      no_labels: "Без міток",
      user: "Користувач",
    },
  },
