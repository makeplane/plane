...
• Створення завдань та коментарів: Додавайте завдання, описи та коментарі за допомогою голосових команд.`,
  ...
  work_item_type_hierarchy: {
    ...
    add_level_modal: {
      ...
      not_found_toast: {
        title: "Помилка",
        message: "Тип робочого елемента не знайдено.",
      },
      error_toast: {
        title: "Помилка",
    ...
    remove_from_level_toast: {
      loading: "Видалення типу робочого елемента з рівня",
      success: {
        title: "Успішно!",
        message: "Тип робочого елемента успішно видалено з рівня.",
      },
      error: {
        title: "Помилка!",
        message: "Не вдалося видалити тип робочого елемента з рівня.",
      },
    },
    work_item_modal: {
