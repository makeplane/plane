export default {
  ...
  "auth": {
    ...
    "sign_up": {
      "header": {
        ...
        "step": {
          ...
          "unique_code": {
            "header": "Реєстрація",
            "sub_header": "Зареєструйтесь за допомогою унікального коду, надісланого на вказану вище адресу електронної пошти."
          }
        }
      },
      "errors": {
    ...
    "forgot_password": {
      ...
      "description": "Введіть підтверджену адресу електронної пошти вашого облікового запису, і ми надішлемо вам посилання для відновлення пароля.",
      ...
      "toast": {
        "success": {
          ...
          "message": "Перевірте свою пошту для відновлення пароля. Якщо не отримали протягом кількох хвилин, перевірте папку «Спам»."
        },
        "error": {
          "title": "Помилка!",
          "message": "Щось пішло не так. Будь ласка, спробуйте ще раз."
  ...
  "deactivate_account_description": "Після деактивації всі дані й ресурси цього облікового запису будуть видалені без можливості відновлення.",
  ...
  "stay_in_the_loop_on_issues_you_are_subscribed_to_enable_this_to_get_notified": "Будьте в курсі робочих одиниць, на які ви підписані. Увімкніть це, щоб отримувати сповіщення.",
  ...
  "property_changes_description": "Повідомляти, коли змінюються властивості робочих одиниць, такі як призначення, пріоритет, оцінки чи інші.",
  ...
  "active_cycles_description": "Відстежуйте цикли між проєктами, слідкуйте за пріоритетними робочими одиницями та звертайте увагу на цикли, які потребують втручання.",
  ...
  "10000_feet_view_description": "Переглядайте всі поточні цикли у різних проєктах одночасно, замість перемикання між ними в кожному проєкті.",
  "get_snapshot_of_each_active_cycle": "Отримайте знімок кожного активного циклу.",
  "get_snapshot_of_each_active_cycle_description": "Відстежуйте ключові метрики для всіх активних циклів, переглядайте їхній прогрес і порівнюйте обсяг із крайніми строками.",
  ...
  "quickly_see_make_or_break_issues_description": "Переглядайте найпріоритетніші робочі одиниці для кожного циклу з урахуванням термінів. Усе за один клік.",
  "zoom_into_cycles_that_need_attention": "Зосередьтеся на циклах, що потребують уваги.",
  "zoom_into_cycles_that_need_attention_description": "Одним кліком вивчайте стан будь-якого циклу, який не відповідає очікуванням.",
  "stay_ahead_of_blockers": "Вчасно виявляйте перешкоди.",
  "stay_ahead_of_blockers_description": "Виявляйте проблеми між проєктами та залежності між циклами, які неочевидні в інших поданнях.",
  "analytics": "Аналітика",
  ...
  "cycles_description": "Обмежуйте роботу в часі для кожного проєкту та за потреби коригуйте період. Один цикл може тривати 2 тижні, наступний — 1 тиждень.",
  ...
  "intake_description": "Дозвольте неучасникам ділитися помилками, відгуками й пропозиціями без порушення робочого процесу.",
  ...
  "please_select_at_least_one_invitation_description": "Виберіть принаймні одне запрошення, щоб приєднатися до робочого простору.",
  "we_see_that_someone_has_invited_you_to_join_a_workspace": "Ми бачимо, що вас запросили приєднатися до робочого простору",
  "join_a_workspace": "Приєднатися до робочого простору",
  "we_see_that_someone_has_invited_you_to_join_a_workspace_description": "Ми бачимо, що вас запросили приєднатися до робочого простору",
  ...
  "deactivate_your_account_description": "Після деактивації вас не можна буде призначати на робочі одиниці, і з вас не стягуватиметься плата за робочий простір. Щоб знову активувати обліковий запис, потрібно отримати запрошення на цей e-mail.",
  ...
  "issue": {
    ...
    "add": {
      ...
      "cycle": {
        ...
        "loading": "Додавання {count, plural, one {робочої одиниці} few {робочих одиниць} other {робочих одиниць}} до циклу"
      },
  ...
  "workspace_creation": {
    ...
    "errors": {
      "creation_disabled": {
        ...
        "description": "Якщо ви знаєте електронну адресу адміністратора інстанції, натисніть кнопку нижче, щоб зв’язатися з ним.",
  ...
  "workspace_dashboard": {
    "empty_state": {
      "general": {
        ...
        "description": "Ласкаво просимо до Plane, ми раді, що ви з нами. Створіть перший проєкт, додайте робочі одиниці — і ця сторінка заповниться вашим прогресом. Адміністратори побачать тут також важливі елементи для команди.",
        "primary_button": {
          "text": "Створіть перший проєкт",
          "comic": {
            "title": "Усе починається з проєкту в Plane",
            "description": "Проєкт може бути дорожньою картою продукту, маркетинговою кампанією або розробкою нового автомобіля."
          }
        }
      }
    }
  ...
  "workspace_projects": {
    ...
    "empty_state": {
      "general": {
        ...
        "description": "Проєкт є базовою одиницею цілей. У проєкті є завдання, Цикли та Модулі. Створіть новий проєкт або перемкніть фільтр на заархівовані.",
        "primary_button": {
          "text": "Розпочати перший проєкт",
          "comic": {
            "title": "Усе починається з проєкту в Plane",
            "description": "Проєкт може бути дорожньою картою продукту, маркетинговою кампанією або розробкою нового авто."
          }
        }
      },
      "no_projects": {
  ...
  "workspace_settings": {
    ...
    "copy_key": "Скопіюйте й збережіть цей ключ для Plane Pages. Після закриття ви його більше не побачите. CSV-файл із ключем було завантажено.",
  ...
  "project_module": {
    ...
    "empty_state": {
      "general": {
        ...
        "description": "Модулі структурують одиниці під окремими логічними компонентами. Відстежуйте крайні строки та прогрес.",
        "primary_button": {
  ...
  "project_page": {
    "empty_state": {
      "general": {
        ...
        "description": "Сторінки — це простір для ідей. Пишіть, форматуйте, вбудовуйте робочі одиниці та використовуйте компоненти.",
        "primary_button": {
