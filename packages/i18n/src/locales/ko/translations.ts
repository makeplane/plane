...
export default {
  ...
  timesheet_no_issues: "이번 주에 추적된 이슈가 없습니다",
  timesheet_week_of: "주간",
  timesheet_this_week: "이번 주",
  timesheet_total: "합계",
  capacity_no_data: "데이터가 없습니다",
  capacity_dashboard: "용량 대시보드",
  capacity_dashboard_description: "팀 용량 및 업무 분배 개요.",
  capacity_total_logged: "총 기록 시간",
  capacity_total_estimated: "총 예상 시간",
  capacity_member: "멤버",
  capacity_overloaded: "과부하",
  capacity_under_capacity: "여유",
  capacity_normal: "정상",
  ...
  workspace_analytics: {
    ...
    tabs: {
      ...
      work_items_resolved_vs_pending: "해결됨 vs 보류 중 작업 항목",
      cycle_progress: "사이클 진행 상황",
      module_progress: "모듈 진행 상황",
      intake_trends: "인테이크 추세",
    },
    empty_state: {
      customized_insights: {
    ...
    completed_issues_title: "완료됨",
    total_intakes_count: "총 인테이크",
    status: {
      accepted: "수락됨",
      declined: "거절됨",
      duplicate: "중복",
