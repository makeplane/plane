...
export default {
  ...
  localized_ui: {
    ...
    editor: {
      ...
      color: "색상",
      text_colors: "텍스트 색상",
      background_colors: "배경색",
      link: "링크",
      enter_or_paste_link: "링크 입력 또는 붙여넣기",
      ...
      copy_code: "코드 복사",
      add_an_image: "이미지 추가",
      error_loading_image: "이미지를 로드하는 중에 오류가 발생했습니다.",
      uploading: "업로드 중",
      drop_image_here: "여기에 이미지를 드롭하세요.",
      retry_duplication: "복제 재시도",
      retry: "다시 해 보다",
      no_emojis_found: "이모티콘을 찾을 수 없습니다.",
      fullscreen_image_viewer: "전체 화면 이미지 뷰어",
      close_image_viewer: "이미지 뷰어 닫기",
      zoom_out: "축소",
      zoom_in: "확대",
      download_image: "이미지 다운로드",
      open_image_in_new_tab: "새 탭에서 이미지 열기",
      view_in_full_screen: "전체 화면으로 보기",
      view_image_in_full_screen: "전체 화면으로 이미지 보기",
      align: "정렬",
      download: "다운로드",
      clear_contents: "내용 지우기",
      insert_above: "위에 삽입",
      insert_below: "아래에 삽입",
      insert_left: "왼쪽에 삽입",
      insert_right: "오른쪽에 삽입",
      header_row: "헤더 행",
      header_column: "헤더 열",
      alignment: {
        left: "왼쪽",
    ...
    onboarding: {
      ...
      profile_setup_completed: "프로필 설정이 완료되었습니다.",
      profile_setup_failed: "프로필 설정에 실패했습니다.",
      usecase_title: "Plane를 어떻게 사용할 계획인가요?",
      usecase_description: "귀하의 경험을 개인화할 수 있도록 하나 이상의 옵션을 선택하십시오.",
      select_one_or_more: "하나 이상 선택",
      select_at_least_one: "옵션을 하나 이상 선택하세요.",
      skip: "건너뛰다",
    },
    inbox: {
      ...
      errors: {
        asset_upload_failed: "자산 업로드에 실패했습니다. 나중에 다시 시도해 주세요.",
        asset_duplication_failed: "자산 복제에 실패했습니다. 나중에 다시 시도해 주세요.",
        permission_denied: "허가가 거부되었습니다",
        mark_duplicate_permission: "프로젝트 관리자만 작업 항목을 중복으로 표시할 수 있습니다.",
        mark_duplicate_permission_plural: "프로젝트 관리자만 작업 항목을 중복으로 표시할 수 있습니다.",
      },
      filters: {
        created_date: "생성일",
        updated_date: "업데이트된 날짜",
        last_updated_date: "마지막 업데이트 날짜",
        status: "상태",
        work_item_status: "작업 항목 상태",
        view_all: "모두 보기",
        view_less: "간략히 보기",
        date_options: {
          today: "오늘",
      ...
      sidebar: {
        label_count: "{count} 라벨",
      },
      toasts: {
        editor_processing: "편집기가 아직 변경사항을 처리 중입니다. 계속하기 전에 잠시 기다려 주십시오.",
        create_success: "작업 항목이 성공적으로 생성되었습니다.",
        delete_failed: "작업 항목 삭제 실패",
        update_failed: "작업 항목 업데이트 실패",
      },
    },
    space_public: {
      error_description_prefix:
        "Plane이 충돌했습니다. 담당 엔지니어에게 알림이 전송되었습니다. 추가 세부 정보가 있으면 다음으로 보내 주세요",
      error_description_middle: "또는 다음에서",
      not_found_hint: "브라우저 주소 표시줄의 URL을 확인한 뒤 다시 시도하세요.",
      logged_in_hint: "보려는 보기 또는 페이지의 공개 공유 URL이나 링크를 브라우저 주소 표시줄에 입력하세요.",
      oauth_with_provider: "{provider}(으)로 {action}",
      auth: {
        sign_in_header: "투표하거나 댓글을 달려면 로그인하세요",
        sign_in_subheader: "원하는 기능이 만들어지도록 의견을 보태세요.",
        sign_up_header: "보고, 댓글을 달고, 더 많은 작업을 수행하세요",
        sign_up_subheader: "Plane 작업 항목과 페이지를 사용하려면 가입하거나 로그인하세요.",
      },
      peek: {
        side: "사이드 피크",
        modal: "모달",
      ...
      bot_name: "{name} 봇",
      commented_time: "{time}에 댓글 작성",
      and_more: "외 {count}명",
      no_upvotes_yet: "아직 찬성표가 없습니다",
      no_downvotes_yet: "아직 반대표가 없습니다",
      modules_count: "모듈 {count}개",
      labels_count: "라벨 {count}개",
      page_not_found_alt: "페이지를 찾을 수 없음",
      something_went_wrong: "문제가 발생했습니다.",
      page_not_found_description: "찾고 있는 페이지가 없거나 이동되었습니다.",
      instance_failure_image_alt: "인스턴스 세부 정보를 가져올 수 없음",
      instance_failure_title: "인스턴스 세부 정보를 가져올 수 없습니다.",
      instance_failure_description: "인스턴스 세부 정보를 로드할 수 없습니다.",
      instance_failure_hint: "연결을 확인한 뒤 다시 시도하세요.",
      powered_by: "제공",
      sign_in_to_add_comment: "댓글을 추가하려면 로그인하세요",
      link_copied: "링크가 복사되었습니다!",
      work_item_link_copied: "작업 항목 링크가 클립보드에 복사되었습니다.",
      comment_post_error: "댓글을 게시하지 못했습니다. 다시 시도하세요.",
      add_comment: "댓글 추가",
      public_board_not_found: "공개 보드가 없습니다. URL을 확인하세요.",
      no_work_items_found: "작업 항목을 찾을 수 없습니다",
      error_title: "문제가 발생했습니다.",
      refresh: "새로 고침",
      forum: "포럼",
      not_found_title: "작동하지 않았습니다",
      user_already_logged_in: "이미 로그인한 사용자입니다",
      logged_in_title: "좋습니다! 한 단계만 더 남았습니다.",
      by_creating_account: "계정을 만들면",
      by_signing_in: "로그인하면",
      you_agree_to_our: "다음에 동의하게 됩니다",
      ...
      view_less: "간단히 보기",
      view_all: "모두 보기",
      no_matches_found: "일치하는 항목이 없습니다",
      no_date: "날짜 없음",
      no_cycle: "사이클 없음",
      no_modules: "모듈 없음",
      no_assignees: "담당자 없음",
