export default {
  ...
  "deactivate_account_description": "계정을 비활성화하면 해당 계정 내의 모든 데이터와 리소스가 영구적으로 삭제되며 복구할 수 없습니다.",
  ...
  "stay_in_the_loop_on_issues_you_are_subscribed_to_enable_this_to_get_notified": "구독한 작업 항목에 대한 최신 정보를 유지하세요. 알림을 받으려면 이 기능을 활성화하세요.",
  ...
  "signing_out": "로그아웃 중",
  "active_cycles": "활성 주기",
  "active_cycles_description": "프로젝트 전반의 주기를 모니터링하고, 고우선 작업 항목을 추적하며, 주의가 필요한 주기를 확대합니다.",
  ...
  "get_snapshot_of_each_active_cycle_description": "모든 활성 주기의 고수준 메트릭을 추적하고, 진행 상태를 확인하며, 마감일에 대한 범위를 파악합니다.",
  ...
  "quickly_see_make_or_break_issues_description": "각 주기의 고우선 작업 항목을 미리 보고 마감일에 대한 모든 작업 항목을 한 번에 확인합니다.",
  ...
  "stay_ahead_of_blockers_description": "프로젝트 간의 문제를 파악하고 다른 뷰에서 명확하지 않은 주기 간의 종속성을 확인합니다.",
  "analytics": "분석",
  ...
  "deactivate_your_account_description": "계정을 비활성화하면 작업 항목에 할당될 수 없으며 작업 공간에 대한 청구가 발생하지 않습니다. 계정을 다시 활성화하려면 이 이메일 주소로 작업 공간 초대가 필요합니다.",
  "deactivating": "비활성화 중",
  "confirm": "확인",
  "confirming": "확인 중",
  ...
  "workspace_dashboard": {
    "empty_state": {
      "general": {
        ...
        "description": "Plane에 오신 것을 환영합니다. 첫 번째 프로젝트를 생성하고 작업 항목을 추적하면 이 페이지가 진행 상황을 돕는 공간으로 변합니다. 관리자도 팀의 진행을 돕는 항목을 볼 수 있습니다.",
        "primary_button": {
          "text": "첫 번째 프로젝트 생성",
          "comic": {
  ...
  "workspace_analytics": {
    ...
    "empty_state": {
      ...
      "general": {
        ...
        "description": "범위 대 수요, 추정치 및 범위 크리프를 확인하세요. 팀 구성원과 팀의 성과를 파악하고 프로젝트가 제시간에 실행되도록 하세요.",
        "primary_button": {
          "text": "첫 번째 프로젝트 시작",
          "comic": {
            "title": "분석은 사이클 + 모듈과 함께 가장 잘 작동합니다",
            "description": "먼저 작업 항목을 사이클로 시간 제한을 두고, 가능하다면 한 사이클 이상 걸리는 작업 항목을 모듈로 그룹화하세요. 왼쪽 탐색에서 둘 다 확인하세요."
          }
        }
      }
    },
  ...
  "workspace_projects": {
    ...
    "empty_state": {
      "general": {
        "title": "활성 프로젝트 없음",
        "description": "각 프로젝트를 목표 지향 작업의 부모로 생각하세요. 프로젝트는 작업, 주기 및 모듈이 존재하는 곳이며, 동료와 함께 목표를 달성하는 데 도움이 됩니다. 새 프로젝트를 생성하거나 아카이브된 프로젝트를 필터링하세요.",
        "primary_button": {
          "text": "첫 번째 프로젝트 시작",
          "comic": {
            "title": "Plane에서 모든 것은 프로젝트로 시작됩니다",
  ...
  "workspace_settings": {
    ...
    "key_created": "키 생성됨",
    "copy_key": "이 비밀 키를 Plane Pages에 복사하고 저장하세요. 닫기 버튼을 누른 후에는 이 키를 볼 수 없습니다. 키가 포함된 CSV 파일이 다운로드되었습니다.",
    ...
    "settings": {
      "general": {
        ...
        "delete_workspace_description": "작업 공간을 삭제하면 해당 작업 공간 내의 모든 데이터와 리소스가 영구적으로 삭제되며 복구할 수 없습니다.",
      ...
      "members": {
        ...
        "leave_confirmation": "작업 공간을 떠나시겠습니까? 더 이상 이 작업 공간에 접근할 수 없습니다. 이 작업은 되돌릴 수 없습니다.",
        "details": {
          "full_name": "전체 이름",
          "display_name": "표시 이름",
      ...
      "api_tokens": {
        ...
        "delete": {
          "title": "API 토큰 삭제",
          "description": "이 토큰을 사용하는 애플리케이션은 더 이상 Plane 데이터에 접근할 수 없습니다. 이 작업은 되돌릴 수 없습니다.",
          "success": {
            "title": "성공!",
    ...
    "empty_state": {
      "api_tokens": {
        "title": "생성된 API 토큰 없음",
        "description": "Plane API를 사용하여 Plane의 데이터를 외부 시스템과 통합할 수 있습니다. 토큰을 생성하여 시작하세요."
      },
      "webhooks": {
        "title": "추가된 웹훅 없음",
  ...
  "profile": {
    ...
    "empty_state": {
      "activity": {
        "title": "아직 활동 없음",
        "description": "새 작업 항목을 생성하여 시작하세요! 세부 정보와 속성을 추가하세요. Plane에서 더 많은 것을 탐색하여 활동을 확인하세요."
      },
      "assigned": {
        "title": "할당된 작업 항목 없음",
        "description": "할당된 작업 항목을 여기에서 추적할 수 있습니다."
  ...
  "project_settings": {
    "general": {
      ...
      "archive_project": {
        "title": "프로젝트 아카이브",
        "description": "프로젝트를 아카이브하면 사이드 내비게이션에서 프로젝트가 목록에서 제외되지만 프로젝트 페이지에서 여전히 접근할 수 있습니다. 언제든지 프로젝트를 복원하거나 삭제할 수 있습니다.",
        "button": "프로젝트 아카이브"
      },
      "delete_project": {
        "title": "프로젝트 삭제",
        "description": "프로젝트를 삭제하면 해당 프로젝트 내의 모든 데이터와 리소스가 영구적으로 삭제되며 복구할 수 없습니다.",
        "button": "프로젝트 삭제"
      },
      "toast": {
  ...
  "project_cycles": {
    ...
    "empty_state": {
      "general": {
        ...
        "description": "작업을 시간 상자로 나누고, 프로젝트 마감일에서 역으로 날짜를 설정하며, 팀으로서 실질적인 진전을 이루세요.",
        "primary_button": {
          "text": "첫 번째 주기 설정",
          "comic": {
            "title": "주기는 반복적인 시간 상자입니다.",
            "description": "스프린트, 반복 또는 주간 또는 격주로 작업을 추적하는 데 사용하는 다른 용어는 모두 주기입니다."
          }
        }
      },
      "no_issues": {
      ...
      "completed_no_issues": {
        "title": "주기에 작업 항목 없음",
        "description": "주기에 작업 항목이 없습니다. 작업 항목이 전송되었거나 숨겨져 있습니다. 숨겨진 작업 항목을 보려면 표시 속성을 적절히 업데이트하세요."
      },
      "active": {
        "title": "활성 주기 없음",
        "description": "활성 주기에는 오늘 날짜가 범위 내에 포함된 모든 기간이 포함됩니다. 여기에서 활성 주기의 진행 상황과 세부 정보를 확인하세요."
      },
      "archived": {
        "title": "아카이브된 주기 없음",
  ...
  "project_issues": {
    "empty_state": {
      "no_issues": {
        ...
        "description": "작업 항목을 작업, 작업, 작업 또는 JTBD로 생각하세요. 작업 항목과 하위 작업 항목은 일반적으로 팀원에게 할당된 시간 기반 작업입니다. 팀은 작업 항목을 생성, 할당 및 완료하여 프로젝트 목표를 향해 나아갑니다.",
        "primary_button": {
          "text": "첫 번째 작업 항목 생성",
          "comic": {
            "title": "작업 항목은 Plane의 구성 요소입니다.",
            "description": "Plane UI 재설계, 회사 리브랜딩 또는 새로운 연료 주입 시스템 출시와 같은 작업 항목은 하위 작업 항목이 있을 가능성이 큽니다."
          }
        }
      },
      "no_archived_issues": {
        "title": "아카이브된 작업 항목 없음",
        "description": "수동으로 또는 자동화를 통해 완료되거나 취소된 작업 항목을 아카이브할 수 있습니다. 아카이브된 항목은 여기에서 찾을 수 있습니다.",
        "primary_button": {
          "text": "자동화 설정"
        }
      },
  ...
  "project_module": {
    ...
    "empty_state": {
      "general": {
        ...
        "description": "논리적이고 계층적인 부모에 속하는 작업 항목 그룹이 모듈을 형성합니다. 이를 프로젝트 마일스톤별로 작업을 추적하는 방법으로 생각하세요. 모듈은 자체 기간과 마감일을 가지며, 마일스톤에 얼마나 가까운지 또는 먼지를 확인하는 데 도움이 되는 분석을 제공합니다.",
        "primary_button": {
          "text": "첫 번째 모듈 생성",
          "comic": {
      ...
      "archived": {
        "title": "아카이브된 모듈 없음",
        "description": "프로젝트를 정리하려면 완료되거나 취소된 모듈을 아카이브하세요. 아카이브된 모듈은 여기에서 찾을 수 있습니다."
      },
      "sidebar": {
  ...
  "project_views": {
    "empty_state": {
      "general": {
        ...
        "description": "뷰는 자주 사용하는 필터 또는 쉽게 접근하고 싶은 필터 세트입니다. 프로젝트의 모든 동료가 모든 사람의 뷰를 보고 자신에게 가장 적합한 뷰를 선택할 수 있습니다.",
        "primary_button": {
          "text": "첫 번째 뷰 생성",
          "comic": {
  ...
  "project_page": {
    "empty_state": {
      "general": {
        ...
        "description": "페이지는 Plane에서 생각을 정리하는 공간입니다. 회의 메모를 작성하고, 쉽게 형식을 지정하고, 작업 항목을 포함하고, 구성 요소 라이브러리를 사용하여 레이아웃을 작성하고, 모든 것을 프로젝트의 맥락에서 유지하세요. 문서를 빠르게 작성하려면 단축키나 버튼 클릭으로 Galileo, Plane의 AI를 호출하세요.",
        "primary_button": {
          "text": "첫 번째 페이지 생성"
        }
      },
  ...
  "disabled_project": {
    "empty_state": {
      "inbox": {
        ...
        "description": "접수는 프로젝트로 들어오는 요청을 관리하고 이를 워크플로우의 작업 항목으로 추가하는 데 도움이 됩니다. 프로젝트 설정에서 접수를 활성화하여 요청을 관리하세요.",
        "primary_button": {
          "text": "기능 관리"
        }
      },
      "cycle": {
        ...
        "description": "작업을 시간 상자로 나누고, 프로젝트 마감일에서 역으로 날짜를 설정하며, 팀으로서 실질적인 진전을 이루세요. 프로젝트에 주기 기능을 활성화하여 사용하세요.",
        "primary_button": {
          "text": "기능 관리"
        }
      },
  ...
  "workspace_draft_issues": {
    ...
    "empty_state": {
      ...
      "description": "이 기능을 사용해 보려면 작업 항목을 추가하고 중간에 멈추거나 아래에서 첫 번째 초안을 생성하세요. 😉",
      "primary_button": {
        "text": "첫 번째 초안 생성"
      }
    },
