...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      page_not_found_alt: "페이지를 찾을 수 없습니다",
      something_went_wrong: "이런! 문제가 발생했습니다.",
      page_not_found_description: "찾으시는 페이지가 존재하지 않거나 이동되었습니다.",
      instance_failure_image_alt: "인스턴스 세부정보를 가져올 수 없습니다.",
      instance_failure_title: "인스턴스 세부정보를 가져올 수 없습니다.",
      instance_failure_description: "인스턴스 세부정보를 로드할 수 없습니다.",
      instance_failure_hint: "연결을 확인하고 다시 시도해 주세요.",
      retry: "다시 해 보다",
      powered_by: "제공:",
      ...
      comment_post_error: "댓글을 게시하지 못했습니다. 다시 시도해 주세요.",
      add_comment: "댓글 추가",
      public_board_not_found: "공개 게시판이 존재하지 않습니다. URL를 확인하세요.",
