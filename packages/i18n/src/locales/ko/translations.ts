...
export default {
  ...
  timezone_setting: "현재 시간대 설정.",
  language_setting: "사용자 인터페이스에서 사용할 언어를 선택하세요.",
  settings_moved_to_preferences: "시간대 및 언어 설정이 환경 설정으로 이동되었습니다.",
  go_to_preferences: "환경 설정으로 이동",
  theme: "테마",
  ...
  capacity_items: "항목",
  total_logged_time: "총 기록 시간",
  total_work_items: "총 작업 항목 수",
  ...
  analytics_logtime_breakdown: "사용자별 기록 시간",
  capacity_main_task_category: "메인 작업 카테고리",
  capacity_sub_task_category: "서브 작업 카테고리",
  capacity_day_details: "이날의 작업",
  ...
  issue: {
    ...
    reason_modal_title: "{field}을(를) 왜 변경하시나요?",
    reason_label: "변경 사유",
    reason_placeholder: "이 날짜를 변경하는 이유를 설명하세요...",
    reason_required: "이 필드를 변경할 때 사유가 필요합니다.",
    activity_reason: "사유",
    activity_due_date_set: "마감일을 다음으로 설정했습니다",
    activity_due_date_removed: "마감일을 제거했습니다",
    activity_completed_at_set: "완료일을 다음으로 설정했습니다",
    activity_completed_at_removed: "완료일을 제거했습니다",
  },
  attachment: {
  ...
  workspace_analytics: {
    ...
    off_track: "지연됨",
    at_risk: "위험",
    current_cycles: "현재 주기",
    upcoming_cycles: "예정된 주기",
    completed_cycles: "완료된 주기",
    completed_modules: "완료된 모듈",
    in_progress_modules: "진행 중인 모듈",
    planned_modules: "계획된 모듈",
    paused_modules: "일시 중지된 모듈",
    accepted: "수락됨",
    declined: "거절됨",
    duplicate: "중복",
    pending_work_items: {
    ...
    tabs: {
      ...
      work_items_resolved_vs_pending: "해결된 작업 항목 대 대기 중인 작업 항목",
    },
    empty_state: {
      customized_insights: {
    ...
    started: "시작됨",
    unstarted: "시작되지 않음",
    total_users_count: "총 사용자 수",
    total_work_items_count: "총 작업 항목 수",
    total_intakes_count: "총 Intake 수",
    completed_issues_title: "완료된 작업 항목",
    status: {
      accepted: "수락됨",
      declined: "거절됨",
      duplicate: "중복",
  ...
  workspace_views: {
    ...
    export: {
      button: "내보내기",
      button_loading: "내보내는 중...",
      col_id: "ID",
      col_title: "제목",
      col_department: "부서",
      col_project: "프로젝트",
      col_main_category: "주요 카테고리",
      col_sub_category: "하위 카테고리",
      col_sub_issues: "하위 작업",
      col_project_lead: "프로젝트 리더",
      col_assignees: "담당자",
      col_bank_wide: "은행 전체",
      col_priority: "우선순위",
      col_state: "상태",
      ...
      col_updated_at: "수정일",
      col_link_count: "링크",
      col_attachments: "첨부파일",
      warning_title: "대용량 데이터",
      warning_message: "{count}개의 작업 항목을 내보냅니다. 시간이 걸릴 수 있습니다. 계속하시겠습니까?",
      warning_confirm: "내보내기",
    },
    empty_state: {
      "all-issues": {
  ...
  account_settings: {
    ...
    preferences: {
      heading: "환경 설정",
      description: "원하는 방식으로 앱 환경을 사용자 정의하세요",
    },
    notifications: {
      heading: "이메일 알림",
      description: "구독 중인 작업 항목에 대한 알림을 받아보세요. 이 설정을 활성화하여 알림을 받으세요.",
    },
    security: {
      heading: "보안",
    },
    api_tokens: {
      heading: "개인 액세스 토큰",
      description: "외부 시스템 및 앱과 데이터를 연동하기 위한 안전한 API 토큰을 생성하세요.",
    },
    activity: {
      heading: "활동",
  ...
  project_settings: {
    ...
    workflows: {
      ...
      reset: "워크플로우 초기화",
      reset_confirm_title: "이 워크플로우를 초기화하시겠습니까?",
      reset_confirm_body: "초기화하면 모든 사용자 지정 워크플로우 설정이 제거됩니다.",
      view_history: "변경 기록 보기",
      ...
      blocker_title: "전환이 허용되지 않음",
      blocker_body: "{{reviewers}}만 이 작업 항목을 {{state}}으로 이동할 수 있습니다.",
      blocker_all_members: "모든 멤버",
      drag_blocked_title: "이 작업 항목을 여기로 이동할 수 없습니다.",
      indicator_popup_title: "상태 변경",
      indicator_popup_for: "다음 작업의 항목",
      indicator_popup_can_move: "으로 이동할 수 있음",
      indicator_all_members: "모든 멤버",
      no_transitions_into_state: "이 상태로의 전환이 정의되지 않았습니다.",
      activity_loading: "로딩 중...",
      activity_empty: "아직 활동이 없습니다.",
      activity_changed: "변경됨",
      activity_from: "에서",
      activity_to: "로",
      activity_system_actor: "시스템",
    },
    automations: {
      heading: "Automations",
      description:
  ...
  power_k: {
    contextual_actions: {
      work_item: {
        ...
        change_assignees: "담당자 지정",
        assign_to_me: "나에게 지정",
        unassign_from_me: "나에게서 해제",
        change_estimate: "예상치 변경",
        add_to_cycle: "주기에 추가",
        add_to_modules: "모듈에 추가",
        add_labels: "라벨 추가",
        subscribe: "알림 구독",
        unsubscribe: "알림 구독 취소",
        delete: "삭제",
        copy_id: "ID 복사",
        copy_id_toast_success: "작업 항목 ID가 클립보드에 복사되었습니다.",
        copy_id_toast_error: "작업 항목 ID를 클립보드에 복사하는 중 오류가 발생했습니다.",
        copy_title: "제목 복사",
        copy_title_toast_success: "작업 항목 제목이 클립보드에 복사되었습니다.",
        copy_title_toast_error: "작업 항목 제목을 클립보드에 복사하는 중 오류가 발생했습니다.",
        copy_url: "URL 복사",
        copy_url_toast_success: "작업 항목 URL이 클립보드에 복사되었습니다.",
        copy_url_toast_error: "작업 항목 URL을 클립보드에 복사하는 중 오류가 발생했습니다.",
      },
      cycle: {
        title: "주기 작업",
        indicator: "주기",
        ...
        remove_from_favorites: "즐겨찾기에서 제거",
        copy_url: "URL 복사",
        copy_url_toast_success: "주기 URL이 클립보드에 복사되었습니다.",
        copy_url_toast_error: "주기 URL을 클립보드에 복사하는 중 오류가 발생했습니다.",
      },
      module: {
        title: "모듈 작업",
        indicator: "모듈",
        add_remove_members: "멤버 추가/제거",
        change_status: "상태 변경",
        add_to_favorites: "즐겨찾기에 추가",
        remove_from_favorites: "즐겨찾기에서 제거",
        copy_url: "URL 복사",
        copy_url_toast_success: "모듈 URL이 클립보드에 복사되었습니다.",
        copy_url_toast_error: "모듈 URL을 클립보드에 복사하는 중 오류가 발생했습니다.",
      },
      page: {
        title: "페이지 작업",
        indicator: "페이지",
        ...
        remove_from_favorites: "즐겨찾기에서 제거",
        copy_url: "URL 복사",
        copy_url_toast_success: "페이지 URL이 클립보드에 복사되었습니다.",
        copy_url_toast_error: "페이지 URL을 클립보드에 복사하는 중 오류가 발생했습니다.",
      },
    },
    creation_actions: {
      create_work_item: "새 작업 항목",
      create_page: "새 페이지",
      create_view: "새 보기",
      create_cycle: "새 주기",
      create_module: "새 모듈",
    ...
    navigation_actions: {
      ...
      nav_subscribed_workspace_work_items: "구독 중인 작업 항목으로 이동",
      nav_workspace_analytics: "작업 공간 분석으로 이동",
      nav_workspace_drafts: "작업 공간 초안으로 이동",
      nav_workspace_archives: "작업 공간 보관함으로 이동",
      open_workspace_setting: "작업 공간 설정 열기",
      nav_workspace_settings: "작업 공간 설정으로 이동",
      nav_project_work_items: "작업 항목으로 이동",
    ...
    miscellaneous_actions: {
      toggle_app_sidebar: "앱 사이드바 토글",
      copy_current_page_url: "현재 페이지 URL 복사",
      copy_current_page_url_toast_success: "현재 페이지 URL이 클립보드에 복사되었습니다.",
      copy_current_page_url_toast_error: "현재 페이지 URL을 클립보드에 복사하는 중 오류가 발생했습니다.",
      focus_top_nav_search: "검색 입력에 포커스",
    },
    preferences_actions: {
      update_theme: "인터페이스 테마 변경",
      update_timezone: "시간대 변경",
      update_start_of_week: "주 시작일 변경",
      update_language: "인터페이스 언어 변경",
      toast: {
        theme: {
          success: "테마가 업데이트되었습니다.",
          error: "테마 업데이트에 실패했습니다. 다시 시도해주세요.",
        },
        timezone: {
          success: "시간대가 업데이트되었습니다.",
          error: "시간대 업데이트에 실패했습니다. 다시 시도해주세요.",
        },
        generic: {
          success: "환경 설정이 업데이트되었습니다.",
          error: "환경 설정 업데이트에 실패했습니다. 다시 시도해주세요.",
        },
      },
    },
    help_actions: {
    ...
    page_placeholders: {
      ...
      update_work_item_estimate: "예상치 변경",
      update_work_item_cycle: "주기에 추가",
      update_work_item_module: "모듈에 추가",
      update_work_item_labels: "라벨 추가",
      update_module_member: "멤버 변경",
      update_module_status: "상태 변경",
      update_theme: "테마 변경",
      update_timezone: "시간대 변경",
      update_start_of_week: "주 시작일 변경",
      update_language: "언어 변경",
    },
    search_menu: {
  ...
  customize_navigation: "탐색 사용자 정의",
  personal: "개인",
  ...
  worklog: {
    ...
    description: "설명",
    date: "날짜",
    no_entries: "기록된 시간이 없습니다",
    delete_confirm: "이 작업 로그를 삭제하시겠습니까?",
    over_budget: "예상 초과",
    on_track: "정상 진행",
    total_logged: "총 기록",
    ...
    updated: "업데이트됨",
    updated_successfully: "작업 로그가 업데이트되었습니다.",
    logged_successfully: "시간이 기록되었습니다.",
    error: "오류",
    duration_required: "기간은 0보다 커야 합니다.",
    save_failed: "작업 로그 저장에 실패했습니다.",
    edit_log: "작업 로그 편집",
    update: "업데이트",
    ...
    locked_description: "60 영업일 이전의 작업 로그는 편집할 수 없습니다",
    daily_limit_exceeded: "일일 시간 한도 초과",
    daily_limit_description: "하루 최대 12시간까지 기록 가능합니다.",
    no_future_dates: "미래 날짜에 시간을 기록할 수 없습니다",
    backdate_limit: "60 영업일 이전의 날짜에 시간을 기록할 수 없습니다",
    reason_label: "변경 사유",
    reason_placeholder: "이 작업 로그를 수정하는 이유를 설명하세요...",
    reason_required: "변경 사유를 입력해야 합니다.",
    delete_reason_label: "삭제 사유",
    delete_reason_placeholder: "이 작업 로그를 삭제하는 이유를 설명하세요...",
    delete_reason_required: "삭제 사유를 입력해야 합니다.",
    confirm_delete: "삭제 확인",
    confirm_delete_title: "작업 로그 삭제",
    confirm_delete_message: "이 작업은 되돌릴 수 없습니다. 이 작업 로그를 삭제하는 이유를 입력하세요.",
    activity_modified: "시간 로그를 수정함",
    activity_deleted_log: "시간 로그를 삭제함",
    activity_reason: "사유",
  ...
  department: {
    ...
    edit: "부서 편집",
    delete: "부서 삭제",
    delete_confirm: "이 부서를 삭제하시겠습니까?",
    name: { label: "부서명", placeholder: "부서명을 입력하세요" },
    code: { label: "코드", placeholder: "코드를 입력하세요" },
    ...
    deleted: "부서 삭제됨",
    deleted_message: "부서가 삭제되었습니다.",
    delete_failed: "부서 삭제에 실패했습니다.",
  },
  staff: {
    label: "직원",
    profile_section_title: "직원 정보",
    add: "직원 추가",
    edit: "직원 편집",
    import: "직원 가져오기",
    delete: "직원 삭제",
    delete_confirm: "이 직원을 삭제하시겠습니까?",
    deactivate_confirm: "이 직원을 비활성화하시겠습니까?",
    staff_id: { label: "직원 ID", placeholder: "직원 ID (예: 18506320)" },
    name: { label: "이름", placeholder: "이름을 입력하세요" },
    first_name: { placeholder: "성" },
    last_name: { placeholder: "이름" },
    email: { label: "이메일", placeholder: "이메일을 입력하세요" },
    position: { label: "직위", placeholder: "직위" },
    department: { label: "부서", select: "부서 선택" },
    job_grade: { placeholder: "직급" },
    ...
    created: "직원 생성됨",
    deleted: "직원 삭제됨",
    deleted_message: "직원이 삭제되었습니다.",
    delete_failed: "직원 삭제에 실패했습니다.",
    deactivated: "직원 비활성화됨",
    deactivated_message: "직원이 비활성화되었습니다.",
    deactivate_failed: "직원 비활성화에 실패했습니다.",
    deactivate: "비활성화",
    actions: "작업",
  },
  dashboard: {
  ...
  analytics_dashboard: {
    ...
    delete: "대시보드 삭제",
    delete_confirm:
      "<strong>{name}</strong>을(를) 삭제하시겠습니까? 이 작업은 되돌릴 수 없으며 이 대시보드의 모든 위젯이 삭제됩니다.",
    duplicate: "복제",
    name: { label: "이름", placeholder: "대시보드 이름" },
    description: { label: "설명", placeholder: "대시보드 설명..." },
    empty: "대시보드가 없습니다",
    default: "기본",
    widgets: "{count}개 위젯",
    ...
    // Form modal
    modal_title_create: "대시보드 생성",
    modal_title_update: "대시보드 업데이트",
    name_max_length: "이름은 255자 이하여야 합니다",
    description_placeholder: "설명 추가 (선택 사항)",
    public_access: "공개 접근",
    public_access_description: "모든 워크스페이스 멤버가 이 대시보드를 볼 수 있도록 허용합니다",
    submit_update: "업데이트",
    submit_create: "생성",
    ...
    add_widget: "위젯 추가",
    submit_update_widget: "위젯 업데이트",
    submit_add_widget: "위젯 추가",
    // Basic settings
    widget_name: "위젯 이름",
    property_x_axis: "속성 (X축)",
    metric_y_axis: "지표 (Y축)",
    chart_model: "차트 모델",
    group_by_optional: "그룹화 기준 (선택 사항)",
    property_required: "속성이 필요합니다",
    metric_required: "지표가 필요합니다",
    select_property: "속성 선택",
    select_metric: "지표 선택",
    widget_name_placeholder: "우선순위별 이슈",
    none: "없음",
    chart_model_basic: "기본",
    chart_model_grouped: "그룹화",
    // Display settings
    show_legend: "범례 표시",
    show_tooltip: "툴팁 표시",
    show_center_value: "중앙값 표시",
    show_data_points: "데이터 포인트 표시",
    // Style settings
    color_preset: "색상 프리셋",
    fill_opacity: "채우기 불투명도",
    show_border: "테두리 표시",
    smooth_lines: "선 부드럽게",
    // Filter settings
    filter_description: "특정 항목으로 위젯 데이터를 필터링합니다. 일치하는 이슈만 차트에 포함됩니다.",
    filter_priority: "우선순위",
    filter_state_group: "상태 그룹",
    filter_date_ranges: "날짜 범위",
    // Context menu
    context_edit: "편집",
    context_open_new_tab: "새 탭에서 열기",
    context_copy_link: "링크 복사",
    context_delete: "삭제",
    link_copied: "링크가 클립보드에 복사되었습니다",
    copy_link_failed: "링크 복사 실패",
    // Toolbar
    refresh: "새로고침",
    done: "완료",
    edit_mode: "편집",
    // Dashboard detail page toasts
    dashboard_refreshed: "대시보드가 새로고침되었습니다",
    refresh_failed: "대시보드 새로고침 실패",
    widget_deleted: "위젯이 삭제되었습니다",
    delete_widget_failed: "위젯 삭제 실패",
    layout_update_failed: "레이아웃 업데이트 실패",
    widget_duplicated: "위젯이 복제되었습니다",
    duplicate_widget_failed: "위젯 복제 실패",
    widget_updated: "위젯이 업데이트되었습니다",
    widget_added: "위젯이 추가되었습니다",
    update_widget_failed: "위젯 업데이트 실패",
    add_widget_failed: "위젯 추가 실패",
    empty_widgets: "위젯이 없습니다. 첫 번째 위젯을 추가하여 시작하세요.",
    // Dashboard list page toasts
    created_success: "대시보드가 성공적으로 생성되었습니다.",
    create_failed: "대시보드 생성 실패",
    updated_success: "대시보드가 성공적으로 업데이트되었습니다.",
    update_failed: "대시보드 업데이트 실패",
    deleted_success: "대시보드가 성공적으로 삭제되었습니다.",
    delete_failed: "대시보드 삭제 실패",
    empty_description: "첫 번째 대시보드를 생성하여 작업 항목 데이터를 시각화하세요.",
