...
export default {
  ...
  localized_ui: {
    editor: {
      ...
      text: "텍스트",
      enter_text_to_display: "표시할 텍스트를 입력하세요.",
      remove_link: "링크 삭제",
      edit_link: "링크 수정",
    },
    workspace_invitation: {
      invitation_not_found: "초대장을 찾을 수 없습니다.",
      invited_to_workspace: "{workspaceName}에 초대되었습니다",
      description:
        "작업 공간은 Plane 계정에서 프로젝트를 생성하고, 작업 항목에 대해 공동 작업하고, 다양한 작업 흐름을 구성하는 곳입니다.",
      accept: "수용하다",
      ignore: "무시하다",
      already_member: "귀하는 이미 {workspaceName}의 회원입니다.",
      continue_to_home: "집으로 계속",
      inactive_title: "이 초대 링크는 더 이상 활성화되지 않습니다.",
      empty_project_link: "또는 빈 프로젝트에서 시작",
      sign_in_to_continue: "계속하려면 로그인하세요.",
      star_on_github: "GitHub에 별표를 표시해 주세요.",
      join_community: "활동적인 제작자 커뮤니티에 참여하세요",
    },
    space_auth: {
      email: "이메일",
      ...
      clear_email: "이메일 지우기",
      password: "비밀번호",
      set_password: "비밀번호를 설정하세요",
      enter_password: "비밀번호를 입력하세요",
      confirm_password: "비밀번호 확인",
      passwords_dont_match: "비밀번호가 일치하지 않습니다.",
      continue: "계속하다",
      go_to_workspace: "작업공간으로 이동",
      sign_in_with_unique_code: "고유 코드로 로그인",
      create_account: "계정 만들기",
      unique_code: "고유 코드",
      paste_code_sent: "이메일로 전송된 코드를 붙여넣으세요.",
      resend_in: "{seconds}s 후에 재전송",
      requesting_new_code: "새 코드 요청 중",
      resend: "재전송",
      sending_code: "코드 전송 중",
    },
    onboarding: {
      create_profile_title: "프로필을 만드세요.",
      create_profile_description: "이것이 Plane에 나타나는 모습입니다.",
      change_image: "이미지 변경",
      upload_image: "이미지 업로드",
      name: "이름",
      name_required: "이름은 필수입니다",
      name_within_50: "이름은 50자 이내로 입력해야 합니다.",
      ...
      continue: "계속하다",
      invite_team_title: "팀원을 초대하세요",
      invite_team_description:
        "Plane에서의 작업은 팀과 함께 가장 잘 이루어집니다. 지금 Plane를 활용해 잠재력을 발휘하도록 초대하세요.",
      invalid_email: "이메일 주소가 아닌 것 같습니다.",
      success: "성공!",
      invitations_sent: "초대장이 성공적으로 전송되었습니다.",
      error: "오류!",
      add_another: "다른 것을 추가하세요",
      do_later: "나중에 할게요",
      join_invites_title: "초대에 참여하거나 작업 공간 만들기",
      unified_description: "모든 작업이 통합됩니다.",
      create_new_workspace: "새 작업공간 만들기",
      no_invitations_found: "초대장을 찾을 수 없습니다.",
      you_are_invited: "당신을 초대합니다!",
      accept_invites: "팀과 협력하려면 초대를 수락하세요.",
      continue_to_workspace: "계속해서 작업공간으로 이동",
      or: "또는",
      create_own_workspace: "나만의 작업 공간 만들기",
      workspace_creation_disabled:
        "워크스페이스에 대한 초대가 없는 것 같고 인스턴스 관리자가 새 워크스페이스 생성을 제한했습니다. 먼저 워크스페이스 소유자나 관리자에게 워크스페이스에 초대해 달라고 요청한 후 이 화면으로 돌아와 참여하세요.",
      create_workspace_title: "작업 공간 만들기",
      enter_workspace_name: "작업공간 이름을 입력하세요.",
      join_existing_workspace: "기존 작업공간에 참여",
    },
  },
} as const;
