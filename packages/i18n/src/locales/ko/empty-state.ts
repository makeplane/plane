export default {
  ...
  project: {
    work_items: {
      ...
      description: "작업 항목은 프로젝트의 구성 요소입니다. 소유자를 할당하고 우선순위를 설정하며 진행 상황을 쉽게 추적할 수 있습니다.",
      cta_primary: "첫 번째 작업 항목 생성",
    },
    cycles: {
      title: "사이클로 작업을 그룹화하고 시간을 정하세요.",
      description: "시간 제한이 있는 단위로 작업을 나누고, 프로젝트 마감일로부터 역으로 날짜를 설정하며, 팀으로서 구체적인 진전을 이루세요.",
    ...
    modules: {
      ...
      description: "모듈은 상호 연결된 작업 항목으로 구성됩니다. 특정 기한과 분석을 통해 프로젝트 단계를 통한 진행 상황을 모니터링하여 해당 단계 달성에 얼마나 가까운지 나타냅니다.",
    ...
    views: {
      ...
      description: "보기는 가장 자주 사용하는 정보에 빠르게 액세스하는 데 도움이 되는 저장된 필터입니다. 팀원들이 특정 요구 사항에 맞게 보기를 공유하고 조정하면서 손쉽게 협업하세요.",
      cta_primary: "보기 생성",
    },
    ...
    pages: {
      ...
      description: "페이지를 사용하면 정보를 한 곳에서 캡처하고 구성할 수 있습니다. 회의록, 프로젝트 문서 및 PRD를 작성하고, 작업 항목을 삽입하며, 바로 사용할 수 있는 구성 요소로 구조화하세요.",
  ...
  workspace: {
    archive_work_items: {
      ...
      description: "수동으로 또는 자동화를 통해 완료되거나 취소된 작업 항목을 보관할 수 있습니다. 보관되면 여기에서 찾을 수 있습니다.",
      cta_primary: "자동화 설정",
    },
    archive_cycles: {
    ...
    analytics_work_items: {
      title: "작업 항목 및 담당자가 있는 프로젝트를 생성하여 여기에서 성과, 진행 상황 및 팀 영향을 추적하기 시작하세요.",
    },
    analytics_no_cycle: {
