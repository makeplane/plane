 ...
 podział pracy według etykiet.`,
  ...
  oauth_bridge_integration: {
    ...
    provider_form: {
      ...
      user_claims_label: "Claim użytkownika",
      user_claims_placeholder: "email",
      user_claims_description: "Claim JWT zawierający adres e-mail użytkownika",
      user_claims_required: "Claim użytkownika jest wymagany.",
