...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      page_not_found_alt: "Nie znaleziono strony",
      ...
      instance_failure_description: "Nie udało się wczytać szczegółów Twojej instancji.",
      ...
      link_copied: "Link skopiowany!",
      work_item_link_copied: "Link do elementu roboczego skopiowany do schowka.",
      comment_post_error: "Nie udało się opublikować komentarza. Spróbuj ponownie.",
      add_comment: "Dodaj komentarz",
      public_board_not_found: "Rada publiczna nie istnieje. Sprawdź plik URL.",
      no_work_items_found: "Nie znaleziono żadnych elementów pracy",
