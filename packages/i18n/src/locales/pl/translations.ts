...
export default {
  ...
  localized_ui: {
    ...
    workspace_views: {
      page_title: "{workspaceName} - Wszystkie widoki",
    },
    ...
    editor: {
      ...
      error_loading_image: "Błąd ładowania obrazu",
      ...
      insert_left: "Wstaw lewy",
      insert_right: "Wstaw po prawej",
      header_row: "Wiersz nagłówka",
      header_column: "Kolumna nagłówka",
      alignment: {
        left: "Lewy",
        center: "Centrum",
        right: "Do prawej",
    ...
    onboarding: {
      ...
      profile_setup_completed: "Konfiguracja profilu zakończona.",
      profile_setup_failed: "Konfiguracja profilu nie powiodła się.",
      usecase_title: "Jak planujesz używać Plane?",
      usecase_description: "Wybierz jedną lub więcej opcji, abyśmy mogli spersonalizować Twoje doświadczenia.",
      select_one_or_more: "Wybierz jeden lub więcej",
      select_at_least_one: "Wybierz co najmniej jedną opcję.",
      skip: "Pominąć",
    },
    inbox: {
      ...
      errors: {
        asset_upload_failed: "Przesyłanie zasobu nie powiodło się. Spróbuj ponownie później.",
        asset_duplication_failed: "Powielanie zasobów nie powiodło się. Spróbuj ponownie później.",
        permission_denied: "Odmowa pozwolenia",
        mark_duplicate_permission: "Tylko administratorzy projektu mogą oznaczać element pracy jako duplikat",
        mark_duplicate_permission_plural: "Tylko administratorzy projektu mogą oznaczać elementy pracy jako duplikaty",
      },
      filters: {
        created_date: "Data utworzenia",
        updated_date: "Zaktualizowana data",
        last_updated_date: "Ostatnia aktualizacja",
        status: "Status",
        work_item_status: "Stan elementu pracy",
      ...
      navigation: {
        previous_work_item: "Poprzedni element pracy",
      ...
      sidebar: {
        label_count: "Etykiety {count}",
      },
      toasts: {
        editor_processing: "Edytor nadal przetwarza zmiany. Proszę poczekać przed kontynuowaniem.",
        create_success: "Element pracy został pomyślnie utworzony.",
        delete_failed: "Nie udało się usunąć elementu roboczego",
        update_failed: "Aktualizacja elementu roboczego nie powiodła się",
      },
    },
    space_public: {
      error_description_prefix:
        "Plane uległ awarii. Nasi inżynierowie zostali powiadomieni. Jeśli masz więcej szczegółów, napisz na",
      error_description_middle: "lub na naszym",
      not_found_hint: "Sprawdź URL w pasku adresu przeglądarki i spróbuj ponownie.",
      logged_in_hint:
        "Wprowadź w pasku adresu przeglądarki publiczny URL udostępnienia lub link do widoku albo strony, którą chcesz zobaczyć.",
      oauth_with_provider: "{action} przez {provider}",
      auth: {
        sign_in_header: "Zaloguj się, aby głosować lub komentować",
        sign_in_subheader: "Pomóż przesuwać do przodu funkcje, które chcesz zobaczyć.",
        sign_up_header: "Przeglądaj, komentuj i rób więcej",
        sign_up_subheader: "Zarejestruj się lub zaloguj, aby pracować z elementami pracy i stronami Plane.",
      },
      peek: {
        side: "Podgląd boczny",
        modal: "Okno modalne",
      ...
      bot_name: "Bot {name}",
      commented_time: "skomentowano {time}",
      and_more: "i jeszcze {count}",
      no_upvotes_yet: "Brak głosów za",
      no_downvotes_yet: "Brak głosów przeciw",
      modules_count: "{count} modułów",
      labels_count: "{count} etykiet",
      page_not_found_alt: "Strona nie znaleziona",
      something_went_wrong: "Ups! Coś poszło nie tak.",
      page_not_found_description: "Strona, której szukasz, nie istnieje lub została przeniesiona.",
      instance_failure_image_alt: "Nie można pobrać szczegółów instancji",
      instance_failure_title: "Nie można pobrać szczegółów instancji.",
      instance_failure_description: "Nie mogliśmy załadować szczegółów Twojej instancji.",
      instance_failure_hint: "Sprawdź połączenie i spróbuj ponownie.",
      powered_by: "Obsługiwane przez",
      sign_in_to_add_comment: "Zaloguj się, aby dodać komentarz",
      link_copied: "Link skopiowany!",
      work_item_link_copied: "Link do elementu pracy skopiowany do schowka.",
      comment_post_error: "Nie udało się opublikować komentarza. Spróbuj ponownie.",
      add_comment: "Dodaj komentarz",
      public_board_not_found: "Publiczna tablica nie istnieje. Sprawdź URL.",
      no_work_items_found: "Nie znaleziono elementów pracy",
      error_title: "Ups! To nie wygląda dobrze.",
      refresh: "Odśwież",
      forum: "Forum",
      not_found_title: "To nie zadziałało",
      user_already_logged_in: "Użytkownik jest już zalogowany",
      logged_in_title: "Świetnie! Jeszcze jeden krok.",
      by_creating_account: "Tworząc konto",
      by_signing_in: "Logując się",
      you_agree_to_our: "akceptujesz nasze",
      ...
      no_date: "Brak daty",
      no_cycle: "Brak cyklu",
      no_modules: "Brak modułów",
      no_assignees: "Brak przypisanych",
