...
export default {
  ...
  localized_ui: {
    editor: {
      url: "URL",
      enter_or_paste_url: "Wpisz lub wklej adres URL",
      text: "Tekst",
      enter_text_to_display: "Wprowadź tekst do wyświetlenia",
      remove_link: "Usuń link",
      edit_link: "Edytuj link",
    },
    workspace_invitation: {
      invitation_not_found: "Nie znaleziono zaproszenia",
      invited_to_workspace: "Zostałeś zaproszony do {workspaceName}",
      description:
