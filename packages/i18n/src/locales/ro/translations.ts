...
export default {
  ...
  localized_ui: {
    ...
    editor: {
      ...
      text: "Text",
      enter_text_to_display: "Introduceți textul de afișat",
      remove_link: "Eliminați linkul",
      ...
      add_an_image: "Adăugați o imagine",
      error_loading_image: "Eroare la încărcarea imaginii",
      uploading: "Încărcare",
      drop_image_here: "Pune imaginea aici",
      retry_duplication: "Reîncercați duplicarea",
      retry: "Reîncercați",
      no_emojis_found: "Nu s-au găsit emoji",
      fullscreen_image_viewer: "Vizualizator de imagini pe ecran complet",
      close_image_viewer: "Închideți vizualizatorul de imagini",
      zoom_out: "Micșorați",
      zoom_in: "Măriți",
      download_image: "Descărcați imaginea",
      open_image_in_new_tab: "Deschide imaginea într-o filă nouă",
      view_in_full_screen: "Vizualizați pe ecran complet",
      view_image_in_full_screen: "Vizualizați imaginea pe tot ecranul",
      align: "Alinia",
      download: "Descărcați",
      clear_contents: "Șterge conținutul",
      insert_above: "Introduceți mai sus",
      insert_below: "Inserați mai jos",
      insert_left: "Inserați stânga",
      insert_right: "Inserați dreapta",
      header_row: "Rând antet",
      header_column: "Coloana antet",
      alignment: {
        left: "Stânga",
        center: "Centru",
        right: "Dreapta",
      ...
      menu_items: {
        ...
        "to-do-list": "Lista de lucruri de făcut",
        quote: "Citat",
        code: "Cod",
        table: "Tabel",
        image: "Imagine",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "Ai fost invitat la {workspaceName}",
      description:
        "Spațiul tău de lucru este locul în care vei crea proiecte, vei colabora la elementele tale de lucru și vei organiza diferite fluxuri de lucru în contul tău Plane.",
      accept: "Accepta",
      ignore: "Ignora",
      already_member: "Sunteți deja membru {workspaceName}",
      continue_to_home: "Continuați spre casă",
      inactive_title: "Acest link de invitație nu mai este activ.",
      empty_project_link: "Sau începeți de la un proiect gol",
      sign_in_to_continue: "Conectați-vă pentru a continua",
      star_on_github: "Afișează-ne pe GitHub",
      join_community: "Alăturați-vă comunității noastre de creatori activi",
    },
    space_auth: {
      email: "E-mail",
      email_invalid: "E-mailul este nevalid",
      clear_email: "Ștergeți e-mailul",
      password: "Parolă",
      set_password: "Setați o parolă",
      enter_password: "Introduceți parola",
      confirm_password: "Confirmați parola",
      passwords_dont_match: "Parolele nu se potrivesc",
      continue: "Continua",
      go_to_workspace: "Accesați spațiul de lucru",
      sign_in_with_unique_code: "Conectați-vă cu codul unic",
      create_account: "Creează cont",
      unique_code: "Cod unic",
      paste_code_sent: "Lipiți codul trimis pe e-mailul dvs",
      resend_in: "Retrimiteți în {seconds}s",
      requesting_new_code: "Se solicită cod nou",
      resend: "Retrimiteți",
      sending_code: "Se trimite cod",
    },
    onboarding: {
      create_profile_title: "Creează-ți profilul.",
      create_profile_description: "Așa vei apărea în Plane.",
      change_image: "Schimbați imaginea",
      upload_image: "Încărcați imaginea",
      name: "Nume",
      name_required: "Numele este obligatoriu",
      name_within_50: "Numele trebuie să aibă maximum 50 de caractere.",
      ...
      continue: "Continua",
      invite_team_title: "Invită-ți colegii de echipă",
      invite_team_description:
        "Lucrul în Plane se întâmplă cel mai bine cu echipa ta. Invitați-i acum să folosească Plane la potențialul său.",
      invalid_email: "Nu arată ca o adresă de e-mail.",
      success: "Succes!",
      invitations_sent: "Invitațiile trimise cu succes.",
      error: "Eroare!",
      add_another: "Adăugați altul",
      do_later: "O voi face mai târziu",
      join_invites_title: "Alăturați-vă invitațiilor sau creați un spațiu de lucru",
      unified_description: "Toată munca ta — unificată.",
      create_new_workspace: "Creați un spațiu de lucru nou",
      no_invitations_found: "Nu au fost găsite invitații",
      you_are_invited: "Esti invitat!",
      accept_invites: "Acceptă invitațiile de a colabora cu echipa ta.",
      continue_to_workspace: "Continuați spre spațiul de lucru",
      or: "sau",
      create_own_workspace: "Creează-ți propriul spațiu de lucru",
      workspace_creation_disabled:
        "Se pare că nu aveți nicio invitație la un spațiu de lucru și administratorul instanței dvs. a restricționat crearea de noi spații de lucru. Vă rugăm să cereți unui proprietar sau unui administrator de spațiu de lucru să vă invite mai întâi într-un spațiu de lucru și să reveniți la acest ecran pentru a vă alătura.",
      create_workspace_title: "Creează-ți spațiul de lucru",
      enter_workspace_name: "Introduceți numele spațiului de lucru",
      join_existing_workspace: "Alăturați-vă spațiului de lucru existent",
      profile_setup_completed: "Configurarea profilului a fost finalizată.",
      profile_setup_failed: "Configurarea profilului a eșuat.",
      usecase_title: "Cum plănuiți să utilizați Plane?",
      usecase_description: "Selectați una sau mai multe opțiuni pentru a vă putea personaliza experiența.",
      select_one_or_more: "Selectați unul sau mai multe",
      select_at_least_one: "Selectați cel puțin o opțiune.",
      skip: "Sari peste",
    },
    inbox: {
      ...
      errors: {
        ...
        asset_duplication_failed: "Dublarea materialelor nu a reușit. Vă rugăm să încercați din nou mai târziu.",
        permission_denied: "Acces refuzat",
        mark_duplicate_permission: "Numai administratorii de proiect pot marca elementul de lucru ca duplicat",
        mark_duplicate_permission_plural: "Numai administratorii de proiect pot marca elementele de lucru ca duplicate",
      },
      filters: {
        created_date: "Data creată",
      ...
      navigation: {
        previous_work_item: "Element de lucru anterior",
        next_work_item: "Următorul articol de lucru",
      },
      properties: {
        duplicate_of: "Duplicat de",
      },
      select_duplicate: {
        select_work_item: "Selectați elementul de lucru",
      },
      sidebar: {
        label_count: "{count} etichete",
      },
      toasts: {
        editor_processing: "Editorul încă procesează modificări. Vă rugăm să așteptați înainte de a continua.",
        create_success: "Element de lucru creat cu succes.",
        delete_failed: "Ștergerea elementului de lucru nu a reușit",
        update_failed: "Actualizarea articolului de lucru nu a reușit",
      },
    },
    space_public: {
      error_description_prefix:
        "Plane s-a blocat. Inginerii noștri au fost anunțați. Dacă aveți mai multe detalii, scrieți la",
      error_description_middle: "sau pe",
      not_found_hint: "Verificați URL-ul din bara de adrese a browserului și încercați din nou.",
      logged_in_hint:
        "Introduceți în bara de adrese a browserului URL-ul public partajat sau linkul vizualizării ori Paginii pe care doriți să o vedeți.",
      oauth_with_provider: "{action} cu {provider}",
      auth: {
        sign_in_header: "Autentificați-vă pentru a vota sau comenta",
        sign_in_subheader: "Ajutați la promovarea funcționalităților pe care doriți să le vedeți construite.",
        sign_up_header: "Vizualizați, comentați și faceți mai mult",
        sign_up_subheader: "Înregistrați-vă sau autentificați-vă pentru a lucra cu elemente de lucru și Pagini Plane.",
      },
      peek: {
        side: "Previzualizare laterală",
        modal: "Modal",
        full_screen: "Ecran complet",
      },
      bot_name: "Bot {name}",
      commented_time: "a comentat {time}",
      and_more: "și încă {count}",
      no_upvotes_yet: "Încă nu există voturi pozitive",
      no_downvotes_yet: "Încă nu există voturi negative",
      modules_count: "{count} module",
      labels_count: "{count} etichete",
      page_not_found_alt: "Pagina nu a fost găsită",
      something_went_wrong: "Ups! Ceva nu a mers bine.",
      page_not_found_description: "Pagina pe care o căutați nu există sau a fost mutată.",
      instance_failure_image_alt: "Nu se pot obține detaliile instanței",
      instance_failure_title: "Nu se pot obține detaliile instanței.",
      instance_failure_description: "Nu am putut încărca detaliile instanței dvs.",
      instance_failure_hint: "Verificați conexiunea și încercați din nou.",
      powered_by: "Propulsat de",
      sign_in_to_add_comment: "Autentificați-vă pentru a adăuga un comentariu",
      link_copied: "Link copiat!",
      work_item_link_copied: "Linkul elementului de lucru a fost copiat în clipboard.",
      comment_post_error: "Comentariul nu a putut fi publicat. Încercați din nou.",
      add_comment: "Adăugați comentariu",
      public_board_not_found: "Panoul public nu există. Verificați URL-ul.",
      no_work_items_found: "Nu s-au găsit elemente de lucru",
      error_title: "Ups! Nu arată bine.",
      refresh: "Reîmprospătează",
      forum: "Forum",
      not_found_title: "Nu a funcționat",
      user_already_logged_in: "Utilizatorul este deja autentificat",
      logged_in_title: "Perfect! Încă un pas.",
      by_creating_account: "Prin crearea unui cont",
      by_signing_in: "Prin autentificare",
      you_agree_to_our: "sunteți de acord cu",
      ...
      view_all: "Vezi tot",
      no_matches_found: "Nu s-au găsit potriviri",
      no_date: "Fără dată",
      no_cycle: "Fără ciclu",
      no_modules: "Fără module",
      no_assignees: "Fără responsabili",
      no_labels: "Fără etichete",
      user: "Utilizator",
    },
  },
} as const;
