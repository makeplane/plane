...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      something_went_wrong: "Hopa! Ceva a mers prost.",
      page_not_found_description: "Pagina pe care o cauți nu există sau a fost mutată.",
      instance_failure_image_alt: "Nu se pot prelua detaliile instanței",
      instance_failure_title: "Nu se pot prelua detaliile instanței.",
      instance_failure_description: "Nu am putut încărca detaliile instanței dvs.",
      instance_failure_hint: "Vă rugăm să vă verificați conexiunea și să încercați din nou.",
      retry: "Reîncercați",
      powered_by: "Cu sprijinul",
      sign_in_to_add_comment: "Conectați-vă pentru a adăuga un comentariu",
      sign_in: "Conectare",
      link_copied: "Link copiat!",
      work_item_link_copied: "Linkul articolului de lucru a fost copiat în clipboard.",
      comment_post_error: "Nu s-a putut posta comentariul. Vă rugăm să încercați din nou.",
      add_comment: "Adaugă comentariu",
      public_board_not_found: "Consiliul public nu există. Vă rugăm să verificați URL.",
