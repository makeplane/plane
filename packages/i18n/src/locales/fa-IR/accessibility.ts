export default {
  aria_labels: {
    projects_sidebar: {
      ...
      open_workspace_switcher: "باز کردن تغییر دهنده فضای کاری",
      open_user_menu: "باز کردن منوی کاربر",
      open_command_palette: "باز کردن خط فرمان",
      open_extended_sidebar: "باز کردن نوار کناری گسترده",
      close_extended_sidebar: "بستن نوار کناری گسترده",
      create_favorites_folder: "ایجاد پوشه علاقه‌مندی‌ها",
      ...
      edition_badge: "باز کردن مودال طرح‌های پولی",
    },
    auth_forms: {
      ...
      close_popover: "بستن پنجره بازشو",
    },
  },
} as const;
