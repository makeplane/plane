...
export default {
  ...
  localized_ui: {
    ...
    workspace_views: {
      page_title: "{workspaceName} - Tutte le viste",
    },
    ...
    editor: {
      url: "URL",
      enter_or_paste_url: "Inserisci o incolla l'URL",
      text: "Testo",
      enter_text_to_display: "Inserisci il testo da visualizzare",
      remove_link: "Rimuovi collegamento",
      edit_link: "Modifica collegamento",
      color: "Colore",
      text_colors: "Colori del testo",
      background_colors: "Colori di sfondo",
      link: "Collegamento",
      enter_or_paste_link: "Inserisci o incolla il collegamento",
      ...
      add_an_image: "Aggiungi un'immagine",
      error_loading_image: "Errore durante il caricamento dell'immagine",
      uploading: "Caricamento",
      drop_image_here: "Rilascia l'immagine qui",
      retry_duplication: "Riprovare la duplicazione",
      retry: "Riprova",
      no_emojis_found: "Nessun emoji trovato",
      fullscreen_image_viewer: "Visualizzatore di immagini a schermo intero",
      close_image_viewer: "Chiudi il visualizzatore di immagini",
      zoom_out: "Rimpicciolisci",
      zoom_in: "Ingrandisci",
      download_image: "Scarica l'immagine",
      open_image_in_new_tab: "Apri l'immagine in una nuova scheda",
      ...
      insert_right: "Inserisci a destra",
      header_row: "Riga di intestazione",
      header_column: "Colonna di intestazione",
      alignment: {
        left: "Sinistra",
        center: "Centro",
        right: "Destra",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "Sei stato invitato a {workspaceName}",
      description:
        "Il tuo spazio di lavoro è il luogo in cui creerai progetti, collaborerai sui tuoi elementi di lavoro e organizzerai diversi flussi di lavoro nel tuo account Plane.",
      accept: "Accettare",
      ignore: "Ignorare",
      already_member: "Sei già membro di {workspaceName}",
      continue_to_home: "Continua a casa",
      inactive_title: "Questo collegamento di invito non è più attivo.",
      empty_project_link: "Oppure inizia da un progetto vuoto",
      sign_in_to_continue: "Accedi per continuare",
      star_on_github: "Stella su GitHub",
      join_community: "Unisciti alla nostra community di creatori attivi",
    },
    space_auth: {
      email: "E-mail",
      email_invalid: "L'e-mail non è valida",
      clear_email: "Cancella e-mail",
      password: "Password",
      set_password: "Imposta una password",
      ...
      continue: "Continuare",
      go_to_workspace: "Vai all'area di lavoro",
      sign_in_with_unique_code: "Accedi con codice univoco",
      create_account: "Creare un account",
      unique_code: "Codice univoco",
      paste_code_sent: "Incolla il codice inviato alla tua email",
      resend_in: "Invia nuovamente tra {seconds}s",
      requesting_new_code: "Richiesta nuovo codice",
      resend: "Invia nuovamente",
      sending_code: "Invio del codice",
    },
    onboarding: {
      create_profile_title: "Crea il tuo profilo.",
      create_profile_description: "Ecco come apparirai in Plane.",
      change_image: "Cambia immagine",
      upload_image: "Carica immagine",
      name: "Nome",
      name_required: "Il nome è obbligatorio",
      name_within_50: "Il nome deve contenere massimo 50 caratteri.",
      ...
      continue: "Continuare",
      invite_team_title: "Invita i tuoi compagni di squadra",
      invite_team_description:
        "Il lavoro in Plane avviene meglio con il tuo team. Invitali ora a sfruttare Plane al massimo delle sue potenzialità.",
      invalid_email: "Non sembra un indirizzo email.",
      success: "Successo!",
      invitations_sent: "Inviti inviati con successo.",
      error: "Errore!",
      add_another: "Aggiungine un altro",
      do_later: "Lo farò più tardi",
      join_invites_title: "Partecipa agli inviti o crea uno spazio di lavoro",
      unified_description: "Tutto il tuo lavoro: unificato.",
      create_new_workspace: "Crea un nuovo spazio di lavoro",
      no_invitations_found: "Nessun invito trovato",
      you_are_invited: "Sei invitato!",
      accept_invites: "Accetta gli inviti a collaborare con il tuo team.",
      continue_to_workspace: "Continua nell'area di lavoro",
      or: "O",
      create_own_workspace: "Crea il tuo spazio di lavoro",
      workspace_creation_disabled:
        "Sembra che tu non abbia inviti a un'area di lavoro e l'amministratore dell'istanza ha limitato la creazione di nuove aree di lavoro. Chiedi prima al proprietario o all'amministratore di un'area di lavoro di invitarti in un'area di lavoro e di tornare a questa schermata per partecipare.",
      create_workspace_title: "Crea il tuo spazio di lavoro",
      enter_workspace_name: "Inserisci il nome dell'area di lavoro",
      join_existing_workspace: "Unisciti allo spazio di lavoro esistente",
      profile_setup_completed: "Configurazione del profilo completata.",
      profile_setup_failed: "La configurazione del profilo non è riuscita.",
      usecase_title: "Come intendi utilizzare Plane?",
      usecase_description: "Seleziona una o più opzioni per consentirci di personalizzare la tua esperienza.",
      select_one_or_more: "Seleziona uno o più",
      select_at_least_one: "Seleziona almeno un'opzione.",
      skip: "Saltare",
    },
    inbox: {
      ...
      errors: {
        ...
        asset_duplication_failed: "Duplicazione della risorsa non riuscita. Per favore riprova più tardi.",
        permission_denied: "Autorizzazione negata",
        mark_duplicate_permission:
          "Solo gli amministratori del progetto possono contrassegnare l'elemento di lavoro come duplicato",
        mark_duplicate_permission_plural:
          "Solo gli amministratori del progetto possono contrassegnare gli elementi di lavoro come duplicati",
      },
      filters: {
        created_date: "Data di creazione",
        updated_date: "Data aggiornata",
        last_updated_date: "Data dell'ultimo aggiornamento",
        status: "Stato",
        work_item_status: "Stato dell'elemento di lavoro",
      ...
      navigation: {
        previous_work_item: "Elemento di lavoro precedente",
        next_work_item: "Elemento di lavoro successivo",
      },
      properties: {
      ...
      toasts: {
        editor_processing: "L'editor sta ancora elaborando le modifiche. Si prega di attendere prima di procedere.",
        create_success: "Elemento di lavoro creato correttamente.",
        delete_failed: "Eliminazione dell'elemento di lavoro non riuscita",
        update_failed: "Aggiornamento dell'elemento di lavoro non riuscito",
      },
    },
    space_public: {
      error_description_prefix:
        "Plane è andato in crash. I nostri ingegneri sono stati avvisati. Se hai altri dettagli, scrivi a",
      error_description_middle: "o sul nostro",
      not_found_hint: "Controlla l'URL nella barra degli indirizzi del browser e riprova.",
      logged_in_hint:
        "Inserisci nella barra degli indirizzi del browser l'URL pubblico condiviso o il link della vista o della Pagina che vuoi visualizzare.",
      oauth_with_provider: "{action} con {provider}",
      auth: {
        sign_in_header: "Accedi per votare o commentare",
        sign_in_subheader: "Aiuta a spingere le funzionalità che vuoi vedere realizzate.",
        sign_up_header: "Visualizza, commenta e fai di più",
        sign_up_subheader: "Registrati o accedi per lavorare con gli elementi di lavoro e le Pagine di Plane.",
      },
      peek: {
        side: "Anteprima laterale",
        modal: "Modale",
        full_screen: "Schermo intero",
      },
      bot_name: "Bot {name}",
      commented_time: "ha commentato {time}",
      and_more: "e altri {count}",
      no_upvotes_yet: "Ancora nessun voto positivo",
      no_downvotes_yet: "Ancora nessun voto negativo",
      modules_count: "{count} moduli",
      labels_count: "{count} etichette",
      page_not_found_alt: "Pagina non trovata",
      ...
      instance_failure_image_alt: "Impossibile recuperare i dettagli dell'istanza",
      instance_failure_title: "Impossibile recuperare i dettagli dell'istanza.",
      instance_failure_description: "Non siamo riusciti a caricare i dettagli della tua istanza.",
      instance_failure_hint: "Controlla la connessione e riprova.",
      powered_by: "Offerto da",
      sign_in_to_add_comment: "Accedi per aggiungere un commento",
      link_copied: "Link copiato!",
      work_item_link_copied: "Link dell'elemento di lavoro copiato negli appunti.",
      comment_post_error: "Impossibile pubblicare il commento. Riprova.",
      add_comment: "Aggiungi commento",
      public_board_not_found: "La bacheca pubblica non esiste. Controlla l'URL.",
      no_work_items_found: "Nessun elemento di lavoro trovato",
      error_title: "Ops! Non sembra andare bene.",
      refresh: "Aggiorna",
      forum: "Forum",
      not_found_title: "Non ha funzionato",
      user_already_logged_in: "Utente già connesso",
      logged_in_title: "Bene! Manca solo un passaggio.",
      by_creating_account: "Creando un account",
      by_signing_in: "Accedendo",
      you_agree_to_our: "accetti i nostri",
