...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      instance_failure_description: "Non è stato possibile caricare i dettagli dell'istanza.",
      ...
      link_copied: "Link copiato!",
      work_item_link_copied: "Collegamento all'elemento di lavoro copiato negli appunti.",
      comment_post_error: "Impossibile pubblicare il commento. Per favore riprova.",
      add_comment: "Aggiungi commento",
      public_board_not_found: "Il consiglio pubblico non esiste. Si prega di controllare URL.",
