...
export default {
  ...
  localized_ui: {
    ...
    workspace_views: {
      page_title: "{workspaceName} - Todas las vistas",
    },
    ...
    editor: {
      url: "URL",
      enter_or_paste_url: "Introduce o pega la URL",
      text: "Texto",
      enter_text_to_display: "Ingrese el texto para mostrar",
      remove_link: "Quitar enlace",
      edit_link: "Editar enlace",
      color: "Color",
      text_colors: "Colores de texto",
      background_colors: "Colores de fondo",
      link: "Enlace",
      enter_or_paste_link: "Ingresar o pegar enlace",
      please_enter_valid_url: "Por favor ingresa un URL válido",
      delete: "Borrar",
      duplicate: "Duplicado",
      multiple: "Múltiple",
      loading: "Cargando",
      ...
      uploading: "Subiendo",
      drop_image_here: "Suelta imagen aquí",
      retry_duplication: "Reintentar la duplicación",
      retry: "Rever",
      no_emojis_found: "No se encontraron emojis",
      fullscreen_image_viewer: "Visor de imágenes en pantalla completa",
      close_image_viewer: "Cerrar visor de imágenes",
      zoom_out: "alejar",
      zoom_in: "Dar un golpe de zoom",
      download_image: "Descargar imagen",
      open_image_in_new_tab: "Abrir imagen en nueva pestaña",
      view_in_full_screen: "Ver en pantalla completa",
      view_image_in_full_screen: "Ver imagen en pantalla completa",
      align: "Alinear",
      download: "Descargar",
      clear_contents: "Borrar contenidos",
      insert_above: "Insertar arriba",
      insert_below: "Insertar abajo",
      insert_left: "Insertar a la izquierda",
      insert_right: "Insertar a la derecha",
      header_row: "fila de encabezado",
      header_column: "columna de encabezado",
      alignment: {
        left: "Izquierda",
        center: "Centro",
        right: "Bien",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "Has sido invitado a {workspaceName}",
      description:
        "Su espacio de trabajo es donde creará proyectos, colaborará en sus elementos de trabajo y organizará diferentes flujos de trabajo en su cuenta Plane.",
      accept: "Aceptar",
      ignore: "Ignorar",
      already_member: "Ya eres miembro de {workspaceName}",
      continue_to_home: "Continuar a casa",
      inactive_title: "Este enlace de invitación ya no está activo.",
      empty_project_link: "O empezar desde un proyecto vacío",
      sign_in_to_continue: "Inicia sesión para continuar",
      star_on_github: "Destacanos en GitHub",
      join_community: "Únete a nuestra comunidad de creadores activos",
    },
    space_auth: {
      email: "Correo electrónico",
      email_invalid: "El correo electrónico no es válido",
      clear_email: "Borrar correo electrónico",
      password: "Contraseña",
      set_password: "Establecer una contraseña",
      ...
      continue: "Continuar",
      go_to_workspace: "Ir al espacio de trabajo",
      sign_in_with_unique_code: "Inicia sesión con código único",
      create_account: "Crear una cuenta",
      unique_code: "código único",
      paste_code_sent: "Pega el código enviado a tu correo electrónico",
    ...
    onboarding: {
      create_profile_title: "Crea tu perfil.",
      create_profile_description: "Así aparecerás en Plane.",
      change_image: "Cambiar imagen",
      upload_image: "Subir imagen",
      name: "Nombre",
      name_required: "El nombre es obligatorio",
      name_within_50: "El nombre debe tener 50 caracteres como máximo.",
      ...
      continue: "Continuar",
      invite_team_title: "Invita a tus compañeros de equipo",
      invite_team_description:
        "El trabajo en Plane se desarrolla mejor con tu equipo. Invítalos ahora a utilizar Plane en todo su potencial.",
      invalid_email: "Eso no parece una dirección de correo electrónico.",
      success: "¡Éxito!",
      invitations_sent: "Invitaciones enviadas exitosamente.",
      error: "¡Error!",
      add_another: "agregar otro",
      do_later: "lo haré más tarde",
      join_invites_title: "Únase a invitaciones o cree un espacio de trabajo",
      unified_description: "Todo tu trabajo, unificado.",
      ...
      accept_invites: "Acepta las invitaciones para colaborar con tu equipo.",
      continue_to_workspace: "Continuar al espacio de trabajo",
      or: "o",
      create_own_workspace: "Crea tu propio espacio de trabajo",
      workspace_creation_disabled:
        "Parece que no tiene ninguna invitación a un espacio de trabajo y el administrador de su instancia ha restringido la creación de nuevos espacios de trabajo. Pídale al propietario o administrador del espacio de trabajo que lo invite primero a un espacio de trabajo y regrese a esta pantalla para unirse.",
      create_workspace_title: "Crea tu espacio de trabajo",
      enter_workspace_name: "Introduzca el nombre del espacio de trabajo",
      join_existing_workspace: "Unirse al espacio de trabajo existente",
      profile_setup_completed: "Configuración del perfil completada.",
      profile_setup_failed: "Error en la configuración del perfil.",
      usecase_title: "¿Cómo planeas utilizar Plane?",
      usecase_description: "Seleccione una o más opciones para que podamos personalizar su experiencia.",
      select_one_or_more: "Seleccione uno o más",
      select_at_least_one: "Seleccione al menos una opción.",
      skip: "Saltar",
    },
    inbox: {
      ...
      errors: {
        ...
        asset_duplication_failed: "Falló la duplicación de activos. Inténtelo de nuevo más tarde.",
        permission_denied: "Permiso denegado",
        mark_duplicate_permission:
          "Solo los administradores del proyecto pueden marcar un elemento de trabajo como duplicado",
        mark_duplicate_permission_plural:
          "Solo los administradores del proyecto pueden marcar elementos de trabajo como duplicados",
      },
      filters: {
        ...
        status: "Estado",
        work_item_status: "Estado del elemento de trabajo",
        view_all: "Ver todo",
        view_less: "Ver menos",
        date_options: {
          today: "Hoy",
      ...
      navigation: {
        ...
        next_work_item: "Siguiente elemento de trabajo",
      },
      properties: {
        duplicate_of: "Duplicado de",
      },
      select_duplicate: {
        select_work_item: "Seleccionar elemento de trabajo",
      },
      sidebar: {
        label_count: "Etiquetas {count}",
      },
      toasts: {
        editor_processing: "El editor todavía está procesando cambios. Espere antes de continuar.",
        create_success: "Elemento de trabajo creado correctamente.",
        delete_failed: "Error al eliminar el elemento de trabajo",
        update_failed: "Error al actualizar el elemento de trabajo",
      },
    },
    space_public: {
      error_title: "¡Vaya! Esto no se ve bien.",
      error_description_prefix:
        "Plane se bloqueó. No te preocupes, nuestros ingenieros ya fueron notificados. Si tienes más detalles, escribe a",
      error_description_middle: "o en nuestro",
      forum: "Foro",
      refresh: "Actualizar",
      not_found_title: "Eso no funcionó",
      not_found_hint: "Comprueba la URL en la barra de direcciones del navegador e inténtalo de nuevo.",
      user_already_logged_in: "El usuario ya ha iniciado sesión",
      logged_in_title: "Bien. Solo falta un paso.",
      logged_in_hint:
        "Introduce en la barra de direcciones del navegador la URL pública compartida o el enlace de la vista o página que quieres ver.",
      by_creating_account: "Al crear una cuenta",
      by_signing_in: "Al iniciar sesión",
      you_agree_to_our: "aceptas nuestros",
      ...
      auth: {
        sign_in_header: "Inicia sesión para votar o comentar",
        sign_in_subheader: "Ayuda a impulsar las funciones que quieres que se creen.",
        sign_up_header: "Ver, comentar y hacer más",
        sign_up_subheader: "Regístrate o inicia sesión para trabajar con elementos de trabajo y páginas de Plane.",
      },
      peek: {
        side: "Vista lateral",
        modal: "Modal",
      ...
      bot_name: "Bot de {name}",
      commented_time: "comentó {time}",
      and_more: "y {count} más",
      no_upvotes_yet: "Aún no hay votos positivos",
      no_downvotes_yet: "Aún no hay votos negativos",
      view_less: "Ver menos",
      view_all: "Ver todo",
      no_matches_found: "No se encontraron coincidencias",
      no_date: "Sin fecha",
      no_cycle: "Sin ciclo",
      no_modules: "Sin módulos",
      modules_count: "{count} módulos",
      no_assignees: "Sin responsables",
      labels_count: "{count} etiquetas",
      page_not_found_alt: "Página no encontrada",
      something_went_wrong: "¡Ups! Algo salió mal.",
      page_not_found_description: "La página que buscas no existe o se ha movido.",
      instance_failure_image_alt: "No se pudieron obtener los detalles de la instancia",
      instance_failure_title: "No se pudieron obtener los detalles de la instancia.",
      instance_failure_description: "No pudimos cargar los detalles de tu instancia.",
      instance_failure_hint: "Comprueba tu conexión e inténtalo de nuevo.",
      retry: "Reintentar",
      powered_by: "Con tecnología de",
      sign_in_to_add_comment: "Inicia sesión para añadir un comentario",
      sign_in: "Iniciar sesión",
      link_copied: "¡Enlace copiado!",
      work_item_link_copied: "Enlace del elemento de trabajo copiado al portapapeles.",
      comment_post_error: "No se pudo publicar el comentario. Inténtalo de nuevo.",
      add_comment: "Añadir comentario",
      public_board_not_found: "El tablero público no existe. Comprueba la URL.",
