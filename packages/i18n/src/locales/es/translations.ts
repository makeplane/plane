...
export default {
  ...
  localized_ui: {
    editor: {
          "url": "URL",
          "enter_or_paste_url": "Introduce o pega una URL",
          "text": "Texto",
          "enter_text_to_display": "Introduce el texto que se mostrará",
      ...
      "workspace_invitation": {
          ...
          "description": "Tu espacio de trabajo es donde crearás proyectos, colaborarás en tus elementos de trabajo y organizarás diferentes flujos de trabajo en tu cuenta de Plane.",
          "accept": "Aceptar",
          "ignore": "Ignorar",
          ...
          "empty_project_link": "O empieza desde un proyecto vacío",
      ...
      "space_auth": {
          ...
          "paste_code_sent": "Pega el código enviado a tu correo",
      ...
      "onboarding": {
          ...
          "name_within_50": "El nombre debe tener 50 caracteres o menos.",
          ...
          "continue": "Continue",
          "invite_team_title": "Invita a tus compañeros",
          "invite_team_description": "Plane funciona mejor con tu equipo. Invítalos ahora para aprovechar todo el potencial de Plane.",
          ...
          "join_invites_title": "Unirse a invitaciones o crear un espacio de trabajo",
          ...
          "you_are_invited": "¡Has sido invitado!",
          "accept_invites": "Acepta las invitaciones para colaborar con tu equipo.",
          "continue_to_workspace": "Continuar al espacio de trabajo",
          "or": "o",
          "create_own_workspace": "Crear tu propio espacio de trabajo",
          "workspace_creation_disabled": "Parece que no tienes invitaciones a ningún espacio de trabajo y el administrador de la instancia ha restringido la creación de nuevos espacios. Pide primero a un propietario o administrador que te invite y vuelve a esta pantalla para unirte.",
          "create_workspace_title": "Crea tu espacio de trabajo",
          "enter_workspace_name": "Introduce el nombre del espacio de trabajo",
          "join_existing_workspace": "Unirse a un espacio de trabajo existente"
      }
  },
} as const;
