...
export default {
  ...
  localized_ui: {
    ...
    workspace_invitation: {
      ...
      description:
        "Tu espacio de trabajo es donde crearás proyectos, colaborarás en tus elementos de trabajo y organizarás diferentes flujos de trabajo en tu cuenta de Plane.",
      accept: "Aceptar",
      ignore: "Ignorar",
    ...
    onboarding: {
      ...
      invite_team_description:
        "Plane funciona mejor con tu equipo. Invítalos ahora para aprovechar todo el potencial de Plane.",
      ...
      workspace_creation_disabled:
        "Parece que no tienes invitaciones a ningún espacio de trabajo y el administrador de la instancia ha restringido la creación de nuevos espacios. Pide primero a un propietario o administrador que te invite y vuelve a esta pantalla para unirte.",
