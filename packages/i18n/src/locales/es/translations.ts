...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      instance_failure_image_alt: "No se pueden recuperar los detalles de la instancia",
      instance_failure_title: "No se pueden recuperar los detalles de la instancia.",
      instance_failure_description: "No pudimos cargar los detalles de su instancia.",
      instance_failure_hint: "Por favor verifique su conexión e inténtelo nuevamente.",
      retry: "Rever",
      powered_by: "Desarrollado por",
      sign_in_to_add_comment: "Inicia sesión para agregar un comentario",
      sign_in: "Iniciar sesión",
      link_copied: "Enlace copiado!",
      work_item_link_copied: "Enlace del elemento de trabajo copiado al portapapeles.",
      comment_post_error: "No se pudo publicar el comentario. Por favor inténtalo de nuevo.",
      add_comment: "Añadir comentario",
      public_board_not_found: "La junta pública no existe. Por favor verifique el URL.",
