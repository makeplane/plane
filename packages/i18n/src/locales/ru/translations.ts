...
export default {
  ...
  localized_ui: {
    ...
    editor: {
      ...
      text: "Текст",
      enter_text_to_display: "Введите текст для отображения",
      remove_link: "Удалить ссылку",
      edit_link: "Изменить ссылку",
      color: "Цвет",
      text_colors: "Цвета текста",
      background_colors: "Цвета фона",
      link: "Ссылка",
      enter_or_paste_link: "Введите или вставьте ссылку",
      ...
      uploading: "Загрузка",
      drop_image_here: "Перетащите изображение сюда",
      retry_duplication: "Повторить попытку дублирования",
      retry: "Повторить попытку",
      no_emojis_found: "Смайлики не найдены",
      fullscreen_image_viewer: "Полноэкранный просмотр изображений",
      close_image_viewer: "Закрыть просмотрщик изображений",
      zoom_out: "Уменьшить масштаб",
      zoom_in: "Увеличить масштаб",
      download_image: "Скачать изображение",
      open_image_in_new_tab: "Открыть изображение в новой вкладке",
      view_in_full_screen: "Посмотреть в полноэкранном режиме",
      view_image_in_full_screen: "Посмотреть изображение в полноэкранном режиме",
      align: "Выровнять",
      download: "Скачать",
      clear_contents: "Очистить содержимое",
      insert_above: "Вставьте выше",
      insert_below: "Вставьте ниже",
      insert_left: "Вставить слева",
      insert_right: "Вставить вправо",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "Вас пригласили в {workspaceName}.",
      description:
        "Ваше рабочее пространство — это место, где вы будете создавать проекты, совместно работать над рабочими элементами и организовывать различные потоки работы в своей учетной записи Plane.",
      accept: "Принимать",
      ignore: "игнорировать",
      already_member: "Вы уже являетесь участником {workspaceName}.",
      continue_to_home: "Продолжить путь домой",
      inactive_title: "Эта ссылка-приглашение больше не активна.",
      empty_project_link: "Или начать с пустого проекта",
      sign_in_to_continue: "Войдите, чтобы продолжить",
      star_on_github: "Поставьте нам звезду на GitHub",
      join_community: "Присоединяйтесь к нашему сообществу активных авторов",
    },
    space_auth: {
      ...
      continue: "Продолжать",
      go_to_workspace: "Перейти в рабочую область",
      sign_in_with_unique_code: "Войдите с помощью уникального кода",
      create_account: "Зарегистрироваться",
      unique_code: "Уникальный код",
      paste_code_sent: "Вставьте код, отправленный на вашу электронную почту",
      resend_in: "Отправить повторно через {seconds}s",
      requesting_new_code: "Запрос нового кода",
      resend: "Отправить повторно",
      sending_code: "Отправка кода",
    },
    onboarding: {
      create_profile_title: "Создайте свой профиль.",
      create_profile_description: "Вот как вы будете выглядеть в Plane.",
      change_image: "Изменить изображение",
      upload_image: "Загрузить изображение",
      name: "Имя",
      name_required: "Требуется имя",
      name_within_50: "Имя должно быть не более 50 символов.",
      ...
      continue: "Продолжать",
      invite_team_title: "Пригласите своих товарищей по команде",
      invite_team_description:
        "Работать в Plane лучше всего вместе с вашей командой. Предложите им сейчас использовать Plane в полной мере.",
      invalid_email: "Это не похоже на адрес электронной почты.",
      success: "Успех!",
      invitations_sent: "Приглашения успешно отправлены.",
      error: "Ошибка!",
      add_another: "Добавить еще",
      do_later: "я сделаю это позже",
      join_invites_title: "Присоединяйтесь к приглашениям или создайте рабочее пространство",
      unified_description: "Вся ваша работа — едина.",
      create_new_workspace: "Создать новое рабочее пространство",
      no_invitations_found: "Приглашения не найдены",
      you_are_invited: "Вы приглашены!",
      accept_invites: "Примите приглашения к сотрудничеству с вашей командой.",
      continue_to_workspace: "Перейти в рабочую область",
      or: "или",
      create_own_workspace: "Создайте свое собственное рабочее пространство",
      workspace_creation_disabled:
        "Похоже, у вас нет приглашений в рабочую область, а администратор вашего экземпляра ограничил создание новых рабочих областей. Попросите владельца или администратора рабочей области сначала пригласить вас в рабочую область, а затем вернитесь на этот экран, чтобы присоединиться.",
      create_workspace_title: "Создайте свое рабочее пространство",
      enter_workspace_name: "Введите имя рабочей области",
      join_existing_workspace: "Присоединиться к существующей рабочей области",
      profile_setup_completed: "Настройка профиля завершена.",
      profile_setup_failed: "Настройка профиля не удалась.",
      usecase_title: "Как вы планируете использовать Plane?",
      usecase_description: "Выберите один или несколько вариантов, чтобы мы могли персонализировать ваш опыт.",
      select_one_or_more: "Выберите один или несколько",
      select_at_least_one: "Выберите хотя бы один вариант.",
      skip: "Пропускать",
    },
    inbox: {
      ...
      errors: {
        ...
        asset_duplication_failed: "Дублирование активов не удалось. Пожалуйста, повторите попытку позже.",
        permission_denied: "Доступ запрещен",
        mark_duplicate_permission: "Только администраторы проекта могут пометить рабочий элемент как дубликат.",
        mark_duplicate_permission_plural:
          "Только администраторы проекта могут отмечать рабочие элементы как повторяющиеся.",
      },
      filters: {
        ...
        status: "Статус",
        work_item_status: "Статус рабочего элемента",
      ...
      navigation: {
        previous_work_item: "Предыдущий рабочий элемент",
      ...
      sidebar: {
        label_count: "Этикетки {count}",
      },
      toasts: {
        editor_processing: "Редактор все еще обрабатывает изменения. Пожалуйста, подождите, прежде чем продолжить.",
        create_success: "Рабочий элемент успешно создан.",
        delete_failed: "Удаление рабочего элемента не удалось",
        update_failed: "Обновление рабочего элемента не удалось",
      },
    },
    space_public: {
      error_description_prefix:
        "Plane аварийно завершил работу. Наши инженеры уже уведомлены. Если у вас есть дополнительные сведения, напишите на",
      error_description_middle: "или в нашем",
      not_found_hint: "Проверьте URL в адресной строке браузера и попробуйте еще раз.",
      logged_in_hint:
        "Введите в адресной строке браузера публичный URL или ссылку на представление либо страницу, которую хотите открыть.",
      oauth_with_provider: "{action} через {provider}",
      auth: {
        sign_in_header: "Войдите, чтобы голосовать или комментировать",
        sign_in_subheader: "Помогите продвинуть функции, которые вы хотите увидеть реализованными.",
        sign_up_header: "Просматривайте, комментируйте и делайте больше",
        sign_up_subheader: "Зарегистрируйтесь или войдите, чтобы работать с рабочими элементами и страницами Plane.",
      },
      peek: {
        side: "Боковой просмотр",
        modal: "Модальное окно",
        full_screen: "Полный экран",
      },
      bot_name: "Бот {name}",
      commented_time: "прокомментировал {time}",
      and_more: "и еще {count}",
      no_upvotes_yet: "Пока нет голосов за",
      no_downvotes_yet: "Пока нет голосов против",
      modules_count: "{count} модулей",
      labels_count: "{count} меток",
      page_not_found_alt: "Страница не найдена",
      ...
      instance_failure_image_alt: "Не удалось получить сведения об инстансе",
      instance_failure_title: "Не удалось получить сведения об инстансе.",
      instance_failure_description: "Не удалось загрузить сведения о вашем инстансе.",
      instance_failure_hint: "Проверьте подключение и попробуйте еще раз.",
      powered_by: "Работает на",
      sign_in_to_add_comment: "Войдите, чтобы добавить комментарий",
      link_copied: "Ссылка скопирована!",
      work_item_link_copied: "Ссылка на рабочий элемент скопирована в буфер обмена.",
      comment_post_error: "Не удалось опубликовать комментарий. Попробуйте еще раз.",
      add_comment: "Добавить комментарий",
      public_board_not_found: "Публичная доска не существует. Проверьте URL.",
      no_work_items_found: "Рабочие элементы не найдены",
      error_title: "Упс! Что-то пошло не так.",
      refresh: "Обновить",
      forum: "Форум",
      not_found_title: "Не получилось",
      user_already_logged_in: "Пользователь уже вошел",
      logged_in_title: "Отлично! Остался еще один шаг.",
      by_creating_account: "Создавая учетную запись",
      by_signing_in: "Входя в систему",
      you_agree_to_our: "вы соглашаетесь с нашими",
      ...
      no_date: "Без даты",
      no_cycle: "Без цикла",
      no_modules: "Без модулей",
      no_assignees: "Без исполнителей",
      no_labels: "Без меток",
      user: "Пользователь",
    },
  },
