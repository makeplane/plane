...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      instance_failure_image_alt: "Не удалось получить сведения об экземпляре.",
      instance_failure_title: "Не удалось получить сведения об экземпляре.",
      instance_failure_description: "Нам не удалось загрузить сведения о вашем экземпляре.",
      instance_failure_hint: "Пожалуйста, проверьте подключение и повторите попытку.",
      retry: "Повторить попытку",
      ...
      comment_post_error: "Не удалось опубликовать комментарий. Пожалуйста, попробуйте еще раз.",
      add_comment: "Добавить комментарий",
      public_board_not_found: "Общественного совета не существует. Пожалуйста, проверьте URL.",
