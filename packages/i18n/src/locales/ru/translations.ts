...
если уверены в правильности поиска.`,
 ...
 Создайте новое представление вместо этого.`,
  ...
  initiatives: {
    ...
    archive_description: "Архивировать можно только завершённые или закрытые инициативы",
    toast: {
      ...
      archive: {
        success: "Инициатива успешно заархивирована.",
        error: "Не удалось заархивировать инициативу",
        initiative_cannot_be_archived_in_this_state: "Инициативу нельзя заархивировать в этом состоянии",
      },
 ...
 Создайте новую инициативу вместо этого.`,
        archived_description: "Не обнаружено архивных инициатив, соответствующих критериям.",
      },
      not_found: {
