...
export default {
  ...
  mail: {
    ...
    webmail: {
      title: "Серверный webmail",
      reload: "Перезагрузить",
      open_external: "Открыть отдельно",
      unavailable_title: "Webmail не настроен",
      unavailable_description: "Укажите MAIL_WEBMAIL_URL или MAIL_DOMAIN, чтобы подключить Roundcube к этому разделу.",
    },
    settings: {
      ...
      account: {
        ...
        webmail_title: "Серверный webmail",
        open_webmail: "Открыть",
        general: "Общие",
