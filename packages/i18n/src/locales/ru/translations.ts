 ...
 разбивку работы по меткам.`,
  ...
  oauth_bridge_integration: {
    ...
    provider_form: {
      ...
      user_claim_label: "Claim пользователя",
      user_claim_placeholder: "email",
      user_claim_description: "JWT claim, содержащий email пользователя",
      user_claim_required: "Claim пользователя обязателен.",
  ...
  work_item_type_hierarchy: {
    ...
    levels: {
      ...
      zero_level_description:
        "По умолчанию все типы рабочих элементов находятся на уровне 0, пока они не назначены в иерархию.",
    },
    add_level_modal: {
