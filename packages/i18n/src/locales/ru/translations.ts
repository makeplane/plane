...
• Создание задач и комментариев: добавляйте задачи, описания и комментарии с помощью голосовых команд.`,
  ...
  work_item_type_hierarchy: {
    ...
    levels: {
      ...
      zero_level_description: "По умолчанию все типы рабочих элементов находятся на уровне 0, пока они не назначены в иерархию.",
    },
    add_level_modal: {
      ...
      empty_state: {
        ...
        description: "Каждый тип рабочего элемента, определённый в этом рабочем пространстве, уже является частью иерархии.",
      },
      invalid_level_toast: {
        title: "Ошибка!",
