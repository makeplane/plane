...
export default {
  ...
  auth: {
    common: {
      ...
      continue_with: "{action} через {provider}",
      sign_in_title: "Вход",
    ...
    no_auth_methods: {
      ...
      description: "Обратитесь к администратору, чтобы включить аутентификацию для вашего инстанса.",
    },
  },
  submit: "Отправить",
  cancel: "Отменить",
  ...
  work_items: "Рабочие элементы",
  all_work_items: "Все рабочие элементы",
  all_epics: "Все эпики",
  cannot_move_to_completed_cycle: "Рабочий элемент нельзя переместить в завершённый цикл",
  ...
  workspace_analytics: {
    ...
    axis: {
      ...
      state_group: "Группа состояний",
      priority: "Приоритет",
      label: "Метка",
      assignee: "Ответственный",
      estimate_point: "Оценка (очки)",
      cycle: "Цикл",
      module: "Модуль",
    ...
    projects_count_overflow: "{count}+ проектов",
  ...
  project_cycles: {
    ...
    active_cycle: {
      ...
      pending_work_items: "Осталось рабочих элементов",
    },
    upcoming_cycle: {
  ...
  mail: {
    ...
    compose: {
      ...
      restore: "Вернуть размер",
      templates: "Шаблоны",
      no_templates: "Шаблонов пока нет",
      body_placeholder: "Текст письма…",
      template_replace_title: "Вставить шаблон?",
      template_replace_description: "Вставив шаблон, вы удалите то, что уже написано в письме.",
      template_replace_confirm: "Вставить шаблон",
      sent: "Письмо поставлено в очередь отправки",
      send_error: "Не удалось отправить письмо",
      draft_saved: "Черновик сохранён",
      draft_error: "Не удалось сохранить черновик",
      upload_error: "Не удалось загрузить вложение",
      import: "Импортировать HTML или Markdown файл",
      import_unsupported: "Можно импортировать только файлы .html и .md",
      import_error: "Не удалось импортировать файл",
      import_replace_title: "Вставить импортированный файл?",
      import_replace_description: "Вставив файл, вы удалите то, что уже написано в письме.",
      import_replace_confirm: "Вставить файл",
      toolbar: {
        bold: "Полужирный",
        italic: "Курсив",
    ...
    settings: {
      ...
      subtitle: "Аккаунт, подпись и предпочтения почты",
      save: "Сохранить",
      cancel: "Отмена",
      create: "Создать",
      edit: "Изменить",
      ...
      account: {
        email: "Почтовый ящик",
        subtitle: "Данные ящика и общие предпочтения",
        domain: "Домен",
        general: "Общие",
        conversation_view: "Группировать письма в цепочки",
        conversation_view_desc: "Объединять связанные письма в одну ветку",
        show_snippets: "Показывать превью писем",
        show_snippets_desc: "Отрывок текста под темой в списке писем",
        language: "Язык интерфейса",
        language_desc: "Язык меню и системных писем",
      },
      signature: {
        empty: "Подписей пока нет",
        subtitle: "Добавляется в конец письма",
        new: "Новая подпись",
        name: "Название",
        name_placeholder: "Например, Основная",
        content: "Текст подписи",
        content_placeholder: "Иван Петров · Gizmo",
      ...
      folders: {
        subtitle: "Системные папки и ваши ярлыки",
        system_title: "Папки",
        labels_title: "Ярлыки",
        new_label: "Создать ярлык",
        label_name: "Название ярлыка",
        color: "Цвет",
        labels_empty: "Ярлыков пока нет",
      },
      filters: {
        empty: "Фильтров пока нет",
        subtitle: "Правила автоматической обработки писем",
        new: "Создать фильтр",
        name: "Название",
        name_placeholder: "Например, Финансы",
        if: "Если",
        then_label: "То",
        match_all: "совпадают все условия",
        match_any: "совпадает любое условие",
        contains: "содержит",
        ...
        actions: {
          label: "Присвоить ярлык",
          mark_read: "Отметить прочитанным",
          skip_inbox: "Пропустить входящие",
          star: "Пометить звездой",
      ...
      templates: {
        ...
        subtitle: "Готовые письма — вставляются в один клик",
        new: "Создать шаблон",
        new_title: "Новый шаблон",
        edit_title: "Редактирование шаблона",
        back: "Все шаблоны",
        name: "Название",
        category: "Категория",
        category_placeholder: "Например, Продажи",
        subject: "Тема письма",
        body: "Тело письма",
        save: "Сохранить шаблон",
      },
      forwarding: {
        enabled: "Пересылать входящие",
        subtitle: "Пересылка писем и автоответ «Нет на месте»",
        enabled_desc: "Копия каждого письма уходит на другой адрес",
        address: "Адрес пересылки",
        address_placeholder: "backup@example.com",
        keep_copy: "Сохранять копию во входящих",
        vacation_title: "Автоответ «Нет на месте»",
        vacation_enabled: "Включить автоответ",
        vacation_subject: "Тема",
        vacation_message: "Текст",
        start: "Начало",
        end: "Окончание",
      },
      security: {
        description: "Доступ к ящику определяется аккаунтом Gizmo и master-user учетными данными Dovecot.",
        subtitle: "Защита аккаунта и доступ к ящику",
      ...
      appearance: {
        ...
        comfortable: "Обычная",
        compact: "Компактная",
        subtitle: "Тема, плотность и область чтения",
        theme: "Тема",
        theme_light: "Светлая",
        theme_dark: "Тёмная",
        theme_system: "Как в Gizmo",
        reading_pane: "Область чтения",
        pane_right: "Справа",
        pane_bottom: "Снизу",
        pane_none: "Скрыта",
        messages_per_page: "Писем на странице",
        mark_read_delay: "Помечать прочитанным",
        delay_none: "Сразу",
        delay_1s: "1 сек",
        delay_1_5s: "1,5 сек",
        delay_3s: "3 сек",
