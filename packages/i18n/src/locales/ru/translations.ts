...
export default {
  ...
  support: "Поддержка",
  forum: "Forum",
  powered_by_plane_pages: "Работает на Gizmo Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Большинство вещей начинаются с проекта в Gizmo.",
        cta: "Начать",
      },
      invite_team: {
  ...
  workspace_creation: {
    ...
    subheading: "Чтобы начать использовать Gizmo, создайте или присоединитесь к рабочему пространству.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Добро пожаловать в Gizmo! Создайте первый проект и отслеживайте рабочие элементы - эта страница станет вашим рабочим пространством. Администраторы также увидят элементы для управления командой.",
        primary_button: {
          text: "Создать первый проект",
          comic: {
            title: "Всё начинается с проекта в Gizmo",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Скопируйте и сохраните секретный ключ в Gizmo Pages. После закрытия ключ будет недоступен. CSV-файл с ключом был скачан.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Используйте API Gizmo для интеграции с внешними системами. Создайте тоекен чтобы начать.",
      },
      webhooks: {
        title: "Нет вебхуков",
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Создайте первый рабочий элемент для начала работы! Добавьте детали и свойства рабочего элемента. Исследуйте больше в Gizmo, чтобы увидеть вашу активность.",
      },
      assigned: {
        title: "Нет назначенных рабочих элементов",
        description: "Здесь отображаются рабочие элементы, назначенные вам.",
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Gizmo будет автоматически архивировать рабочие элементы, которые были завершены или отменены.",
        duration: "Автоархивация рабочих элементов, которые закрыты в течение",
      },
      "auto-close": {
        title: "Автоматическое закрытие рабочих элементов",
        description: "Gizmo будет автоматически закрывать рабочие элементы, которые не были завершены или отменены.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Рабочие элементы - строительные блоки Gizmo",
            description:
  ...
  project_page: {
    empty_state: {
      general: {
        title: "Создавайте заметки, документы или базу знаний. Используйте Galileo, ИИ-помощник Gizmo.",
        description:
          "Страницы - пространство для организации мыслей в Gizmo. Делайте заметки, форматируйте текст, встраивайте рабочие элементы, используйте компоненты. Для быстрого создания документов используйте Galileo через горячие клавиши или кнопку.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Gizmo не запустился. Это может быть из-за того, что один или несколько сервисов Gizmo не смогли запуститься.",
  ...
  power_k: {
    ...
    help_actions: {
      ...
      open_plane_documentation: "Открыть документацию Gizmo",
  ...
  mail: {
    ...
    login: {
      ...
      description:
        "Создайте новый адрес на почтовом домене инстанса или войдите в уже существующий ящик, чтобы привязать его к вашему аккаунту.",
      tabs: {
