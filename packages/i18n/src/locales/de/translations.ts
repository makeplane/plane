...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      instance_failure_image_alt: "Instanzdetails können nicht abgerufen werden",
      instance_failure_title: "Instanzdetails können nicht abgerufen werden.",
      instance_failure_description: "Wir konnten Ihre Instanzdetails nicht laden.",
      instance_failure_hint: "Bitte überprüfen Sie Ihre Verbindung und versuchen Sie es erneut.",
      retry: "Wiederholen",
      powered_by: "Angetrieben von",
      sign_in_to_add_comment: "Melden Sie sich an, um einen Kommentar hinzuzufügen",
      sign_in: "anmelden",
      link_copied: "Link kopiert!",
      work_item_link_copied: "Der Link zum Arbeitselement wurde in die Zwischenablage kopiert.",
      comment_post_error: "Kommentar konnte nicht gepostet werden. Bitte versuchen Sie es erneut.",
      add_comment: "Kommentar hinzufügen",
      public_board_not_found: "Den öffentlichen Vorstand gibt es nicht. Bitte überprüfen Sie die URL.",
