export default {
  ...
  "select_or_customize_your_interface_color_scheme": "Wählen oder gestalten Sie Ihr Farbdesign für die Benutzeroberfläche.",
  "theme": "Theme",
  ...
  "issue": {
    ...
    "add": {
      ...
      "cycle": {
        ...
        "success": "{count, plural, one {Arbeitselement} few {Arbeitselemente} other {Arbeitselemente}} zum Zyklus hinzugefügt.",
    ...
    "archive": {
      ...
      "confirm_message": "Möchten Sie dieses Arbeitselement wirklich archivieren? Alle archivierten Elemente können später wiederhergestellt werden.",
      "success": {
  ...
  "workspace_creation": {
    ...
    "errors": {
      "creation_disabled": {
        ...
        "description": "Wenn Sie die E-Mail Ihres Instanzadministrators kennen, klicken Sie unten, um ihn zu kontaktieren.",
  ...
  "workspace_dashboard": {
    "empty_state": {
      "general": {
        ...
        "description": "Willkommen bei Plane, wir freuen uns, dass Sie hier sind. Erstellen Sie Ihr erstes Projekt, verfolgen Sie Arbeitselemente und diese Seite verwandelt sich in einen Ort für Ihren Fortschritt. Administratoren sehen hier zusätzlich teamrelevante Elemente.",
        "primary_button": {
          "text": "Erstes Projekt erstellen",
          "comic": {
            "title": "Alles beginnt mit einem Projekt in Plane",
            "description": "Ein Projekt kann eine Produkt-Roadmap, eine Marketingkampagne oder die Markteinführung eines neuen Autos sein."
          }
        }
      }
    }
  ...
  "workspace_analytics": {
    ...
    "empty_state": {
      ...
      "general": {
        "title": "Verfolgen Sie Fortschritt, Arbeitsbelastung und Zuweisungen. Erkennen Sie Trends, beseitigen Sie Hindernisse und arbeiten Sie schneller",
        "description": "Sehen Sie Umfang vs. Nachfrage, Schätzungen und Scope Creep. Messen Sie die Leistung von Teammitgliedern und Teams und stellen Sie sicher, dass Ihr Projekt rechtzeitig abgeschlossen wird.",
        "primary_button": {
          "text": "Erstes Projekt starten",
          "comic": {
            "title": "Analytics funktioniert am besten mit Zyklen + Modulen",
            "description": "Begrenzen Sie zunächst Ihre Arbeitselemente zeitlich in Zyklen und gruppieren Sie, wenn möglich, Arbeitselemente, die mehr als einen Zyklus umfassen, in Module. Schauen Sie sich beide in der linken Navigation an."
          }
        }
      }
    },
  ...
  "workspace_projects": {
    ...
    "empty_state": {
      "general": {
        ...
        "description": "Ein Projekt ist einem übergeordneten Ziel zugeordnet. Projekte enthalten Aufgaben, Zyklen und Module. Erstellen Sie ein neues oder filtern Sie archivierte.",
        "primary_button": {
          "text": "Erstes Projekt erstellen",
          "comic": {
            "title": "Alles beginnt mit einem Projekt in Plane",
  ...
  "workspace_settings": {
    ...
    "copy_key": "Kopieren Sie diesen Schlüssel und fügen Sie ihn in Plane Pages ein. Nach dem Schließen können Sie ihn nicht mehr sehen. Eine CSV-Datei mit dem Schlüssel wurde heruntergeladen.",
    ...
    "settings": {
      "general": {
        ...
        "delete_workspace_description": "Das Löschen des Arbeitsbereichs entfernt alle Daten und Ressourcen. Diese Aktion ist nicht umkehrbar.",
      ...
      "members": {
        ...
        "leave_confirmation": "Möchten Sie diesen Arbeitsbereich wirklich verlassen? Sie verlieren den Zugriff. Diese Aktion ist nicht umkehrbar.",
        "details": {
      ...
      "api_tokens": {
        ...
        "delete": {
          ...
          "description": "Alle Anwendungen, die diesen Token verwenden, verlieren den Zugriff. Diese Aktion ist nicht umkehrbar.",
          "success": {
            "title": "Erfolg!",
