...
export default {
  ...
  localized_ui: {
    ...
    workspace_views: {
      page_title: "{workspaceName} - Alle Ansichten",
    },
    ...
    editor: {
      url: "URL",
      enter_or_paste_url: "Geben Sie die URL ein oder fügen Sie sie ein",
      text: "Text",
      enter_text_to_display: "Geben Sie den anzuzeigenden Text ein",
      ...
      link: "Link",
      enter_or_paste_link: "Link eingeben oder einfügen",
      ...
      add_an_image: "Fügen Sie ein Bild hinzu",
      error_loading_image: "Fehler beim Laden des Bildes",
      uploading: "Hochladen",
      drop_image_here: "Bild hier einfügen",
      retry_duplication: "Versuchen Sie es erneut",
      retry: "Wiederholen",
      no_emojis_found: "Keine Emojis gefunden",
      fullscreen_image_viewer: "Vollbild-Bildbetrachter",
      close_image_viewer: "Bildbetrachter schließen",
      zoom_out: "Herauszoomen",
      zoom_in: "Vergrößern",
      download_image: "Bild herunterladen",
      open_image_in_new_tab: "Bild in neuem Tab öffnen",
      view_in_full_screen: "Im Vollbildmodus ansehen",
      view_image_in_full_screen: "Bild im Vollbildmodus anzeigen",
      align: "Ausrichten",
      download: "Herunterladen",
      clear_contents: "Klare Inhalte",
      insert_above: "Oben einfügen",
      insert_below: "Unten einfügen",
      insert_left: "Links einfügen",
      insert_right: "Rechts einfügen",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "Sie wurden zu {workspaceName} eingeladen",
      description:
        "In Ihrem Arbeitsbereich erstellen Sie Projekte, arbeiten gemeinsam an Ihren Arbeitselementen und organisieren verschiedene Arbeitsströme in Ihrem Plane-Konto.",
      accept: "Akzeptieren",
      ignore: "Ignorieren",
      already_member: "Sie sind bereits Mitglied von {workspaceName}",
      continue_to_home: "Weiter nach Hause",
      inactive_title: "Dieser Einladungslink ist nicht mehr aktiv.",
      empty_project_link: "Oder beginnen Sie mit einem leeren Projekt",
      sign_in_to_continue: "Melden Sie sich an, um fortzufahren",
      star_on_github: "Star uns auf GitHub",
      join_community: "Treten Sie unserer Community aktiver YouTuber bei",
    },
    space_auth: {
      email: "E-Mail",
      email_invalid: "E-Mail ist ungültig",
      clear_email: "Klare E-Mail",
      password: "Passwort",
      ...
      go_to_workspace: "Gehen Sie zum Arbeitsbereich",
      sign_in_with_unique_code: "Melden Sie sich mit einem eindeutigen Code an",
      create_account: "Benutzerkonto erstellen",
      unique_code: "Eindeutiger Code",
      paste_code_sent: "Fügen Sie den an Ihre E-Mail gesendeten Code ein",
      resend_in: "In {seconds}s erneut senden",
      requesting_new_code: "Fordern Sie neuen Code an",
      resend: "Erneut senden",
      sending_code: "Code senden",
    },
    onboarding: {
      create_profile_title: "Erstellen Sie Ihr Profil.",
      create_profile_description: "So werden Sie in Plane angezeigt.",
      change_image: "Bild ändern",
      upload_image: "Bild hochladen",
      name: "Name",
      name_required: "Name ist erforderlich",
      name_within_50: "Der Name muss maximal 50 Zeichen lang sein.",
      ...
      continue: "Weitermachen",
      invite_team_title: "Laden Sie Ihre Teamkollegen ein",
      invite_team_description:
        "Die Arbeit in Plane gelingt am besten mit Ihrem Team. Laden Sie sie jetzt ein, Plane voll auszuschöpfen.",
      invalid_email: "Das sieht nicht nach einer E-Mail-Adresse aus.",
      success: "Erfolg!",
      invitations_sent: "Einladungen erfolgreich versendet.",
      error: "Fehler!",
      add_another: "Fügen Sie einen weiteren hinzu",
      do_later: "Ich werde es später tun",
      join_invites_title: "Nehmen Sie an Einladungen teil oder erstellen Sie einen Arbeitsbereich",
      unified_description: "Ihre gesamte Arbeit – einheitlich.",
      create_new_workspace: "Neuen Arbeitsbereich erstellen",
      no_invitations_found: "Keine Einladungen gefunden",
      you_are_invited: "Sie sind eingeladen!",
      accept_invites: "Nehmen Sie die Einladungen zur Zusammenarbeit mit Ihrem Team an.",
      continue_to_workspace: "Weiter zum Arbeitsbereich",
      or: "oder",
      create_own_workspace: "Erstellen Sie Ihren eigenen Arbeitsbereich",
      workspace_creation_disabled:
        "Sie haben offenbar keine Einladungen zu einem Arbeitsbereich und Ihr Instanzadministrator hat die Erstellung neuer Arbeitsbereiche eingeschränkt. Bitten Sie einen Workspace-Inhaber oder Administrator, Sie zunächst zu einem Workspace einzuladen und zu diesem Bildschirm zurückzukehren, um beizutreten.",
      create_workspace_title: "Erstellen Sie Ihren Arbeitsbereich",
      enter_workspace_name: "Geben Sie den Namen des Arbeitsbereichs ein",
      join_existing_workspace: "Treten Sie einem vorhandenen Arbeitsbereich bei",
      profile_setup_completed: "Profileinrichtung abgeschlossen.",
      profile_setup_failed: "Die Profileinrichtung ist fehlgeschlagen.",
      usecase_title: "Wie planen Sie den Einsatz von Plane?",
      usecase_description: "Wählen Sie eine oder mehrere Optionen aus, damit wir Ihr Erlebnis personalisieren können.",
      select_one_or_more: "Wählen Sie eine oder mehrere aus",
      select_at_least_one: "Wählen Sie mindestens eine Option aus.",
      skip: "Überspringen",
    },
    inbox: {
      ...
      errors: {
        ...
        asset_duplication_failed:
          "Die Duplizierung von Assets ist fehlgeschlagen. Bitte versuchen Sie es später noch einmal.",
        permission_denied: "Zugriff verweigert",
        mark_duplicate_permission: "Nur Projektadministratoren können Arbeitselemente als Duplikat markieren",
        mark_duplicate_permission_plural: "Nur Projektadministratoren können Arbeitselemente als Duplikat markieren",
      },
      filters: {
        ...
        status: "Status",
        work_item_status: "Arbeitselementstatus",
      ...
      navigation: {
        previous_work_item: "Vorheriges Arbeitselement",
        next_work_item: "Nächstes Arbeitselement",
      },
      properties: {
        duplicate_of: "Duplikat von",
      },
      select_duplicate: {
        select_work_item: "Arbeitselement auswählen",
      },
      sidebar: {
        label_count: "{count}-Etiketten",
      },
      toasts: {
        editor_processing: "Der Editor verarbeitet noch Änderungen. Bitte warten Sie, bevor Sie fortfahren.",
        create_success: "Arbeitselement erfolgreich erstellt.",
        delete_failed: "Das Löschen des Arbeitselements ist fehlgeschlagen",
        update_failed: "Die Aktualisierung des Arbeitselements ist fehlgeschlagen",
      },
    },
    space_public: {
      error_title: "Hoppla! Das sieht nicht gut aus.",
      error_description_prefix:
        "Plane ist abgestürzt. Keine Sorge, unsere Entwickler wurden benachrichtigt. Wenn Sie weitere Details haben, schreiben Sie bitte an",
      error_description_middle: "oder in unserem",
      forum: "Forum",
      refresh: "Aktualisieren",
      not_found_title: "Das hat nicht funktioniert",
      not_found_hint: "Prüfen Sie die URL in der Adressleiste des Browsers und versuchen Sie es erneut.",
      user_already_logged_in: "Benutzer ist bereits angemeldet",
      logged_in_title: "Gut! Nur noch ein Schritt.",
      logged_in_hint:
        "Geben Sie die öffentliche Freigabe-URL oder den Link der Ansicht oder Seite, die Sie öffnen möchten, in die Adressleiste des Browsers ein.",
      by_creating_account: "Mit dem Erstellen eines Kontos",
      by_signing_in: "Mit der Anmeldung",
      you_agree_to_our: "stimmen Sie unseren",
      terms_of_service: "Nutzungsbedingungen",
      and: "und",
      privacy_policy: "Datenschutzrichtlinie",
      sign_up: "Registrieren",
      oauth_with_provider: "{action} mit {provider}",
      auth: {
        sign_in_header: "Melden Sie sich an, um abzustimmen oder zu kommentieren",
        sign_in_subheader: "Helfen Sie dabei, die Funktionen voranzubringen, die Sie umgesetzt sehen möchten.",
        sign_up_header: "Ansehen, kommentieren und mehr tun",
        sign_up_subheader:
          "Registrieren Sie sich oder melden Sie sich an, um mit Plane-Arbeitselementen und Seiten zu arbeiten.",
      },
      peek: {
        side: "Seitenansicht",
        modal: "Modal",
      ...
      bot_name: "{name}-Bot",
      commented_time: "kommentierte {time}",
      and_more: "und {count} weitere",
      no_upvotes_yet: "Noch keine Upvotes",
      no_downvotes_yet: "Noch keine Downvotes",
      view_less: "Weniger anzeigen",
      view_all: "Alle anzeigen",
      ...
      instance_failure_image_alt: "Instanzdetails konnten nicht abgerufen werden",
      instance_failure_title: "Instanzdetails konnten nicht abgerufen werden.",
      instance_failure_description: "Ihre Instanzdetails konnten nicht geladen werden.",
      instance_failure_hint: "Prüfen Sie Ihre Verbindung und versuchen Sie es erneut.",
      retry: "Erneut versuchen",
      powered_by: "Bereitgestellt von",
      sign_in_to_add_comment: "Melden Sie sich an, um einen Kommentar hinzuzufügen",
      sign_in: "Anmelden",
      link_copied: "Link kopiert!",
      work_item_link_copied: "Link zum Arbeitselement in die Zwischenablage kopiert.",
      comment_post_error: "Kommentar konnte nicht veröffentlicht werden. Bitte versuchen Sie es erneut.",
      add_comment: "Kommentar hinzufügen",
      public_board_not_found: "Das öffentliche Board existiert nicht. Bitte prüfen Sie die URL.",
      no_work_items_found: "Keine Arbeitselemente gefunden",
