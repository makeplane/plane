...
Vytvořte nový.`,
 ...
 Vytvořte nový pohled místo toho.`,
  ...
  initiatives: {
    ...
    archive_description: "Archivovat lze pouze dokončené nebo uzavřené iniciativy",
    toast: {
      ...
      archive: {
        success: "Iniciativa byla úspěšně archivována.",
        error: "Iniciativu se nepodařilo archivovat",
        initiative_cannot_be_archived_in_this_state: "Iniciativu v tomto stavu nelze archivovat",
      },
 ...
 Vytvořte novou iniciativu místo toho.`,
        archived_description: "Žádné archivované iniciativy nebyly detekovány s odpovídajícími kritérii.",
      },
      not_found: {
 ...
 rozdělení práce podle štítků.`,
  ...
  project: {
    members_import: {
      title: "Importovat členy z CSV",
      description:
        "Nahrajte CSV se sloupci: E-mail a Role (5=Host, 15=Člen, 20=Správce). Uživatelé musí být již členy pracovního prostoru.",
      ...
      item_delete_confirmation: {
        ...
        errors: {
          ...
          cannot_delete_work_item_type_with_associated_work_items:
            "Typ pracovní položky s přidruženými pracovními položkami nelze odstranit",
        },
  ...
  oauth_bridge_integration: {
    ...
    header_description:
      "Ověřujte externě vydané OIDC/JWT tokeny z vašeho IdP (Azure AD, Okta atd.) pro přístup k API Plane.",
    connected: "Připojeno",
    connect: "Připojit",
    ...
    provider_form: {
      ...
      jwks_cache_ttl_description:
        "Doba ukládání klíčů JWKS poskytovatele do mezipaměti (minimum 60s, výchozí 24 hodin)",
      ...
      rate_limit_description:
        "Omezení požadavků jako počet/období (např. 120/minute). Ponechte prázdné pro výchozí limit.",
  ...
  dashboards: {
    ...
    create_modal: {
      ...
      filters_label: "Nastavte filtry pro výše uvedené zdroje dat",
...
• Vytvoření úkolu a komentáře: Vytvořte úkoly, popisy a komentáře pomocí hlasových příkazů.`,
  ...
  releases: {
    label: "{count, plural, one {Vydání} other {Vydání}}",
    ...
    scope: "Rozsah",
    page_title: {
      scope: "Vydání - {name} | Rozsah",
      scope_fallback: "Vydání | Rozsah",
    },
    properties: "Vlastnosti",
    ...
    release_tag: "Tag",
    labels: "Štítky",
    description_placeholder: "Přidejte popis...",
    progress: "Průběh",
    completed_work_items: "Dokončené pracovní položky",
    pending_work_items: "Čekající pracovní položky",
    cancelled_work_items: "Zrušené pracovní položky",
    scope_page: {
      work_items: "Pracovní položky",
      add_work_items: "Přidat pracovní položky",
      remove_from_release: "Odebrat z vydání",
      empty_state: {
        title: "Žádné pracovní položky",
        description: "Přidejte pracovní položky pro vymezení rozsahu vydání.",
      },
      confirm_remove: {
        content: "Opravdu chcete odebrat tuto pracovní položku z vydání? V projektu zůstane.",
        primary_button: {
          default: "Odebrat",
          loading: "Odebírání",
        },
    ...
    empty_state: {
      title: "Zatím žádný rozsah",
      description: "Přidejte pracovní položky k vydání a sledujte jejich dokončení pro toto vydání.",
      add_scope: "Přidat rozsah",
      not_found: {
        title: "Vydání nenalezeno",
        description: "Vydání mohlo být smazáno.",
        primary_button: "Zpět na vydání",
      },
    },
    toast: {
      work_items_added: "{count, plural, one {Pracovní položka přidána} other {Pracovní položky přidány}}",
      work_items_error: "Nepodařilo se přidat pracovní položky",
    },
  ...
  work_item_type_hierarchy: {
    settings: {
      ...
      description:
        "Nastavte úrovně hierarchie pro organizaci vaší práce. Každá úroveň definuje nadřazený vztah s položkou přímo nad ní a podřazený vztah s položkou přímo pod ní. ",
    ...
    break_hierarchy_modal: {
      ...
      content: {
        ...
        parent_items:
          "{count, plural, one {nadřazenou pracovní položku} few {nadřazené pracovní položky} other {nadřazených pracovních položek}}",
        child_items:
          "{count, plural, one {podřazenou pracovní položku} few {podřazené pracovní položky} other {podřazených pracovních položek}}",
        parent_line_suffix_when_also_children: ", a ",
        footer:
          "Tato změna odstraní nadřazené a podřazené vztahy u stávajících pracovních položek typu {workItemTypeName}.",
      },
      confirm_input: {
      ...
      error_toast: {
        title: "Chyba!",
        message: "Nepodařilo se přerušit hierarchii. Zkuste to prosím znovu.",
      },
      confirm_button: {
        loading: "Používání",
        default: "Použít a odpojit",
      },
    },
    work_item_modal: {
      invalid_work_item_type_create_toast: {
        title: "Chyba!",
        message:
          "Vybraný typ pracovní položky nelze použít k vytvoření nové pracovní položky, protože porušuje pravidla hierarchie.",
      },
  ...
  page_actions: {
    move_page: {
      placeholders: {
        ...
        teamspace_to_all_with_wiki: "Hledat wiki kolekce, projekty a týmové prostory",
      },
      toasts: {
        collection_error: {
  ...
  wiki_collections: {
    ...
    delete_modal: {
      ...
      transfer_description:
        "Před smazáním přesuňte všechny stránky do jiné kolekce. Stránky i jejich oprávnění zůstanou zachovány.",
