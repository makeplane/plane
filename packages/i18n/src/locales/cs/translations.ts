...
export default {
  ...
  localized_ui: {
    ...
    space_public: {
      ...
      instance_failure_description: "Nepodařilo se načíst podrobnosti o vaší instanci.",
      instance_failure_hint: "Zkontrolujte připojení a zkuste to znovu.",
      retry: "Zkuste to znovu",
      powered_by: "Provozováno na",
      sign_in_to_add_comment: "Chcete-li přidat komentář, přihlaste se",
      sign_in: "Přihlaste se",
      link_copied: "Odkaz zkopírován!",
      work_item_link_copied: "Odkaz na pracovní položku zkopírován do schránky.",
      comment_post_error: "Komentář se nepodařilo přidat. Zkuste to prosím znovu.",
      add_comment: "Přidat komentář",
      public_board_not_found: "Veřejná rada neexistuje. Zkontrolujte prosím URL.",
