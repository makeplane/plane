...
export default {
  ...
  localized_ui: {
    ...
    editor: {
      ...
      text: "Text",
      enter_text_to_display: "Zadejte text, který chcete zobrazit",
      remove_link: "Odebrat odkaz",
      edit_link: "Upravit odkaz",
      color: "Barva",
      text_colors: "Barvy textu",
      background_colors: "Barvy pozadí",
      link: "Odkaz",
      enter_or_paste_link: "Zadejte nebo vložte odkaz",
      ...
      add_an_image: "Přidejte obrázek",
      error_loading_image: "Chyba při načítání obrázku",
      uploading: "Nahrávání",
      drop_image_here: "Přetáhněte obrázek sem",
      retry_duplication: "Opakovat duplikaci",
      retry: "Zkuste to znovu",
      no_emojis_found: "Nebyly nalezeny žádné emotikony",
      fullscreen_image_viewer: "Prohlížeč obrázků na celou obrazovku",
      close_image_viewer: "Zavřete prohlížeč obrázků",
      zoom_out: "Oddálit",
      zoom_in: "Přiblížit",
      download_image: "Stáhnout obrázek",
      open_image_in_new_tab: "Otevřít obrázek na nové kartě",
      view_in_full_screen: "Zobrazit přes celou obrazovku",
      view_image_in_full_screen: "Zobrazit obrázek na celé obrazovce",
      align: "Zarovnat",
      download: "Stáhnout",
      clear_contents: "Přehledný obsah",
      insert_above: "Vložte výše",
      insert_below: "Vložte níže",
      insert_left: "Vložte vlevo",
      insert_right: "Vložte vpravo",
      header_row: "Řádek záhlaví",
      header_column: "Sloupec záhlaví",
      alignment: {
        left: "Vlevo",
        center: "Centrum",
        right: "Vpravo",
    ...
    workspace_invitation: {
      ...
      invited_to_workspace: "Byli jste pozváni do {workspaceName}",
      description:
        "Váš pracovní prostor je místo, kde budete vytvářet projekty, spolupracovat na svých pracovních položkách a organizovat různé toky práce ve svém účtu Plane.",
      accept: "Přijmout",
      ignore: "Ignorovat",
      already_member: "Již jste členem {workspaceName}",
      continue_to_home: "Pokračujte domů",
      inactive_title: "Tento odkaz na pozvánku již není aktivní.",
      empty_project_link: "Nebo začněte z prázdného projektu",
      sign_in_to_continue: "Chcete-li pokračovat, přihlaste se",
      star_on_github: "Sledujte nás na GitHub",
      join_community: "Připojte se k naší komunitě aktivních tvůrců",
    },
    space_auth: {
      email: "E-mail",
      ...
      continue: "Pokračovat",
      go_to_workspace: "Přejděte do pracovního prostoru",
      sign_in_with_unique_code: "Přihlaste se pomocí jedinečného kódu",
      create_account: "Vytvořit účet",
      unique_code: "Unikátní kód",
      paste_code_sent: "Vložte kód zaslaný na váš e-mail",
      resend_in: "Znovu odeslat v {seconds}s",
      requesting_new_code: "Požadavek na nový kód",
      resend: "Odeslat znovu",
      sending_code: "Odesílání kódu",
    },
    onboarding: {
      create_profile_title: "Vytvořte si svůj profil.",
      create_profile_description: "Takto se objevíte v Plane.",
      change_image: "Změnit obrázek",
      upload_image: "Nahrajte obrázek",
      name: "Jméno",
      name_required: "Jméno je povinné",
      name_within_50: "Název musí mít maximálně 50 znaků.",
      enter_full_name: "Zadejte své celé jméno",
      set_password: "Nastavte heslo",
      optional: "Volitelný",
      passwords_do_not_match: "Hesla se neshodují",
      passwords_match: "Hesla se shodují",
      continue: "Pokračovat",
      invite_team_title: "Pozvěte své spoluhráče",
      invite_team_description: "Práce v Plane probíhá nejlépe s vaším týmem. Pozvěte je, aby využili potenciál Plane.",
      invalid_email: "To nevypadá jako e-mailová adresa.",
      success: "Úspěch!",
      invitations_sent: "Pozvánky byly úspěšně odeslány.",
      error: "Chyba!",
      add_another: "Přidejte další",
      do_later: "Udělám to později",
      join_invites_title: "Připojte se k pozvánkám nebo vytvořte pracovní prostor",
      unified_description: "Veškerá vaše práce – jednotná.",
      create_new_workspace: "Vytvořte nový pracovní prostor",
      no_invitations_found: "Nebyly nalezeny žádné pozvánky",
      you_are_invited: "Jste zváni!",
      accept_invites: "Přijměte pozvání ke spolupráci se svým týmem.",
      continue_to_workspace: "Pokračujte do pracovního prostoru",
      or: "nebo",
      create_own_workspace: "Vytvořte si vlastní pracovní prostor",
      workspace_creation_disabled:
        "Zdá se, že nemáte žádné pozvánky do pracovního prostoru a váš správce instance omezil vytváření nových pracovních prostorů. Požádejte vlastníka nebo správce pracovního prostoru, aby vás nejprve pozval do pracovního prostoru a vraťte se na tuto obrazovku a připojte se.",
      create_workspace_title: "Vytvořte si svůj pracovní prostor",
      enter_workspace_name: "Zadejte název pracovního prostoru",
      join_existing_workspace: "Připojte se k existujícímu pracovnímu prostoru",
      profile_setup_completed: "Nastavení profilu dokončeno.",
      profile_setup_failed: "Nastavení profilu se nezdařilo.",
      usecase_title: "Jak plánujete používat Plane?",
      usecase_description: "Vyberte jednu nebo více možností, abychom mohli přizpůsobit váš zážitek.",
      select_one_or_more: "Vyberte jednu nebo více",
      select_at_least_one: "Vyberte alespoň jednu možnost.",
      skip: "Přeskočit",
    },
    inbox: {
      ...
      errors: {
        ...
        asset_duplication_failed: "Duplikace aktiv se nezdařila. Zkuste to znovu později.",
        permission_denied: "Povolení odepřeno",
        mark_duplicate_permission: "Pouze správci projektu mohou označit pracovní položku jako duplicitní",
        mark_duplicate_permission_plural: "Pouze správci projektu mohou označit pracovní položky jako duplicitní",
      },
      filters: {
      ...
      navigation: {
        previous_work_item: "Předchozí pracovní položka",
        next_work_item: "Další pracovní položka",
      },
      properties: {
        duplicate_of: "Duplikát",
      },
      select_duplicate: {
        select_work_item: "Vyberte pracovní položku",
      },
      sidebar: {
        label_count: "{count} štítky",
      },
      toasts: {
        editor_processing: "Editor stále zpracovává změny. Před pokračováním prosím počkejte.",
        create_success: "Pracovní položka byla úspěšně vytvořena.",
        delete_failed: "Smazání pracovní položky se nezdařilo",
        update_failed: "Aktualizace pracovní položky se nezdařila",
      },
    },
    space_public: {
      error_title: "Jejda! Tohle nevypadá dobře.",
      error_description_prefix:
        "Plane spadl. Nemějte obavy, naši inženýři už byli upozorněni. Pokud máte další podrobnosti, napište na",
      error_description_middle: "nebo na našem",
      forum: "Fórum",
      refresh: "Obnovit",
      not_found_title: "Tohle nefungovalo",
      not_found_hint: "Zkontrolujte URL v adresním řádku prohlížeče a zkuste to znovu.",
      user_already_logged_in: "Uživatel je již přihlášen",
      logged_in_title: "Skvělé! Ještě jeden krok.",
      logged_in_hint:
        "Zadejte do adresního řádku prohlížeče veřejně sdílenou URL nebo odkaz na zobrazení či stránku, kterou chcete otevřít.",
      by_creating_account: "Vytvořením účtu",
      by_signing_in: "Přihlášením",
      you_agree_to_our: "souhlasíte s našimi",
      terms_of_service: "Podmínkami služby",
      and: "a",
      privacy_policy: "Zásadami ochrany osobních údajů",
      sign_up: "Zaregistrovat se",
      oauth_with_provider: "{action} přes {provider}",
      auth: {
        sign_in_header: "Přihlaste se, abyste mohli hlasovat nebo komentovat",
        sign_in_subheader: "Pomozte posunout funkce, které chcete mít vytvořené.",
        sign_up_header: "Zobrazujte, komentujte a dělejte víc",
        sign_up_subheader:
          "Zaregistrujte se nebo přihlaste, abyste mohli pracovat s pracovními položkami a stránkami Plane.",
      },
      peek: {
        side: "Boční náhled",
        modal: "Modální okno",
      ...
      bot_name: "Bot {name}",
      commented_time: "komentováno {time}",
      and_more: "a dalších {count}",
      no_upvotes_yet: "Zatím žádné hlasy pro",
      no_downvotes_yet: "Zatím žádné hlasy proti",
      view_less: "Zobrazit méně",
      view_all: "Zobrazit vše",
      no_matches_found: "Nebyly nalezeny žádné shody",
      no_date: "Bez data",
      no_cycle: "Bez cyklu",
      no_modules: "Bez modulů",
      modules_count: "{count} modulů",
      no_assignees: "Bez přiřazených osob",
      labels_count: "{count} štítků",
      page_not_found_alt: "Stránka nenalezena",
      something_went_wrong: "Jejda! Něco se pokazilo.",
      page_not_found_description: "Stránka, kterou hledáte, neexistuje nebo byla přesunuta.",
      instance_failure_image_alt: "Nelze načíst podrobnosti instance",
      instance_failure_title: "Nelze načíst podrobnosti instance.",
      instance_failure_description: "Podrobnosti vaší instance se nepodařilo načíst.",
      instance_failure_hint: "Zkontrolujte připojení a zkuste to znovu.",
      retry: "Zkusit znovu",
      powered_by: "Používá",
      sign_in_to_add_comment: "Přihlaste se a přidejte komentář",
      sign_in: "Přihlásit se",
      link_copied: "Odkaz zkopírován!",
      work_item_link_copied: "Odkaz na pracovní položku byl zkopírován do schránky.",
      comment_post_error: "Komentář se nepodařilo odeslat. Zkuste to prosím znovu.",
      add_comment: "Přidat komentář",
      public_board_not_found: "Veřejná nástěnka neexistuje. Zkontrolujte URL.",
      no_work_items_found: "Nebyly nalezeny žádné pracovní položky",
