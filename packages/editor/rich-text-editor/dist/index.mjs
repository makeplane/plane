...
import { EditorContainer, EditorContentWrapper, getEditorClassNames, useEditor as useEditor2 } from "@plane/editor-core";
...
import * as core_star from "@tiptap/core";

// ../../../node_modules/@tiptap/extension-floating-menu/dist/index.js
import { posToDOMRect as posToDOMRect2, Extension as Extension2 } from "@tiptap/core";
var FloatingMenuView = class {
  ...
  update(view, oldState) {
    ...
    (_b = this.tippy) === null || _b === void 0 ? void 0 : _b.setProps({
      getReferenceClientRect: ((_c = this.tippyOptions) === null || _c === void 0 ? void 0 : _c.getReferenceClientRect) || (() => posToDOMRect2(view, from, to))
    });
    this.show();
  }
  show() {
...
var PureEditorContent = class extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      React.Fragment,
      null,
      React.createElement("div", __spreadValues({ ref: this.editorContentRef }, rest)),
...
var EditorContentWithKey = (props) => {
  ...
  return React.createElement(PureEditorContent, __spreadValues({ key }, props));
};
...
var useEditor = (options = {}, deps = []) => {
  ...
  const onCreateRef = useRef(onCreate2);
  const onDestroyRef = useRef(onDestroy2);
...
var NodeViewContent = (props) => {
  ...
  return React.createElement(Tag, __spreadProps(__spreadValues({}, props), { ref: nodeViewContentRef, "data-node-view-content": "", style: __spreadValues({
    whiteSpace: "pre-wrap"
  }, props.style) }));
};
var NodeViewWrapper = React.forwardRef((props, ref) => {
  ...
  const Tag = props.as || "div";
  return React.createElement(Tag, __spreadProps(__spreadValues({}, props), { ref, "data-node-view-wrapper": "", onDragStart, style: __spreadValues({
    whiteSpace: "normal"
  }, props.style) }));
});
...
var ReactRenderer = class {
  ...
  render() {
    ...
    this.reactElement = React.createElement(Component, __spreadValues({}, props));
    ...
    const ReactNodeViewProvider = (componentProps) => {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Component, __spreadValues({}, componentProps))
        )
      );
    };
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative h-full", children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { children: activeItem == null ? void 0 : activeItem.name }),
          /* @__PURE__ */ jsx(ChevronDown, { className: "h-4 w-4" })
        ]
      }
    ),
    isOpen && /* @__PURE__ */ jsx("section", { className: "fixed top-full z-[99999] mt-1 flex w-48 flex-col overflow-hidden rounded border border-custom-border-300 bg-custom-background-100 p-1 shadow-xl animate-in fade-in slide-in-from-top-1", children: items.map((item, index) => /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        onClick: () => {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2", children: [
            /* @__PURE__ */ jsx("div", { className: "rounded-sm border border-custom-border-300 p-1", children: /* @__PURE__ */ jsx(item.icon, { className: "h-3 w-3" }) }),
            /* @__PURE__ */ jsx("span", { children: item.name })
          ] }),
          activeItem.name === item.name && /* @__PURE__ */ jsx(Check, { className: "h-4 w-4" })
        ]
      },
      index
    )) })
...
// src/ui/menus/bubble-menu/link-selector.tsx
import { cn as cn2 } from "@plane/editor-core";
  ...
  return /* @__PURE__ */ jsxs2("div", { className: "relative", children: [
    /* @__PURE__ */ jsxs2(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx2("p", { className: "text-base", children: "\u2197" }),
          /* @__PURE__ */ jsx2(
            "p",
            {
              className: cn2("underline underline-offset-4", {
    ...
    isOpen && /* @__PURE__ */ jsxs2(
      "div",
      {
        ...
        children: [
          ...
          editor.getAttributes("link").href ? /* @__PURE__ */ jsx2(
            "button",
            {
              type: "button",
              ...
              children: /* @__PURE__ */ jsx2(Trash, { className: "h-4 w-4" })
            }
          ) : /* @__PURE__ */ jsx2(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsx2(Check2, { className: "h-4 w-4" })
            }
          )
        ]
      }
...
// src/ui/menus/bubble-menu/index.tsx
import { cn as cn3 } from "@plane/editor-core";
...
var EditorBubbleMenu = (props) => {
  ...
  const [isNodeSelectorOpen, setIsNodeSelectorOpen] = useState2(false);
  const [isLinkSelectorOpen, setIsLinkSelectorOpen] = useState2(false);
  return /* @__PURE__ */ jsxs3(
    BubbleMenu2,
    __spreadProps(__spreadValues({}, bubbleMenuProps), {
      className: "flex w-fit divide-x divide-custom-border-300 rounded border border-custom-border-300 bg-custom-background-100 shadow-xl",
      children: [
        !props.editor.isActive("table") && /* @__PURE__ */ jsx3(
          NodeSelector,
          {
            editor: props.editor,
        ...
        /* @__PURE__ */ jsx3("div", { className: "flex", children: items.map((item, index) => /* @__PURE__ */ jsx3(
          "button",
          {
            type: "button",
...
import { useState as useState3, useEffect as useEffect3, useCallback as useCallback2, useRef as useRef3, useLayoutEffect } from "react";
...
import { cn as cn4, insertTableCommand, startImageUpload, toggleBulletList } from "@plane/editor-core";
import { jsx as jsx4, jsxs as jsxs4 } from "react/jsx-runtime";
var Command = Extension3.create({
  name: "slash-command",
  addOptions() {
    return {
      suggestion: {
...
var getSuggestionItems = (uploadFile, setIsSubmitting) => ({ query }) => [
  {
    ...
    icon: /* @__PURE__ */ jsx4(Text, { size: 18 }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsx4(Heading12, { size: 18 }),
    command: ({ editor, range }) => {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsx4(Heading22, { size: 18 }),
    command: ({ editor, range }) => {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsx4(Heading32, { size: 18 }),
    command: ({ editor, range }) => {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsx4(CheckSquare2, { size: 18 }),
    command: ({ editor, range }) => {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsx4(List, { size: 18 }),
    command: ({ editor, range }) => {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsx4(MinusSquare, { size: 18 }),
    command: ({ editor, range }) => {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsx4(Table, { size: 18 }),
    command: ({ editor, range }) => {
  ...
  },
  {
    ...
    searchTerms: ["ordered"],
    icon: /* @__PURE__ */ jsx4(ListOrdered2, { size: 18 }),
    command: ({ editor, range }) => {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsx4(TextQuote2, { size: 18 }),
    command: ({ editor, range }) => (
      // @ts-ignore
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsx4(Code2, { size: 18 }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsx4(ImageIcon, { size: 18 }),
    command: ({ editor, range }) => {
...
var CommandList = ({
  ...
  const commandListContainer = useRef3(null);
  useLayoutEffect(() => {
  ...
  return items.length > 0 ? /* @__PURE__ */ jsx4(
    "div",
    {
      id: "slash-command",
      ...
      children: items.map((item, index) => /* @__PURE__ */ jsx4(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxs4("div", { children: [
            ...
            /* @__PURE__ */ jsx4("p", { className: "text-xs text-custom-text-300", children: item.description })
          ] })
        },
        index
      ))
...
var RichTextEditor = ({
  ...
  if (!editor)
    return null;
  return /* @__PURE__ */ jsxs5(EditorContainer, { editor, editorClassNames, children: [
    editor && /* @__PURE__ */ jsx5(EditorBubbleMenu, { editor }),
    /* @__PURE__ */ jsx5("div", { className: "flex flex-col", children: /* @__PURE__ */ jsx5(EditorContentWrapper, { editor, editorContentCustomClassNames }) })
  ] });
};
var RichTextEditorWithRef = React2.forwardRef((props, ref) => /* @__PURE__ */ jsx5(RichTextEditor, __spreadProps(__spreadValues({}, props), { forwardedRef: ref })));
...
var RichReadOnlyEditor = ({
  ...
  if (!editor)
    return null;
  return /* @__PURE__ */ jsx6(EditorContainer2, { editor, editorClassNames, children: /* @__PURE__ */ jsx6("div", { className: "flex flex-col", children: /* @__PURE__ */ jsx6(EditorContentWrapper2, { editor, editorContentCustomClassNames }) }) });
};
var RichReadOnlyEditorWithRef = React3.forwardRef((props, ref) => /* @__PURE__ */ jsx6(RichReadOnlyEditor, __spreadProps(__spreadValues({}, props), { forwardedRef: ref })));
