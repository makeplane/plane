...
export function CustomCalloutBlock(props: CustomCalloutNodeViewProps) {
  ...
  return (
    <NodeViewWrapper
      className="editor-callout-component group/callout-node relative bg-custom-background-90 rounded-lg text-primary p-4 my-2 flex items-start gap-4 transition-colors duration-500 break-words"
      style={{
