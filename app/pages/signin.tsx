...
const SignInPage: NextPage = () => {
  ...
  useEffect(() => {
    console.log("effect ENV", process.env.NEXT_PUBLIC_ENABLE_OAUTH);
  }, [router]);
  ...
  return (
    ...
    >
      {isLoading && (
        <div className="absolute left-0 top-0 z-50 flex h-full w-full flex-col items-center justify-center gap-y-3 bg-white">
            ...
            <div className="flex flex-col rounded-[10px] bg-brand-surface-2  shadow-md">
              {parseInt(process.env.NEXT_PUBLIC_ENABLE_OAUTH || "0") ? (
                <>
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 border-t border-brand-base px-5 py-5 ">
