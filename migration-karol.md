...
| **11. LLM skills**                                                                                                                       | Per-project skills in Arsenal, deployed to DSH/Claude Code/etc.; agent tokens wired                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Agent can triage + work + resolve via skill — **in progress 2026-09-09** (structure decided: SKILL.md orchestrator + resources/route-*.md + scripts/questimus.js CLI + .token per skill; questimus-legaliosa built + verified; 9 remaining) |
