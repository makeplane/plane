...
| **Total**                                                                                       | **647** (559 − 8 + 3 doc − 2 deleted + 3 deferred + 7 archive + 1 pm doc + 47 + 3 + 4 + 30) | **24** (29 − 2 − 3 − 1 + 1) | **120**   |
...
| **7. Don Saldo**                                                                                                                         | 2 tickets + bank-import note (move to last batch if it becomes active)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Counts verified — **done 2026-09-09** (34 issues: 2 tickets + 2 doc tickets + 30 pm items; label-permission fix, §6.2)                                        |
