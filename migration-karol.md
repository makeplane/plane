...
| research notes                     | **Ticket bodies** (Karol 2026-09-08, supersedes the pages approach): `own-server-vs-vps-etc.md` → **PERSONAL-12**, `how-does-claudian…flatrate-subscription.md` → **PERSONAL-29**; all 4 pages deleted. General rule for the remaining phases: a standalone doc with a sibling issue → merge the content into the issue description; only docs **without** a sibling become pages. **Revised 2026-09-09 (Phase 5 review):** the Media Consumerus pages (Backlog / TODOS / Design — DESIGN) were **transformed into tickets** (full document content in the description, pages archived + deleted) — plain documents live in ticket bodies; pages remain only for design reviews/decisions (O8) |
...
| don-saldo                                                                                       | 2                                                                                 | 1               | 0         |
| media-consumerus                                                                                | 15 (10 backlog + 2 todos + 3 doc tickets; +4 deduped section ids)                  | 0 (pages → tickets 2026-09-09) | 0         |
...
| **Total**                                                                                       | **554** (559 − 8 dropped + 3 doc tickets)                                          | **24** (29 − 2 − 3) | **120**   |
...
| `Media Consumerus\planning`                                     | BACKLOG.md rows → issues (priority/effort → priority/estimate); TODOS.md → issues with resolution log in description; full docs (BACKLOG/TODOS/DESIGN) → **doc tickets** (pages transformed 2026-09-09) — **imported 2026-09-09 (Phase 5)**                                                                                                                                                                                                                                                                         |
...
2. **Media Consumerus** (Phase 5 — exercises tables, sections, estimates, pages) — **done 2026-09-09** (15 issues: 12 + 3 doc tickets; pages transformed to tickets; two importer fixes: §9.2)
...
| **5. Media Consumerus**                                                                                                                  | BACKLOG table + TODOS sections → issues (estimates, labels), pages (the pm-folder config `media-consumerus-pm` is dropped — O13)                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Counts verified — **done 2026-09-09** (15 issues: 12 + 3 doc tickets; pages → tickets; two importer fixes, §9.2)                                            |
