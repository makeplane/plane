...
"""Action artifacts endpoint (mobile)."""
...
@mobile_router.get("/")
async def get_action_artifacts(
...
@mobile_router.get("/chat/{chat_id}/")
...
@mobile_router.post("/{artifact_id}/followup/", response_model=ArtifactUpdateResponse)
async def update_artifact_with_prompt(
