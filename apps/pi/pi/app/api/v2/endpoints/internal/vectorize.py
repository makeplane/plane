...
from pi.app.api.v2.helpers.plane_sql_queries import get_all_workspace_ids
...
async def trigger_vectorization(
    ...
    This endpoint is protected by TrustedHostMiddleware and only accessible
    from the configured PLANE_INTERNAL_API_URL.
