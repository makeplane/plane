...
from workspaces.db.mixins import SoftDeletionManager, ChangeTrackerMixin
from workspaces.utils.exception_logger import log_exception
from .project import ProjectBaseModel
from workspaces.utils.uuid import convert_uuid_to_integer
...
class Issue(ChangeTrackerMixin, ProjectBaseModel):
    ...
    def _ensure_default_state(self):
        ...
        if self.state is not None:
            return
        try:
            from workspaces.db.models import State
