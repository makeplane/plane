...
import workspaces.db.models.api
import workspaces.db.models.webhook
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.URLField(
                        validators=[
                            workspaces.db.models.webhook.validate_schema,
                            workspaces.db.models.webhook.validate_domain,
                        ]
                    ),
                ),
                ...
                (
                    "secret_key",
                    models.CharField(
                        default=workspaces.db.models.webhook.generate_token,
                        max_length=255,
                    ),
                ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                db_index=True,
                default=workspaces.db.models.api.generate_token,
                max_length=255,
                unique=True,
            ),
        ),
