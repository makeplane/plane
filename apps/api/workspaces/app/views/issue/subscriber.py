...
from workspaces.app.serializers import IssueSubscriberSerializer, ProjectMemberLiteSerializer
from workspaces.app.permissions import ProjectEntityPermission, ProjectLitePermission
from workspaces.db.models import IssueSubscriber, ProjectMember
