...
# Module imports
from workspaces.app.permissions import WorkspaceEntityPermission
from workspaces.app.serializers import WorkspaceEstimateSerializer
from workspaces.app.views.base import BaseAPIView
from workspaces.db.models import Estimate, Project
from workspaces.utils.cache import cache_response
