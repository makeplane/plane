...
# Module imports
from workspaces.db.models import Issue
from workspaces.license.utils.instance_value import get_email_configuration
from workspaces.utils.analytics_plot import build_graph_plot
from workspaces.utils.email import generate_plain_text_from_html
...
def analytic_export_task(email, data, slug):
    try:
        ...
        logging.getLogger("workspaces.worker").info("Email sent successfully.")
        return
