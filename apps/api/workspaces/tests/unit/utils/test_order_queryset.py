...
from workspaces.utils.order_queryset import ISSUE_GROUP_BY_ALLOWLIST, sanitize_order_by
...
class TestIssueGroupByAllowlist:
    ...
    `issue_group_values()` (workspaces/utils/grouper.py and
    workspaces/space/utils/grouper.py) knows how to resolve safely. Anything
