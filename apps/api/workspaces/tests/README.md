...
```bash
# Run unit tests
python -m pytest workspaces/tests/unit/

# Run API contract tests
python -m pytest workspaces/tests/contract/api/

# Run App contract tests
python -m pytest workspaces/tests/contract/app/

# Run smoke tests
python -m pytest workspaces/tests/smoke/
```
...
```bash
python -m pytest --cov=workspaces --cov-report=term --cov-report=html
```
