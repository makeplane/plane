...
```python
from workspaces.utils.openapi import (
    asset_docs,
    ASSET_ID_PARAMETER,
...
```python
from workspaces.utils.openapi.decorators import asset_docs
from workspaces.utils.openapi.parameters import ASSET_ID_PARAMETER
from workspaces.utils.openapi.responses import UNAUTHORIZED_RESPONSE
```
...
- `workspaces/api/views/asset.py` - All methods use new `@asset_docs` helpers
- `workspaces/api/views/project.py` - Import updated
- `workspaces/api/views/user.py` - Import updated
- `workspaces/api/views/state.py` - Import updated
- `workspaces/api/views/intake.py` - Import updated
- `workspaces/api/views/member.py` - Import updated
- `workspaces/api/views/module.py` - Import updated
- `workspaces/api/views/cycle.py` - Import updated
- `workspaces/api/views/issue.py` - Import updated
- `workspaces/settings/common.py` - Hook paths updated
- `workspaces/api/apps.py` - Auth extension import updated
