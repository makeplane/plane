...
from workspaces.license.models import InstanceConfiguration
from workspaces.license.api.serializers import InstanceConfigurationSerializer
from workspaces.license.utils.encryption import encrypt_data
from workspaces.utils.cache import cache_response, invalidate_cache
from workspaces.license.utils.instance_value import get_email_configuration
...
class EmailCredentialCheckEndpoint(BaseAPIView):
    def post(self, request):
        ...
        subject = "Email Notification from Workspaces"
        message = "This is a sample email notification sent from Workspaces application."
        # Send the email
        try:
