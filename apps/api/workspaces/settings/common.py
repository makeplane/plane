...
# Module imports
from workspaces.utils.url import is_valid_url


BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

_logger = logging.getLogger("workspaces")
...
MIDDLEWARE = [
    ...
    "workspaces.authentication.middleware.session.SessionMiddleware",
    ...
    "workspaces.middleware.request_body_size.RequestBodySizeLimitMiddleware",
    "workspaces.middleware.logger.APITokenLogMiddleware",
    "workspaces.middleware.logger.RequestLoggerMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "workspaces.authentication.adapter.exception.auth_exception_handler",
...
ASGI_APPLICATION = "workspaces.asgi.application"
...
if os.environ.get("ENABLE_READ_REPLICA", "0") == "1":
    ...
    # Database Routers
    DATABASE_ROUTERS = ["workspaces.utils.core.dbrouters.ReadReplicaRouter"]
    # Add middleware at the end for read replica routing
    MIDDLEWARE.append("workspaces.middleware.db_routing.ReadReplicaRoutingMiddleware")
...
STORAGES["default"] = {"BACKEND": "workspaces.settings.storage.S3Storage"}
...
CELERY_IMPORTS = (
    # scheduled tasks
    "workspaces.bgtasks.issue_automation_task",
    "workspaces.bgtasks.exporter_expired_task",
    "workspaces.bgtasks.file_asset_task",
    "workspaces.bgtasks.email_notification_task",
    "workspaces.bgtasks.cleanup_task",
    "workspaces.license.bgtasks.telemetry_metrics",
    ...
    # `workspaces/bgtasks/*_task.py`, so a task nothing imports at runtime is never
    ...
    "workspaces.bgtasks.operations_reminder_task",
    # management tasks
    "workspaces.bgtasks.dummy_data_task",
    # issue version tasks
    "workspaces.bgtasks.issue_version_sync",
    "workspaces.bgtasks.issue_description_version_sync",
)
...
SESSION_ENGINE = "workspaces.db.models.session"
...
CSRF_FAILURE_VIEW = "workspaces.authentication.views.common.csrf_failure"
