...
SPECTACULAR_SETTINGS = {
    ...
    # ========================================================================
    "TITLE": "The Workspaces REST API",
    "DESCRIPTION": (
        "The Workspaces REST API\n\n"
        "Workspaces is built on Workspaces; the upstream API reference at "
        "[developers.plane.so](https://developers.plane.so/api-reference/introduction) applies."
    ),
    "CONTACT": {
        "name": "Workspaces",
        "url": "https://workspaces.hgsoftware.com.np",
    },
    "VERSION": "0.0.1",
    "LICENSE": {
        "name": "GNU AGPLv3",
    ...
    # ========================================================================
    "PREPROCESSING_HOOKS": [
        "workspaces.utils.openapi.hooks.preprocess_filter_api_v1_paths",
    ],
    # ========================================================================
    ...
    "AUTHENTICATION_WHITELIST": [
        "workspaces.api.middleware.api_authentication.APIKeyAuthentication",
    ],
    # ========================================================================
    ...
    "ENUM_NAME_OVERRIDES": {
        "ModuleStatusEnum": "workspaces.db.models.module.ModuleStatus",
        "IntakeWorkItemStatusEnum": "workspaces.db.models.intake.IntakeIssueStatus",
    },
}
