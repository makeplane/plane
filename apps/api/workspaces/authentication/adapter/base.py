...
from workspaces.utils.url_security import pinned_fetch_following_redirects
...
from workspaces.bgtasks.user_activation_email_task import user_activation_email

# Module imports
from workspaces.db.models import FileAsset, Profile, User, WorkspaceMemberInvite
from workspaces.license.utils.instance_value import get_configuration_value
...
class Adapter:
    ...
    def __init__(self, request, provider, callback=None):
        ...
        self.user_data = None
        self.logger = logging.getLogger("workspaces.authentication")
