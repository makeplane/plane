...
from plane.ee.models import IssueProperty, IssuePropertyOption, PropertyTypeEnum, RelationTypeEnum
...
class IssuePropertyBulkOperationAPIView(BaseServiceAPIView):
