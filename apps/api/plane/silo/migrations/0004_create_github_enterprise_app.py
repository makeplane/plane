# Generated by Django 4.2.22 on 2025-06-24 14:23

from django.db import migrations

def create_github_enterprise_app(apps, schema_editor):
    ...
    if instance_admin:
        generate_application(
            ...
            app_key=APPLICATIONS["github_enterprise"]["key"],
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('silo', '0003_create_importer_app'),
    ]

    operations = [
        migrations.RunPython(create_github_enterprise_app, reverse_code=migrations.RunPython.noop),
    ]
