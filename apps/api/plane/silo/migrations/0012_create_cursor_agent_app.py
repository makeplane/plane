# Generated by Django 4.2.22 on 2026-02-16

from django.db import migrations

def create_cursor_agent_app(apps, schema_editor):
    ...
    if instance_admin:
        generate_application(
            ...
            app_key=APPLICATIONS["cursor"]["key"],
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('silo', '0011_create_runner_app'),
    ]

    operations = [
        migrations.RunPython(create_cursor_agent_app, reverse_code=migrations.RunPython.noop),
    ]
