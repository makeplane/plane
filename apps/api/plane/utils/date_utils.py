...
def get_analytics_date_range(
    ...
    if date_filter == "yesterday":
        ...
        return {
            "current": {
                "gte": datetime.combine(today - timedelta(days=6), datetime.min.time()),
                "lte": datetime.combine(today, datetime.max.time()),
            },
            "previous": {
                "gte": datetime.combine(today - timedelta(days=13), datetime.min.time()),
        ...
        return {
            "current": {
                "gte": datetime.combine(today - timedelta(days=29), datetime.min.time()),
                "lte": datetime.combine(today, datetime.max.time()),
            },
            "previous": {
                "gte": datetime.combine(today - timedelta(days=59), datetime.min.time()),
                "lte": datetime.combine(today - timedelta(days=30), datetime.max.time()),
            },
        }
    elif date_filter == "last_3_months":
        return {
            "current": {
                "gte": datetime.combine(today - timedelta(days=89), datetime.min.time()),
                "lte": datetime.combine(today, datetime.max.time()),
            },
            "previous": {
                "gte": datetime.combine(today - timedelta(days=179), datetime.min.time()),
                "lte": datetime.combine(today - timedelta(days=90), datetime.max.time()),
            },
        }
...
def get_chart_period_range(
    ...
    period_ranges = {
        ...
        "last_3_months": (today - timedelta(days=89), today),
    }
