# SPDX-FileCopyrightText: 2023-present Gizmo Software, Inc.
# SPDX-License-Identifier: LicenseRef-Gizmo-Commercial
#
# Licensed under the Gizmo Commercial License (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
# https://gizmo.so/legals/eula
#
