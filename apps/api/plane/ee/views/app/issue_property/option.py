...
class WorkspaceWorkItemPropertyOptionEndpoint(BaseAPIView):
    permission_classes = [WorkspaceEntityPermission]

    @check_feature_flag(FeatureFlag.WORKSPACE_WORK_ITEM_TYPES)
    def get(self, request, slug, issue_property_id=None, pk=None):
        ...
        # Get all issue property options for the workspace in the form of property_id: options[]
        issue_property_options = IssuePropertyOption.objects.filter(
            workspace__slug=slug,
            property__issue_type_properties__issue_type__is_epic=False,
        )
    ...
    @check_feature_flag(FeatureFlag.WORKSPACE_WORK_ITEM_TYPES)
    def post(self, request, slug, issue_property_id):
    ...
    @check_feature_flag(FeatureFlag.WORKSPACE_WORK_ITEM_TYPES)
    def patch(self, request, slug, issue_property_id, pk):
    ...
    @check_feature_flag(FeatureFlag.WORKSPACE_WORK_ITEM_TYPES)
    def delete(self, request, slug, issue_property_id, pk):
