# Generated by Django 4.2.28 on 2026-03-12 03:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('db', '0140_seed_update_system_states'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='priority',
            field=models.CharField(choices=[('urgent', 'Urgent'), ('high', 'High'), ('medium', 'Medium'), ('low', 'Low')], default='medium', max_length=30, verbose_name='Issue Priority'),
        ),
        migrations.AlterField(
            model_name='issue',
            name='priority',
        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(choices=[(0, 'Sunday'), (1, 'Monday'), (2, 'Tuesday'), (3, 'Wednesday'), (4, 'Thursday'), (5, 'Friday'), (6, 'Saturday')], default=1),
        ),
        migrations.AlterField(
