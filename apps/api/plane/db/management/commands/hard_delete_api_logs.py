...
# Module imports
from plane.bgtasks.hard_delete_api_log_task import schedule_hard_delete_api_logs


class Command(BaseCommand):
    help = "Hard delete API logs"
    ...
    def handle(self, *args, **options):
        ...
        schedule_hard_delete_api_logs.delay(batch_size=int(batch_size), batch_countdown=int(batch_countdown))
