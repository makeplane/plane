...
# Module imports
from plane.bgtasks.hard_delete_email_notification_log_task import (
    schedule_hard_delete_email_notification_logs,
)


class Command(BaseCommand):
    help = "Hard delete email notification logs"
    ...
    def handle(self, *args, **options):
        ...
        schedule_hard_delete_email_notification_logs.delay(
