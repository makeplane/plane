...
new_url_patterns = [
    ...
    path(
        "workspaces/<str:slug>/projects/<uuid:project_id>/work-items/<uuid:issue_id>/user-plan/",
        UserIssuePlanAPIEndpoint.as_view(http_method_names=["get", "patch", "delete"]),
        name="work-item-user-plan",
    ),
]
