...
urlpatterns = [
    ...
    path(
        ...
        BulkIssueOperationEndpoint.as_view(),
    ...
    path(
        "workspaces/<str:slug>/projects/<uuid:project_id>/issues/<uuid:issue_id>/issue-pages/<uuid:page_id>/",
        IssuePageEndpoint.as_view(),
        name="project-issue-pages",
    ),
    path(
