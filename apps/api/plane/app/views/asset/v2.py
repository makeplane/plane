...
class ProjectBulkAssetEndpoint(BaseAPIView):
    ...
    def post(self, request, slug, project_id, entity_id):
        ...
        # Assets created for a not-yet-existing project (e.g. a cover image
        # uploaded while the project creation form is still open) have no
        # project_id yet, so also match those -- this call is what assigns
        # them to the project below.
