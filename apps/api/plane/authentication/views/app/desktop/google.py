...
class DesktopGoogleOauthInitiateEndpoint(View):
    def get(self, request):
        ...
        try:
            ...
            redirect_uri = f"{scheme}://{request.get_host()}/auth/desktop/google/callback/"
...
class DesktopGoogleCallbackEndpoint(View):
    def get(self, request):
