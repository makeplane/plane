...
AUTHENTICATION_ERROR_CODES = {
    ...
    "ZELIAN_NOT_CONFIGURED": 5113,
    "GOOGLE_OAUTH_PROVIDER_ERROR": 5115,
    "GITHUB_OAUTH_PROVIDER_ERROR": 5120,
    "GITLAB_OAUTH_PROVIDER_ERROR": 5121,
    "GITEA_OAUTH_PROVIDER_ERROR": 5123,
    # Upstream owns 5124 (OAUTH_PROVIDER_UNVERIFIED_EMAIL). Zelian codes live in the
    # 59xx block so future upstream additions never collide with the fork.
    "OAUTH_PROVIDER_UNVERIFIED_EMAIL": 5124,
    "ZELIAN_OAUTH_PROVIDER_ERROR": 5910,
    # Reset Password
