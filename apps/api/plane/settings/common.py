...
LOOPERNET_DIRECTORY_TIMEOUT_SECONDS = float(os.environ.get("LOOPERNET_DIRECTORY_TIMEOUT_SECONDS", "2"))
LOOPERNET_PRESENCE_MAX_AGE_SECONDS = int(os.environ.get("LOOPERNET_PRESENCE_MAX_AGE_SECONDS", "90"))
