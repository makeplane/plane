...
# P1 sub module switches (workspace settings may override them)
RESEARCH_STAGE_ENABLED = os.environ.get("RESEARCH_STAGE_ENABLED", "1") == "1"
RESEARCH_EXPERIMENT_ENABLED = os.environ.get("RESEARCH_EXPERIMENT_ENABLED", "1") == "1"
RESEARCH_CODE_ENABLED = os.environ.get("RESEARCH_CODE_ENABLED", "1") == "1"
RESEARCH_INTEGRATION_ENABLED = os.environ.get("RESEARCH_INTEGRATION_ENABLED", "1") == "1"

# P1 gate defaults (ResearchStageRequirement and workspace settings win)
RESEARCH_LITERATURE_MIN_INCLUDED = int(os.environ.get("RESEARCH_LITERATURE_MIN_INCLUDED", 20))
RESEARCH_LITERATURE_MAX_ENTRIES = int(os.environ.get("RESEARCH_LITERATURE_MAX_ENTRIES", 100))
RESEARCH_STAGE_MIN_REVIEWERS = int(os.environ.get("RESEARCH_STAGE_MIN_REVIEWERS", 3))
RESEARCH_STAGE_PASS_RATIO = float(os.environ.get("RESEARCH_STAGE_PASS_RATIO", 0.5))
RESEARCH_CODE_SNAPSHOT_MAX_MB = int(os.environ.get("RESEARCH_CODE_SNAPSHOT_MAX_MB", 500))

# P1 integration base layer (P1-INT-06, P1-INT-07)
RESEARCH_INTEGRATION_TIMEOUT_SECONDS = int(os.environ.get("RESEARCH_INTEGRATION_TIMEOUT_SECONDS", 3))
RESEARCH_INTEGRATION_CACHE_TTL_SECONDS = int(os.environ.get("RESEARCH_INTEGRATION_CACHE_TTL_SECONDS", 300))
RESEARCH_INTEGRATION_DEGRADED_MODE = os.environ.get("RESEARCH_INTEGRATION_DEGRADED_MODE", "link_only")
