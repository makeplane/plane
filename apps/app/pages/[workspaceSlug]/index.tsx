        ...
        projects.length > 0 ? (
          <div className="p-8">
            <div className="flex flex-col gap-8">
              <div className="flex flex-col justify-between gap-x-2 gap-y-6 rounded-lg border border-custom-border-100 bg-custom-background-100 px-4 py-6 md:flex-row md:items-center md:py-3">
                ...
                <div className="flex items-center gap-2 text-custom-text-200">
                  <button
                    ...
                    className="rounded-md border-2 border-custom-border-100 px-3 py-1.5 text-sm hover:text-custom-text-100 font-medium duration-300"
                  >
                    {`What's New?`}
                  </button>
                  <a
