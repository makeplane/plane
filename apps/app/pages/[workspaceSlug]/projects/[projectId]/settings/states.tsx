      ...
      >
        <div className="grid grid-cols-12 gap-10">
          <div className="col-span-12 sm:col-span-5">
            <h3 className="text-2xl font-semibold text-skin-base">States</h3>
            <p className="text-skin-muted-2">Manage the states of this project.</p>
          </div>
                ...
                if (orderedStateGroups[key].length !== 0)
                  return (
                    <div key={key}>
                      ...
                      <div className="divide-y divide-skin-base rounded-[10px] border border-skin-base">
                        {key === activeGroup && (
                          <CreateUpdateStateInline
                            onClose={() => {
                              setActiveGroup(null);
