    ...
    >
      <section className="space-y-8">
        ...
        <div className="space-y-5">
          <div className="flex items-center justify-between gap-x-8 gap-y-2 rounded-[10px] border border-skin-base bg-skin-surface-2 p-5">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                projectDetails?.cycle_view ? "bg-green-500" : "bg-skin-surface-2"
              }`}
              role="switch"
            ...
            >
              ...
              <span
                aria-hidden="true"
                className={`inline-block h-5 w-5 transform rounded-full bg-skin-surface-2 shadow ring-0 transition duration-200 ease-in-out ${
          ...
          <div className="flex items-center justify-between gap-x-8 gap-y-2 rounded-[10px] border border-skin-base bg-skin-surface-2 p-5">
            ...
            <button
              type="button"
              className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                projectDetails?.module_view ? "bg-green-500" : "bg-skin-surface-2"
              }`}
              role="switch"
          ...
          <div className="flex items-center justify-between gap-x-8 gap-y-2 rounded-[10px] border border-skin-base bg-skin-surface-2 p-5">
            ...
            <button
              type="button"
              className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                projectDetails?.issue_views_view ? "bg-green-500" : "bg-skin-surface-2"
              }`}
              role="switch"
          ...
          <div className="flex items-center justify-between gap-x-8 gap-y-2 rounded-[10px] border border-skin-base bg-skin-surface-2 p-5">
            ...
            <button
              type="button"
              className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                projectDetails?.page_view ? "bg-green-500" : "bg-skin-surface-2"
              }`}
              role="switch"
