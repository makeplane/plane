                    ...
                    <>
                      {pageDetails.labels.map((labelId) => {
                        ...
                        return (
                          <div
                            key={label.id}
                            className="group flex cursor-pointer items-center gap-1 rounded-2xl border border-custom-border-80 px-2 py-0.5 text-xs hover:border-red-500 hover:bg-red-50"
                            onClick={() => {
