        ...
        right={
          <div className="flex items-center gap-2">
            ...
            <SecondaryButton
              ...
              className="!py-1.5 rounded-md font-normal text-custom-sidebar-text-200 border-custom-sidebar-border-80 hover:bg-custom-sidebar-background-90"
              outline
            >
              Analytics
            </SecondaryButton>
            {projectDetails && projectDetails.inbox_view && (
              <Link href={`/${workspaceSlug}/projects/${projectId}/inbox/${inboxList?.[0]?.id}`}>
                <a>
                  <SecondaryButton
                    className="relative !py-1.5 rounded-md font-normal text-custom-sidebar-text-200 border-custom-sidebar-border-80 hover:bg-custom-sidebar-background-90"
                    outline
                  >
                    <span>Inbox</span>
                    {inboxList && inboxList?.[0]?.pending_issue_count !== 0 && (
                      <span className="absolute -top-1 -right-1 h-4 w-4 rounded-full text-custom-text-100 bg-custom-sidebar-background-80 border border-custom-sidebar-border-80">
