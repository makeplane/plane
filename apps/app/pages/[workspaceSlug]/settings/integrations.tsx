    ...
    >
      <section className="space-y-8">
        <div className="flex flex-col items-start gap-3">
          ...
          <div className="flex items-center gap-3 rounded-[10px] border border-brand-accent/75 bg-brand-accent/5 p-4 text-xs text-brand-base">
            <ExclamationIcon height={20} width={20} className="fill-current text-brand-base" />
