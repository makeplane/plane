  ...
  return (
    <>
      ...
      <div
        ...
        } h-full w-[24rem] overflow-y-auto border-l border-custom-border-80 bg-custom-sidebar-background-100 pt-5 pb-10 duration-300`}
      >
        {module ? (
          <>
                ...
                <div className="flex items-center ">
                  <Controller
                    ...
                    render={({ field: { value } }) => (
                      <CustomSelect
                        customButton={
                          <span className="flex cursor-pointer items-center rounded border-[0.5px] border-custom-border-80 bg-custom-background-90 px-2 py-1 text-center text-xs capitalize">
                ...
                <div className="relative flex h-full w-52 items-center gap-2 text-sm">
                  <Popover className="flex h-full items-center justify-center rounded-lg">
                    {({ open }) => (
                      <>
                        <Popover.Button
                          className={`group flex h-full items-center gap-2 whitespace-nowrap rounded border-[0.5px] border-custom-border-80 bg-custom-background-90 px-2 py-1 text-xs ${
                  ...
                  <Popover className="flex h-full items-center justify-center rounded-lg">
                    {({ open }) => (
                      <>
                        <Popover.Button
                          className={`group flex items-center gap-2 whitespace-nowrap rounded border-[0.5px] border-custom-border-80 bg-custom-background-90 px-2 py-1 text-xs ${
            ...
            <div className="flex w-full flex-col items-center justify-start gap-2 border-t border-custom-border-80 p-6">
            ...
            <div className="flex w-full flex-col border-t border-custom-border-80 px-6 py-6 text-xs">
