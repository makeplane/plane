  ...
  return (
    <>
      <DeleteModuleModal
        ...
        user={user}
      />
      <div className="flex flex-col divide-y divide-custom-border-80 overflow-hidden rounded-[10px] border border-custom-border-80 bg-custom-background-100 text-xs">
        <div className="p-4">
