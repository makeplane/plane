  ...
  return (
    <>
      <DeleteModuleModal
        ...
        data={module}
      />
      <div className="flex flex-col divide-y divide-skin-base overflow-hidden rounded-[10px] border border-skin-base bg-skin-surface-2 text-xs">
        <div className="p-4">
          <div className="flex w-full flex-col gap-5">
            <div className="flex items-start justify-between gap-2">
              <Tooltip tooltipContent={module.name} position="top-left">
                <Link href={`/${workspaceSlug}/projects/${module.project}/modules/${module.id}`}>
                  <a className="w-auto max-w-[calc(100%-9rem)]">
                    <h3 className="truncate break-all text-lg font-semibold text-skin-base">
              ...
              <div className="flex items-center gap-1">
                <div className="mr-2 flex whitespace-nowrap rounded bg-skin-surface-1 px-2.5 py-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-start gap-1">
                <CalendarMonthIcon className="h-4 w-4 text-skin-base" />
        ...
        <div className="flex h-20 flex-col items-end">
          <div className="flex w-full items-center justify-between gap-2 justify-self-end bg-skin-surface-1 p-4">
            <span>Progress</span>
          ...
          <div className="item-center flex h-full w-full justify-between bg-skin-surface-1 px-4 pb-4">
