      ...
      <Dialog as="div" className="relative z-20" onClose={handleClose}>
        ...
        <div className="fixed inset-0 z-10">
          <div className="mt-10 flex min-h-full items-start justify-center p-4 text-center sm:p-0 md:mt-20">
            ...
            >
              <Dialog.Panel className="relative transform rounded-lg bg-skin-surface-2 py-5 text-left shadow-xl transition-all sm:w-full sm:max-w-2xl">
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-2 pb-3 px-5 border-b border-skin-base">
                    <MagnifyingGlassIcon className="h-4 w-4 text-skin-muted-2" />
                    <input
                    ...
                    {filteredOptions ? (
                      filteredOptions.length > 0 ? (
                        filteredOptions.map((option: ICycle) => (
                          <button
                            key={option.id}
                            className="flex items-center gap-4 px-4 py-3 text-gray-600 text-sm rounded w-full hover:bg-skin-surface-1"
                            onClick={() => {
                              transferIssue({
                        ...
                        <div className="flex items-center justify-center gap-4 p-5 text-sm w-full">
                          ...
                          <span className="text-center text-skin-muted-2">
