...
export const SingleCycleCard: React.FC<TSingleStatProps> = ({
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-lg bg-brand-base text-xs shadow">
            ...
            <div className="flex justify-between">
              ...
              <div className="flex items-center gap-2.5 text-brand-secondary">
                <div className="-my-0.5 flex items-center justify-center gap-2">
                  <AssigneesList
                    userIds={cycle.assignees.map((assignee: any) => assignee.id)}
                    length={3}
                    showLength={true}
                  />
                </div>
      ...
      <div className="mt-auto bg-brand-surface-2 py-2.5">
        <Tooltip
          tooltipContent={
          ...
          position="bottom"
        >
          <div className="flex w-full items-center gap-2 rounded-b-lg px-4 ">
            <div>Progress</div>
