  ...
  return (
    ...
    >
      ...
      >
        <Tab
          className={({ selected }) =>
            `px-3 py-1 text-custom-text-100 rounded-3xl border border-custom-border-80 ${
              ...
              if (assignee.assignee_id)
                ...
                return (
                  <SingleProgressStats
                    ...
                    title={
                      <div className="flex items-center gap-2">
                        <div className="h-5 w-5 rounded-full border-2 border-custom-border-80 bg-custom-background-80">
                          <img
                            src="/user.png"
                            height="100%"
                            width="100%"
