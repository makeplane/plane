...
export const ActiveCycleDetails: React.FC = () => {
  ...
  return (
    <div className="grid-row-2 grid rounded-[10px] shadow divide-y bg-custom-background-100 border border-custom-border-80">
      <div className="grid grid-cols-1 divide-y border-custom-border-80 lg:divide-y-0 lg:divide-x lg:grid-cols-3">
        ...
        <div className="grid col-span-2 grid-cols-1 divide-y border-custom-border-80 md:divide-y-0 md:divide-x md:grid-cols-2">
          <div className="flex h-60 flex-col border-custom-border-80">
          ...
          <div className="border-custom-border-80 h-60 overflow-y-scroll">
      ...
      <div className="grid grid-cols-1 divide-y border-custom-border-80 lg:divide-y-0 lg:divide-x lg:grid-cols-2">
              ...
              {issues ? (
                issues.length > 0 ? (
                  issues.map((issue) => (
                    <div
                      key={issue.id}
                      className="flex flex-wrap rounded-md items-center justify-between gap-2 border border-custom-border-80 bg-custom-background-90 px-3 py-1.5"
                    >
                        ...
                        {issue.label_details.length > 0 ? (
                          <div className="flex flex-wrap gap-1">
                            {issue.label_details.map((label) => (
                              <span
                                key={label.id}
                                className="group flex items-center gap-1 rounded-2xl border border-custom-border-80 px-2 py-0.5 text-xs text-custom-text-200"
                              >
                                <span
        ...
        <div className="flex flex-col justify-between border-custom-border-80 p-4">
