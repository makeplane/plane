      ...
      {cycles ? (
        cycles.length > 0 ? (
          ...
          showNoCurrentCycleMessage && (
            <div className="flex items-center justify-between bg-skin-surface-2 w-full px-6 py-4 rounded-[10px]">
              <h3 className="text-base font-medium text-skin-base "> No current cycle is present.</h3>
