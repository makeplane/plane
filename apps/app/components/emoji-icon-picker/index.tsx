...
const EmojiIconPicker: React.FC<Props> = ({ label, value, onChange, onIconColorChange }) => {
  ...
  return (
    <Popover className="relative z-[1]" ref={ref}>
      ...
      >
        <Popover.Panel className="absolute z-10 mt-2 w-[250px] rounded-[4px] border border-custom-border-80 bg-custom-background-80 shadow-lg">
          <div className="h-[230px] w-[250px] overflow-auto rounded-[4px] border border-custom-border-80 bg-custom-background-80 p-2 shadow-xl">
            <Tab.Group as="div" className="flex h-full w-full flex-col">
              ...
              <Tab.Panels className="flex-1 overflow-y-auto">
                <Tab.Panel>
                  ...
                  <hr className="mb-2 h-[1px] w-full border-custom-border-80" />
                  <div>
                ...
                <div className="py-2">
                  <Tab.Panel className="flex h-full w-full flex-col justify-center">
                    ...
                    <hr className="mb-1 h-[1px] w-full border-custom-border-80" />
