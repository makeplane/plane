...
export const SpreadsheetView: React.FC<Props> = ({
  ...
  return (
    <div className="h-full rounded-lg text-custom-text-200 overflow-x-auto whitespace-nowrap bg-custom-background-100">
      <div className="sticky z-[2] top-0 border-b border-custom-border-80 bg-custom-background-90 w-full min-w-max">
      ...
      {spreadsheetIssues ? (
        <div className="flex flex-col h-full w-full bg-custom-background-100 rounded-sm ">
          ...
          >
            {type === "issue" ? (
              <button
                className="flex gap-1.5 items-center  pl-7 py-2.5 text-sm sticky left-0 z-[1] text-custom-text-200 bg-custom-background-100 group-hover:text-custom-text-100 group-hover:bg-custom-background-80 border-custom-border-80 w-full"
                onClick={() => {
