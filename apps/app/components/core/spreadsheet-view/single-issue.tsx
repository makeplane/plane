...
export const SingleSpreadsheetIssue: React.FC<Props> = ({
  ...
  return (
    <div
      className="relative group grid auto-rows-[minmax(44px,1fr)] hover:rounded-sm hover:bg-custom-background-80 border-b border-custom-border-80 w-full min-w-max"
      style={{ gridTemplateColumns }}
    >
      <div className="flex gap-1.5 items-center px-4 sticky z-[1] left-0 text-custom-text-200 bg-custom-background-100 group-hover:text-custom-text-100 group-hover:bg-custom-background-80 border-custom-border-80 w-full">
            ...
            {!isNotAllowed && !isCompleted && (
              <div className="absolute top-0 left-2.5 opacity-0 group-hover:opacity-100">
                <Popover2
                  ...
                  content={
                    <div
                      className={`flex flex-col gap-1.5 overflow-y-scroll whitespace-nowrap rounded-md border p-1 text-xs shadow-lg focus:outline-none max-h-44 min-w-full border-custom-border-80 bg-custom-background-90`}
                    >
                      <button
                        type="button"
      ...
      {properties.state && (
        <div className="flex items-center text-xs text-custom-text-200 text-center p-2 group-hover:bg-custom-background-80 border-custom-border-80">
          <ViewStateSelect
            issue={issue}
