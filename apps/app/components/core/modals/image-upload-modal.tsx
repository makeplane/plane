      ...
      <Dialog as="div" className="relative z-30" onClose={handleClose}>
        ...
        <div className="fixed inset-0 z-30 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg border border-custom-border-80 bg-custom-background-100 px-5 py-8 text-left shadow-xl transition-all sm:w-full sm:max-w-xl sm:p-6">
                      ...
                      <div
                        ...
                        className={`relative grid h-80 w-full cursor-pointer place-items-center rounded-lg p-12 text-center focus:outline-none focus:ring-2 focus:ring-custom-primary focus:ring-offset-2 ${
                          (image === null && isDragActive) || !value
                            ? "border-2 border-dashed border-custom-border-80 hover:bg-custom-background-90"
                            : ""
                        }`}
                      >
