                    ...
                    {selectedIssues.length > 0 ? (
                      <div className="flex items-center gap-2 flex-wrap mt-1">
                        {selectedIssues.map((issue) => (
                          <div
                            key={issue.id}
                            className="flex items-center gap-1 text-xs border border-custom-border-80 bg-custom-background-80 pl-2 py-1 rounded-md text-custom-text-100 whitespace-nowrap"
                          >
                      ...
                      <div className="w-min text-xs border border-custom-border-80 bg-custom-background-80 p-2 rounded-md whitespace-nowrap">
                        No issues selected
                      </div>
                    )}
                  </div>
