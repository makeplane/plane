...
export const SingleCalendarIssue: React.FC<Props> = ({
  ...
  return (
    <div
      ...
      className={`w-full relative cursor-pointer rounded border border-custom-border-80 px-1.5 py-1.5 text-xs duration-300 hover:cursor-move hover:bg-custom-background-80 ${
