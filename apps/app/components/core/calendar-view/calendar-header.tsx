  ...
  return (
    <div className="mb-4 flex items-center justify-between">
            ...
            <>
              ...
              >
                <Popover.Panel className="absolute top-10 left-0 z-20 flex w-full max-w-xs transform flex-col overflow-hidden rounded-[10px] bg-custom-background-80 shadow-lg">
                  ...
                  <div className="grid grid-cols-4  border-t border-custom-border-80 px-2">
      ...
      <div className="flex w-full items-center justify-end gap-2">
        <button
          className="group flex cursor-pointer items-center gap-2 rounded-md border border-custom-border-80 px-3 py-1 text-sm hover:bg-custom-background-80 hover:text-custom-text-100 focus:outline-none"
          onClick={() => {
            if (isMonthlyView) {
              updateDate(new Date());
            } else {
        ...
        <CustomMenu
          customButton={
            <div className="group flex cursor-pointer items-center gap-2 rounded-md border border-custom-border-80 px-3 py-1 text-sm hover:bg-custom-background-80 hover:text-custom-text-100 focus:outline-none ">
        ...
        >
          ...
          <div className="mt-1 flex w-52 items-center justify-between border-t border-custom-border-80 py-2 px-1  text-sm text-custom-text-200">
            <h4>Show weekends</h4>
