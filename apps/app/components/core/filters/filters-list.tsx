    ...
    <div className="flex flex-1 flex-wrap items-center gap-2 text-xs">
      {Object.keys(filters).map((key) => {
        if (filters[key as keyof typeof filters] !== null)
          return (
            <div
              key={key}
              className="flex items-center gap-x-2 rounded-full border border-custom-border-80 bg-custom-background-80 px-2 py-1"
            >
                    ...
                    <div className="flex flex-wrap items-center gap-1">
                      {filters.target_date?.map((date: string) => {
                        ...
                        return (
                          <div
                            key={date}
                            className="inline-flex items-center gap-x-1 rounded-full border border-custom-border-80 bg-custom-background-100 px-1 py-0.5"
                          >
      ...
      {Object.keys(filters).length > 0 && nullFilters.length !== Object.keys(filters).length && (
        <button
          ...
          className="flex items-center gap-x-1 rounded-full border border-custom-border-80 bg-custom-background-80 px-3 py-1.5 text-xs"
        >
