...
export const JiraImporterRoot: React.FC<Props> = ({ user }) => {
  ...
  return (
    <div className="flex h-full flex-col space-y-2">
      ...
      <div className="flex h-full flex-col space-y-4 rounded-[10px] border border-custom-border-80 bg-custom-background-100 p-4">
            ...
            {integrationWorkflowData.map((integration, index) => (
              <React.Fragment key={integration.key}>
                <button
                  ...
                  className={`flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border border-custom-border-80 ${
        ...
        <div className="relative h-full w-full pt-6">
          <FormProvider {...methods}>
            <form className="flex h-full w-full flex-col">
              ...
              <div className="-mx-4 mt-4 flex justify-end gap-4 border-t border-custom-border-80 p-4 pb-0">
