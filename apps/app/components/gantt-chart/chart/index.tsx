  ...
  return (
    <div
      className={`${
        ...
        border ? `border border-custom-border-80` : ``
      } flex h-full flex-col rounded-sm select-none bg-custom-background-100 shadow`}
    >
      {/* chart title */}
      {/* <div className="flex w-full flex-shrink-0 flex-wrap items-center gap-5 gap-y-3 whitespace-nowrap p-2 border-b border-custom-border-80">
        {title && (
      ...
      <div className="flex w-full flex-shrink-0 flex-wrap items-center gap-5 gap-y-3 whitespace-nowrap p-2">
        {/* <div
          className="transition-all border border-custom-border-80 w-[30px] h-[30px] flex justify-center items-center cursor-pointer rounded-sm hover:bg-custom-background-80"
        ...
        <div className="flex flex-wrap items-center gap-2">
          {allViews &&
            ...
            allViews.map((_chatView: any, _idx: any) => (
              <div
                key={_chatView?.key}
                className={`cursor-pointer rounded-sm border border-custom-border-80 p-1 px-2 text-xs ${
        ...
        <div className="flex items-center gap-1">
          <div
            className={`cursor-pointer rounded-sm border border-custom-border-80 p-1 px-2 text-xs hover:bg-custom-background-80`}
            onClick={handleToday}
          >
            Today
          </div>
      ...
      {/* content */}
      <div className="relative flex h-full w-full flex-1 overflow-hidden border-t border-custom-border-80">
        <div
