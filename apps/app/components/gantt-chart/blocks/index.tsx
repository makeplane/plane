...
export const GanttChartBlocks: FC<{
  ...
  return (
    ...
    >
              ...
              {block.start_date && block.target_date && (
                ...
                >
                  ...
                  >
                    ...
                    <div
                      className="rounded shadow-sm bg-custom-background-100 overflow-hidden relative flex items-center h-[34px] border border-custom-border-80"
                      style={{
      ...
      {/* sidebar */}
      {/* <div className="fixed top-0 bottom-0 w-[300px] flex-shrink-0 divide-y divide-custom-border-80 border-r border-custom-border-80 overflow-y-auto">
        {blocks &&
          blocks.length > 0 &&
          blocks.map((block: any, _idx: number) => (
