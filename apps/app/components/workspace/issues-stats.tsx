...
export const IssuesStats: React.FC<Props> = ({ data }) => (
  <div className="grid grid-cols-1 rounded-[10px] border border-skin-base bg-skin-surface-2 lg:grid-cols-3">
    <div className="grid grid-cols-1 divide-y divide-skin-base border-b border-skin-base lg:border-r lg:border-b-0">
      <div className="flex">
        ...
        <div className="basis-1/2 border-l border-skin-base p-4">
