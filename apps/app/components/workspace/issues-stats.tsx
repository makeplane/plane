...
export const IssuesStats: React.FC<Props> = ({ data }) => (
  <div className="grid grid-cols-1 rounded-[10px] border border-custom-border-80 bg-custom-background-100 lg:grid-cols-3">
    <div className="grid grid-cols-1 divide-y divide-custom-border-80 border-b border-custom-border-80 lg:border-r lg:border-b-0">
      <div className="flex">
        ...
        <div className="basis-1/2 border-l border-custom-border-80 p-4">
    ...
    <div className="p-4 lg:col-span-2">
      <h3 className="mb-2 font-semibold capitalize flex items-center gap-2">
        ...
        <Tooltip
          ...
          className="w-72 border border-custom-border-80"
        >
