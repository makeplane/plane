...
export const CustomFloatingToolbar: React.FC<Props> = ({
  ...
  return (
    <div className="z-[99999] flex flex-col items-center gap-y-2 divide-x divide-y divide-custom-border-80 rounded border border-custom-border-80 bg-custom-background-80 p-1 px-0.5 shadow-md">
      <div className="flex items-center gap-y-2 divide-x divide-custom-border-80">
