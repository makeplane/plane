...
export const FloatingLinkToolbar = () => {
  ...
  return (
    <>
      {!isEditing && (
        <FloatingToolbar className="rounded bg-skin-surface-2 p-1 shadow-lg">
          {linkEditButtons}
        </FloatingToolbar>
      )}
      {!isEditing && empty && (
        <FloatingToolbar positioner={linkPositioner} className="rounded bg-skin-surface-2 p-1 shadow-lg">
          {linkEditButtons}
        </FloatingToolbar>
      )}
