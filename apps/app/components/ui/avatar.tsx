    ...
    {user && user.avatar && user.avatar !== "" ? (
      <div
        className={`rounded-full border-2 ${
          index ? "border-custom-border-80 bg-custom-background-80" : "border-transparent"
        }`}
        style={{
          height: height,
          width: width,
      ...
      <div
        className="grid place-items-center rounded-full border-2 border-custom-border-80 bg-gray-700 text-xs capitalize text-white"
        style={{
          height: height,
          width: width,
          fontSize: fontSize,
