        ...
        {({ open }) => (
          <div className="relative mt-1">
            <Listbox.Button
              ...
              className="relative w-full cursor-default rounded-lg bg-skin-surface-2 py-2 pl-3 pr-10 text-left shadow-md sm:text-sm"
            >
            ...
            >
              <Listbox.Options
                static
                className="absolute mt-1 max-h-60 w-full rounded-md bg-skin-surface-2 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
              >
                {options.map((option) => (
                  <Listbox.Option
                    key={option.id}
                    className={
                      "relative cursor-default select-none py-2 pl-10 pr-4 hover:bg-skin-surface-1 hover:text-skin-base"
                    }
                    onClick={(e: any) => {
                    ...
                    {({ selected }) => (
                      <>
                        {openChildFor?.id === option.id && (
                          <div
                            className={`absolute h-auto max-h-72 w-72 rounded-lg border border-skin-base bg-skin-surface-2 ${
                              direction === "right"
                          ...
                          >
                            ...
                            <div
                              className={`absolute h-0 w-0 border-t-8 border-skin-base ${
                                direction === "right"
