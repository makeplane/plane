                    ...
                    {({ selected }) => (
                      <>
                        {openChildFor?.id === option.id && (
                          <div
                            className={`absolute h-auto max-h-72 w-72 rounded-lg border border-custom-border-100 bg-custom-background-80 ${
                              direction === "right"
                          ...
                          >
                            ...
                            <div
                              className={`absolute h-0 w-0 border-t-8 border-custom-border-100 ${
                                direction === "right"
