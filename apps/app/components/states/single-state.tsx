...
export const SingleState: React.FC<Props> = ({
  ...
  return (
    <div className="group flex items-center justify-between gap-2 border-custom-border-80 bg-custom-background-100 p-5 first:rounded-t-[10px] last:rounded-b-[10px]">
