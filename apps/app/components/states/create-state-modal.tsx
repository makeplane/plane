      ...
      <Dialog as="div" className="relative z-30" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-skin-surface-2 px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6">
                      ...
                      <div>
                        <Popover className="relative">
                          {({ open }) => (
                            <>
                              <Popover.Button
                                className={`group inline-flex items-center rounded-md bg-skin-surface-2 text-base font-medium hover:text-skin-base focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 ${
