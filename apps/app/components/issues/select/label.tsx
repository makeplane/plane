...
export const IssueLabelSelect: React.FC<Props> = ({ setIsOpen, value, onChange, projectId }) => {
  ...
  return (
    ...
    >
      {({ open }: any) => (
        <>
          <Combobox.Button className="flex cursor-pointer items-center rounded-md border border-custom-border-80 text-xs shadow-sm duration-200 hover:bg-custom-background-80">
          ...
          >
            ...
            >
              <div className="flex w-full items-center justify-start rounded-sm  border-[0.6px] border-custom-border-80 bg-custom-background-90 px-2">
                  ...
                  filteredOptions.length > 0 ? (
                    filteredOptions.map((label) => {
                      ...
                      if (children.length === 0) {
                        ...
                        return (
                          <div className="border-y border-custom-border-80">
