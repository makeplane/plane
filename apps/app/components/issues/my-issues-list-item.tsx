...
export const MyIssuesListItem: React.FC<Props> = ({ issue, properties, projectId }) => {
  ...
  return (
    <div className="border-b border-custom-border-80 bg-custom-background-100 px-4 py-2.5 last:border-b-0">
      <div key={issue.id} className="flex items-center justify-between gap-2">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs">
          ...
          {properties.assignee && (
            <div className="flex cursor-default items-center rounded-md border border-custom-border-80 px-2 py-1 text-xs shadow-sm">
              <Tooltip
                position="top-right"
