      ...
      <form onSubmit={handleSubmit(handleCreateUpdateIssue)}>
        <div className="space-y-5">
          <div className="flex items-center gap-x-2">
            ...
            />
            <h3 className="text-xl font-semibold leading-6 text-skin-base">
              {status ? "Update" : "Create"} Issue
            </h3>
          </div>
          {watch("parent") && watch("parent") !== "" ? (
            <div className="flex w-min items-center gap-2 whitespace-nowrap rounded bg-skin-surface-1 p-2 text-xs">
              ...
              <div>
                ...
                {mostSimilarIssue && (
                  <div className="flex items-center gap-x-2">
                    ...
                    <button
                      type="button"
                      className="text-sm text-skin-accent"
                      onClick={() => {
              ...
              <div className="relative">
                <div className="flex justify-end -mb-2">
                  {issueName && issueName !== "" && (
                    <button
                      type="button"
                      className={`flex items-center gap-1 rounded px-1.5 py-1 text-xs hover:bg-skin-surface-1 ${
        ...
        <div className="-mx-5 mt-5 flex items-center justify-between gap-2 border-t border-skin-base px-5 pt-5">
          <div
          ...
          >
            ...
            <button
              ...
              className={`pointer-events-none relative inline-flex h-4 w-7 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent ${
                createMore ? "bg-skin-accent" : "bg-gray-300"
            ...
            >
              ...
              <span
                ...
                } transform rounded-full bg-skin-surface-2 shadow ring-0 transition duration-300 ease-in-out`}
              />
            </button>
          </div>
          <div className="flex items-center gap-2">
