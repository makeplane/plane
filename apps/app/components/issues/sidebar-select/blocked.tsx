            ...
            {watch("blocked_issues") && watch("blocked_issues").length > 0
              ? watch("blocked_issues").map((issue) => (
                  <div
                    ...
                    className="group flex cursor-pointer items-center gap-1 rounded-2xl border border-custom-border-80 px-1.5 py-0.5 text-xs text-red-500 duration-300 hover:border-red-500/20 hover:bg-red-500/20"
                  >
                    <Link
