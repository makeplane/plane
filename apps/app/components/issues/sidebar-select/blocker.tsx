      ...
      <div className="flex flex-wrap items-start py-2">
        ...
        <div className="space-y-1 sm:basis-1/2">
            ...
            {watch("blocker_issues") && watch("blocker_issues").length > 0
              ? watch("blocker_issues").map((issue) => (
                  <div
                    ...
                    className="group flex cursor-pointer items-center gap-1 rounded-2xl border border-custom-border-80 px-1.5 py-0.5 text-xs text-yellow-500 duration-300 hover:border-yellow-500/20 hover:bg-yellow-500/20"
                  >
                    <Link
          ...
          <button
            ...
            } items-center justify-between gap-1 rounded-md border border-custom-border-80 px-2 py-1 text-xs shadow-sm duration-300 focus:outline-none`}
