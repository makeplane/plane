  ...
  return (
    <div className="flex items-center gap-2 flex-wrap text-[0.65rem] p-3">
      ...
      <button
        ...
        className="flex items-center gap-x-1 rounded-full border border-custom-border-80 bg-custom-background-80 px-3 py-1.5 text-custom-text-200 hover:text-custom-text-100"
      >
        <span>Clear all</span>
        <XMarkIcon className="h-3 w-3" />
      </button>
