  ...
  return (
    ...
    >
      <a>
        <div
          id={issue.id}
          className={`relative min-h-[5rem] cursor-pointer select-none space-y-3 py-2 px-4 border-b border-custom-border-80 hover:bg-custom-primary hover:bg-opacity-10 ${
        ...
        >
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            >
              <div className="flex items-center gap-1 rounded border border-custom-border-80 shadow-sm text-xs px-2 py-[0.19rem] text-custom-text-200">
