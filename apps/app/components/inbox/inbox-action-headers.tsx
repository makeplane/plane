  ...
  return (
    <>
      ...
      <DeleteIssueModal
        ...
        data={inboxIssues?.find((i) => i.bridge_id === inboxIssueId)}
      />
      <div className="grid grid-cols-4 border-b border-custom-border-80 divide-x divide-custom-border-80">
        ...
        {inboxIssueId && (
          <div className="flex justify-between items-center gap-4 px-4 col-span-3">
            <div className="flex items-center gap-x-2">
              <button
                type="button"
                className="rounded border border-custom-border-80 bg-custom-background-90 p-1.5 hover:bg-custom-background-80"
                onClick={() => {
              ...
              {isAllowed && (issueStatus === 0 || issueStatus === -2) && (
                <div className="flex-shrink-0">
                  <Popover className="relative">
                    ...
                    <Popover.Panel className="w-80 p-2 absolute right-0 z-10 mt-2 rounded-md border border-custom-border-80 bg-custom-background-80 shadow-lg">
                      {({ close }) => (
