...
export const SingleProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <>
      {members ? (
        <div className="flex flex-col rounded-[10px] shadow bg-skin-surface-2">
                ...
                <div className="flex items-center">
                  {(isOwner || isMember) && (
                    <Link href={`/${workspaceSlug}/projects/${project.id}/settings`}>
                      <a className="grid cursor-pointer place-items-center rounded p-1 duration-300 hover:bg-skin-surface-1">
