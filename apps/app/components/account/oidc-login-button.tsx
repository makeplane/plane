...
export const OidcLoginButton: FC<OidcLoginButtonProps> = (props) => {
  ...
  return (
    <div className="w-full flex justify-center items-center px-[3px]">
      <Link
        href={`${process.env.NEXT_PUBLIC_OIDC_URL_AUTHORIZE}?client_id=${process.env.NEXT_PUBLIC_OIDC_CLIENT_ID}&redirect_uri=${loginCallBackURL}&scope=openid%20profile%20email&response_type=code`}
      >
