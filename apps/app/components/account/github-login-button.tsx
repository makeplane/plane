...
export const GithubLoginButton: FC<GithubLoginButtonProps> = (props) => {
  ...
  return (
    <div className="px-1 w-full">
      ...
      >
        <button className="flex w-full items-center justify-center gap-3 rounded-md border border-skin-base p-2 text-sm font-medium text-gray-600 duration-300 hover:bg-gray-50">
