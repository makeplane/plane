      ...
      >
        <Dialog as="div" className="relative z-30" onClose={() => setIsPaletteOpen(false)}>
          ...
          <div className="fixed inset-0 z-30 overflow-y-auto p-4 sm:p-6 md:p-20">
            ...
            >
              <Dialog.Panel className="relative mx-auto max-w-2xl transform divide-y divide-custom-border-80 divide-opacity-10 rounded-xl border border-custom-border-80 bg-custom-background-100 shadow-2xl transition-all">
                <Command
                  filter={(value, search) => {
