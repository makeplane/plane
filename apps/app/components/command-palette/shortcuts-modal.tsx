                ...
                <div className="bg-custom-background-80 p-5">
                  <div className="sm:flex sm:items-start">
                    <div className="flex w-full flex-col gap-y-4 text-center sm:text-left">
                      ...
                      <div>
                        <div className="flex w-full items-center justify-start gap-1 rounded border-[0.6px] border-custom-border-80 bg-custom-background-90 px-3 py-2">
                                    ...
                                    <div className="flex items-center gap-x-2.5">
                                      {shortcut.keys.split(",").map((key, index) => (
                                        <span key={index} className="flex items-center gap-1">
                                          {key === "Ctrl" ? (
                                            <span className="flex h-full items-center rounded-sm border border-custom-border-80 bg-custom-background-90 p-1.5">
                                              <CommandIcon className="h-4 w-4 fill-current text-custom-text-200" />
                                            </span>
                                          ) : key === "Ctrl" ? (
                                            <kbd className="rounded-sm border border-custom-border-80 bg-custom-background-90 p-1.5 text-sm font-medium text-custom-text-200">
                                              <CommandIcon className="h-4 w-4 fill-current text-custom-text-200" />
                                            </kbd>
                                          ) : (
                                            <kbd className="rounded-sm border border-custom-border-80 bg-custom-background-90 px-2 py-1 text-sm font-medium text-custom-text-200">
                                              {key}
                                            </kbd>
                                          )}
                                        </span>
                                  ...
                                  <div key={index} className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-x-2.5">
                                      {keys.split(",").map((key, index) => (
                                        <span key={index} className="flex items-center gap-1">
                                          {key === "Ctrl" ? (
                                            <span className="flex h-full items-center rounded-sm border border-custom-border-80 bg-custom-background-90 p-1.5 text-custom-text-200">
                                              <CommandIcon className="h-4 w-4 fill-current text-custom-text-200" />
                                            </span>
                                          ) : key === "Ctrl" ? (
                                            <kbd className="rounded-sm border border-custom-border-80 bg-custom-background-90 p-1.5 text-sm font-medium text-custom-text-200">
