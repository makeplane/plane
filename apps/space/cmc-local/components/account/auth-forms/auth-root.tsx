...
import { AuthHeader } from "@/components/account/auth-forms/auth-header";
import { CmcOAuthOptions } from "@/components/account/auth-forms/cmc-oauth-options";
import { AuthEmailForm } from "@/components/account/auth-forms/email";
import { AuthPasswordForm } from "@/components/account/auth-forms/password";
import { AuthUniqueCodeForm } from "@/components/account/auth-forms/unique-code";
// helpers
  ...
  return (
    <div className="mt-10 flex w-full flex-grow flex-col items-center justify-center py-6">
      <div className="relative flex w-full max-w-[22.5rem] flex-col gap-6">
        ...
        {isOAuthEnabled && <CmcOAuthOptions options={oAuthOptions} compact={authStep === EAuthSteps.PASSWORD} />}
