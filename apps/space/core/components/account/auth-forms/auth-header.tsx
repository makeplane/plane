  ...
  return (
    <>
      <div className="flex flex-col gap-1">
        <span className="text-2xl font-semibold text-primary leading-7">{header}</span>
        <span className="text-2xl font-semibold text-placeholder leading-7">{subHeader}</span>
      </div>
    </>
  );
}
