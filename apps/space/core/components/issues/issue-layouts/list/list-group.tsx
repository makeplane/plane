...
export const ListGroup = observer(function ListGroup(props: Props) {
  ...
  const loadMore = isPaginating ? (
    ...
    <div
      className={
        "h-11 relative flex items-center gap-3 bg-custom-background-100 border border-transparent border-t-subtle-1 pl-6 p-3 text-13 font-medium text-custom-primary-100 hover:text-custom-primary-200 hover:underline cursor-pointer"
      }
