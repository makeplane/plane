    ...
    >
      ...
      <div className="space-y-1">
        ...
        <div className="flex w-full items-center justify-between px-1 pt-1 text-11">
          ...
          >
            {resendTimerCode > 0
              ? t("space_auth.resend_in", { seconds: resendTimerCode })
              : isRequestingNewCode
                ? t("space_auth.requesting_new_code")
                : t("space_auth.resend")}
          </button>
        </div>
      </div>
