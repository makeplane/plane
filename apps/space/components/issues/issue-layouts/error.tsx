        ...
        <div className="mx-auto grid h-52 w-52 place-items-center rounded-full">
          <div className="grid h-32 w-32 place-items-center">
            <img
              ...
              alt={t("space_public.something_went_wrong")}
              className="h-full w-full object-contain"
            />
          </div>
        </div>
        <h1 className="mt-12 text-24 font-semibold">{t("space_public.something_went_wrong")}</h1>
        <p className="mt-4 text-tertiary">{t("space_public.public_board_not_found")}</p>
      </div>
    </div>
  );
}
