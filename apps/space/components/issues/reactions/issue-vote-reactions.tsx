            ...
            {allUpVotes.length > 0 ? (
              <>
                ...
                {allUpVotes.length > VOTES_LIMIT &&
                  t("localized_ui.space_public.and_more", { count: allUpVotes.length - VOTES_LIMIT })}
              </>
            ) : (
              t("localized_ui.space_public.no_upvotes_yet")
            )}
          </div>
        }
      >
            ...
            {allDownVotes.length > 0 ? (
              <>
                ...
                {allDownVotes.length > VOTES_LIMIT &&
                  t("localized_ui.space_public.and_more", { count: allDownVotes.length - VOTES_LIMIT })}
              </>
            ) : (
              t("localized_ui.space_public.no_downvotes_yet")
            )}
          </div>
        }
      >
