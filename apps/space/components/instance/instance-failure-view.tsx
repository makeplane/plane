    ...
    <div className="relative container mx-auto flex h-screen items-center justify-center overflow-x-hidden overflow-y-auto px-5">
      <div className="relative w-auto max-w-2xl space-y-8 py-10">
        <div className="relative flex flex-col items-center justify-center space-y-4">
          <img src={instanceImage} alt={t("localized_ui.space_public.instance_failure_image_alt")} />
          <h3 className="text-20 font-medium text-on-color">{t("localized_ui.space_public.instance_failure_title")}</h3>
          <p className="text-center text-14 font-medium">
            {t("localized_ui.space_public.instance_failure_description")} <br />
            {t("localized_ui.space_public.instance_failure_hint")}
          </p>
        </div>
        <div className="flex justify-center">
          <Button size="lg" onClick={handleRetry}>
            {t("localized_ui.space_public.retry")}
          </Button>
        </div>
      </div>
    </div>
