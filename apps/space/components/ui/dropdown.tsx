  ...
  return (
    <Popover className="absolute -left-1">
      ...
      >
        <Popover.Panel
          ref={ref}
          className="absolute left-1/2 -translate-x-full z-10 mt-1 max-w-[9rem] origin-top-right select-none rounded-md bg-gray-50 border border-gray-300 text-xs shadow-lg focus:outline-none"
        >
    ...
    <div className="w-full group relative flex gap-x-6 rounded-lg p-1">
      {(!as_ || as_ === "button" || as_ === "div") && (
        <button
          ...
          className={`w-full flex items-center gap-1 rounded px-1 py-1.5 text-gray-600 hover:bg-gray-100 ${
  ...
  return (
    <Popover className="relative">
      {({ open }) => (
        <>
          <Popover.Button
            className={`group flex items-center justify-between gap-2 rounded-md border border-gray-200 px-3 py-1.5 text-xs shadow-sm duration-300 focus:outline-none hover:text-custom-text-100 hover:bg-gray-100 ${
              open ? "bg-gray-100 text-gray-800" : "text-gray-700"
            }`}
          >
          ...
          <Transition
            ...
            leaveTo="opacity-0 translate-y-1"
          >
            <Popover.Panel className="absolute left-full -translate-x-full z-10 mt-1 w-36 origin-top-right select-none rounded-md bg-gray-50 border border-gray-300 text-xs shadow-lg focus:outline-none">
