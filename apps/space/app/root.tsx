...
const APP_TITLE = "DirectCloud Publish | Share boards publicly with one-click";
const APP_DESCRIPTION = "DirectCloud Publish makes your project boards and roadmaps public";
