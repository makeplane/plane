      ...
      <div className="text-center">
        <div className="mx-auto grid size-32 place-items-center rounded-full md:size-52">
          <div className="grid size-16 place-items-center md:size-32">
            <img src={SomethingWentWrongImage} alt="Что-то пошло не так" width={128} height={128} />
          </div>
        </div>
        <h1 className="mt-8 text-18 font-semibold md:mt-12 md:text-24">Не удалось загрузить страницу</h1>
        <p className="mt-2 text-13 md:mt-4 md:text-14">
          Проверьте URL в адресной строке браузера и попробуйте снова.
        </p>
      </div>
    </div>
  );
