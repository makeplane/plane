 ...
 * declares (`anchor` inside an `:anchor` subtree), so they index straight into the record.
 * This wrapper keeps that contract in one place rather than making every call site assert
 * non-null individually.
 *
