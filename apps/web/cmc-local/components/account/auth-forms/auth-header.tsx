...
// constants
import { CMC_AUTH_BRANDING } from "@/constants/cmc-auth";
// helpers
...
const Titles = {
  [EAuthModes.SIGN_IN]: {
    [EAuthSteps.EMAIL]: {
      header: CMC_AUTH_BRANDING.title,
      subHeader: CMC_AUTH_BRANDING.subtitle,
    },
    [EAuthSteps.PASSWORD]: {
      header: CMC_AUTH_BRANDING.title,
      subHeader: CMC_AUTH_BRANDING.subtitle,
...
export function AuthHeaderBase(props: TAuthHeaderBase) {
  return (
    <div className="flex flex-col gap-3">
      <img src={CMC_AUTH_BRANDING.logoUrl} alt="CMC Telecom" className={CMC_AUTH_BRANDING.logoClassName} />
