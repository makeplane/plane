...
export const ENVIRONMENTS_NAV = [
  { key: "connections", path: "", i18n: "environments.nav.connections" },
  { key: "schema", path: "/schema", i18n: "environments.nav.schema" },
] as const;

export function EnvironmentsTabNavigation() {
