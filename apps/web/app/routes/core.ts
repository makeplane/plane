  ...
  layout("./(all)/layout.tsx", [
    ...
    layout("./(all)/[workspaceSlug]/layout.tsx", [
      ...
      layout("./(all)/[workspaceSlug]/(projects)/layout.tsx", [
        ...
        route(":workspaceSlug/research/reports", "./(all)/[workspaceSlug]/(projects)/research/reports/page.tsx"),
        route(
          ":workspaceSlug/research/reports/summary",
          "./(all)/[workspaceSlug]/(projects)/research/reports/summary/page.tsx"
        ),
        route(
          ":workspaceSlug/research/reports/:reportId",
        ...
        route(
          ":workspaceSlug/research/integrations",
          "./(all)/[workspaceSlug]/(projects)/research/integrations/page.tsx"
        ),
        route(
        ...
        route(
          ":workspaceSlug/research/settings/identity",
          "./(all)/[workspaceSlug]/(projects)/research/settings/identity/page.tsx"
        ),
        route(
          ":workspaceSlug/research/settings/templates",
          "./(all)/[workspaceSlug]/(projects)/research/settings/templates/page.tsx"
        ),
        route(
        ...
        route(
          ":workspaceSlug/research/projects/:projectId/literature",
          "./(all)/[workspaceSlug]/(projects)/research/projects/[projectId]/literature/page.tsx"
        ),
        route(
          ":workspaceSlug/research/projects/:projectId/experiments",
          "./(all)/[workspaceSlug]/(projects)/research/projects/[projectId]/experiments/page.tsx"
        ),
        route(
          ":workspaceSlug/research/projects/:projectId/code",
          "./(all)/[workspaceSlug]/(projects)/research/projects/[projectId]/code/page.tsx"
        ),
        route(
          ":workspaceSlug/research/projects/:projectId/outcomes",
          "./(all)/[workspaceSlug]/(projects)/research/projects/[projectId]/outcomes/page.tsx"
        ),
        route(
          ":workspaceSlug/research/projects/:projectId/timeline",
          "./(all)/[workspaceSlug]/(projects)/research/projects/[projectId]/timeline/page.tsx"
        ),
