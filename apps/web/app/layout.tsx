...
export const meta = () => [
  { title: "WinSecOps | Simple, extensible, open-source project management tool." },
  ...
  { property: "og:title", content: "WinSecOps | Simple, extensible, open-source project management tool." },
  {
  ...
  { property: "og:image:alt", content: "WinSecOps - Modern project management" },
  { name: "twitter:site", content: "@planepowers" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: "https://app.plane.so/og-image.png" },
  { name: "twitter:image:width", content: "1200" },
  { name: "twitter:image:height", content: "630" },
  { name: "twitter:image:alt", content: "WinSecOps - Modern project management" },
];
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="WinSecOps" />
