...
export const meta = () => [
  ...
  { property: "og:url", content: "https://app.mycustomsite.com/" },
  { property: "og:image", content: "https://app.mycustomsite.com/og-image.png" },
  { property: "og:image:width", content: "1200" },
  { property: "og:image:height", content: "630" },
  { property: "og:image:alt", content: "Plane - Modern project management" },
  { name: "twitter:site", content: "@mycustomtwitter" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: "https://app.mycustomsite.com/og-image.png" },
