...
// components
import { EditionSelector } from "@/components/upgrade/edition-selector";
// types
...
export default function UpgradePlanPage({ loaderData }: Route.ComponentProps) {
  return <EditionSelector planType={loaderData.planType} />;
}
