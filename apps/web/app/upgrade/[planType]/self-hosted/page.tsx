...
export default function SelfHostedUpgradePage({ loaderData }: Route.ComponentProps) {
  return <PlanPricingSelector planType={loaderData.planType} editionType={EExternalUpgradeEditionType.SELF_HOSTED} />;
}
