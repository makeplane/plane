...
// workspaces imports
import { SITE_DESCRIPTION, SITE_NAME } from "@workspaces/constants";
// types
// assets
...
const APP_TITLE = "Workspaces | Engineering operations and project management for HG Software.";
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:title", content: APP_TITLE },
  {
    ...
    content: "Engineering operations platform to manage work items, cycles, attendance, and delivery in one place",
  },
  { property: "og:url", content: "https://workspaces.hgsoftware.com.np/" },
  { property: "og:image", content: ogImage },
  { property: "og:image:width", content: "1200" },
  { property: "og:image:height", content: "630" },
  { property: "og:image:alt", content: "Workspaces - Engineering operations for HG Software" },
  {
    name: "keywords",
    content:
  ...
  { name: "twitter:image:alt", content: "Workspaces - Engineering operations for HG Software" },
];
