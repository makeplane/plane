  ...
  return (
    <>
      <div className="md:hidden flex justify-evenly border-b border-subtle-1 py-2 z-[13] bg-custom-background-100">
        <Row className="flex flex-grow items-center justify-center border-l border-subtle-1 text-sm text-secondary">
          <ViewOrderByDropdown
        ...
        <div className="flex flex-grow items-center justify-center border-l border-subtle-1 text-sm text-secondary">
          <FiltersDropdown
            ...
            menuButton={
              <Row className="flex items-center text-sm text-secondary">
                Filters
