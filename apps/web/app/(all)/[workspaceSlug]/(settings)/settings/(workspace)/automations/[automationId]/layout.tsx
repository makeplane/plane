  ...
  return (
    <WorkspaceAutomationsDetailsWrapper automationId={automationId} workspaceSlug={workspaceSlug}>
      <ContentWrapper className="flex flex-col overflow-hidden">
        <AppHeader
          header={<WorkspaceAutomationDetailsHeader automationId={automationId} workspaceSlug={workspaceSlug} />}
        />
        <Outlet />
      </ContentWrapper>
    </WorkspaceAutomationsDetailsWrapper>
  );
}

export default observer(WorkspaceAutomationDetailsLayout);
