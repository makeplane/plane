...
const ProjectSettingsPage = () => {
  ...
  return (
    <div className="flex flex-col gap-4 items-center justify-center h-full max-w-[480px] mx-auto">
      <Image src={resolvedPath} alt="No programs yet" width={384} height={250} />
      <div className="text-lg font-semibold text-custom-text-350">No programs yet</div>
      <div className="text-sm text-custom-text-350 text-center">
        Programs act as the foundation for goal-driven work. They let you manage your teams, tasks, and everything you
