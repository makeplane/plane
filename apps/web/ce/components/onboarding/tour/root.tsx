...
// assets
import ShinhanWorkspaceIntro from "@/app/assets/Shinhan_Workspace_Intro.mp4?url";
...
const TOUR_STEPS: {
...
}[] = [
  {
    ...
    description:
      "The work item is the building block of Shinhan Workspace. Most concepts in Shinhan Workspace are either associated with work items and their properties.",
    image: IssuesTour,
    nextStep: "cycles",
  },
  {
      ...
      {step === "welcome" ? (
        <div className="w-4/5 overflow-hidden rounded-[10px] bg-surface-1 md:w-1/2 lg:w-2/5">
          <div className="h-full overflow-hidden">
            <div className="overflow-hidden bg-accent-primary">
              <video src={ShinhanWorkspaceIntro} className="block h-auto w-full" autoPlay loop playsInline>
                <track kind="captions" srcLang="en" label="English" />
              </video>
            </div>
            <div className="flex flex-col overflow-y-auto p-6">
              <h3 className="font-semibold sm:text-18">
                Welcome to Shinhan Workspace, {currentUser?.first_name} {currentUser?.last_name}
              </h3>
              <p className="mt-3 text-13 text-secondary">
                We{"'"}re glad that you decided to try out Shinhan Workspace. You can now manage your projects with
                ease. Get started by creating a project.
              </p>
