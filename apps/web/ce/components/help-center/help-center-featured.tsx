...
export const HelpCenterFeatured = ({ category, onSelect }: Props) => {
  ...
  return (
    <button
      ...
      className="mb-6 flex w-full items-center justify-between gap-4 rounded-lg border border-subtle bg-surface-1 px-5 py-4 text-left transition-colors hover:bg-surface-2 focus-visible:ring-1 focus-visible:ring-accent-strong focus-visible:outline-none"
    >
      <div className="min-w-0">
        <p className="text-13 font-medium tracking-wide text-accent-primary uppercase">
