    ...
    const columns = useMemo(
        () => [
            ...
            columnHelper.accessor("issue_identifier", {
                header: () => (
                    <span className="text-[10px] font-bold text-tertiary uppercase tracking-wide">Issue</span>
                ),
                cell: (info) => (
                        ...
                        <tr key={headerGroup.id} className="border-b border-subtle bg-layer-1-hover">
                            {headerGroup.headers.map((header) => (
                                <th
                                    ...
                                    className={cn(
                                        "px-3 py-2.5",
                                        header.id !== "issue_identifier" && "text-center w-20"
                                    )}
                                >
                        ...
                        >
                            {row.getVisibleCells().map((cell) => (
                                <td
                                    ...
                                    className={cn(
                                        "px-3 py-2",
                                        cell.column.id !== "issue_identifier" && "text-center"
                                    )}
                                >
