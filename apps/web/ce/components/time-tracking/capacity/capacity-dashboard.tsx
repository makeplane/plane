...
export const CapacityDashboard = observer((props: ICapacityDashboardProps) => {
    ...
    const { capacityData, isCapacityLoading, fetchCapacityReport } = useWorklog();
    ...
    const fetchReport = useCallback(() => {
        ...
        fetchCapacityReport(workspaceSlug, projectId, params);
    }, [workspaceSlug, projectId, selectedMembers, dateRange, fetchCapacityReport]);
    ...
    const handleExport = () => {
        ...
        const exportData = capacityData.members.map((member) => ({
            ...
            ...Object.keys(member.days || {}).reduce((acc: any, date) => {
