...
import type { ProjectViewPermissions } from "./permissions";
import { ProjectViewPermissionsInstance } from "./permissions";
...
export interface IProjectViewStore {
  ...
  // permissions
  permissions: ProjectViewPermissions;
}
...
export class ProjectViewStore implements IProjectViewStore {
  ...
  constructor(_rootStore: CoreRootStore) {
    ...
    // root store
    this.permissions = new ProjectViewPermissionsInstance(_rootStore, this);
  ...
  async createView(workspaceSlug: string, projectId: string, data: Partial<IProjectView>): Promise<IProjectView> {
    ...
    void this.rootStore.preferencesRoot.workspace.updateChecklistIfNotDoneAlready(workspaceSlug, "view_created");
