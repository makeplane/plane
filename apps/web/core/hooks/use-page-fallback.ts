...
import type { EditorRefApi, CollaborationState } from "@workspaces/editor";
// workspaces editor
import { convertBinaryDataToBase64String, getBinaryDataFromDocumentEditorHTMLString } from "@workspaces/editor";
// workspaces types
