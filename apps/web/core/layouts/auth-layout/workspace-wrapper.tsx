      ...
      <div className="relative flex h-full w-full flex-col items-center justify-center bg-surface-2">
        <div className="relative container mx-auto flex h-full w-full flex-col overflow-hidden overflow-y-auto px-5 py-14 md:px-0">
          ...
          <div className="relative flex h-full w-full flex-grow flex-col items-center justify-center space-y-3">
            ...
            <h3 className="text-center text-16 font-semibold">{t("workspace_access.not_found_title")}</h3>
            <p className="text-center text-13 text-secondary">{t("workspace_access.not_found_description")}</p>
            <div className="flex items-center justify-center gap-2 pt-4">
              ...
              {allWorkspaces?.length > 0 && (
                <Link href="/settings/profile/general/" className={cn(getButtonStyling("secondary", "base"))}>
                  {t("workspace_access.visit_profile")}
                </Link>
              )}
              {allWorkspaces && allWorkspaces.length === 0 && (
        ...
        <div className="grid h-full place-items-center p-4">
          <div className="space-y-8 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto w-1/2 text-13 text-secondary">{t("workspace_access.not_authorized_description")}</p>
            </div>
            <div className="flex items-center justify-center gap-2">
              <Link href="/invitations">
                <span>
                  <Button variant="secondary">{t("workspace_access.check_pending_invites")}</Button>
                </span>
              </Link>
              <Link href="/create-workspace">
                <span>
                  <Button variant="primary">{t("onboarding.create_new_workspace")}</Button>
                </span>
              </Link>
            </div>
          </div>
