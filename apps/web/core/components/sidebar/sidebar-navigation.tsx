  ...
  return (
    <div
      className={cn(
        ...
        {
          "text-secondary bg-custom-background-80/75": isActive,
          "text-secondary hover:bg-custom-sidebar-background-90 active:bg-custom-sidebar-background-90": !isActive,
        },
        className
      )}
    >
