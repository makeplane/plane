...
export function ListItem(props: IListItemProps) {
  ...
  return (
    <div ref={parentRef} className="relative">
      <Row
        className={cn(
          "group min-h-[52px] flex w-full flex-col items-center justify-between gap-3 py-4 text-13 border-b border-subtle-1 bg-custom-background-100 hover:bg-custom-background-90 ",
