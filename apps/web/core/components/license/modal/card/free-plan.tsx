    ...
    <div className="py-4 px-2 border border-subtle-1 rounded-xl">
      {isOnFreePlan && (
        <div className="py-2 px-3">
          <span className="px-2 py-1 bg-custom-background-90 text-sm text-tertiary font-medium rounded">Your plan</span>
        </div>
      )}
      <div className="px-4 py-2 font-semibold">
        <div className="text-2xl">Free</div>
        <div className="text-sm text-tertiary">$0 per user per month</div>
      </div>
