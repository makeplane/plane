    ...
    <div className="max-w-2xl">
      ...
      <Card>
        <div className="flex items-center gap-4 p-5">
          <div className="grid size-14 flex-shrink-0 place-items-center rounded-full bg-[var(--mail-ink)] text-lg font-semibold text-white">
            {initialsOf(mail.mailboxEmail)}
          </div>
          <div className="min-w-0 flex-1">
            <div className="truncate text-base font-semibold text-[var(--mail-ink)]">{mail.mailboxEmail}</div>
            <div className="mt-0.5 text-sm text-[var(--mail-muted)]">
      ...
      <Card>
        <CardRow>
          ...
          <MailToggle
            value={!!prefs?.conversation_view}
            onChange={(value) => patch({ conversation_view: value })}
          />
        </CardRow>
        <CardRow>
          <div className="flex-1">
        ...
        <CardRow last>
          <div className="flex-1">
            ...
            <div className="mt-0.5 text-sm text-[var(--mail-muted)]">{t("mail.settings.account.language_desc")}</div>
          </div>
