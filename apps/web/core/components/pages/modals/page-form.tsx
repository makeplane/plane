  ...
  return (
    <form onSubmit={handlePageFormSubmit}>
      <div className="space-y-5 p-5">
        <h3 className="text-18 font-medium text-secondary">Создать страницу</h3>
          ...
          <div className="flew-grow w-full space-y-1">
            ...
            {isTitleLengthMoreThan255Character && (
              <span className="text-11 text-danger-primary">
                Длина названия должна быть менее 255 символов
              </span>
            )}
          </div>
        </div>
      ...
      <div className="flex items-center justify-between gap-2 border-t-[0.5px] border-subtle px-5 py-4">
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          >
            {isSubmitting ? "Создание..." : "Создать страницу"}
          </Button>
        </div>
      </div>
    </form>
