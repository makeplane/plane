...
function CollectionPageTableSkeleton() {
  return (
...
export function CollectionPageTableLoader() {
  return <CollectionPageTableSkeleton />;
}

export function CollectionPageLoader() {
  return (
    <div className="@container size-full overflow-y-scroll vertical-scrollbar scrollbar-sm">
      <div className="w-full px-page-x py-9 @min-[67.5rem]:px-24">
