    ...
    await handleRestore(versionDetails?.description_html ?? "<p></p>")
      .then(() => {
        setToast({
          ...
          title: "Версия страницы восстановлена.",
        });
        handleClose();
      })
      .catch(() =>
        setToast({
          ...
          title: "Не удалось восстановить версию страницы.",
        })
      )
      ...
      {versionDetailsError ? (
        <div className="grid flex-grow place-items-center">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div>
              <h6 className="text-16 font-semibold">Что-то пошло не так!</h6>
              <p className="text-13 text-tertiary">Не удалось загрузить версию, пожалуйста, попробуйте снова.</p>
            </div>
