    ...
    <div>
        ...
        <div className="col-span-6 ml-8">
          <Controller
            ...
            rules={{
              pattern: {
                value: emailRegex,
                message: t("onboarding.invalid_email"),
              },
            }}
      ...
      {email && !emailRegex.test(email) && (
        <div className="mx-8 my-1">
          ...
          <span className="mt-1 text-11 text-danger-primary">{t("onboarding.invalid_email")}</span>
        </div>
      )}
    </div>
  );
    ...
    await workspaceService
      ...
      .then(() => {
        setToast({
          ...
          message: t("onboarding.invitations_sent"),
        });
        return nextStep();
      })
      .catch((err) => {
      ...
      <div className="h-full w-full overflow-auto px-6 py-10 sm:px-7 sm:py-14 md:px-14 lg:px-28">
        <div className="mx-auto mt-6 flex w-full flex-col items-center justify-center p-8 md:w-4/5">
          <div className="mx-auto w-4/5 space-y-1 py-4 text-center">
            <h3 className="text-24 font-bold text-primary">{t("onboarding.invite_team_title")}</h3>
            <p className="font-medium text-placeholder">{t("onboarding.invite_team_description")}</p>
          </div>
          <form
          ...
          >
            <div className="w-full py-4 text-13">
              <div className="group relative mx-8 grid grid-cols-10 gap-4 py-2">
                <div className="col-span-6 px-1 text-13 font-medium text-secondary">{t("space_auth.email")}</div>
