...
import { BRAND_NAME, ROLE, ROLE_DETAILS } from "@plane/constants";
            ...
            render={({ field: { value, onChange } }) => (
              ...
              >
                ...
                <Listbox.Options
                  ...
                  {...attributes.popper}
                >
                  <div className="shadow-sm absolute mt-1 h-fit w-48 space-y-1 rounded-md border border-strong bg-surface-1 p-2 focus:outline-none sm:w-60">
        ...
        <div className="mx-auto mt-6 flex w-full flex-col items-center justify-center p-8 md:w-4/5">
          <div className="mx-auto w-4/5 space-y-1 py-4 text-center">
            ...
            <p className="font-medium text-placeholder">
              Work in {BRAND_NAME} happens best with your team. Invite them now to use {BRAND_NAME} to its full
              potential.
            </p>
          </div>
          <form
