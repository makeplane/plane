    ...
    <div className={`flex flex-col overflow-hidden rounded-lg bg-surface-2 transition-all duration-300 ease-in-out`}>
      ...
      >
        <div className="flex items-center gap-1 text-tertiary">
          ...
          <span className="font-medium">{t("localized_ui.onboarding.set_password")}</span>
          <span>({t("localized_ui.onboarding.optional")})</span>
        </div>
      ...
      <div className={expandedContentClasses}>
        ...
        <div className="flex transform flex-col gap-2 pt-1 transition-all duration-300 ease-in-out">
          <PasswordInput
            ...
            placeholder={t("localized_ui.onboarding.set_password")}
        ...
        <div className="flex flex-col gap-2 pb-2">
          ...
          <div className="transform transition-all delay-100 duration-300 ease-in-out">
            ...
            />
            {hasPasswordMismatch && (
              <p className="mt-1 text-11 text-danger-primary">{t("localized_ui.onboarding.passwords_do_not_match")}</p>
            )}
            {isPasswordValid && (
              <p className="mt-1 text-11 text-success-primary">✓ {t("localized_ui.onboarding.passwords_match")}</p>
            )}
          </div>
        </div>
      </div>
