  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
      ...
      <CommonOnboardingHeader
        title={t("onboarding.create_profile_title")}
        description={t("onboarding.create_profile_description")}
      />
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <span className="text-13">{userAvatar ? t("onboarding.change_image") : t("onboarding.upload_image")}</span>
        </button>
      </div>
      ...
      <div className="flex w-full flex-col gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Controller
            ...
            name="first_name"
            rules={{
              required: t("onboarding.name_required"),
              validate: validatePersonName,
              maxLength: {
                value: 50,
                message: t("onboarding.name_within_50"),
              },
            }}
            render={({ field: { value, onChange, ref } }) => (
              <input
                ...
                placeholder={t("onboarding.enter_full_name")}
                autoComplete="on"
              />
            )}
          />
