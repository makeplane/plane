          ...
          {currentView === ECreateOrJoinWorkspaceViews.WORKSPACE_JOIN ? (
            ...
            isWorkspaceCreationEnabled ? (
              ...
              <div className="flex h-96 w-full items-center justify-center">
                <div className="flex gap-2.5 w-full items-start justify-center text-13 leading-5 mt-4 px-6 py-4 rounded border border-custom-primary-100/20 bg-custom-primary-100/10 text-custom-primary-200">
