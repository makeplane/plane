...
export const GanttChartSidebar = observer(function GanttChartSidebar(props: Props) {
  ...
  return (
    <Row
      ...
      id="gantt-sidebar"
      className="sticky left-0 z-10 min-h-full h-max flex-shrink-0 border-r-[0.5px] border-subtle-1 bg-custom-background-100"
      style={{
    ...
    >
      <Row
        className="group/list-header box-border flex-shrink-0 flex items-end justify-between gap-2 border-b-[0.5px] border-subtle-1 pb-2 pr-4 text-sm font-medium text-custom-text-300 sticky top-0 z-10 bg-custom-background-100"
        style={{
