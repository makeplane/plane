          ...
          <div className="my-10 flex items-center justify-center p-4 text-center sm:p-0 md:my-20">
            ...
            >
              <Dialog.Panel className="relative flex h-full items-center justify-center">
                <div className="flex h-[61vh] w-full flex-col  space-y-4 overflow-hidden rounded-lg bg-surface-1 py-5 shadow-raised-200 transition-all sm:w-[29rem]">
                  ...
                  <ScrollArea size="sm" className="overflow-y-scroll px-5">
