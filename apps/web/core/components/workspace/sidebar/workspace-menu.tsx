...
// plane imports
import { AnalyticsIcon, CycleIcon, ProjectIcon, TimelineLayoutIcon, ViewsIcon } from "@plane/propel/icons";
...
export const SidebarWorkspaceMenu = observer(function SidebarWorkspaceMenu() {
  ...
  const SIDEBAR_WORKSPACE_MENU_ITEMS = [
    ...
    },
    {
      ...
      labelTranslationKey: "sidebar.program_timeline",
      href: `/${workspaceSlug}/program-timeline/`,
      access: [EUserWorkspaceRoles.ADMIN, EUserWorkspaceRoles.MEMBER],
