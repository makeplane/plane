...
export const PlanDetail = observer(function PlanDetail(props: TPlanDetailProps) {
  ...
  return (
    <div className="col-span-1 px-6 py-4 flex flex-col justify-between gap-4">
        ...
        {isProductsAPILoading ? (
          ...
          <div className="flex gap-1.5">
            {isSubscriptionActive && displayPrice !== undefined && (
              <div key={`${subscriptionType}-${billingFrequency}`} className="text-h6-medium animate-slide-up">
