    ...
    <Header variant={EHeaderVariant.SECONDARY} className="min-h-[44px] z-[12] bg-surface-1">
      ...
      {isAuthorizedUser ? (
        <button
          ...
          className="sticky -right-4 flex flex-shrink-0 items-center justify-center border-transparent bg-surface-1 py-3 hover:border-subtle-1 hover:text-placeholder"
