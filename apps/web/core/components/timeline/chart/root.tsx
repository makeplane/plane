...
import { TimelineChartHeader, TimelineChartMainContent } from "@/components/timeline";
// helpers
// hooks
...
type TimelineChartViewRootProps = {
  border: boolean;
  title: string;
  loaderTitle: string;
  blockIds: string[];
...
export const TimelineChartViewRoot = observer(function TimelineChartViewRoot(props: TimelineChartViewRootProps) {
  const {
    border,
    title,
    blockIds,
