...
// constants
import { TIMELINE_SELECT_GROUP, HEADER_HEIGHT, SIDEBAR_WIDTH } from "../constants";

type TimelineChartSidebarProps = {
  blockIds: string[];
...
export const TimelineChartSidebar = observer(function TimelineChartSidebar(props: TimelineChartSidebarProps) {
  ...
  const isGroupSelectionEmpty = selectionHelpers.isGroupSelected(TIMELINE_SELECT_GROUP) === "empty";
