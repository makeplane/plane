...
interface ArchivedEpicsHeaderProps {
  workspaceSlug: string;
  projectId: string;
}

export const ArchivedEpicsHeader = observer(function ArchivedEpicsHeader(props: ArchivedEpicsHeaderProps) {
  ...
  return (
    <Header variant={EHeaderVariant.SECONDARY}>
      ...
      <Header.RightItem className="items-center">
        <WorkItemFiltersToggle entityType={EIssuesStoreType.ARCHIVED_EPIC} entityId={projectId} />
        <FiltersDropdown title={t("common.display")} placement="bottom-end">
          <DisplayFiltersSelection
            ...
            layoutDisplayFiltersOptions={
              activeLayout ? ISSUE_DISPLAY_FILTERS_BY_PAGE.archived_epics.layoutOptions[activeLayout] : undefined
            }
