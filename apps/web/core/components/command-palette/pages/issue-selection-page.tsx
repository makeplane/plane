...
export const IssueSelectionPage: React.FC<IssueSelectionPageProps> = (props) => {
  const { workspaceSlug, projectId, searchTerm, debouncedSearchTerm, isLoading, isSearching, resolvedPath, isWorkspaceLevel = false } = props;
  // router
