      ...
      <div>
        ...
        <div className="mt-6">
          ...
          {currentActiveEstimateId ? (
            <>
              ...
              <div className="mt-12 flex flex-col gap-y-4">
                <SettingsHeading title="Список оценок" variant="h6" />
                <EstimateList
          ...
          {archivedEstimateIds && archivedEstimateIds.length > 0 && (
            <div className="mt-12 flex flex-col gap-y-4">
              <SettingsHeading
                title="Архивные оценки"
                description={
                  <>
                    Система оценок изменилась — это оценки из ваших прежних версий, которые
                    не использовались. Подробнее о них читайте&nbsp;
                    <a
                      href={"https://docs.gizmo.so/core-concepts/projects/run-project#estimate"}
                      target="_blank"
