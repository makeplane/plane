        ...
        <>
          ...
          <div className="border-0.5 z-10 flex items-center justify-end gap-2 p-3">
            {issueName && issueName.trim() !== "" && config?.has_llm_configured && (
              <button
                type="button"
                className={`flex items-center gap-1 rounded-sm bg-surface-2 hover:bg-layer-1 px-1.5 py-1 text-11 ${
            ...
            {config?.has_llm_configured && projectId && (
              <GptAssistantPopover
                ...
                button={
                  <button
                    type="button"
                    className="flex items-center gap-1 rounded-sm px-1.5 py-1 text-11 bg-surface-2 hover:bg-layer-1"
