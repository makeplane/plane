...
export const IssueDescriptionEditor = observer(function IssueDescriptionEditor(props: TIssueDescriptionEditorProps) {
  ...
  return (
    <div className="border-[0.5px] border-subtle-1 rounded-lg relative">
      {descriptionHtmlData === undefined || !projectId ? (
        <Loader className="min-h-[120px] max-h-64 space-y-2 overflow-hidden rounded-md border border-subtle-1 p-3 py-2 pt-3">
        ...
        <>
          ...
          <div className="border-0.5 z-10 flex items-center justify-end gap-2 p-3">
            {issueName && issueName.trim() !== "" && config?.has_llm_configured && (
              <button
                type="button"
                className={`flex items-center gap-1 rounded bg-custom-background-90 hover:bg-custom-background-80 px-1.5 py-1 text-11 ${
            ...
            {config?.has_llm_configured && projectId && (
              <GptAssistantPopover
                ...
                button={
                  <button
                    type="button"
                    className="flex items-center gap-1 rounded px-1.5 py-1 text-11 bg-custom-background-90 hover:bg-custom-background-80"
