...
import { ICON_BUTTON_CLASS, ROW_FILTER_LABELS, SURFACE_CLASS, TAG_TABLE_GRID_CLASS } from "./constants";
    ...
    <div className="max-h-[520px] overflow-auto">
      <div className="min-w-full">
        ...
        >
          ...
          <div>{sportTableConfig.secondaryDetailLabel}</div>
          <div>Actions</div>
        </div>
                    ...
                    {rows.map((row, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div>{row.result}</div>
                          <div>{row.primaryDetail}</div>
                          <div>{row.secondaryDetail}</div>
