        ...
        <div className="h-full w-full overflow-y-auto px-6">
          ...
          <div className={`mb-2 mt-3 space-y-2.5 ${!isEditable ? "opacity-60" : ""}`}>
            <div className="flex h-8 items-center gap-2">
              <div className="flex w-2/5 flex-shrink-0 items-center gap-1 text-body-xs-regular text-tertiary">
            ...
            {createdByDetails && (
              <div className="flex h-8 items-center gap-2">
                ...
                <div className="w-full h-full flex items-center gap-1.5 rounded-sm px-2 py-0.5 text-body-xs-regular justify-between cursor-not-allowed">
            ...
            {projectDetails?.module_view && (
              <div className="flex min-h-8 gap-2">
                <div className="flex w-2/5 flex-shrink-0 gap-1 pt-2 text-body-xs-regular text-tertiary">
