...
export function LabelActivityChip(props: TIssueLabelPill) {
  ...
  return (
    <Tooltip tooltipContent={name}>
      <span className="inline-flex w-min max-w-32 cursor-default flex-shrink-0 items-center gap-2 truncate whitespace-nowrap rounded-full border border-strong px-2 py-0.5 text-xs">
        <span
