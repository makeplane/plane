...
export const IssueAttachmentsUploadDetails = observer(function IssueAttachmentsUploadDetails(props: Props) {
  ...
  return (
    <div className="flex h-[60px] items-center justify-between gap-1 rounded-md border-[2px] border-subtle-1 bg-custom-background-90 px-4 py-2 text-sm pointer-events-none">
