...
export const SpreadsheetSubIssueColumn = observer(function SpreadsheetSubIssueColumn(props: Props) {
  ...
  return (
    <Row
      ...
      className={cn(
        "flex h-11 w-full items-center border-b-[0.5px] border-subtle-1 py-1 text-11 hover:bg-surface-2 group-[.selected-issue-row]:bg-accent-primary/5 group-[.selected-issue-row]:hover:bg-custom-primary-90",
        {
