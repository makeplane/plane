...
type TCycleIssueQuickActionsProps = Exclude<IQuickActionProps, "readOnly" | "disabled"> & {
  permissions: {
    canEdit: boolean;
    canDelete: boolean;
    canArchive: boolean;
...
export const CycleIssueQuickActions = observer(function CycleIssueQuickActions(props: TCycleIssueQuickActionsProps) {
  const {
    issue,
    handleDelete,
    handleUpdate,
