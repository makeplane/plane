...
type TProfileIssuesListLayoutProps = {
  workspaceSlug: string;
  profileViewId: string;
};

export const ProfileIssuesListLayout = observer(function ProfileIssuesListLayout(props: TProfileIssuesListLayoutProps) {
  const { workspaceSlug, profileViewId } = props;
  // store
  const { permissions } = useIssues(EIssuesStoreType.PROFILE);
