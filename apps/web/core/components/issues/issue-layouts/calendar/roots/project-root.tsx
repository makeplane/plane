...
type TCalendarLayoutProps = {
  workspaceSlug: string;
  projectId: string | undefined;
};

export const CalendarLayout = observer(function CalendarLayout(props: TCalendarLayoutProps) {
  ...
  return (
    <BaseCalendarRoot
      ...
      layoutPermissions={{
        canQuickAddWorkItem: projectId ? permissions.getCanCreate(workspaceSlug, projectId) : false,
      }}
