    ...
    <div className="m-1 overflow-hidden rounded shadow-custom-shadow-sm">
      <form ref={ref} onSubmit={onSubmit} className="flex w-full items-center gap-x-3 bg-custom-background-100 p-3">
        <div className="w-full">
          <h4 className="text-xs font-medium leading-5 text-tertiary">{projectDetail?.identifier ?? "..."}</h4>
          <input
            autoComplete="off"
            ...
            className="w-full rounded-md bg-transparent px-2 py-1.5 pl-0 text-sm font-medium leading-5 text-secondary outline-none"
          />
        </div>
      </form>
      <div className="px-3 py-2 text-xs italic text-secondary">
