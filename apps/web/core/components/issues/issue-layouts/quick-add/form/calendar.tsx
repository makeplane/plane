  ...
  return (
    ...
    >
      <form
        ref={ref}
        onSubmit={onSubmit}
        className="z-50 flex w-full items-center gap-x-2 rounded-sm md:border-[0.5px] border-subtle-1 bg-surface-1 px-2 md:shadow-custom-shadow-2xs transition-opacity"
      >
