 ...
 * dot from the type's own color, §7.12). Rendered next to the issue key
 * wherever the type is known — list rows, boards, relations, preview cards,
 * detail/peek headers (§5.4 planning model: Plan/Ticket/Design).
 */
