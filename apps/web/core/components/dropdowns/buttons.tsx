...
function BorderButton(props: ButtonProps) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "h-full w-full flex items-center gap-1.5 border-[0.5px] border-strong hover:bg-layer-transparent-hover-lg text-11 px-2 py-0.5",
          {
...
function BackgroundButton(props: ButtonProps) {
  ...
  return (
    ...
    >
      <div
        className={cn("h-full w-full flex items-center gap-1.5 rounded-lg text-11 px-2 py-0.5 bg-layer-3", className)}
      >
        {children}
      </div>
    </Tooltip>
...
function TransparentButton(props: ButtonProps) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "h-full w-full flex items-center gap-1.5 rounded-lg text-11 px-2 py-0.5 hover:bg-layer-transparent-hover",
          {
            "bg-layer-transparent-active": isActive,
          },
          className
