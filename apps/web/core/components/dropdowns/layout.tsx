...
export const LayoutDropDown = observer(function LayoutDropDown(props: TLayoutDropDown) {
  ...
  return (
    <Dropdown
      ...
      options={options}
      buttonContainerClassName="bg-surface-1 border border-subtle-1 hover:bg-surface-2 focus:text-tertiary focus:bg-surface-2 px-2 py-1.5  rounded-sm flex items-center gap-1.5 whitespace-nowrap transition-all justify-center relative"
