...
export const InboxIssueAppliedFilters = observer(function InboxIssueAppliedFilters() {
  ...
  return (
    <Header variant={EHeaderVariant.TERNARY}>
      ...
      {/* created_at */}
      <InboxIssueAppliedFiltersDate filterKey="created_at" label={t("localized_ui.inbox.filters.created_date")} />
      {/* updated_at */}
      <InboxIssueAppliedFiltersDate filterKey="updated_at" label={t("localized_ui.inbox.filters.updated_date")} />
    </Header>
  );
});
