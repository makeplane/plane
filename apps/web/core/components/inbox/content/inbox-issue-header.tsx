  ...
  const handleActionWithPermission = (isAdmin: boolean, action: () => void, errorMessage: string) => {
    if (isAdmin) action();
      ...
      setToast({
        ...
        title: t("inbox.errors.permission_denied"),
          ...
          {!isNotificationEmbed && (
            <div className="flex items-center gap-x-2">
              <IconButton
                ...
                size="lg"
                icon={ChevronUpIcon}
                aria-label={t("inbox.navigation.previous_work_item")}
              ...
              <IconButton
                ...
                aria-label={t("inbox.navigation.next_work_item")}
                      ...
                      <CustomMenu.MenuItem
                        onClick={() =>
                          handleActionWithPermission(
                            ...
                            t("inbox.errors.mark_duplicate_permission")
                          )
                        }
                      >
                        <div className="flex items-center gap-2">
