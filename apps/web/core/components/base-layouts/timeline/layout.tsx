...
import { BaseTimelineSidebar } from "./sidebar";

export const BaseTimelineLayout = observer(function BaseTimelineLayout<T extends IBaseLayoutsGanttItem>(
  ...
  const sidebarToRender = useCallback(
    ...
    (sidebarProps: any) => {
      ...
      return (
        <BaseTimelineSidebar {...sidebarProps} items={items} renderItem={renderBlock} loadMoreItems={loadMoreItems} />
      );
    },
