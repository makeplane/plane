...
import { TimelineDnDHOC } from "@/components/timeline/sidebar/timeline-dnd-HOC";
import { handleOrderChange } from "@/components/timeline/sidebar/utils";
import { TimelineLayoutListItemLoader } from "@/components/ui/loader/layouts/timeline-layout-loader";
import { useIntersectionObserver } from "@/hooks/use-intersection-observer";
import { useTimeLineChartStore } from "@/hooks/use-timeline-chart";

type BaseTimelineSidebarProps<T extends IBaseLayoutsBaseItem> = {
...
export const BaseTimelineSidebar = observer(function BaseTimelineSidebar<T extends IBaseLayoutsBaseItem>(
  props: BaseTimelineSidebarProps<T>
) {
  const {
    blockUpdateHandler,
    blockIds,
          ...
          {blockIds.map((blockId, index) => {
            ...
            return (
              <RenderIfVisible
                ...
                placeholderChildren={<TimelineLayoutListItemLoader />}
              >
                <TimelineDnDHOC
                  id={blockId}
