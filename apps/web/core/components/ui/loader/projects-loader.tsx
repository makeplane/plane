  ...
  return (
    <div className="h-full w-full overflow-y-auto p-8 animate-pulse">
      <div className="grid grid-cols-1 gap-9 md:grid-cols-2 lg:grid-cols-3">
        {range(3).map((i) => (
          <div key={i} className="flex cursor-pointer flex-col rounded border border-subtle-1 bg-custom-background-100">
            <div className="relative min-h-[118px] w-full rounded-t border-b border-subtle-1 ">
