...
export const ProfileSidebar = observer(function ProfileSidebar(props: TProfileSidebar) {
  ...
  return (
    <div
      className={cn(
        `vertical-scrollbar fixed z-5 scrollbar-md h-full shrink-0 overflow-hidden overflow-y-auto border-l border-subtle bg-surface-1 shadow-raised-200 transition-[width,margin] duration-300 ease-in-out md:relative`,
