      ...
      <div className="grid h-full w-full place-items-center">
        <div className="text-center">
          <img
            ...
            alt="Нет подходящих модулей"
          />
          <h5 className="mt-7 mb-1 text-18 font-medium">Нет подходящих модулей</h5>
          <p className="text-14 text-placeholder">
            {archivedModulesSearchQuery.trim() === ""
              ? "Уберите фильтры, чтобы увидеть все модули"
              : "Уберите критерии поиска, чтобы увидеть все модули"}
          </p>
        </div>
      </div>
    );
