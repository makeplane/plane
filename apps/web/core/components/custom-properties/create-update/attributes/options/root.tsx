...
export const IssuePropertyOptionsRoot = observer(function IssuePropertyOptionsRoot(props: TIssuePropertyOptionsRoot) {
  ...
  // store hooks
  const { propertyOptions, handlePropertyOptionsList } = useCustomPropertyOptions();
  // derived values
            ...
            render={(propertyOption: TIssuePropertyOptionCreateUpdateData) => (
              <div key={propertyOption.id} className="flex group w-full items-center">
                <Tooltip tooltipContent="Drag to rearrange">
                  <div className="rounded-sm shrink-0 w-3 relative flex justify-center items-center transition-colors cursor-grab">
        ...
        {createListData.map((issuePropertyOption, index) => (
          <div key={issuePropertyOption.key} className="flex group w-full items-center">
            <Tooltip tooltipContent="Save to enable drag-and-rearrange">
              <div className="rounded-sm shrink-0 w-3 relative flex justify-center items-center transition-colors cursor-not-allowed">
