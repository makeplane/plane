...
type CustomPropertyQuickActionsProps = {
...
export const CustomPropertyQuickActions = observer(function CustomPropertyQuickActions(
  props: CustomPropertyQuickActionsProps
) {
  const { isPropertyDisabled, onDisable, onDelete, onEdit, canEdit, canDelete } = props;
  // plane hooks
