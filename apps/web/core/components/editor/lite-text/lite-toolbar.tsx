  ...
  return (
    <div className="flex items-center gap-2 pb-1">
      ...
      <button
        ...
        className="p-1 bg-custom-primary-100 hover:bg-custom-primary-200 disabled:bg-custom-text-400 disabled:text-secondary text-primary rounded transition-colors"
      >
