...
export function ComingSoonBadge({ className }: { className?: string }) {
  return (
    <span
      className={cn(
        "bg-[#3f76ff] text-white font-semibold text-9 py-0.5 px-1.5 w-fit whitespace-nowrap rounded",
        className
      )}
    >
      COMING SOON
...
export const PLANS_COMPARISON_LIST: TPlansComparisonDetails[] = [
  ...
  },
  {
    ...
    features: [
      ...
      //     pro: (
      //       <span className="flex flex-col items-end lg:items-center gap-1">
      //         <span className="bg-[#3f76ff] text-white font-semibold text-9 p-0.5 w-fit whitespace-nowrap rounded-sm">
      //           COMING SOON
      //         </span>
