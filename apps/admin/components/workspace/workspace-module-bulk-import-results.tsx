...
type Props = { result: IWorkspaceModuleBulkImportResponse };

export const WorkspaceModuleBulkImportResults = observer(function WorkspaceModuleBulkImportResults({ result }: Props) {
  return (
