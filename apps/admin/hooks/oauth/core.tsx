...
export const getCoreAuthenticationModesMap: (
  ...
  oidc: {
    ...
    description: "Allow members to log in or sign up to Plane through any OpenID Connect provider such as Keycloak.",
    icon: <img src={oidcLogo} height={20} width={20} alt="OpenID Connect Logo" />,
