          ...
          <div className="max-h-40 overflow-x-auto rounded border border-subtle">
            <table className="text-sm min-w-full">
              <thead className="bg-layer-2">
                <tr>
                  <th className="text-xs px-3 py-1.5 text-left font-medium text-tertiary">dept_code</th>
                  <th className="text-xs px-3 py-1.5 text-left font-medium text-tertiary">category_name</th>
                </tr>
              </thead>
