  ...
  return (
    ...
    >
      <div className="space-y-6">
            ...
            <div className="space-y-3">
              {groups.map((group) => {
                ...
                return (
                  <div
                    key={group.id}
                    className={`rounded-md border bg-background-100 ${
                      group.is_designated ? "border-primary-100 ring-1 ring-primary-100/30" : "border-border-200"
                    }`}
                  >
                    {/* Group header */}
                    <div
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            {group.is_designated && (
                              <span className="flex items-center gap-1 rounded-full bg-primary-100/10 px-2 py-0.5 text-12 text-primary-100 font-medium">
                      ...
                      <div className="flex items-center gap-2">
                        {!group.is_designated && (
                          <button
                            ...
                            className="flex items-center gap-1 rounded-md border border-border-200 px-2 py-1 text-12 hover:bg-background-80 transition-colors"
        ...
        {!selectedSlug && <p className="text-14 text-tertiary">Select a workspace to manage CAB groups.</p>}
      </div>
    </PageWrapper>
  );
});
