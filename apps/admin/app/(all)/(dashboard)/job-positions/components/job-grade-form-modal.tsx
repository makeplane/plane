  ...
  useEffect(() => {
    if (editGrade) {
      reset({
        ...
        sort_order: editGrade.sort_order,
        is_active: editGrade.is_active,
      });
    } else {
        ...
        <div className="p-6">
          ...
          <form onSubmit={(e) => void handleSubmit(onSubmit)(e)} className="mt-4 space-y-3">
            <div className="space-y-1">
              <label htmlFor="jg-name" className="text-13 font-medium">
                Name *
              </label>
            ...
            <div className="space-y-1">
              <label htmlFor="jg-description" className="text-13 font-medium">
                Description
              </label>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                <label htmlFor="jg-sort-order" className="text-13 font-medium">
                  Sort order
                </label>
