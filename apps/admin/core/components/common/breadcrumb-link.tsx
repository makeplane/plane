    ...
    <Tooltip tooltipContent={label} position="bottom">
      <li className="flex items-center space-x-2" tabIndex={-1}>
        <div className="flex flex-wrap items-center gap-2.5">
          {href ? (
            <Link className="flex items-center gap-1 text-sm font-medium text-tertiary hover:text-primary" href={href}>
              {icon && (
            ...
            <div className="flex cursor-default items-center gap-1 text-sm font-medium text-primary">
