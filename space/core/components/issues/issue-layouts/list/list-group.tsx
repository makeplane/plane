...
export const ListGroup = observer((props: Props) => {
  ...
  const loadMore = isPaginating ? (
    ...
    <div
      className={
        "h-11 relative flex items-center gap-3 bg-custom-background-100 border border-transparent border-t-custom-border-200 pl-6 p-3 text-sm font-medium text-custom-text-300 hover:text-custom-text-200 hover:underline cursor-pointer"
      }
