...
export class WorkspaceEntityConnectionAPIService extends APIService {
    ...
    async createWorkspaceEntityConnection(data: Partial<TWorkspaceEntityConnection>): Promise<TWorkspaceEntityConnection> {
    ...
    async updateWorkspaceEntityConnection(connectionId: string, data: Partial<TWorkspaceEntityConnection>): Promise<TWorkspaceEntityConnection> {
    ...
    async listWorkspaceEntityConnections(params?: Partial<Record<keyof TWorkspaceEntityConnection, string>>): Promise<TWorkspaceEntityConnection[]> {
