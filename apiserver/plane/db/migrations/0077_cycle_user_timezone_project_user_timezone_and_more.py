# Generated by Django 4.2.15 on 2024-09-16 07:40
...
def populate_cycle_issue_state_progress(apps, schema_editor):
    # Get the models
    CycleIssue = apps.get_model("db", "CycleIssue")
    CycleIssueStateProgress = apps.get_model("db", "CycleIssueStateProgress")
    Project = apps.get_model("db", "Project")

    # Prepare a list to hold all CycleIssueStateProgress objects
    progress_records = []

    # Iterate through all CycleIssue records
    for cycle_issue in CycleIssue.objects.all():

        estimate_type = Project.objects.filter(
            workspace_id=cycle_issue.workspace_id,
            pk=cycle_issue.project_id,
            estimate__isnull=False,
            estimate__type="points",
        ).exists()

        # Create a CycleIssueStateProgress object for each cycle_issue
        progress_records.append(
            CycleIssueStateProgress(
                ...
                workspace_id=cycle_issue.workspace_id,
                created_by_id=cycle_issue.created_by_id,
                updated_by_id=cycle_issue.updated_by_id,
            )
        )

    # Bulk create all records in one query
    if progress_records:
        CycleIssueStateProgress.objects.bulk_create(progress_records)
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                ...
                default=1,
                null=True,
                verbose_name="Issue Sequence ID",
            ),
        ),
