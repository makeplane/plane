...
import plane.db.models.external_api
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(default=plane.db.models.external_api.generate_token, max_length=255, unique=True)),
                ('label', models.CharField(default=plane.db.models.external_api.generate_label_token, max_length=255)),
