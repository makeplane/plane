...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='issue',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issue_cycle', to='db.issue'),
        ),
        migrations.AlterField(
            model_name='draftissuecycle',
            name='draft_issue',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='draft_issue_cycle', to='db.draftissue'),
        ),
