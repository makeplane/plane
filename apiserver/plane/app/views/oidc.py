    ...
    def post(self, request):
        try:
            ...
            if not id_token:
                return Response(
                    {
                        "error": "Something went wrong. Please try again later or contact the support team. No ID Token found in request."
                    },
                    status=status.HTTP_400_BAD_REQUEST,
                )
            ...
            if "@" in email:
                ...
                return Response(
                    {
                        "error": "Something went wrong. Please try again later or contact the support team. No valid email found."
                    },
                    status=status.HTTP_400_BAD_REQUEST,
                )
