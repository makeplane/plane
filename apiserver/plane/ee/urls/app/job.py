...
urlpatterns = [
    ...
    # Report endpoints
    path("workspaces/<str:slug>/import-reports/", ImportReportView.as_view(), name="import-reports"),
    path("workspaces/<str:slug>/import-reports/<uuid:pk>/", ImportReportView.as_view(), name="import-report"),
]