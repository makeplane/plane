...
class TeamSpacePageEndpoint(TeamBaseEndpoint):
...
class TeamSpacePageUnarchiveEndpoint(TeamBaseEndpoint):
...
class TeamSpacePageLockEndpoint(TeamBaseEndpoint):
...
class TeamSpacePagesDescriptionEndpoint(TeamBaseEndpoint):
...
class TeamSpacePageVersionEndpoint(TeamBaseEndpoint):
...
class TeamSpacePageFavoriteEndpoint(TeamBaseEndpoint):
