  ...
  return {
    ...
    responsiveBreakpoint:
      typeof statuslineLayout.responsiveBreakpoint === "number"
        ...
        : 0.85,
    maxAgentRows: typeof statuslineLayout.maxAgentRows === "number" ? statuslineLayout.maxAgentRows : 4,
    todoTruncation: typeof statuslineLayout.todoTruncation === "number" ? statuslineLayout.todoTruncation : 50,
  };
}
