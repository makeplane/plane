...
python .claude/skills/design/scripts/slides/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python .claude/skills/design/scripts/slides/search-slides.py "series a funding" -d strategy --json
```
