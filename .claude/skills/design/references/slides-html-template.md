...
<head>
    ...
    <!-- Zero-dependency default (no CDN). For charts, copy the vendored bundle
         from the design skill's assets/chart/chart.umd.js (v4.4.3) into this
         deck's folder and reference it locally: <script src="chart.umd.js"></script> -->
    <style>
...
```html
<div class="slide slide-with-bg" style="background-image: url('design/backgrounds/hero/hero-01.jpg')">
