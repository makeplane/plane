...
_Remove delta column if `--compare` not set._
...
_Include only when `--team` flag is set. Otherwise omit this section._
...
_Replace with 2-4 factual observations from the data. No invented praise._
...
_3-5 specific, actionable items grounded in the metrics above. No generic advice._

---

_Generated by `ck:retro` — data sourced from git history only_
